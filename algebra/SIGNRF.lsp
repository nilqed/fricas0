...
(SDEFUN |SIGNRF;psign| ((|p| |Polynomial| R) ($ |Union| (|Integer|) "failed"))
        (SPROG
         ((|ans| (|Integer|)) (#1=#:G428 NIL)
          (|u| (|Union| (|Integer|) "failed")) (#2=#:G429 NIL) (|term| NIL)
...
(SDEFUN |SIGNRF;listSign|
        ...
        (SPROG
         ((#2=#:G443 NIL) (#3=#:G444 NIL) (|u| (|Union| (|Integer|) #1#))
          (#4=#:G445 NIL) (|term| NIL))
         (SEQ
          (EXIT
           (SEQ
            (SEQ (LETT |term| NIL) (LETT #4# |l|) G190
                 ...
                 (SEQ (LETT |u| (|SIGNRF;termSign| |term| $))
                      (EXIT
                       (COND
                        ((QEQCAR |u| 1)
                         (PROGN (LETT #3# (CONS 1 "failed")) (GO #5=#:G442)))
                        ('T
                         (SEQ
                          (EXIT
                           (COND
...
(SDEFUN |SIGNRF;termSign|
        ...
        (SPROG ((#1=#:G453 NIL) (#2=#:G454 NIL) (#3=#:G455 NIL) (|var| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ
...
(DEFUN |RationalFunctionSign| (#1=#:G456)
  (SPROG NIL
         (PROG (#2=#:G457)
           (RETURN
            (COND
