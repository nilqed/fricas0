...
(SDEFUN |UPXS;approximateLaurent|
        ((|x| |UnivariateLaurentSeries| |Coef| |var| |cen|) (|term| |Coef|)
         (|n| |Integer|) ($ |Coef|))
        (SPROG
         ((|app| (|Coef|)) (#1=#:G421 NIL) (|m| (|Integer|)) (|e| (|Integer|)))
...
(SDEFUN |UPXS;termsToOutputForm|
        ...
        (SPROG
         ((|l| (|List| (|OutputForm|))) (|uu1| (|Stream| |Coef|)) (|n| NIL)
          (#1=#:G452 NIL) (|count| (|NonNegativeInteger|)))
         (SEQ (LETT |l| NIL)
              (EXIT
               (COND
...
(DEFUN |UnivariatePuiseuxSeries| (&REST #1=#:G482)
  (SPROG NIL
         (PROG (#2=#:G483)
           (RETURN
            (COND
...
(DEFUN |UnivariatePuiseuxSeries;| (|#1| |#2| |#3|)
  (SPROG
   ((|pv$| NIL) (#1=#:G475 NIL) (#2=#:G476 NIL) (#3=#:G477 NIL) (#4=#:G478 NIL)
    (#5=#:G480 NIL) ($ NIL) (|dv$| NIL) (DV$3 NIL) (DV$2 NIL) (DV$1 NIL))
   (PROGN
...
(MAKEPROP '|UnivariatePuiseuxSeries| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL (|UnivariatePuiseuxSeriesConstructor| 6 14)
              ...
              (|Record| (|:| |coef1| $) (|:| |coef2| $)) (|Union| 98 '"failed")
              (|Factored| $) (|Record| (|:| |k| 27) (|:| |c| 6)) (|Stream| 101)
