...
(SDEFUN |LUD;LUDecomp;MR;1|
        ((AA |Matrix| D)
         ($ |Record| (|:| LU (|Matrix| D)) (|:| |Perm| (|Vector| (|Integer|)))
          (|:| |Pivots| (|List| D))))
        (SPROG
         ((#1=#:G407 NIL) (|k| NIL) (|d| (D)) (|Pivs| (|List| D))
          (|i0| (|Integer|)) (|s| (D)) (#2=#:G406 NIL) (#3=#:G405 NIL)
          (|i| NIL) (#4=#:G404 NIL) (#5=#:G403 NIL) (#6=#:G402 NIL) (|j| NIL)
          (|PermV| (|Vector| (|Integer|))) (#7=#:G385 NIL) (|maxC| (|Integer|))
...
(SDEFUN |LUD;LUSolve;MV2V;2|
        ((LU |Matrix| D) (|Perm| |Vector| (|Integer|)) (XX |Vector| D)
         ($ |Vector| D))
        (SPROG
         ((|s| (D)) (#1=#:G421 NIL) (|j| NIL) (#2=#:G420 NIL) (|i| NIL)
          (|ii| (|Integer|)) (#3=#:G419 NIL) (|ip| (|Integer|)) (#4=#:G418 NIL)
...
(SDEFUN |LUD;LUInverse;MR;3|
        ...
        (SPROG
         ((|res| (|Matrix| D)) (|v| (|Vector| D)) (#1=#:G429 NIL) (|i| NIL)
