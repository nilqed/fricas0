...
(SDEFUN |HOMOL;homologyGroup;2M$;1|
        ...
        (SPROG
         ((|kernelFree| (|List| (|Vector| (|Integer|))))
          (|v| (|Vector| (|Integer|))) (#1=#:G407 NIL) (|i| NIL)
          ...
          (|g|
           (|Record| (|:| |vec| (|Vector| (|Integer|)))
                     (|:| |ord| (|Integer|))))
          (|order| (|Integer|)) (|r| (|Vector| (|Integer|))) (#7=#:G406 NIL)
...
(SDEFUN |HOMOL;homology;LLL$;2|
        ...
        (SPROG
         ((|kernelFree| (|List| (|Vector| (|Integer|)))) (#1=#:G419 NIL)
          (|v| NIL) (#2=#:G418 NIL)
          (|res|
           (|List|
            (|Record| (|:| |vec| (|Vector| (|Integer|)))
          ...
          (|r3|
           (|Record| (|:| |vec| (|Vector| (|Integer|)))
                     (|:| |ord| (|Integer|))))
          (#3=#:G416 NIL) (|r1| NIL) (#4=#:G417 NIL) (|r2| NIL))
         (SEQ
          (COND
...
(SDEFUN |HOMOL;=;2$B;9| ((|a| $) (|b| $) ($ |Boolean|))
        (SPROG
         ((#1=#:G442 NIL) (|noTorsionB| #2=(|Boolean|)) (#3=#:G444 NIL)
          (|tb| NIL) (|noTorsionA| #2#) (#4=#:G443 NIL) (|ta| NIL)
          (|torb|
           #5=(|List|
               (|Record| (|:| |vec| (|Vector| (|Integer|)))
                         (|:| |ord| (|Integer|)))))
...
(SDEFUN |HOMOL;coerce;$Of;10| ((|s| $) ($ |OutputForm|))
        (SPROG
         ((|res| (|OutputForm|)) (|firstTermRead| (|Boolean|))
          (|ln2| (|OutputForm|)) (#1=#:G454 NIL) (|t| NIL)
