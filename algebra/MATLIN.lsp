...
(SDEFUN |MATLIN;rowAllZeroes?| ((|x| M) (|i| |Integer|) ($ |Boolean|))
        (SPROG ((#1=#:G403 NIL) (#2=#:G404 NIL) (#3=#:G405 NIL) (|j| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ
...
(SDEFUN |MATLIN;colAllZeroes?| ((|x| M) (|j| |Integer|) ($ |Boolean|))
        (SPROG ((#1=#:G410 NIL) (#2=#:G411 NIL) (#3=#:G412 NIL) (|i| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ
                          ...
                          (EXIT
                           (COND
                            ((SPADCALL (SPADCALL |x| |i| |j| (QREFELT $ 13))
                                       (|spadConstant| $ 14) (QREFELT $ 16))
                             (PROGN
                              (LETT #1# (PROGN (LETT #2# NIL) (GO #4=#:G409)))
                              (GO #5=#:G407))))))
...
(SDEFUN |MATLIN;minorDet|
        ...
        (SPROG
         ((|j| (|Integer|)) (|rl| (|List| (|Integer|))) (|pos| (|Boolean|))
          (#2=#:G438 NIL) (|ans| (R)) (|md| (R)) (#3=#:G425 NIL)
...
(SDEFUN |MATLIN;minordet;MR;4| ((|x| M) ($ R))
        (SPROG
         ((#1=#:G453 NIL) (|i| NIL) (#2=#:G452 NIL) (#3=#:G451 NIL)
          (|maxC| (|Integer|)) (|minR| (|Integer|))
          (|v| (|PrimitiveArray| (|Union| R "uncomputed"))) (#4=#:G442 NIL)
...
(SDEFUN |MATLIN;fractionFreeGauss!;2M;8| ((|x| M) ($ M))
        (SPROG
         ((#1=#:G499 NIL) (|j| NIL) (|lasti| #2=(|Integer|)) (#3=#:G491 NIL)
          (#4=#:G493 NIL) (|i| #5=(|Integer|)) (|b| (R)) (#6=#:G474 NIL)
          (|val| (R)) (#7=#:G498 NIL) (|l| NIL) (|pv| (R)) (#8=#:G497 NIL)
          (#9=#:G496 NIL) (|k| NIL) (|c| (R)) (|ans| (R)) (#10=#:G492 NIL)
          (|rown| #2#) (#11=#:G495 NIL) (#12=#:G494 NIL) (|maxC| (|Integer|))
...
(SDEFUN |MATLIN;lastStep| ((|x| M) ($ M))
        (SPROG
         ((|iCol| #1=(|Integer|)) (#2=#:G504 NIL) (|ss| (R)) (#3=#:G501 NIL)
          (#4=#:G500 (R)) (#5=#:G502 (R)) (#6=#:G513 NIL) (|k| NIL)
          (#7=#:G512 NIL) (|j| NIL) (|i| NIL) (|iRow| #8=(|Integer|))
...
(SDEFUN |MATLIN;rowEchelon;2M;12| ((|y| M) ($ M)) (SPADCALL |y| (QREFELT $ 65))) 
...
(SDEFUN |MATLIN;rank;MNni;21| ((|x| M) ($ |NonNegativeInteger|))
        (SPROG
         ((|rk| (|NonNegativeInteger|)) (#1=#:G552 NIL) (|i| (|Integer|))
...
(SDEFUN |MATLIN;rowEchelon;2M;25| ((|y| M) ($ M))
        (SPROG
         ((|i| #1=(|Integer|)) (#2=#:G602 NIL) (|k1| NIL)
          (|qr| (|Record| (|:| |quotient| R) (|:| |remainder| R)))
          (#3=#:G601 NIL) (|k| NIL) (|xij| (R)) (#4=#:G600 NIL) (|jj| NIL)
          (|un|
           (|Record| (|:| |unit| R) (|:| |canonical| R) (|:| |associate| R)))
          (|val2| (R)) (|val1| (R)) (#5=#:G599 NIL) (|a1| (R)) (#6=#:G575 NIL)
          (|b1| (R)) (|d| (R)) (|b| (R)) (|a| (R)) (|#G67| (R)) (|#G66| (R))
          (|#G65| (R))
          (|aa| (|Record| (|:| |coef1| R) (|:| |coef2| R) (|:| |generator| R)))
          (#7=#:G598 NIL) (|xnj| (R)) (|n| (|Integer|)) (|xkj| (R))
          (#8=#:G597 NIL) (#9=#:G595 NIL) (#10=#:G596 NIL) (|j| NIL)
               ...
               (EXIT
                (SEQ (LETT |j| |minC|) (LETT #10# |maxC|) G190
                     ...
                     (SEQ
                      (COND
                       ((> |i| |maxR|)
                        (PROGN (LETT #9# |$NoValue|) (GO #11=#:G592))))
                      (LETT |n| (- |minR| 1))
...
(DEFUN |MatrixLinearAlgebraFunctions| (&REST #1=#:G604)
  (SPROG NIL
         (PROG (#2=#:G605)
           (RETURN
            (COND
