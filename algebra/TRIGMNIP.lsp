...
(SDEFUN |TRIGMNIP;complexKernels|
        ...
        (SPROG
         ((|lv| (|List| F)) (|lk| (|List| (|Kernel| F)))
          (|u| (|Union| F "failed")) (#1=#:G403 NIL) (|k| NIL))
...
(SDEFUN |TRIGMNIP;kcomplex| ((|k| |Kernel| F) ($ |Union| F "failed"))
        (SPROG
         ((#1=#:G419 NIL) (|u| (|Union| (|Integer|) "failed")) (|a| (F))
          (#2=#:G418 NIL) (|n| (F)) (|arg| (|List| F))
          (|op| (|BasicOperator|)))
...
(SDEFUN |TRIGMNIP;complexNormalize;FSF;9| ((|f| F) (|x| |Symbol|) ($ F))
        (SPROG ((#1=#:G433 NIL) (|g| (F)) (|k| NIL) (#2=#:G432 NIL))
               (SEQ
                (COND
                 ((SPADCALL
...
(SDEFUN |TRIGMNIP;complexElementary;FSF;11| ((|f| F) (|x| |Symbol|) ($ F))
        (SPROG ((#1=#:G446 NIL) (|g| (F)) (|k| NIL) (#2=#:G445 NIL))
               (SEQ
                (COND
                 ((SPADCALL
...
(SDEFUN |TRIGMNIP;localexplogs|
        ...
        (SPROG ((#1=#:G454 NIL) (|k| NIL) (#2=#:G453 NIL))
               (SEQ
...
(DEFUN |TrigonometricManipulations| (&REST #1=#:G458)
  (SPROG NIL
         (PROG (#2=#:G459)
           (RETURN
            (COND
