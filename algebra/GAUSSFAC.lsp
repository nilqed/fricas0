...
(SDEFUN |GAUSSFAC;findelt| ((|q| |Integer|) ($ |Integer|))
        (SPROG
         ((|t| (|FMod|)) (|s| (|FMod|)) (#1=#:G415 NIL) (|i| NIL)
          (|qq1| (|FMod|)) (|r1| (|Union| (|Integer|) "failed"))
          (|r| #2=(|Integer|)) (#3=#:G390 NIL) (|q1| #2#))
...
(SDEFUN |GAUSSFAC;intfactor|
        ...
        (SPROG
         ((|r|
          ...
          (|unity| #1#) (|exp| (|NonNegativeInteger|)) (#2=#:G439 NIL)
