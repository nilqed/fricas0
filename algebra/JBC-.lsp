...
(SDEFUN |JBC-;m2r;LL;1|
        ...
        (SPROG
         ((|k| (|PositiveInteger|)) (|ri| (|List| (|PositiveInteger|)))
          (#1=#:G412 NIL) (|j| NIL) (#2=#:G411 NIL) (|i| NIL))
...
(SDEFUN |JBC-;r2m;LL;2|
        ...
        (SPROG
         ((#1=#:G416 NIL) (|i| NIL) (|mi| (|List| (|NonNegativeInteger|))))
...
(SDEFUN |JBC-;allRepeated;LL;3|
        ...
        (SPROG
         ((|res| (|List| (|List| (|PositiveInteger|))))
          (|tmp| (|List| (|List| (|PositiveInteger|)))) (#1=#:G417 NIL)
          (|nu| (|List| (|NonNegativeInteger|))) (#2=#:G441 NIL) (|i| NIL)
          (#3=#:G442 NIL) (|k| NIL))
         (SEQ (LETT |res| NIL)
...
(SDEFUN |JBC-;class;LNni;5|
        ...
        (SPROG ((|res| (|PositiveInteger|)) (#1=#:G447 NIL) (|i| NIL))
               (SEQ (LETT |res| 1)
...
(SDEFUN |JBC-;order;SNni;7| ((|jv| S) ($ |NonNegativeInteger|))
        (SPROG ((|sum| (|NonNegativeInteger|)) (#1=#:G454 NIL) (|i| NIL))
               (SEQ
                (COND
...
(SDEFUN |JBC-;P;PiLS;15|
        ...
        (SPROG
         ((|lop| (|List| (|PositiveInteger|))) (#1=#:G467 NIL) (#2=#:G472 NIL)
          (|i| NIL))
         (SEQ
          (COND
...
(SDEFUN |JBC-;dimJ;2Nni;18|
        ((|q| |NonNegativeInteger|) ($ |NonNegativeInteger|))
        (SPROG
         ((|res| (|NonNegativeInteger|)) (#1=#:G481 NIL) (#2=#:G485 NIL)
...
(SDEFUN |JBC-;dimS;2Nni;19|
        ((|q| |NonNegativeInteger|) ($ |NonNegativeInteger|))
        (SPROG
         ((|res| (|NonNegativeInteger|)) (#1=#:G492 NIL) (#2=#:G496 NIL)
...
(SDEFUN |JBC-;derivativeOf?;2SL;21|
        ...
        (SPROG
         ((|res| (|List| (|NonNegativeInteger|))) (#1=#:G514 NIL)
          (#2=#:G520 NIL) (#3=#:G521 NIL) (|i1| NIL) (#4=#:G522 NIL) (|i2| NIL)
          (|jt| (|Symbol|)))
         (SEQ
          (EXIT
           (COND
...
(SDEFUN |JBC-;integrateIfCan;SPiU;22|
        ...
        (SPROG
         ((|rind| (|List| (|PositiveInteger|))) (|pos| (|Integer|))
          (#1=#:G526 NIL) (|mi| (|NonNegativeInteger|))
...
(SDEFUN |JBC-;<;2SB;27| ((|jv1| S) (|jv2| S) ($ |Boolean|))
        (SPROG
         ((#1=#:G558 NIL) (#2=#:G559 NIL) (|i1| NIL) (#3=#:G560 NIL) (|i2| NIL)
...
(SDEFUN |JBC-;variables;NniL;29| ((|q| |NonNegativeInteger|) ($ |List| S))
        (SPROG
         ((#1=#:G595 NIL) (#2=#:G612 NIL) (|i| NIL) (#3=#:G611 NIL)
          (#4=#:G592 NIL) (#5=#:G610 NIL) (#6=#:G609 NIL) (JV (|List| S))
          (#7=#:G576 NIL) (#8=#:G608 NIL) (|k| NIL) (#9=#:G607 NIL) (|ind| NIL)
          (|IndList| (|List| (|List| (|PositiveInteger|))))
          (|OIndList| (|List| (|List| (|PositiveInteger|))))
          (|NIndList| (|List| (|List| (|PositiveInteger|)))) (#10=#:G570 NIL)
          (#11=#:G606 NIL) (|j| NIL) (#12=#:G605 NIL) (#13=#:G604 NIL)
          (|qq| NIL) (#14=#:G567 NIL) (#15=#:G603 NIL) (#16=#:G565 NIL)
          (#17=#:G602 NIL) (#18=#:G601 NIL) (#19=#:G563 NIL) (#20=#:G600 NIL))
         (SEQ
          (COND
           ((ZEROP |q|)
            (PROGN
...
(SDEFUN |JBC-;variables;NniPiL;30|
        ...
        (SPROG
         ((JV (|List| S)) (#1=#:G622 NIL) (#2=#:G634 NIL) (|k| NIL)
          (#3=#:G633 NIL) (|ind| NIL)
          (|OIndList| (|List| (|List| (|PositiveInteger|))))
          (|NIndList| (|List| (|List| (|PositiveInteger|)))) (#4=#:G616 NIL)
          (#5=#:G632 NIL) (|j| NIL) (#6=#:G631 NIL) (#7=#:G630 NIL) (|qq| NIL)
          (#8=#:G613 NIL) (#9=#:G629 NIL) (|i| NIL) (#10=#:G628 NIL))
         (SEQ
          (COND ((ZEROP |q|) NIL)
                ('T
                 (SEQ
