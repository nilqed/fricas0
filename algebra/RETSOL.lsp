...
(SDEFUN |RETSOL;LEQQ2F|
        ...
        (SPROG ((#1=#:G383 NIL) (|eq| NIL) (#2=#:G382 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |RETSOL;solveRetract;LLL;4|
        ...
        (SPROG
         ((#1=#:G394 NIL) (|l| NIL) (#2=#:G393 NIL) (#3=#:G392 NIL) (|p| NIL)
          (#4=#:G391 NIL)
...
(SDEFUN |RETSOL;QIfCan|
        ...
        (SPROG
         ((|ans| (|List| (|Fraction| (|Polynomial| Q)))) (#1=#:G405 NIL)
...
(SDEFUN |RETSOL;PQIfCan|
        ...
        (SPROG
         ((|up| (|SparseUnivariatePolynomial| (|Polynomial| R)))
          (|ans| (|Fraction| (|Polynomial| Q))) (#2=#:G423 NIL)
...
(DEFUN |RetractSolvePackage| (&REST #1=#:G424)
  (SPROG NIL
         (PROG (#2=#:G425)
           (RETURN
            (COND
