...
(SDEFUN |IALGFACT;perturbfactor|
        ((|f| |AlPol|) (|k| |Integer|) (|fact| |Mapping| (|Factored| UP) UP)
         ($ |List| |AlPol|))
        (SPROG
         ((#1=#:G387 NIL) (|pp| NIL) (#2=#:G386 NIL) (|pol| (|AlPol|))
...
(SDEFUN |IALGFACT;irrfactor|
        ((|f| |AlPol|) (|k| |Integer|) (|fact| |Mapping| (|Factored| UP) UP)
         ($ |List| |AlPol|))
        (SPROG
         ((|listerm| (|List| |AlPol|)) (|newf| (|AlPol|)) (#1=#:G393 NIL)
          (|g| (|AlPol|)) (#2=#:G403 NIL) (|pelt| NIL)
          (|listfact|
           (|List|
...
(SDEFUN |IALGFACT;factor;AlPolMF;3|
        ((|f| |AlPol|) (|fact| |Mapping| (|Factored| UP) UP)
         ($ |Factored| |AlPol|))
        (SPROG
         ((#1=#:G406 NIL) (#2=#:G405 #3=(|Factored| |AlPol|)) (#4=#:G407 #3#)
          (#5=#:G410 NIL) (#6=#:G409 #3#) (#7=#:G411 #3#) (#8=#:G416 NIL)
          (|pol| NIL) (#9=#:G415 NIL) (|sqterm| NIL)
          (|sqf| (|Factored| |AlPol|)))
...
(DEFUN |InnerAlgFactor| (&REST #1=#:G422)
  (SPROG NIL
         (PROG (#2=#:G423)
           (RETURN
            (COND
