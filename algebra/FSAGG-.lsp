...
(SDEFUN |FSAGG-;coerce;AOf;9| ((|s| A) ($ |OutputForm|))
        (SPROG ((#1=#:G412 NIL) (|x| NIL) (#2=#:G411 NIL))
               (SEQ
                (SPADCALL
                 (PROGN
                  (LETT #2# NIL)
...
(SDEFUN |FSAGG-;universe;A;14| (($ A))
        (SPROG ((#1=#:G431 NIL) (#2=#:G435 NIL) (|i| NIL) (#3=#:G434 NIL))
               (SEQ
                (SPADCALL
                 (PROGN
                  (LETT #3# NIL)
...
(SDEFUN |FSAGG-;index;PiA;17| ((|i| |PositiveInteger|) ($ A))
        (SPROG
         ((#1=#:G439 NIL) (#2=#:G444 NIL) (|j| NIL) (#3=#:G443 NIL)
          (|l| (|Integer|)))
...
(SDEFUN |FSAGG-;lookup;APi;18| ((|s| A) ($ |PositiveInteger|))
        (SPROG
         ((|n| (|PositiveInteger|)) (#1=#:G446 NIL) (#2=#:G450 NIL) (|x| NIL))
         (SEQ (LETT |n| 1)
