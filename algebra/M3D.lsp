...
(SDEFUN |M3D;matrixConcat3D;S3$;1|
        ...
        (SPROG
         ((|retVal| ($)) (#1=#:G406 NIL) (|j| NIL)
          (|temp| (|PrimitiveArray| (|PrimitiveArray| R))) (#2=#:G405 NIL)
          (|i| NIL) (#3=#:G404 NIL)
          (|matRep2|
...
(SDEFUN |M3D;identityMatrix;Nni$;8| ((|iLength| |NonNegativeInteger|) ($ $))
        (SPROG
         ((|row2| (|PrimitiveArray| (|PrimitiveArray| R)))
          (|row1| (|PrimitiveArray| R)) (#1=#:G420 NIL) (|count| NIL)
...
(SDEFUN |M3D;plus;3$;9| ((|mat1| $) (|mat2| $) ($ $))
        (SPROG
         ((|resultMatrix| ($)) (|sum| (R)) (#1=#:G431 NIL) (|k| NIL)
          (#2=#:G430 NIL) (|j| NIL) (#3=#:G429 NIL) (|i| NIL)
...
(SDEFUN |M3D;construct;L$;10| ((|listRep| |List| (|List| (|List| R))) ($ $))
        (SPROG
         ((|resultMatrix| ($)) (|element| (R)) (#1=#:G453 NIL) (|k| NIL)
          (#2=#:G452 NIL) (|j| NIL) (#3=#:G451 NIL) (|i| NIL)
          (|row3| (|PrimitiveArray| (|PrimitiveArray| (|PrimitiveArray| R))))
          (|row2| (|PrimitiveArray| (|PrimitiveArray| R)))
          (|row1| (|PrimitiveArray| R)) (#4=#:G448 NIL) (#5=#:G450 NIL)
          (|subSubList| NIL) (#6=#:G449 NIL) (|subList| NIL)
...
(DEFUN |ThreeDimensionalMatrix| (#1=#:G459)
  (SPROG NIL
         (PROG (#2=#:G460)
           (RETURN
            (COND
...
(DEFUN |ThreeDimensionalMatrix;| (|#1|)
  (SPROG
   ((|pv$| NIL) (#1=#:G457 NIL) (#2=#:G458 NIL) ($ NIL) (|dv$| NIL) (DV$1 NIL))
   (PROGN
