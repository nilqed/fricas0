...
(SDEFUN |PRROOT;get_rational_roots;UPL;1|
        ...
        (SPROG
         ((|res| (|List| (|Fraction| (|Integer|))))
          ...
          (|fac| #1=(|SparseUnivariatePolynomial| (|Integer|))) (#2=#:G388 NIL)
          (|facr| NIL)
          (|facl|
           (|List|
...
(SDEFUN |PRROOT;integerBound;UPI;2| ((|p| UP) ($ |Integer|))
        (SPROG
         ((|res| (|Integer|)) (|q| (|Integer|))
          (|qu| (|Union| (|Integer|) "failed")) (#1=#:G397 NIL) (|r| NIL)
...
(DEFUN |PolynomialRationalRoots| (&REST #1=#:G398)
  (SPROG NIL
         (PROG (#2=#:G399)
           (RETURN
            (COND
