...
(SDEFUN |JLF;collect;2$;23| ((|exp| $) ($ $))
        (SPROG
         ((|rec| (|RepRec|)) (|newLazy| (|List| (|Reference| |LazyTerm|)))
          (|res| #1=(|Boolean|)) (|co| (D)) (#2=#:G466 NIL) (|newSharp?| #1#)
          (|newLD| (JB)) (|newCoeff| #3=(|Union| D $)) (|newEval?| #1#)
          (|d| (D)) (#4=#:G465 NIL) (|prod| #3#) (|der| (|LazyDer|))
          (|lt| (|LazyTerm|)) (#5=#:G554 NIL) (|rlt| NIL))
...
(SDEFUN |JLF;evalDeriv|
        ...
        (SPROG
         ((|dfun| (D)) (#1=#:G463 NIL) (#2=#:G462 NIL) (|fun| (D))
          (#3=#:G466 NIL) (#4=#:G465 NIL) (|der| (|LazyDer|)))
...
(SDEFUN |JLF;evalTerm|
        ...
        (SPROG
         ((|res| (D)) (#1=#:G465 NIL) (|co| (D)) (#2=#:G466 NIL)
          (|lt| (|LazyTerm|)))
         (SEQ (LETT |lt| (SPADCALL |rlt| (QREFELT $ 38)))
              (EXIT
               (COND ((QVELT |lt| 2) |rlt|)
...
(SDEFUN |JLF;eval1;2$;27| ((|exp| $) ($ $))
        (SPROG
         ((|lazy| (|List| (|Reference| |LazyTerm|))) (|ld| (JB))
          (|rlt| (|Reference| |LazyTerm|)) (|d| (D)) (|co| (D)) (#1=#:G465 NIL)
          (|rco| (|LazyTerm|)) (#2=#:G583 NIL) (#3=#:G584 NIL)
          (|rec| (|RepRec|)))
         (SEQ
          (EXIT
           (SEQ (LETT |rec| (SPADCALL |exp| (QREFELT $ 37)))
...
(SDEFUN |JLF;-;2$;37| ((|x| $) ($ $))
        (SPROG
         ((|resLazy| (|List| (|Reference| |LazyTerm|))) (|lt| (|LazyTerm|))
          (#1=#:G615 NIL) (|rlt| NIL) (#2=#:G614 NIL) (|rec| (|RepRec|)))
...
(SDEFUN |JLF;*;3$;41| ((|x| $) (|y| $) ($ $))
        (SPROG
         ((|resSharp?| (|Boolean|)) (|resLD| (JB)) (|resJV2| #1=(|List| JB))
          ...
          (#2=#:G651 NIL) (|ylt| NIL) (#3=#:G650 NIL) (|xlt| NIL)
...
(SDEFUN |JLF;formalDiff2;LPiSemR;49|
        ...
        (SPROG
         ((LJV (|List| (|List| JB))) (JV (|List| JB)) (|LRes| (|List| $))
          (|res| ($)) (|djv| (|Union| JB "0")) (#1=#:G707 NIL) (|df| NIL)
          (#2=#:G708 NIL) (|jv| NIL)
          (|r|
           (|Record| (|:| |Indices| (|List| JB)) (|:| |Entries| (|List| $))))
          (#3=#:G705 NIL) (|l| NIL) (#4=#:G706 NIL) (|f| NIL) (#5=#:G704 NIL)
          (|eq| NIL) (#6=#:G703 NIL) (#7=#:G702 NIL) (#8=#:G701 NIL)
          (|inds| (|List| JB)))
        ...
        (SPROG
         ((|newL|
           (|List|
            (|Record| (|:| |Dep| (|List| (|NonNegativeInteger|)))
                      (|:| |Fun| $))))
          (#1=#:G793 NIL) (|deq| NIL) (#2=#:G794 NIL)
          (|dep| (|List| (|NonNegativeInteger|))) (#3=#:G792 NIL)
          (|newDep| (|List| (|List| (|NonNegativeInteger|))))
          (|ndep| (|List| (|NonNegativeInteger|))) (#4=#:G791 NIL) (|d| NIL)
          (#5=#:G790 NIL) (#6=#:G758 NIL) (#7=#:G789 NIL) (|eq| NIL)
          (#8=#:G788 NIL)
          (|tmp|
           (|Record| (|:| |Sys| (|List| D))
          ...
          (|oldDep| (|List| (|List| (|NonNegativeInteger|)))) (#10=#:G787 NIL)
          (#11=#:G786 NIL) (|sys| (|List| D)) (#12=#:G785 NIL) (#13=#:G784 NIL)
          (|newld| (JB)) (|neweq| ($)) (#14=#:G740 NIL) (#15=#:G783 NIL)
          (|seq|
           (|Record| (|:| |Dep| (|List| (|NonNegativeInteger|)))
                     (|:| |Fun| $)))
          (|solvable?| (|Boolean|)) (|s| (|Union| $ #9#)) (#16=#:G781 NIL)
          (#17=#:G782 NIL)
          (|eqLD|
           (|List|
...
(SDEFUN |JLF;simplify;LSemR;57|
        ...
        (SPROG
         ((|r|
           (|Record| (|:| |Indices| (|List| JB)) (|:| |Entries| (|List| $))))
          (|tmp| (|SparseEchelonMatrix| JB $)) (#1=#:G820 NIL) (|eq| NIL)
          (#2=#:G821 NIL) (|dep| NIL) (|i| NIL)
          (|resJM| (|SparseEchelonMatrix| JB $)) (|inds| (|List| JB))
          (|resDep| (|List| (|List| (|NonNegativeInteger|)))) (#3=#:G819 NIL)
          (|l| NIL) (#4=#:G818 NIL) (|resSys| (|List| $)) (#5=#:G817 NIL)
          (#6=#:G816 NIL)
          (|sl|
           (|List|
            (|Record| (|:| |Dep| (|List| (|NonNegativeInteger|)))
                      (|:| |Fun| $))))
          (#7=#:G815 NIL) (|f| NIL) (#8=#:G814 NIL))
         (SEQ
          (LETT |sl|
                (PROGN
                 (LETT #8# NIL)
...
(SDEFUN |JLF;reduceMod;3L;58|
        ...
        (SPROG
         ((#2=#:G832 NIL) (|d| NIL) (#3=#:G831 NIL) (|sys2D| (|List| D))
          (#4=#:G830 NIL) (|exp| NIL) (#5=#:G829 NIL) (|sys1D| (|List| D))
          (#6=#:G828 NIL) (#7=#:G827 NIL))
         (SEQ
          (LETT |sys1D|
                (PROGN
                 (LETT #7# NIL)
...
(SDEFUN |JLF;autoReduce;2L;59| ((|sys| |List| $) ($ |List| $))
        (SPROG
         ((#1=#:G840 NIL) (|d| NIL) (#2=#:G839 NIL) (|sysD| (|List| D))
          (#3=#:G838 NIL) (|exp| NIL) (#4=#:G837 NIL))
         (SEQ
          (LETT |sysD|
                (PROGN
                 (LETT #4# NIL)
...
(DEFUN |JetLazyFunction| (&REST #1=#:G847)
  (SPROG NIL
         (PROG (#2=#:G848)
           (RETURN
            (COND
