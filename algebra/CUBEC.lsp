...
(SDEFUN |CUBEC;cubicalComplex;LL$;2|
        ...
        (SPROG ((|res| (|List| (|CubicalFacet|))) (#1=#:G394 NIL) (|f| NIL))
               (SEQ (LETT |res| NIL)
...
(SDEFUN |CUBEC;maxIndex;$Nni;5| ((|s| $) ($ |NonNegativeInteger|))
        (SPROG
         ((|res| (|NonNegativeInteger|)) (|m| (|NonNegativeInteger|))
          (|i| (|List| (|Segment| (|Integer|)))) (#1=#:G405 NIL) (|fac| NIL)
...
(SDEFUN |CUBEC;boundary;2$;7| ((|s| $) ($ $))
        (SPROG
         ((|res| ($)) (#1=#:G420 NIL) (|y| NIL) (|x| (|List| (|CubicalFacet|)))
          (#2=#:G419 NIL) (|facet| NIL))
...
(SDEFUN |CUBEC;grade;$L;8| ((|s| $) ($ |List| (|List| (|CubicalFacet|))))
        (SPROG
         ((|gr| (|Integer|)) (#1=#:G431 NIL) (|face| NIL)
          (|res| (|List| (|List| (|CubicalFacet|)))) (#2=#:G430 NIL) (|a| NIL)
          (#3=#:G428 NIL) (|maxGrade| (|NonNegativeInteger|)) (#4=#:G429 NIL)
         ...
         (SEQ
          (EXIT
           (SEQ (LETT |simp| (QCDR |s|)) (LETT |maxGrade| 0)
                ...
                (LETT |res| NIL)
                (COND
                 ((< |maxGrade| 0) (PROGN (LETT #3# |res|) (GO #5=#:G427))))
...
(SDEFUN |CUBEC;isNewFace?|
        ...
        (SPROG ((#1=#:G436 NIL) (#2=#:G437 NIL) (|a| NIL))
               (SEQ
                (EXIT
                 (SEQ
...
(SDEFUN |CUBEC;listUnion|
        ((|a| |List| (|CubicalFacet|)) (|b| |List| (|CubicalFacet|))
         ($ |List| (|CubicalFacet|)))
        (SPROG
         ((|res| (|List| (|CubicalFacet|))) (#1=#:G444 NIL) (|b1| NIL)
          (#2=#:G443 NIL) (|a1| NIL))
         (SEQ (LETT |res| NIL)
...
(SDEFUN |CUBEC;addImpliedFaces;$L;11|
        ...
        (SPROG
         ((|newFaces| (|List| (|CubicalFacet|))) (|len| (|NonNegativeInteger|))
          (#1=#:G461 NIL) (|face| NIL) (#2=#:G460 NIL) (#3=#:G459 NIL)
          (#4=#:G457 NIL) (|gr| NIL) (#5=#:G458 NIL) (|grn| NIL)
          (|res| (|List| (|List| (|CubicalFacet|)))) (#6=#:G456 NIL) (|a| NIL)
          (#7=#:G455 NIL) (|maxGrade| (|NonNegativeInteger|))
         ...
         (SEQ
          (EXIT
           (SEQ (LETT |inputList| (REVERSE (SPADCALL |s| (QREFELT $ 41))))
                ...
                (COND
                 ((< |maxGrade| 1) (PROGN (LETT #7# |res|) (GO #8=#:G454))))
...
(SDEFUN |CUBEC;product;3$;12| ((|a| $) (|b| $) ($ $))
        (SPROG
         ((|res| (|List| (|CubicalFacet|))) (|p| (|CubicalFacet|))
          (#1=#:G473 NIL) (|cubeb| NIL) (#2=#:G472 NIL) (|cubea| NIL)
          (|vs| (|List| VS)) (|pp| (VS)) (#3=#:G471 NIL) (|pb| NIL)
          (#4=#:G470 NIL) (|pa| NIL) (|cubesb| #5=(|List| (|CubicalFacet|)))
          (|cubesa| #5#))
...
(SDEFUN |CUBEC;=;2$B;17| ((|a| $) (|b| $) ($ |Boolean|))
        (SPROG
         ((#1=#:G492 NIL) (#2=#:G496 NIL) (|f| NIL)
          (|x| (|NonNegativeInteger|)) (#3=#:G495 NIL) (|a1| NIL)
          (|flags| (|List| (|Boolean|))) (#4=#:G494 NIL) (#5=#:G493 NIL)
...
(SDEFUN |CUBEC;coerce;$Of;18| ((|s| $) ($ |OutputForm|))
        (SPROG
         ((|res| (|OutputForm|)) (#1=#:G502 NIL) (|a| NIL) (#2=#:G501 NIL))
         (SEQ
          (EXIT
...
(DEFUN |FiniteCubicalComplex| (#1=#:G504)
  (SPROG NIL
         (PROG (#2=#:G505)
           (RETURN
            (COND
