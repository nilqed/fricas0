...
(SDEFUN |FFHOM;initialize| (($ |Void|))
        (SPROG
         ((|matbs| #1=(|Matrix| GF)) (#2=#:G412 NIL) (|matsb| #1#)
          (#3=#:G438 NIL) (|i| NIL) (|mat| #1#)
          (|arr| (|PrimitiveArray| (|SparseUnivariatePolynomial| GF)))
          (#4=#:G437 NIL) (#5=#:G436 NIL) (|rowind| (|Integer|))
...
(DEFUN |FiniteFieldHomomorphisms| (&REST #1=#:G457)
  (SPROG NIL
         (PROG (#2=#:G458)
           (RETURN
            (COND
...
(MAKEPROP '|FiniteFieldHomomorphisms| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) (|local| |#2|)
              ...
              (|NonNegativeInteger|) (8 . ~=) '#:G378 (|Matrix| 7)
