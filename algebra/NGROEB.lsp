...
(SDEFUN |NGROEB;makeCrit|
        ((|sp1| |Record| (|:| |totdeg| (|NonNegativeInteger|))
         ...
         ($ |Record| (|:| |lcmfij| |Expon|)
          ...
          (|:| |polj| |Dpol|)))
        (SPROG
         ((|tdeg| (|NonNegativeInteger|)) (|e2| (|Expon|)) (#1=#:G405 NIL)
...
(SDEFUN |NGROEB;gbasis| ((|Pol| |List| |Dpol|) ($ |List| |Dpol|))
        (SPROG
         ((#1=#:G445 NIL) (|x| NIL) (#2=#:G444 NIL) (|redPols| (|List| |Dpol|))
          (|basPols|
           (|List|
          ...
          (D
           (|List|
            #3=(|Record| (|:| |lcmfij| |Expon|)
                         ...
                         (|:| |poli| |Dpol|) (|:| |polj| |Dpol|))))
          (D1 (|List| #3#)) (#4=#:G443 NIL) (#5=#:G442 NIL) (#6=#:G437 NIL)
          (|h| (|Dpol|)) (|s| (|Dpol|))
          (D0
           (|Record| (|:| |lcmfij| |Expon|)
                     (|:| |totdeg| (|NonNegativeInteger|)) (|:| |poli| |Dpol|)
                     (|:| |polj| |Dpol|)))
          (#7=#:G441 NIL) (#8=#:G440 NIL) (#9=#:G439 NIL) (#10=#:G438 NIL)
                       ...
                       (COND
                        ...
                        ((SPADCALL (SPADCALL |h| (QREFELT $ 16))
                         ...
                         (SEQ (LETT D NIL)
                              ...
                              (EXIT
                               (PROGN (LETT #6# |$NoValue|) (GO #11=#:G433)))))
                        ('T
                         (SEQ
                          (LETT D1
                                (PROGN
...
(DEFUN |NGroebnerPackage| (&REST #1=#:G496)
  (SPROG NIL
         (PROG (#2=#:G497)
           (RETURN
            (COND
