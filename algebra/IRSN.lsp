...
(SDEFUN |IRSN;aIdInverse| (($ |Void|))
        (SPROG
         ((#1=#:G514 NIL) (#2=#:G452 NIL) (#3=#:G429 NIL) (|i| NIL)
          (#4=#:G525 NIL) (|k| NIL) (#5=#:G417 NIL) (#6=#:G401 NIL) (|j| NIL)
          (#7=#:G524 NIL) (|l| NIL) (#8=#:G523 NIL)
          (|idperm| (|List| (|Integer|))) (#9=#:G521 NIL) (#10=#:G522 NIL))
         (SEQ
          (EXIT
           (SEQ (SETELT $ 13 (MAKE_MATRIX1 (QREFELT $ 7) (QREFELT $ 7) 0))
                ...
                (COND
                 ((< (QREFELT $ 10) 5)
                  (PROGN (LETT #9# (QREFELT $ 13)) (GO #11=#:G520))))
                (LETT |idperm| NIL)
...
(SDEFUN |IRSN;alreadyComputed?| ((|lambda| |List| #1=(|Integer|)) ($ |Void|))
        (SPROG
         ((#2=#:G534 NIL) (#3=#:G532 NIL) (#4=#:G531 #1#) (#5=#:G533 #1#)
          (#6=#:G537 NIL) (#7=#:G378 NIL) (#8=#:G527 NIL) (#9=#:G526 NIL))
         (SEQ
          (COND
...
(SDEFUN |IRSN;sumPartition|
        ...
        (SPROG
         ((#1=#:G561 NIL) (|prev| (|Integer|)) (|ok| (|Boolean|))
          (|sum| (|Integer|)) (#2=#:G564 NIL) (|x| NIL))
...
(SDEFUN |IRSN;testPermutation|
        ...
        (SPROG
         ((#1=#:G572 NIL) (#2=#:G576 NIL) (|i| NIL)
          (|test| (|Vector| (|Boolean|))) (#3=#:G569 NIL) (|ok| (|Boolean|))
          (#4=#:G575 NIL))
...
(SDEFUN |IRSN;dimensionOfIrreducibleRepresentation;LNni;7|
        ((|lambda| |List| (|Integer|)) ($ |NonNegativeInteger|))
        (SPROG
         ((#1=#:G579 NIL) (|dd| (|Integer|)) (#2=#:G583 NIL) (|j| NIL)
          (#3=#:G582 NIL) (|i| NIL) (|lambdaprime| (|List| (|Integer|)))
          (|nn| (|Integer|)))
...
(SDEFUN |IRSN;irreducibleRepresentation;LPM;8|
        ((|lambda| |List| (|Integer|)) (|pi| |Permutation| (|Integer|))
         ($ |Matrix| (|Integer|)))
        (SPROG
         ((#1=#:G590 NIL) (|l| NIL) (#2=#:G589 NIL) (|k| NIL)
...
(SDEFUN |IRSN;irreducibleRepresentation;LLL;10|
        ((|lambda| |List| (|Integer|))
         (|listperm| |List| (|Permutation| (|Integer|)))
         ($ |List| (|Matrix| (|Integer|))))
        (SPROG ((#1=#:G599 NIL) (|pi| NIL) (#2=#:G598 NIL))
