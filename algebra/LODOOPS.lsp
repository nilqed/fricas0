...
(SDEFUN |LODOOPS;vec2LODO| ((|v| |Vector| A) ($ L))
        (SPROG
         ((#1=#:G380 NIL) (#2=#:G379 (L)) (#3=#:G381 (L)) (#4=#:G382 NIL)
          (#5=#:G384 NIL) (|i| NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
...
(SDEFUN |LODOOPS;killer|
        ((|u|
         ...
         (|diff| |Mapping| A A) ($ L))
        (SPROG
         ((|lu| (|List| #1#)) (#2=#:G402 NIL) (|l| (|List| (|Vector| A)))
          (|mat| (|Matrix| A)) (#3=#:G403 NIL) (|q| NIL))
         (SEQ
          (EXIT
           (SEQ (LETT |lu| (LIST |u|))
...
(DEFUN |LinearOrdinaryDifferentialOperatorsOps| (&REST #1=#:G414)
  (SPROG NIL
         (PROG (#2=#:G415)
           (RETURN
            (COND
