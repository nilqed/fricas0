...
(SDEFUN |FFIELDC-;createPrimitiveElement;S;8| (($ S))
        (SPROG
         ((|found| (|Boolean|)) (|e| (S)) (#1=#:G765 NIL) (|i| NIL)
...
(SDEFUN |FFIELDC-;primitive?;SB;9| ((|a| S) ($ |Boolean|))
        (SPROG
         ((|equalone| (|Boolean|)) (#1=#:G775 NIL) (|exp| NIL)
          (|q| (|Integer|))
          (|explist|
           (|List|
...
(SDEFUN |FFIELDC-;order;SPi;10| ((|e| S) ($ |PositiveInteger|))
        (SPROG
         ((|ord| (|Integer|)) (|goon| (|Boolean|)) (|a| (|Integer|))
          (#1=#:G784 NIL) (|j| NIL) (|primeDivisor| #2=(|Integer|))
          (#3=#:G783 NIL) (|rec| NIL)
          (|lof|
           (|List|
...
(SDEFUN |FFIELDC-;discreteLog;2SU;12|
        ...
        (SPROG
         ((|a| (S)) (|mult| (|Integer|)) (|disclog| (|Integer|))
          (|rho| (|Integer|)) (#1=#:G824 NIL)
          (|rhoHelp| (|Union| (|NonNegativeInteger|) "failed"))
          (|exp| (|Integer|)) (#2=#:G826 NIL) (|t| NIL) (|primroot| (S))
          (|fac| #3=(|Integer|)) (#4=#:G825 NIL) (|f| NIL)
          (|faclist|
...
(SDEFUN |FFIELDC-;factorSquareFreePolynomial;SupF;15|
        ...
        (SPROG
         ((#1=#:G849 NIL)
          (#2=#:G848 #3=(|Factored| (|SparseUnivariatePolynomial| S)))
          (#4=#:G850 #3#) (#5=#:G853 NIL) (|u| NIL)
          (|flist|
           (|Record| (|:| |cont| S)
                     (|:| |factors|
                          (|List|
         ...
         (SEQ
          (COND
           ...
           (#6='T
            (SEQ
             (LETT |flist| (SPADCALL |f| 'T (QREFELT $ 87))
                   . #7=(|FFIELDC-;factorSquareFreePolynomial;SupF;15|))
             (EXIT
              (SPADCALL (SPADCALL (QCAR |flist|) (QREFELT $ 88))
                        (PROGN
                         (LETT #1# NIL . #7#)
                         (SEQ (LETT |u| NIL . #7#)
...
(MAKEPROP '|FiniteFieldCategory&| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) (0 . |Zero|)
              ...
              (|Factored| 77) (|SparseUnivariatePolynomial| $)
                       ...
                       (CONS '#()
                             (|makeByteWordVec2| 96
                                                 '(0 6 0 7 1 6 10 0 11 1 6 0 10
                                                   ...
                                                   44 65 0 66 1 49 42 0 67 3 68
                                                   57 6 6 31 69 2 44 0 31 0 70
                                                   ...
                                                   0 0 9 2 0 77 77 77 96 1 0 76
                                                   77 93 1 0 76 77 81 1 0 31 0
                                                   60 2 0 57 0 0 71 1 0 0 0 8 0
