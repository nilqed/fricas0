...
(SDEFUN |RECOP;getShiftRec|
        ...
        (SPROG
         ((#1=#:G438 NIL) (|num| (|SparseUnivariatePolynomial| F))
           ...
           (SEQ (LETT |a| (SPADCALL |f| (QREFELT $ 20)))
                (COND
                 ((SPADCALL (CONS #'|RECOP;getShiftRec!0| (VECTOR $ |n|)) |a|
                            (QREFELT $ 25))
                  (PROGN (LETT #1# (CONS 0 0)) (GO #2=#:G437))))
                (COND
...
(SDEFUN |RECOP;shiftInfoRec|
        ((|op| |BasicOperator|) (|argsym| |Symbol|) (|eq| F)
         ($ |Union|
          ...
          "failed"))
        (SPROG
         ((#1=#:G450 NIL) (#2=#:G453 NIL) (|minShift| (|Integer|))
...
(SDEFUN |RECOP;makeRec;BoSFLSF;7|
        ...
        (SPROG
         ((#1=#:G500 NIL) (|info| (|BasicOperator|))
          (|fn| (|Mapping| (|List| F) (|List| F))) (|fl| (|List| F))
          (#2=#:G504 NIL) (|i| NIL) (#3=#:G503 NIL) (|ord1| (|Integer|))
          (|max1| (|Integer|)) (|next| (F)) (#4=#:G502 NIL) (#5=#:G501 NIL)
...
(SDEFUN |RECOP;irecur| ((|l| |List| F) ($ F))
        (SPROG
         ((#1=#:G529 NIL) (|s| (|Stream| F)) (|ll| (|List| F)) (#2=#:G531 NIL)
          (|i| NIL) (#3=#:G530 NIL) (|o| (|NonNegativeInteger|))
          (#4=#:G518 NIL) (|g| (|Mapping| (|List| F) (|List| F)))
          (#5=#:G514 NIL) (N (|NonNegativeInteger|)) (#6=#:G512 NIL)
          (|info|
           (|Record| (|:| |eqn| F) (|:| |idx| (|Symbol|))
                     (|:| |fnc| (|BasicOperator|)) (|:| |par| (|List| F))
                     (|:| |val| (|Stream| F))
...
(SDEFUN |RECOP;ddrec| ((|l| |List| F) ($ |OutputForm|))
        (SPROG
         ((|RecList| (|List| (|OutputForm|))) (#1=#:G541 NIL) (|i| NIL)
          (#2=#:G540 NIL) (|RecEq| #3=(|OutputForm|)) (|RecCoeff| #3#)
          (|v| (|NonNegativeInteger|)) (#4=#:G534 NIL) (|e| (F))
...
(SDEFUN |RECOP;makeFEq;Bo2SFLSF;11|
        ((|op| |BasicOperator|) (|v| |Symbol|) (|argsym| |Symbol|) (|eq| F)
         (|params| |List| F) (|values| |Stream| F) ($ F))
        (SPROG
         ((#1=#:G586 NIL) (|fn| (|Mapping| (|Stream| F)))
...
(SDEFUN |RECOP;iADE| ((|l| |List| F) ($ F))
        (SPROG
         ((#1=#:G604 NIL) (|g| (|Mapping| (|Stream| F))) (#2=#:G596 NIL)
          (N (|NonNegativeInteger|)) (#3=#:G594 NIL)
          (|info|
           (|Record| (|:| |eqn| F) (|:| |idx| (|Symbol|))
                     (|:| |fnc| (|BasicOperator|)) (|:| |var| (|Symbol|))
                     (|:| |par| (|List| F)) (|:| |val| (|Stream| F))
...
(SDEFUN |RECOP;getEq;2F;13| ((|f| F) ($ F))
        (SPROG
         ((#1=#:G613 NIL) (|info| #2=(|BasicOperator|)) (|arg| (|List| F))
...
(SDEFUN |RECOP;eltable?;FB;14| ((|f| F) ($ |Boolean|))
        (SPROG
         ((#1=#:G629 NIL) (|info| #2=(|BasicOperator|)) (|arg| (|List| F))
          (|op| #2#) (|kl| (|List| (|Kernel| F))))
         (SEQ
          (EXIT
           (SEQ (LETT |kl| (SPADCALL |f| (QREFELT $ 50)))
...
(SDEFUN |RECOP;ddADE| ((|l| |List| F) ($ |OutputForm|))
        (SPROG
         ((|TaylorPoly| (|OutputForm|)) (|TaylorO| (|OutputForm|))
          (|TaylorList| (|List| (|OutputForm|))) (#1=#:G645 NIL) (|i| NIL)
          (#2=#:G644 NIL) (|v| (|NonNegativeInteger|)) (#3=#:G634 NIL)
...
(DEFUN |RecurrenceOperator| (&REST #1=#:G654)
  (SPROG NIL
         (PROG (#2=#:G655)
           (RETURN
            (COND
