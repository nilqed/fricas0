...
(SDEFUN |SOLVEFOR;solve;UPL;4| ((|u| UP) ($ |List| F))
        (SPROG
         ((|ls| (|List| F)) (#1=#:G399 NIL) (|i| NIL) (|lsf| (|List| F))
          (#2=#:G398 NIL) (|f| NIL))
         (SEQ (LETT |ls| NIL)
              (SEQ (LETT |f| NIL)
                   (LETT #2#
...
(SDEFUN |SOLVEFOR;cubic;4FL;18|
        ...
        (SPROG
         ((#1=#:G443 NIL) (|u| NIL) (#2=#:G442 NIL) (S (F)) (D (F)) (R (F))
          (Q (F)) (#3=#:G441 NIL) (#4=#:G440 NIL) (P (F)) (#5=#:G439 NIL)
          (#6=#:G438 NIL) (|a3| (F)) (|a2| (F)) (|a1| (F)))
...
(SDEFUN |SOLVEFOR;quartic;5FL;20|
        ...
        (SPROG
         ((#1=#:G455 NIL) (|s| NIL) (#2=#:G454 NIL) (|slist| (|List| F))
...
(DEFUN |PolynomialSolveByFormulas| (&REST #1=#:G460)
  (SPROG NIL
         (PROG (#2=#:G461)
           (RETURN
            (COND
