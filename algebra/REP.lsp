...
(SDEFUN |REP;evalvect|
        ...
        (SPROG
         ((|v| (|Expression| (|Integer|))) (#1=#:G387 NIL) (|i| NIL)
...
(SDEFUN |REP;radicalEigenvector;EML;5|
        ...
        (SPROG
         ((#1=#:G402 NIL) (|v| NIL) (#2=#:G401 NIL) (#3=#:G400 NIL) (|j| NIL)
          (#4=#:G399 NIL) (|i| NIL) (B (|Matrix| (|Expression| (|Integer|))))
          (|n| (|NonNegativeInteger|)))
         ...
         ((|sln|
           (|List|
            (|Record| (|:| |radval| (|Expression| (|Integer|)))
                      ...
                      (|:| |radvect|
                           (|List| (|Matrix| (|Expression| (|Integer|))))))))
          (|nsl| #1#) (#2=#:G427 NIL) (|ep| NIL) (#3=#:G426 NIL)
          (#4=#:G425 NIL) (|alg| NIL)
          (|lval| (|List| (|Expression| (|Integer|)))) (|xx| (|Symbol|))
          (|sym| (|SuchThat| (|Symbol|) (|Polynomial| (|Integer|))))
          (#5=#:G407 NIL) (#6=#:G406 NIL)
          (|veclist| (|List| (|Matrix| (|Expression| (|Integer|)))))
          (#7=#:G424 NIL) (|i| NIL) (|m| (|Matrix| (|Expression| (|Integer|))))
          (#8=#:G423 NIL) (|ll| NIL) (#9=#:G422 NIL) (|eig| NIL)
          (|n| (|NonNegativeInteger|))
          (|leig|
           (|List|
            (|Record|
...
(SDEFUN |REP;gramschmidt;2L;7|
        ...
        (SPROG
         ((|orth| (|List| (|Matrix| (|Expression| (|Integer|)))))
          (|pol| (|Matrix| (|Expression| (|Integer|)))) (#1=#:G435 NIL)
          (#2=#:G434 (RMR)) (#3=#:G436 (RMR)) (#4=#:G442 NIL) (|w| NIL)
          (#5=#:G441 NIL) (|v| (|Matrix| (|Expression| (|Integer|))))
          (RMR
           (|Join|
...
(SDEFUN |REP;eigenMatrix;MU;8|
        ...
        (SPROG
         ((|d| (|Matrix| (|Expression| (|Integer|)))) (#1=#:G458 NIL) (|v| NIL)
          (|n| (|NonNegativeInteger|))
          (|lef| #2=(|List| (|Matrix| (|Expression| (|Integer|)))))
          (#3=#:G448 NIL) (#4=#:G447 #2#) (#5=#:G449 #2#) (#6=#:G457 NIL)
          (|eiv| NIL))
         (SEQ
          (LETT |lef|
                (PROGN
...
(SDEFUN |REP;orthonormalBasis;ML;9|
        ...
        (SPROG
         ((|basis| (|List| (|Matrix| (|Expression| (|Integer|)))))
          ...
          (#1=#:G467 NIL) (|alterm| NIL) (|n| (|NonNegativeInteger|))
          (|alglist|
           (|List|
            (|Record| (|:| |radval| (|Expression| (|Integer|)))
                      (|:| |radmult| (|Integer|))
