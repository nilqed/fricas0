...
(SDEFUN |INEP;evalvect|
        ((|vect| |Matrix| (|SparseUnivariatePolynomial| K)) (|alg| F)
         ($ |Matrix| F))
        (SPROG
         ((|v| (F)) (|polf| (|SparseUnivariatePolynomial| F)) (#1=#:G399 NIL)
...
(SDEFUN |INEP;inteigen|
        ...
        (SPROG
         ((|res|
          ...
          (#1=#:G446 NIL) (|i| NIL)
          (|wk| (|Matrix| (|SparseUnivariatePolynomial| K))) (#2=#:G445 NIL)
          (|vec| NIL) (|sln2| (|List| (|Vector| MM))) (#3=#:G444 NIL) (|j| NIL)
          (#4=#:G443 NIL) (B (AM)) (|alg| (MM))
          (|ppol| (|SparseUnivariatePolynomial| K))
          (|lr| (|List| (|Matrix| F))) (#5=#:G442 NIL) (|wf| (|Matrix| F))
          (#6=#:G441 NIL) (|vecr| NIL) (#7=#:G440 NIL) (#8=#:G439 NIL)
          (B1 (|Matrix| K)) (|alpha| (K))
          (|pol| #9=(|SparseUnivariatePolynomial| K)) (#10=#:G438 NIL)
          (|ff| NIL)
          (|lff|
           (|List|
...
(SDEFUN |INEP;solve1;SupParL;8|
        ...
        (SPROG
         ((|upi| (|SparseUnivariatePolynomial| (|Integer|)))
          (|denom| #1=(|Integer|)) (#2=#:G448 NIL) (#3=#:G447 #1#)
          (#4=#:G449 #1#) (#5=#:G453 NIL) (|c| NIL))
         (SEQ
          (LETT |denom|
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |INEP;solve1;SupParL;9|
        ...
        (SPROG
         ((|upgi| (|SparseUnivariatePolynomial| (|Complex| (|Integer|))))
          (|denom| #1=(|Integer|)) (#2=#:G455 NIL) (#3=#:G454 #1#)
          (#4=#:G456 #1#) (#5=#:G460 NIL) (|c| NIL))
         (SEQ
          (LETT |denom|
                (PROGN
                 (LETT #2# NIL)
        ...
        (SPROG
         ((|sln|
          ...
          (|nsl|
           (|Record| (|:| |outval| F) (|:| |outmult| (|Integer|))
                     (|:| |outvect| (|List| (|Matrix| F)))))
          (#1=#:G475 NIL) (|ep| NIL) (#2=#:G474 NIL) (#3=#:G473 NIL)
          ...
          (|leva|
           (|Record| (|:| |algpol| (|SparseUnivariatePolynomial| K))
                     ...
                     (|:| |poleigen|
                          (|List|
                           (|Matrix| (|SparseUnivariatePolynomial| K))))))
          (#4=#:G472 NIL) (|lev| NIL) (|n| (|NonNegativeInteger|))
          (|sln1|
           (|List|
            (|Union|
             (|Record| (|:| |outval| F) (|:| |outmult| (|Integer|))
...
(DEFUN |InnerNumericEigenPackage| (&REST #1=#:G484)
  (SPROG NIL
         (PROG (#2=#:G485)
           (RETURN
            (COND
