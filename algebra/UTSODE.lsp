...
(SDEFUN |UTSODE;odeNre|
        ((|f| |Mapping| (|Stream| |Coef|) (|List| (|Stream| |Coef|)))
         ...
         ($ |List| (|Stream| |Coef|)))
        (SPROG
         ((|yil| (|List| (|Stream| |Coef|))) (#1=#:G467 NIL) (|c| NIL)
          (#2=#:G468 NIL) (|y| NIL) (#3=#:G466 NIL))
         (SEQ
          (LETT |yil|
                (PROGN
                 (LETT #3# NIL)
...
(SDEFUN |UTSODE;simulre|
        ...
        (SPROG
         ((#1=#:G488 NIL) (|csti| NIL) (#2=#:G489 NIL) (|lsfi| NIL)
          (#3=#:G487 NIL))
         (SEQ
          (PROGN
           (LETT #3# NIL)
...
(SDEFUN |UTSODE;mpsode;LLL;19|
        ((|cs| |List| |Coef|) (|lsts| |List| (|Mapping| UTS (|List| UTS)))
         ($ |List| UTS))
        (SPROG
         ((|stSol| (|List| (|Stream| |Coef|))) (#1=#:G500 NIL) (|lst| NIL)
          (#2=#:G499 NIL))
         (SEQ
          (LETT |stSol|
                (|UTSODE;iMpsode| |cs|
...
(DEFUN |UnivariateTaylorSeriesODESolver| (&REST #1=#:G501)
  (SPROG NIL
         (PROG (#2=#:G502)
           (RETURN
            (COND
