...
(SDEFUN |MATSTOR;copy!;3M;2| ((|c| |Matrix| R) (|a| |Matrix| R) ($ |Matrix| R))
        (SPROG
         ((#1=#:G414 NIL) (|j| NIL) (|cRow| #2=(|PrimitiveArray| R))
          (|aRow| #2#) (#3=#:G413 NIL) (|i| NIL)
...
(SDEFUN |MATSTOR;plus!;4M;3|
        ...
        (SPROG
         ((#1=#:G425 NIL) (|j| NIL) (|cRow| #2=(|PrimitiveArray| R))
          (|bRow| #2#) (|aRow| #2#) (#3=#:G424 NIL) (|i| NIL)
...
(SDEFUN |MATSTOR;minus!;3M;4|
        ...
        (SPROG
         ((#1=#:G434 NIL) (|j| NIL) (|cRow| #2=(|PrimitiveArray| R))
          (|aRow| #2#) (#3=#:G433 NIL) (|i| NIL)
          (|cc| #4=(|PrimitiveArray| (|PrimitiveArray| R))) (|aa| #4#)
          (|n| (|NonNegativeInteger|)) (|m| (|NonNegativeInteger|)))
         (SEQ (LETT |m| (ANROWS |a|)) (LETT |n| (ANCOLS |a|))
              (COND
...
(SDEFUN |MATSTOR;minus!;4M;5|
        ((|c| |Matrix| R) (|a| |Matrix| R) (|b| |Matrix| R) ($ |Matrix| R))
        (SPROG
         ((#1=#:G445 NIL) (|j| NIL) (|cRow| #2=(|PrimitiveArray| R))
          (|bRow| #2#) (|aRow| #2#) (#3=#:G444 NIL) (|i| NIL)
          (|cc| #4=(|PrimitiveArray| (|PrimitiveArray| R))) (|bb| #4#)
          (|aa| #4#) (|n| (|NonNegativeInteger|)) (|m| (|NonNegativeInteger|)))
         (SEQ (LETT |m| (ANROWS |a|)) (LETT |n| (ANCOLS |a|))
              (COND
...
(SDEFUN |MATSTOR;leftScalarTimes!;MR2M;6|
        ...
        (SPROG
         ((#1=#:G454 NIL) (|j| NIL) (|cRow| #2=(|PrimitiveArray| R))
          (|aRow| #2#) (#3=#:G453 NIL) (|i| NIL)
          (|cc| #4=(|PrimitiveArray| (|PrimitiveArray| R))) (|aa| #4#)
          (|n| (|NonNegativeInteger|)) (|m| (|NonNegativeInteger|)))
         (SEQ (LETT |m| (ANROWS |a|)) (LETT |n| (ANCOLS |a|))
              (COND
...
(SDEFUN |MATSTOR;rightScalarTimes!;2MRM;7|
        ...
        (SPROG
         ((#1=#:G463 NIL) (|j| NIL) (|cRow| #2=(|PrimitiveArray| R))
          (|aRow| #2#) (#3=#:G462 NIL) (|i| NIL)
          (|cc| #4=(|PrimitiveArray| (|PrimitiveArray| R))) (|aa| #4#)
          (|n| (|NonNegativeInteger|)) (|m| (|NonNegativeInteger|)))
         (SEQ (LETT |m| (ANROWS |a|)) (LETT |n| (ANCOLS |a|))
              (COND
...
(SDEFUN |MATSTOR;times!;4M;9|
        ((|c| |Matrix| R) (|a| |Matrix| R) (|b| |Matrix| R) ($ |Matrix| R))
        (SPROG
         ((|sum| (R)) (#1=#:G479 NIL) (|k| NIL)
          (|cRow| #2=(|PrimitiveArray| R)) (|aRow| #2#) (#3=#:G478 NIL)
          (|i| NIL) (#4=#:G477 NIL) (|j| NIL) (|n1| #5=(|Integer|)) (|m1| #5#)
          (|bCol| (|PrimitiveArray| R))
...
(SDEFUN |MATSTOR;power!;4MNniM;10|
        ...
        (SPROG
         ((#1=#:G495 NIL) (|flag| (|Boolean|)) (|nn| (|NonNegativeInteger|))
...
(DEFUN |StorageEfficientMatrixOperations| (#1=#:G499)
  (SPROG NIL
         (PROG (#2=#:G500)
           (RETURN
            (COND
