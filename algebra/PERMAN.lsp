...
(SDEFUN |PERMAN;permanent3| ((|x| |SquareMatrix| |n| R) ($ R))
        (SPROG
         ((|a| (R)) (|j| (|Integer|)) (|vv| (|Vector| (|Vector| (|Integer|))))
          (|b| (R)) (#1=#:G393 NIL) (|i| NIL) (|k| (R)) (|sgn| (R))
          (|w| (|Vector| R)))
...
(SDEFUN |PERMAN;permanent;SmR;2| ((|x| |SquareMatrix| |n| R) ($ R))
        (SPROG
         ((|a| (R)) (|j| #1=(|Integer|))
          (|vv| (|Vector| (|Vector| (|Integer|)))) (#2=#:G405 NIL) (|b| (R))
          (#3=#:G415 NIL) (|i| NIL) (|k| #1#) (|sgn| (R)) (#4=#:G414 NIL)
          (#5=#:G400 NIL) (#6=#:G413 NIL) (|rowi| #7=(|Vector| R))
          (#8=#:G412 NIL) (|w| #7#) (#9=#:G411 NIL)
...
(SDEFUN |PERMAN;permanent2| ((|x| |SquareMatrix| |n| R) ($ R))
        (SPROG
         ((#1=#:G432 NIL) (|b| (R)) (#2=#:G430 NIL) (|a| (R))
          (|j| #3=(|Integer|)) (|vv| (|Vector| (|Vector| (|Integer|))))
          (#4=#:G425 NIL) (#5=#:G441 NIL) (|i| NIL) (|c| (R)) (|k| #3#)
          (|sgn| (R)) (#6=#:G440 NIL) (#7=#:G420 NIL) (#8=#:G439 NIL)
          (|rowi| #9=(|Vector| R)) (#10=#:G438 NIL) (|w| #9#) (|two| (R))
          (#11=#:G437 NIL))
         (SEQ
          (EXIT
