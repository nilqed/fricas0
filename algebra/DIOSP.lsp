...
(SDEFUN |DIOSP;dioSolve;ER;1|
        ...
        (SPROG
         ((|vars| (|List| (|Symbol|))) (#1=#:G409 NIL) (|x| NIL)
          (#2=#:G408 NIL) (|ihs| #3=(|List| (|Vector| (|NonNegativeInteger|))))
          ...
          (#4=#:G407 NIL) (|n| (|NonNegativeInteger|))
...
(SDEFUN |DIOSP;initializeGraph|
        ...
        (SPROG
         ((#1=#:G422 NIL) (#2=#:G424 NIL) (|i| NIL) (#3=#:G423 NIL)
          ...
          (|coeffs| (|Vector| (|Integer|))) (#4=#:G421 NIL) (|x| NIL)
          (#5=#:G420 NIL))
         (SEQ
          (LETT |coeffs|
                (SPADCALL
...
(SDEFUN |DIOSP;createNode|
        ((|ind| |Integer|) (|coeffs| |Vector| (|Integer|))
         ...
         ($ |Record| (|:| |vert| (|Vector| (|Integer|)))
          (|:| |is_free| (|Boolean|))))
        (SPROG
         ((#1=#:G432 NIL) (#2=#:G431 NIL) (#3=#:G433 NIL) (|i| NIL)
          (|v| (|Vector| (|Integer|))))
...
(SDEFUN |DIOSP;findSolutions|
        ...
        (SPROG
         ((|sols| (|List| (|Vector| (|NonNegativeInteger|))))
          ...
          (|x| (|NonNegativeInteger|)) (#3=#:G448 NIL) (|i| NIL) (|k| #1#)
          (|v| #2#)
          (|node|
           (|Record| (|:| |vert| (|Vector| (|Integer|)))
                     (|:| |is_free| (|Boolean|)))))
...
(SDEFUN |DIOSP;verifyMinimality|
        ...
        (SPROG
         ((#1=#:G451 NIL) (|x| (|NonNegativeInteger|))
...
(SDEFUN |DIOSP;verifySolution|
        ((|sol| |Vector| (|NonNegativeInteger|)) (|ind| |Integer|)
         ...
         ($ |Boolean|))
        (SPROG
         ((#3=#:G467 NIL) (|flag| (|Boolean|)) (#4=#:G457 NIL)
          (|x| (|NonNegativeInteger|)) (#5=#:G468 NIL) (|i| NIL) (|k| #1#)
          (|v| #2#)
          (|node|
           (|Record| (|:| |vert| (|Vector| (|Integer|)))
                     (|:| |is_free| (|Boolean|)))))
