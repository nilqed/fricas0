...
(SDEFUN |BEZOUT;sylvesterMatrix;2UPM;1| ((|p| UP) (|q| UP) ($ M))
        (SPROG
         ((#1=#:G398 NIL) (|i| NIL) (|q0| (UP))
          (|deg| #2=(|NonNegativeInteger|)) (|coef| (R)) (#3=#:G397 NIL)
...
(SDEFUN |BEZOUT;bezoutMatrix;2UPM;4| ((|p| UP) (|q| UP) ($ M))
        (SPROG
         ((#1=#:G497 NIL) (|k| NIL) (#2=#:G496 NIL) (|i| NIL) (|p0| (UP))
          (|c| (R)) (#3=#:G495 NIL) (|coef| (R))
          (|deg| #4=(|NonNegativeInteger|)) (|q0| (UP)) (#5=#:G494 NIL)
          (|bound| #6=(|Integer|)) (#7=#:G493 NIL) (|bezmat| (M))
          (#8=#:G492 NIL) (#9=#:G491 NIL) (|maxC| (|Integer|))
          (|maxR| (|Integer|)) (|minC| (|Integer|)) (|minR| (|Integer|))
...
(SDEFUN |BEZOUT;subresultant| ((|m| M) (|j| |NonNegativeInteger|) ($ UP))
        (SPROG
         ((#1=#:G499 NIL) (#2=#:G498 (UP)) (#3=#:G500 (UP)) (#4=#:G503 NIL)
          (|k| NIL) (|x| (UP)))
         (SEQ
          (COND
           ((EQL |j| 0)
...
(SDEFUN |BEZOUT;subresultants;2UPIv;6|
        ...
        (SPROG
         ((#1=#:G510 NIL) (|i| NIL) (#2=#:G509 NIL)
          (|j| (|NonNegativeInteger|)) (#3=#:G504 NIL) (|m| (M))
...
(SDEFUN |BEZOUT;bezoutDiscriminant;UPR;8| ((|f| UP) ($ R))
        (SPROG ((#1=#:G513 NIL) (|degMod4| (|Integer|)))
...
(DEFUN |BezoutMatrix| (&REST #1=#:G520)
  (SPROG NIL
         (PROG (#2=#:G521)
           (RETURN
            (COND
