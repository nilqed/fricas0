...
(SDEFUN |IBATOOL;diagonalProduct;MR;1| ((|m| |Matrix| R) ($ R))
        (SPROG
         ((|ans| (R)) (#1=#:G391 NIL) (|i| NIL) (#2=#:G392 NIL) (|j| NIL))
...
(SDEFUN |IBATOOL;matrixGcd;MRNniR;2|
        ...
        (SPROG
         ((#1=#:G399 NIL) (|d| (R)) (|mij| (R)) (#2=#:G401 NIL) (|j| NIL)
          (#3=#:G400 NIL) (|i| NIL))
         (SEQ
          (EXIT
           (SEQ (LETT |d| |sing|)
...
(SDEFUN |IBATOOL;divideIfCan!;2MRIR;3|
        ((|matrix| |Matrix| R) (|matrixOut| |Matrix| R) (|prime| R)
         (|n| |Integer|) ($ R))
        (SPROG
         ((#1=#:G410 NIL) (|a| (|Union| R "failed")) (#2=#:G412 NIL) (|j| NIL)
          (#3=#:G411 NIL) (|i| NIL))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |IBATOOL;idealiserMatrix;3M;5|
        ...
        (SPROG
         ((#1=#:G425 NIL) (|k| NIL) (#2=#:G424 NIL) (|j| NIL)
          (|m| (|Matrix| R)) (|r| (|Matrix| R)) (#3=#:G423 NIL) (|i| NIL)
...
(SDEFUN |IBATOOL;idealiser;2MRM;7|
        ((|ideal| |Matrix| R) (|idealinv| |Matrix| R) (|denom| R)
         ($ |Matrix| R))
        (SPROG ((|bigm| (|Matrix| R)) (#1=#:G429 NIL))
               (SEQ
                (LETT |bigm|
                      (PROG2
                          (LETT #1#
...
(DEFUN |IntegralBasisTools| (&REST #1=#:G446)
  (SPROG NIL
         (PROG (#2=#:G447)
           (RETURN
            (COND
