...
(SDEFUN |TABLBUMP;slex;LL;7| ((|ls| |List| S) ($ |List| (|List| S)))
        (SPROG
         ((#1=#:G414 NIL) (|i| NIL) (#2=#:G415 NIL) (|j| NIL) (#3=#:G413 NIL))
         (SEQ
          (SPADCALL
           (PROGN
            (LETT #3# NIL)
...
(SDEFUN |TABLBUMP;inverse;2L;8| ((|ls| |List| S) ($ |List| S))
        (SPROG
         ((#1=#:G420 NIL) (#2=#:G422 NIL) (|i| NIL) (#3=#:G423 NIL) (|j| NIL)
          (#4=#:G421 NIL) (|lss| NIL) (#5=#:G419 NIL))
         (SEQ
          (PROGN
           (LETT #5# NIL)
           (SEQ (LETT |lss| NIL)
...
(SDEFUN |TABLBUMP;bat1;LL;13|
        ...
        (SPROG ((#1=#:G443 NIL) (|lls| NIL) (#2=#:G442 NIL))
               (SEQ
                (SPADCALL NIL
                          (PROGN
                           (LETT #2# NIL)
