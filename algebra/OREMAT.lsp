...
(SDEFUN |OREMAT;rowEchelon;MFLR;2|
        ((|m| |Matrix| LO) (|cc| F) (|lv| |List| (|Vector| F))
         ($ |Record| (|:| |mat| (|Matrix| LO))
          (|:| |vecs| (|List| (|Vector| F)))))
        (SPROG
         ((|i| (|Integer|)) (#1=#:G430 NIL) (|w| NIL) (#2=#:G429 NIL)
          (|k1| NIL) (|r| (LO)) (|q| (LO))
          (|#G18| (|Record| (|:| |quotient| LO) (|:| |remainder| LO)))
          (|mkj| (LO)) (#3=#:G428 NIL) (|k| NIL) (|elf2| (F)) (|elf1| (F))
          (#4=#:G427 NIL) (|el2| (LO)) (|el1| (LO)) (#5=#:G426 NIL) (|v| (LO))
          (|u| (LO)) (|d| (LO)) (|c| (LO)) (|mij| (LO))
          (|#G14|
           (|Record| (|:| |generator| LO) (|:| |coef1| LO) (|:| |coef2| LO)
                     (|:| |coefu| LO) (|:| |coefv| LO)))
          (#6=#:G425 NIL) (#7=#:G424 NIL) (|mm| (|Matrix| LO))
          (|dpiv| (|Integer|)) (|pivk| (|Integer|))
          (|dp1| (|NonNegativeInteger|)) (#8=#:G423 NIL) (#9=#:G418 NIL)
          (#10=#:G422 NIL) (|j| NIL) (#11=#:G421 NIL)
          (|nr| (|NonNegativeInteger|)) (|nc| (|NonNegativeInteger|))
          (|lw| (|List| (|Vector| F))) (#12=#:G420 NIL) (|vv| NIL)
          (#13=#:G419 NIL))
               ...
               (EXIT
                (SEQ (LETT |j| 1) (LETT #10# |nc|) G190
                     ...
                     (SEQ
                      (COND
                       ((> |i| |nr|)
                        (PROGN (LETT #9# |$NoValue|) (GO #14=#:G415))))
...
(SDEFUN |OREMAT;triangular_solve|
        ((|m| |Matrix| LO) (|cc| F) (|lv| |List| (|Vector| F))
         ...
         ($ |Union|
          ...
          "failed"))
        (SPROG
         ((#4=#:G509 NIL) (|ba| NIL) (#5=#:G510 NIL) (|bv| #6=(|Vector| F))
          (#7=#:G508 NIL) (|bvl| (|List| (|Vector| F))) (|cba| (|List| #6#))
          (|cb| (|List| #6#)) (|ncba| (|List| (|Vector| F)))
          (|na| (|Vector| F)) (|ncb| (|List| (|Vector| F))) (#8=#:G507 NIL)
          (|k| NIL) (|nbcv2| #6#) (#9=#:G506 NIL) (|nbcv1| #6#)
          (#10=#:G504 NIL) (|j| NIL) (#11=#:G505 NIL) (|slj| NIL)
          (|nsl2| (|List| F)) (|nbvl| (|List| (|Vector| F))) (#12=#:G503 NIL)
          (|nbcv| #6#) (#13=#:G475 NIL) (#14=#:G474 NIL)
          (|nrl1| (|NonNegativeInteger|)) (#15=#:G502 NIL) (#16=#:G501 NIL)
          (|ss| (F)) (#17=#:G500 NIL) (|slk| NIL) (#18=#:G499 NIL)
          (|noff| (|NonNegativeInteger|)) (|cm2| (|Matrix| F))
          (|cm1| (|Matrix| F)) (#19=#:G498 NIL) (|ncv| NIL) (#20=#:G497 NIL)
          (|nsl1| (|List| F)) (#21=#:G496 NIL) (|pr| NIL) (#22=#:G495 NIL)
          (|ncvl| (|List| #3#)) (#23=#:G494 NIL) (#24=#:G493 NIL)
          (|nrl| (|NonNegativeInteger|)) (|prl| #2#) (#25=#:G492 NIL)
          (|be| NIL) (|resi| #1#) (|lvi| (|List| F)) (|lvi2| (|List| F))
          (|vvi| (F)) (#26=#:G491 NIL) (#27=#:G489 NIL) (#28=#:G490 NIL)
          (|lvi1| (|List| F)) (#29=#:G488 NIL) (#30=#:G487 NIL)
          (|nbas| #31=(|NonNegativeInteger|)) (|nlvi| (|NonNegativeInteger|))
          (#32=#:G486 NIL) (#33=#:G485 NIL) (|lvi0| (|List| F))
          (#34=#:G484 NIL) (|v| NIL) (#35=#:G483 NIL) (#36=#:G476 NIL)
          (|i| NIL) (#37=#:G481 NIL) (#38=#:G482 NIL) (#39=#:G480 NIL)
          (#40=#:G479 NIL) (#41=#:G478 NIL) (#42=#:G477 NIL) (|n| #31#)
          (|nr| (|NonNegativeInteger|)) (|nc| (|NonNegativeInteger|)))
         (SEQ
          (EXIT
...
(DEFUN |OrePolynomialMatrixOperations| (&REST #1=#:G525)
  (SPROG NIL
         (PROG (#2=#:G526)
           (RETURN
            (COND
