...
(SDEFUN |TBAGG-;coerce;SOf;5| ((|t| S) ($ |OutputForm|))
        (SPROG ((#1=#:G402 NIL) (|k| NIL) (#2=#:G401 NIL))
               (SEQ
...
(SDEFUN |TBAGG-;parts;SL;10|
        ...
        (SPROG ((#1=#:G427 NIL) (|k| NIL) (#2=#:G426 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |k| NIL) (LETT #1# (SPADCALL |t| (QREFELT $ 18)))
...
(SDEFUN |TBAGG-;=;2SB;13| ((|s| S) (|t| S) ($ |Boolean|))
        (SPROG
         ((#1=#:G443 NIL) (#2=#:G444 NIL) (|e| (|Union| |Entry| "failed"))
          (#3=#:G445 NIL) (|k| NIL))
         (SEQ
          (EXIT
...
(SDEFUN |TBAGG-;find;MSU;17|
        ((|f| |Mapping| (|Boolean|)
         ...
         ($ |Union| (|Record| (|:| |key| |Key|) (|:| |entry| |Entry|))
          "failed"))
        (SPROG ((#1=#:G478 NIL) (#2=#:G479 NIL) (|ke| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ (LETT |ke| NIL) (LETT #2# (SPADCALL |t| (QREFELT $ 58)))
                       ...
                       (SEQ
                        (EXIT
                         (COND
                          ((SPADCALL |ke| |f|)
                           (PROGN (LETT #1# (CONS 0 |ke|)) (GO #3=#:G477))))))
...
(SDEFUN |TBAGG-;any?;MSB;21|
        ...
        (SPROG ((#1=#:G498 NIL) (#2=#:G499 NIL) (|k| NIL))
               (SEQ
                (EXIT
                 (SEQ
...
(SDEFUN |TBAGG-;every?;MSB;22|
        ((|f| |Mapping| (|Boolean|) |Entry|) (|t| S) ($ |Boolean|))
        (SPROG ((#1=#:G504 NIL) (#2=#:G505 NIL) (|k| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ (LETT |k| NIL) (LETT #2# (SPADCALL |t| (QREFELT $ 18)))
...
(SDEFUN |TBAGG-;count;MSNni;23|
        ...
        (SPROG ((|tally| (|NonNegativeInteger|)) (#1=#:G509 NIL) (|k| NIL))
               (SEQ (LETT |tally| 0)
                    (SEQ (LETT |k| NIL)
                         (LETT #1# (SPADCALL |t| (QREFELT $ 18))) G190
                         (COND
