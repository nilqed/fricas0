...
(SDEFUN |FRAC;gcdPolynomial;3Sup;34|
        ...
        (SPROG
         ((|lc| (S)) (|g| (|SparseUnivariatePolynomial| S))
          ...
          (#3=#:G1063 NIL) (#4=#:G1062 (S)) (#5=#:G1064 (S)) (#6=#:G1073 NIL)
          (|u| NIL) (|ppD| #2#) (|denpp| (S)) (#7=#:G1059 NIL) (#8=#:G1058 (S))
          (#9=#:G1060 (S)) (#10=#:G1072 NIL))
         (SEQ
...
(SDEFUN |FRAC;clear| ((|l| |List| $) ($ |List| S))
        (SPROG
         ((#1=#:G1106 NIL) (#2=#:G1113 NIL) (|x| NIL) (#3=#:G1112 NIL)
          (|d| (S)) (#4=#:G1103 NIL) (#5=#:G1102 (S)) (#6=#:G1104 (S))
          (#7=#:G1111 NIL))
         (SEQ
          (LETT |d|
                (PROGN
...
(SDEFUN |FRAC;conditionP;MU;39|
        ...
        (SPROG
         ((#2=#:G1131 NIL) (#3=#:G1133 NIL) (|i| NIL) (#4=#:G1132 NIL)
          (|ansDD| (|Vector| S)) (|ansD| (|Union| (|Vector| S) #1#))
          (|matD| (|Matrix| S)) (#5=#:G1130 NIL) (|l| NIL) (#6=#:G1129 NIL))
         (SEQ
          (LETT |matD|
                (SPADCALL
                 (PROGN
...
(SDEFUN |FRAC;factorPolynomial;SupF;40|
        ...
        (SPROG
         ((|lfact|
          ...
          (|den1| ($)) (|lc| ($)) (#2=#:G1156 NIL) (|w| NIL) (#3=#:G1155 NIL)
          (|ff| (|Factored| (|SparseUnivariatePolynomial| S)))
          (|ppD| (|SparseUnivariatePolynomial| S)) (|denpp| (S))
          (#4=#:G1135 NIL) (#5=#:G1134 (S)) (#6=#:G1136 (S)) (#7=#:G1154 NIL)
          (|u| NIL))
         (SEQ
         ...
         ((|lfact|
           (|List|
            (|Record| (|:| |flag| (|Union| "nil" "sqfr" "irred" "prime"))
                      (|:| |factor| (|SparseUnivariatePolynomial| $))
                      (|:| |exponent| (|NonNegativeInteger|)))))
          (|den1| ($)) (|lc| ($)) (#2=#:G1180 NIL) (|w| NIL) (#3=#:G1179 NIL)
          (|ff| (|Factored| (|SparseUnivariatePolynomial| S)))
          (|ppD| (|SparseUnivariatePolynomial| S)) (|denpp| (S))
          (#4=#:G1160 NIL) (#5=#:G1159 (S)) (#6=#:G1161 (S)) (#7=#:G1178 NIL)
          (|u| NIL) (|lcpp| ($)))
         (SEQ
          (COND ((SPADCALL |pp| (QREFELT $ 80)) (|spadConstant| $ 118))
...
(DEFUN |Fraction;| (|#1|)
  (SPROG
   ((|pv$| NIL) (#1=#:G1200 NIL) (#2=#:G1201 NIL) (#3=#:G1202 NIL)
    (#4=#:G1204 NIL) (#5=#:G1203 NIL) ($ NIL) (|dv$| NIL) (DV$1 NIL))
   (PROGN
