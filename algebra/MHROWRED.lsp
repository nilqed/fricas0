...
(SDEFUN |MHROWRED;non0|
        ((|v| |Vector| R) (|rown| |Integer|)
         ($ |Union|
          ...
          "failed"))
        (SPROG
         ((#2=#:G411 NIL) (|ans| #1#) (|allZero| (|Boolean|)) (#3=#:G412 NIL)
          (|i| NIL))
         (SEQ
          (EXIT
           (SEQ (LETT |allZero| 'T)
...
(SDEFUN |MHROWRED;mkMat|
        ...
        (SPROG
         ((|ll| (|List| (|List| R))) (#1=#:G430 NIL) (|i| NIL) (#2=#:G429 NIL))
         (SEQ
          (COND
           ((NULL
             (LETT |ll|
...
(SDEFUN |MHROWRED;diagSubMatrix|
        ((|x| |Matrix| R)
         ($ |Union| (|Record| (|:| |val| R) (|:| |mat| (|Matrix| R)))
          "failed"))
        (SPROG
         ((#1=#:G479 NIL) (#2=#:G480 NIL) (#3=#:G491 NIL) (|r| NIL)
          (#4=#:G490 NIL) (#5=#:G489 NIL) (|z| NIL) (#6=#:G488 NIL)
          (#7=#:G487 NIL) (#8=#:G486 NIL) (#9=#:G483 NIL) (#10=#:G485 NIL)
          (#11=#:G484 NIL) (|a| NIL)
          (|l|
           (|List|
...
(SDEFUN |MHROWRED;determinantOfMinor| ((|x| |Matrix| R) ($ R))
        (SPROG
         ((#1=#:G500 NIL) (#2=#:G501 NIL) (|j| (|Integer|)) (|d| (R))
          (#3=#:G506 NIL) (|n| (|Integer|)) (|i| NIL)
          (|lr| (|List| (|Integer|))) (#4=#:G505 NIL) (#5=#:G504 NIL)
          (|lc| (|List| (|Integer|))) (#6=#:G503 NIL) (#7=#:G502 NIL)
...
(SDEFUN |MHROWRED;enumerateBinomial|
        ((|l| |List| (|Integer|)) (|m| |Integer|) (|i| |Integer|)
         ($ |List| (|Integer|)))
        (SPROG
         ((#1=#:G512 NIL) (|b| (|Integer|)) (#2=#:G513 NIL) (|n| (|Integer|))
          (|j| NIL) (|m1| (|Integer|)))
         (SEQ
          (EXIT
...
(SDEFUN |MHROWRED;order| ((|m| R) (|p| R) ($ |Integer|))
        (SPROG ((#1=#:G530 NIL) (|mm| (|Union| R "failed")) (|i| NIL))
               (SEQ
                (EXIT
...
(SDEFUN |MHROWRED;rowEchelonLocal;M2RM;13|
        ...
        (SPROG
         ((|i| #1=(|Integer|)) (#2=#:G581 NIL) (|k1| NIL)
          (|qr| (|Record| (|:| |quotient| R) (|:| |remainder| R)))
          (#3=#:G580 NIL) (|k| NIL) (|v2| (R)) (#4=#:G579 NIL) (|q| (R))
          (#5=#:G556 NIL) (#6=#:G578 NIL) (#7=#:G577 NIL) (|pivot| (R))
          (|d| (R)) (|b| (R)) (|a| (R))
          (|#G79|
           (|Record| (|:| |coef1| R) (|:| |coef2| R) (|:| |generator| R)))
          (|x| (|Matrix| R)) (#8=#:G573 NIL) (|pivord| #9=(|Integer|))
          (|rown| (|Integer|)) (|npivord| #9#) (#10=#:G576 NIL)
          (#11=#:G574 NIL) (#12=#:G575 NIL) (|j| NIL) (|minr| #1#)
          (|ncols| (|Integer|)) (|nrows| (|Integer|)) (#13=#:G547 NIL))
         (SEQ
          (LETT |m|
                (SPADCALL |p|
           ...
           (EXIT
            (SEQ (LETT |j| (PROGN |x| 1)) (LETT #12# |ncols|) G190
                 ...
                 (SEQ
                  (COND
                   ((> |i| |nrows|)
                    (PROGN (LETT #11# |$NoValue|) (GO #14=#:G570))))
                  (LETT |rown| (- |minr| 1))
...
(SDEFUN |MHROWRED;rowEchelon1| ((|y| |Matrix| R) (|m| R) ($ |Matrix| R))
        (SPROG
         ((|i| #1=(|Integer|)) (#2=#:G620 NIL) (|k1| NIL)
          (|qr| (|Record| (|:| |quotient| R) (|:| |remainder| R)))
          (#3=#:G619 NIL) (|k| NIL) (|xij| (R)) (#4=#:G618 NIL) (|jj| NIL)
          (|un|
           (|Record| (|:| |unit| R) (|:| |canonical| R) (|:| |associate| R)))
          (|v2| (R)) (|v1| (R)) (#5=#:G617 NIL) (|a1| (R)) (|b1| (R))
          (|#G98| (R)) (#6=#:G593 NIL) (|#G97| (R)) (|d| (R)) (|b| (R))
          (|a| (R))
          (|#G96|
           (|Record| (|:| |coef1| R) (|:| |coef2| R) (|:| |generator| R)))
          (#7=#:G616 NIL) (|x| (|Matrix| R)) (|rown| (|Integer|))
          (#8=#:G615 NIL) (#9=#:G613 NIL) (#10=#:G614 NIL) (|j| NIL)
               ...
               (EXIT
                (SEQ (LETT |j| (PROGN |x| 1)) (LETT #10# |ncols|) G190
                     ...
                     (SEQ
                      (COND
                       ((> |i| |nrows|)
                        (PROGN (LETT #9# |$NoValue|) (GO #11=#:G610))))
                      (LETT |rown| (- |minr| 1))
...
(DEFUN |ModularHermitianRowReduction| (#1=#:G621)
  (SPROG NIL
         (PROG (#2=#:G622)
           (RETURN
            (COND
