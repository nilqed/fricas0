...
(SDEFUN |GALPOLYU;factorsOfDegree;PiFL;1|
        ...
        (SPROG
         ((|lfact| (|List| UP)) (#1=#:G386 NIL) (|i| NIL) (#2=#:G385 NIL)
          (|fr| NIL))
         (SEQ (LETT |lfact| NIL)
...
(SDEFUN |GALPOLYU;factorOfDegree;PiFUP;2|
        ...
        (SPROG ((#1=#:G392 NIL) (|factor| (UP)) (#2=#:G393 NIL) (|i| NIL))
               (SEQ
                (EXIT
...
(SDEFUN |GALPOLYU;reverse;2UP;5| ((|p| UP) ($ UP))
        (SPROG
         ((|r| (UP)) (#1=#:G400 NIL) (#2=#:G404 NIL) (|i| NIL)
...
(DEFUN |GaloisGroupPolynomialUtilities| (&REST #1=#:G420)
  (SPROG NIL
         (PROG (#2=#:G421)
           (RETURN
            (COND
