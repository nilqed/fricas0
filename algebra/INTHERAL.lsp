...
(SDEFUN |INTHERAL;HermiteIntegrate;RMRR;2|
        ((|f| R) (|derivation| |Mapping| UP UP) (|d0| R)
         ($ |Record| (|:| |answer| R) (|:| |logpart| R)))
        (SPROG
         ((|iden| (UP)) (|inum| #1=(|Vector| UP)) (#2=#:G395 NIL)
          (#3=#:G411 NIL) (#4=#:G413 NIL) (|i| NIL) (#5=#:G412 NIL)
          (|ratform| (R)) (|cnum| #1#)
          (|corr| #6=(|Record| (|:| |num| #1#) (|:| |den| UP))) (|s0| (R))
          (|sol| (|Vector| UP)) (|p| (UP)) (|j| (|NonNegativeInteger|))
          (#7=#:G400 NIL) (|nn| (|Integer|)) (|sys| (|Matrix| UP)) (|u'| (UP))
          (|u| (UP)) (|v| (UP)) (#8=#:G410 NIL) (|trm| NIL) (|coef| (UP))
...
(SDEFUN |INTHERAL;localsolve|
        ...
        (SPROG
         ((#1=#:G430 NIL)
          ...
          (#2=#:G434 NIL) (|i| NIL)
          (|sol| (|Union| (|Vector| (|Fraction| UP)) "failed")) (#3=#:G431 NIL)
          (#4=#:G432 NIL) (|j| NIL) (#5=#:G433 NIL) (|k| NIL)
          (|ans| (|Vector| UP)))
         (SEQ
          (EXIT
...
(DEFUN |AlgebraicHermiteIntegration| (&REST #1=#:G435)
  (SPROG NIL
         (PROG (#2=#:G436)
           (RETURN
            (COND
