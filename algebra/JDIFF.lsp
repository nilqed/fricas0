...
(SDEFUN |JDIFF;coerce;$Of;6| ((|om| $) ($ |OutputForm|))
        (SPROG
         ((#1=#:G411 NIL) (|c| NIL) (#2=#:G412 NIL) (|jb| NIL) (#3=#:G410 NIL))
         (SEQ
          (COND
...
(SDEFUN |JDIFF;+;3$;14| ((|om1| $) (|om2| $) ($ $))
        (SPROG
         ((|lj2| (|List| JB)) (|lc2| (|List| D)) (|resJ| (|List| JB))
          (|resC| (|List| D)) (|sum| (D)) (#1=#:G440 NIL) (|c1| NIL)
          (#2=#:G441 NIL) (|j1| NIL))
         (SEQ
...
(SDEFUN |JDIFF;*;D2$;15| ((|f| D) (|om| $) ($ $))
        (SPROG ((#1=#:G446 NIL) (|c| NIL) (#2=#:G445 NIL))
               (SEQ
...
(SDEFUN |JDIFF;d;D$;16| ((|f| D) ($ $))
        (SPROG
         ((|Co| (|List| D)) (#1=#:G452 NIL) (|jv| NIL) (#2=#:G451 NIL)
          (JV (|List| JB)))
...
(SDEFUN |JDIFF;eval;$JvfD;17| ((|om| $) (|v| |JetVectorField| JB D) ($ D))
        (SPROG
         ((|lj2| (|List| JB)) (|lc2| (|List| D)) (|res| (D)) (#1=#:G465 NIL)
          (|c1| NIL) (#2=#:G466 NIL) (|j1| NIL))
         (SEQ
          (COND
...
(DEFUN |JetDifferential| (&REST #1=#:G472)
  (SPROG NIL
         (PROG (#2=#:G473)
           (RETURN
            (COND
...
(DEFUN |JetDifferential;| (|#1| |#2|)
  (SPROG
   ((|pv$| NIL) (#1=#:G471 NIL) ($ NIL) (|dv$| NIL) (DV$2 NIL) (DV$1 NIL))
   (PROGN
