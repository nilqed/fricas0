         ...
         ((#1=#:G400 NIL)
          (|res|
           (|Record| (|:| |particular| (|Union| (|Vector| R) "failed"))
                     (|:| |basis| (|List| (|Vector| R)))))
          (#2=#:G404 NIL) (|i| NIL) (|transitionMatrix| (|Matrix| R))
...
(SDEFUN |SCPKG;structuralConstants;LV;3|
        ...
        (SPROG
         ((#1=#:G418 NIL) (|k| NIL) (|covec| (|Vector| R)) (#2=#:G417 NIL)
          (|j| NIL) (#3=#:G416 NIL) (|i| NIL) (|sC| (|Vector| (|Matrix| R)))
          (#4=#:G413 NIL) (#5=#:G415 NIL) (#6=#:G414 NIL)
          (|m| (|NonNegativeInteger|)) (#7=#:G405 NIL))
         (SEQ
          (LETT |m|
...
(SDEFUN |SCPKG;structuralConstants;LMV;4|
        ...
        (SPROG
         ((|lscopy| (|List| (|Symbol|)))
          ...
          (|p| (|Polynomial| R)) (#1=#:G431 NIL) (|j| NIL) (#2=#:G430 NIL)
...
(SDEFUN |SCPKG;structuralConstants;LMV;5|
        ...
        (SPROG
         ((|lscopy| (|List| (|Symbol|)))
          ...
          (|r| (|Fraction| (|Polynomial| R))) (#1=#:G445 NIL) (|j| NIL)
          (#2=#:G444 NIL) (|i| NIL) (|s| (|Symbol|))
...
(DEFUN |StructuralConstantsPackage| (#1=#:G446)
  (SPROG NIL
         (PROG (#2=#:G447)
           (RETURN
            (COND
