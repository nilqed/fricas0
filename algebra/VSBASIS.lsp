...
(SDEFUN |VSBASIS;column2matrix| ((|Lv| |List| (|Vector| R)) ($ |Matrix| R))
        (SPROG
         ((#1=#:G399 NIL) (|k| NIL) (#2=#:G400 NIL) (|v| NIL) (M (|Matrix| R))
...
(SDEFUN |VSBASIS;subVector|
        ...
        (SPROG ((#1=#:G414 NIL) (|k| NIL) (|vv| (|Vector| R)) (#2=#:G410 NIL))
               (SEQ
                (LETT |vv|
                      (MAKEARR1
                       (PROG1 (LETT #2# (+ (- |b| |a|) 1))
...
(SDEFUN |VSBASIS;linearSum|
        ...
        (SPROG
         ((#1=#:G422 NIL) (|j| NIL) (|t2| (R)) (#2=#:G420 NIL) (|k| NIL)
          (#3=#:G421 NIL) (|v2| NIL) (|vv| (|Vector| R)))
         (SEQ
          (LETT |vv|
...
(SDEFUN |VSBASIS;intBasis0|
        ((|Lv| |List| (|Vector| R)) (|Lw| |List| (|Vector| R)) ($ $))
        (SPROG
         ((#1=#:G439 NIL) (|cc| NIL) (#2=#:G438 NIL)
          (|LcoeffB1| (|List| (|Vector| R))) (#3=#:G437 NIL) (|kv| NIL)
          (#4=#:G436 NIL) (|lker| (|List| (|Vector| R))) (#5=#:G434 NIL)
          (|k| NIL) (#6=#:G435 NIL) (|v| NIL) (#7=#:G432 NIL) (#8=#:G433 NIL)
...
(SDEFUN |VSBASIS;=;2$B;25| ((B1 $) (B2 $) ($ |Boolean|))
        (SPROG
         ((|rks| #1=(|NonNegativeInteger|)) (#2=#:G461 NIL) (|rk2| #1#)
          (|rk1| #1#))
         (SEQ
          (EXIT
           (COND
...
(SDEFUN |VSBASIS;canonicalBasis;Nni$;26| ((|n| |NonNegativeInteger|) ($ $))
        (SPROG
         ((L (|List| (|Vector| R))) (|v| (|Vector| R)) (#1=#:G466 NIL)
          (|k| NIL))
         (SEQ (LETT L NIL)
...
(SDEFUN |VSBASIS;complementSpace;L$;27| ((|Lv| |List| (|Vector| R)) ($ $))
        (SPROG
         ((|ind| (|NonNegativeInteger|)) (RES ($)) (#1=#:G476 NIL) (|k| NIL)
          (#2=#:G477 NIL) (|v| NIL) (#3=#:G474 NIL) (#4=#:G475 NIL)
...
(SDEFUN |VSBASIS;complementSpace;2$;29| ((B $) ($ $))
        (SPROG
         ((|ind| (|NonNegativeInteger|)) (RES ($)) (#1=#:G485 NIL) (|k| NIL)
          (#2=#:G486 NIL) (|v| NIL) (|n| (|NonNegativeInteger|))
