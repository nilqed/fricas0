...
(SDEFUN |VSBASIS;column2matrix| ((|Lv| |List| (|Vector| R)) ($ |Matrix| R))
        (SPROG
         ((#1=#:G734 NIL) (|k| NIL) (#2=#:G735 NIL) (|v| NIL) (M (|Matrix| R))
...
(SDEFUN |VSBASIS;subVector|
        ...
        (SPROG ((#1=#:G749 NIL) (|k| NIL) (|vv| (|Vector| R)) (#2=#:G745 NIL))
               (SEQ
                (LETT |vv|
                      (MAKEARR1
                       (PROG1
...
(SDEFUN |VSBASIS;linearSum|
        ...
        (SPROG
         ((#1=#:G757 NIL) (|j| NIL) (|t2| (R)) (#2=#:G755 NIL) (|k| NIL)
          (#3=#:G756 NIL) (|v2| NIL) (|vv| (|Vector| R)))
         (SEQ
          (LETT |vv|
...
(SDEFUN |VSBASIS;intBasis;2L$;15|
        ((|Lv| |List| (|Vector| R)) (|Lw| |List| (|Vector| R)) ($ $))
        (SPROG
         ((#1=#:G774 NIL) (|cc| NIL) (#2=#:G773 NIL)
          (|LcoeffB1| (|List| (|Vector| R))) (#3=#:G772 NIL) (|kv| NIL)
          (#4=#:G771 NIL) (|lker| (|List| (|Vector| R))) (#5=#:G769 NIL)
          (|k| NIL) (#6=#:G770 NIL) (|v| NIL) (#7=#:G767 NIL) (#8=#:G768 NIL)
...
(SDEFUN |VSBASIS;=;2$B;24| ((B1 $) (B2 $) ($ |Boolean|))
        (SPROG
         ((|rks| #1=(|NonNegativeInteger|)) (#2=#:G797 NIL) (|rk2| #1#)
          (|rk1| #1#))
         (SEQ
          (EXIT
           (COND
...
(SDEFUN |VSBASIS;canonicalBasis;Nni$;25| ((|n| |NonNegativeInteger|) ($ $))
        (SPROG
         ((L (|List| (|Vector| R))) (|v| (|Vector| R)) (#1=#:G802 NIL)
          (|k| NIL))
...
(SDEFUN |VSBASIS;complementSpace;L$;26| ((|Lv| |List| (|Vector| R)) ($ $))
        (SPROG
         ((|ind| (|NonNegativeInteger|)) (RES ($)) (#1=#:G812 NIL) (|k| NIL)
          (#2=#:G813 NIL) (|v| NIL) (#3=#:G810 NIL) (#4=#:G811 NIL)
...
(SDEFUN |VSBASIS;complementSpace;2$;28| ((B $) ($ $))
        (SPROG
         ((|ind| (|NonNegativeInteger|)) (RES ($)) (#1=#:G821 NIL) (|k| NIL)
          (#2=#:G822 NIL) (|v| NIL) (|n| (|NonNegativeInteger|))
