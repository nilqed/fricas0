...
(SDEFUN |UTSODETL;UP2UTS;UPUTS;1| ((|p| UP) ($ UTS))
        (SPROG
         ((#1=#:G379 NIL) (#2=#:G378 (UTS)) (#3=#:G380 (UTS)) (#4=#:G383 NIL)
          (|i| NIL) (|q| (UP)))
         (SEQ
          (LETT |q|
                (SPADCALL |p|
...
(SDEFUN |UTSODETL;UTS2UP;UTSNniUP;2|
        ...
        (SPROG
         ((|xmcn| (UP)) (|ans| (UP)) (#1=#:G388 NIL) (|i| NIL) (|xmc| (UP)))
         (SEQ
          (LETT |xmc|
...
(SDEFUN |UTSODETL;LODO2FUN;LM;3| ((|op| L) ($ |Mapping| UTS (|List| UTS)))
        (SPROG
         ((|v| (|Vector| UTS)) (#1=#:G399 NIL) (#2=#:G401 NIL) (|i| NIL)
          (#3=#:G400 NIL) (|n| (|NonNegativeInteger|)) (#4=#:G393 NIL)
          (|a| (UTS)) (#5=#:G391 NIL))
         (SEQ
          (LETT |a|
                (PROG2
...
(SDEFUN |UTSODETL;fun| ((|v| |Vector| UTS) (|l| |List| UTS) ($ UTS))
        (SPROG ((|ans| (UTS)) (#1=#:G405 NIL) (|b| NIL) (|i| NIL))
