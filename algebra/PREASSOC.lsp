...
(SDEFUN |PREASSOC;makeMonic|
        ...
        (SPROG
         ((#1=#:G398 NIL) (|u| (|Union| R "failed")) (#2=#:G399 NIL)
          (#3=#:G390 NIL) (|i| NIL) (|a| (|PrimitiveArray| R))
                ...
                (SEQ (LETT |i| 0)
                     ...
                     (SEQ
                      ...
                      (EXIT
                       (COND
                        ((QEQCAR |u| 1)
                         (PROGN (LETT #1# (CONS 1 "failed")) (GO #4=#:G397)))
                        ('T
                         (QSETAREF1 |a| |i|
...
(DEFUN |PrecomputedAssociatedEquations| (&REST #1=#:G422)
  (SPROG NIL
         (PROG (#2=#:G423)
           (RETURN
            (COND
