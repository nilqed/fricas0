...
(SDEFUN |COCHNC;validate;$B;3| ((|a| $) ($ |Boolean|))
        (SPROG
         ((|last| #1=(|Matrix| (|Integer|))) (#2=#:G393 NIL)
          (|prod| (|Matrix| (|Integer|))) (|m| #1#) (#3=#:G394 NIL) (|x| NIL)
          (|len| (|NonNegativeInteger|)))
         (SEQ
          (EXIT
           (SEQ (LETT |len| (LENGTH |a|))
                (COND ((< |len| 2) (PROGN (LETT #2# 'T) (GO #4=#:G392))))
...
(SDEFUN |COCHNC;coboundary;$Nni2L;4|
        ...
        (SPROG
         ((|res| (|List| VS)) (#1=#:G408 NIL) (|i| NIL) (#2=#:G407 NIL)
          (|res1| (|List| VS)) (|val| (VS)) (#3=#:G406 NIL) (|v| NIL)
          (|fst| (|Boolean|)) (|vs| (|Vector| (|Integer|)))
          (|m| (|Matrix| (|Integer|))) (|b| (|Vector| (|Integer|)))
          (|base| (|List| (|Integer|))) (#4=#:G405 NIL) (|x| NIL)
          (#5=#:G404 NIL) (#6=#:G403 NIL) (|p| NIL)
...
(SDEFUN |COCHNC;coHomology;$L;5| ((|a| $) ($ |List| (|Homology|)))
        (SPROG
         ((|prev| (|Matrix| (|Integer|))) (|notFirst| (|Boolean|))
          (|res| (|List| (|Homology|))) (|m2| (|Homology|)) (#1=#:G414 NIL)
          (|m1| NIL))
...
(SDEFUN |COCHNC;coerce;$Of;6| ((|s| $) ($ |OutputForm|))
        (SPROG
         ((|lst| (|List| (|OutputForm|))) (#1=#:G419 NIL) (|x| NIL)
          (#2=#:G418 NIL))
         (SEQ
          (LETT |lst|
                (PROGN
