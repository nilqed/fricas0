...
(SDEFUN |APPRULE;applist|
        ((|lrule| |List| (|RewriteRule| |Base| R F)) (|arglist| |List| F)
         ($ |List| F))
        (SPROG ((#1=#:G389 NIL) (|arg| NIL) (#2=#:G388 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |APPRULE;splitRules|
        ...
        (SPROG
         ((|lv| (|List| F)) (|lk| (|List| (|Kernel| F)))
          ...
          (|u| (|Union| (|Equation| F) "failed")) (#1=#:G399 NIL) (|r| NIL))
...
(SDEFUN |APPRULE;localApply|
        ((|lk| |List| (|Kernel| F)) (|lv| |List| F)
         ...
         (|n| |PositiveInteger|) ($ F))
        (SPROG
         ((#1=#:G415 NIL) (|k| NIL) (#2=#:G416 NIL) (|v| NIL) (#3=#:G414 NIL)
          (|i| NIL))
         (SEQ
...
(SDEFUN |APPRULE;rewrite|
        ((|f| F) (|res| |PatternMatchResult| |Base| F) (|l| |List| (|Symbol|))
         ($ F))
        (SPROG
         ((|lv| (|List| F)) (|lk| (|List| (|Kernel| F))) (#1=#:G422 NIL)
          (|rec| NIL))
...
(SDEFUN |APPRULE;isitwithpred|
        ...
        (SPROG
         ((#1=#:G427 NIL) (#2=#:G435 NIL) (|v| NIL) (#3=#:G424 NIL)
...
(SDEFUN |APPRULE;isit|
        ((|subject| F) (|pat| |Pattern| |Base|)
         ($ |PatternMatchResult| |Base| F))
        (SPROG ((#1=#:G440 NIL) (|l| (|List| (|Pattern| |Base|))) (|v| NIL))
               (SEQ
                (COND
...
(SDEFUN |APPRULE;app|
        ...
        (SPROG
         ((#1=#:G465 NIL) (#2=#:G462 NIL) (#3=#:G460 NIL) (|f| (F))
          (|ee| (|Record| (|:| |val| F) (|:| |exponent| (|Integer|))))
          (|e|
           (|Union| (|Record| (|:| |val| F) (|:| |exponent| (|Integer|)))
                    #4="failed"))
          (#5=#:G453 NIL) (#6=#:G452 (F)) (#7=#:G454 (F)) (#8=#:G476 NIL)
          (#9=#:G379 NIL) (|l| (|Union| (|List| F) #4#)) (#10=#:G450 NIL)
          (#11=#:G449 (F)) (#12=#:G451 (F)) (#13=#:G475 NIL) (#14=#:G378 NIL)
          (|k| (|Union| (|Kernel| F) "failed")) (#15=#:G472 NIL)
          (#16=#:G473 NIL) (|u| (|PatternMatchResult| |Base| F))
          (#17=#:G474 NIL) (|r| NIL))
         (SEQ
          (EXIT
           (SEQ
