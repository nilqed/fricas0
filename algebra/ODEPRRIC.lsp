...
(SDEFUN |ODEPRRIC;poly1|
        ...
        (SPROG
         ((#1=#:G408 NIL) (#2=#:G407 #3=(|SparseUnivariatePolynomial| UP))
          (#4=#:G409 #3#) (#5=#:G411 NIL) (|j| NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
        ...
        ((|n| |NonNegativeInteger|)
         (|l| |List|
          (|Record| (|:| |ij| (|List| (|Integer|)))
                    (|:| |deg| (|NonNegativeInteger|))))
         ($ |List| (|Integer|)))
        (SPROG ((#1=#:G416 NIL) (|r| NIL) (#2=#:G415 NIL))
               (SEQ
                (SPADCALL
                 (SPADCALL
                  (PROGN
...
(SDEFUN |ODEPRRIC;denomRicDE;LUP;8| ((|l| L) ($ UP))
        (SPROG
         ((#1=#:G418 NIL) (#2=#:G417 (UP)) (#3=#:G419 (UP)) (#4=#:G421 NIL)
          (|c| NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
...
(SDEFUN |ODEPRRIC;refine|
        ((|l| |List| UP) (|ezfactor| |Mapping| (|Factored| UP) UP)
         ($ |List| UP))
        (SPROG
         ((#1=#:G435 NIL) (|r| NIL) (#2=#:G434 NIL) (#3=#:G433 NIL) (|p| NIL)
          (#4=#:G432 NIL))
         (SEQ
          (SPADCALL
           (PROGN
...
(SDEFUN |ODEPRRIC;padicsol|
        ...
        (SPROG
         ((|ans| (|List| (|Record| (|:| |frac| (|Fraction| UP)) (|:| |eq| L))))
          (#1=#:G456 NIL) (|sol| NIL) (#2=#:G455 NIL)
          (|sols|
           (|List| (|Record| (|:| |frac| (|Fraction| UP)) (|:| |eq| L))))
          (#3=#:G441 NIL) (|neweq| (L)) (|rcn| (|Fraction| UP)) (#4=#:G454 NIL)
          (|r| NIL) (#5=#:G453 NIL) (|rec| NIL)
          (|lc|
           (|List|
         ...
         ((|done| (|List| (|NonNegativeInteger|)))
          (|ans|
           (|List|
            (|Record| (|:| |deg| (|NonNegativeInteger|))
                      (|:| |eq| (|SparseUnivariatePolynomial| UP)))))
          (|ind| (|List| (|Integer|))) (#1=#:G468 NIL) (|rec| NIL)
          (|lb|
           (|List|
            (|Record| (|:| |ij| (|List| (|Integer|)))
                      (|:| |deg| (|NonNegativeInteger|))))))
...
(SDEFUN |ODEPRRIC;getPol|
        ((|rec| |Record| (|:| |ij| (|List| (|Integer|)))
         ...
         ($ |SparseUnivariatePolynomial| UP))
        (SPROG
         ((#1=#:G471 NIL) (#2=#:G470 #3=(|SparseUnivariatePolynomial| UP))
          (#4=#:G472 #3#) (#5=#:G475 NIL) (#6=#:G474 NIL) (#7=#:G478 NIL)
          (|i| NIL))
         (SEQ
...
(SDEFUN |ODEPRRIC;getPol1|
        ((|ind| |List| (|Integer|)) (|c| UP) (|l| L)
         ($ |SparseUnivariatePolynomial| UP))
        (SPROG
         ((#1=#:G480 NIL) (#2=#:G479 #3=(|SparseUnivariatePolynomial| UP))
          (#4=#:G481 #3#) (#5=#:G515 NIL) (#6=#:G518 NIL) (|i| NIL)
          (|cp| (UP)))
...
(SDEFUN |ODEPRRIC;constantCoefficientRicDE;LML;15|
        ...
        (SPROG
         ((#1=#:G530 NIL) (|a| NIL) (#2=#:G529 NIL)
          (|m| #3=(|NonNegativeInteger|)) (#4=#:G521 NIL) (#5=#:G520 #3#)
          (#6=#:G522 #3#) (#7=#:G528 NIL) (|p| NIL))
         (SEQ
          (LETT |m|
                (PROGN
                 (LETT #4# NIL)
...
(SDEFUN |ODEPRRIC;getPoly|
        ...
        (SPROG
         ((#1=#:G538 NIL) (#2=#:G537 (UP)) (#3=#:G539 (UP)) (#4=#:G542 NIL)
          (#5=#:G541 NIL) (#6=#:G544 NIL) (|i| NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
           (SEQ (LETT |i| NIL) (LETT #6# |ind|) G190
...
(SDEFUN |ODEPRRIC;innermax|
        ...
        (SPROG
         ((|ans| (|List| (|Integer|))) (#1=#:G552 NIL) (|k| #2=(|Integer|))
          (|f| (UP)) (#3=#:G553 NIL) (|j| NIL) (|m| #2#) (#4=#:G547 NIL)
        ...
        (SPROG
         ((|done| (|List| (|NonNegativeInteger|)))
          (|ans|
           (|List|
            (|Record| (|:| |deg| (|NonNegativeInteger|)) (|:| |eq| UP))))
          (|ind| (|List| (|Integer|))) (#1=#:G566 NIL) (|rec| NIL)
          (|lb|
           (|List|
            (|Record| (|:| |ij| (|List| (|Integer|)))
                      (|:| |deg| (|NonNegativeInteger|))))))
...
(SDEFUN |ODEPRRIC;changeVar;LUPL;21| ((|l| L) (|a| UP) ($ L))
        (SPROG ((|dpan| (L)) (|op| (L)) (#1=#:G577 NIL) (|i| NIL) (|dpa| (L)))
               (SEQ
                (LETT |dpa|
...
(SDEFUN |ODEPRRIC;changeVar;LFL;22| ((|l| L) (|a| |Fraction| UP) ($ L))
        (SPROG
         ((|dpan| (LQ)) (|op| (LQ)) (#1=#:G583 NIL) (|i| NIL) (|dpa| (LQ)))
         (SEQ
          (LETT |dpa|
        ...
        (SPROG
         ((|lb|
           (|List|
            (|Record| (|:| |ij| (|List| (|Integer|)))
                      (|:| |deg| (|NonNegativeInteger|)))))
          (#1=#:G596 NIL) (|b| (|Integer|))
          (|u| (|Union| (|Integer|) "failed")) (|lj| (UP)) (#2=#:G604 NIL)
          (|j| NIL) (|li| (UP)) (#3=#:G603 NIL) (|i| NIL)
          (|n| (|NonNegativeInteger|)))
...
(SDEFUN |ODEPRRIC;fracsol|
        ...
        (SPROG
         ((|ans| (|List| (|Record| (|:| |frac| (|Fraction| UP)) (|:| |eq| L))))
          (#1=#:G630 NIL) (|sol| NIL) (#2=#:G629 NIL)
          (|sols|
           (|List| (|Record| (|:| |frac| (|Fraction| UP)) (|:| |eq| L))))
          (|neweq| (L)) (#3=#:G628 NIL) (|rec| NIL))
         (SEQ (LETT |ans| NIL)
              (EXIT
               (COND ((NULL |lc|) |ans|)
                     ((NULL
...
(SDEFUN |ODEPRRIC;polysol|
        ...
        (SPROG
         ((|ans| (|List| (|Record| (|:| |poly| UP) (|:| |eq| L))))
          (#1=#:G648 NIL) (|sol| NIL) (#2=#:G647 NIL)
          (|sols| (|List| (|Record| (|:| |poly| UP) (|:| |eq| L))))
          (#3=#:G635 NIL) (|neweq| (L)) (|atn| (UP)) (#4=#:G646 NIL) (|a| NIL)
          (#5=#:G645 NIL) (|rec| NIL)
          (|lc|
           (|List|
            (|Record| (|:| |deg| (|NonNegativeInteger|)) (|:| |eq| UP)))))
...
(DEFUN |PrimitiveRatRicDE| (&REST #1=#:G649)
  (SPROG NIL
         (PROG (#2=#:G650)
           (RETURN
            (COND
