...
(SDEFUN |SCNP;isPointLeaf?;$B;4| ((|n| $) ($ |Boolean|))
        (SPROG ((#1=#:G417 NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (COND ((QEQCAR |n| 0) (PROGN (LETT #1# 'T) (GO #2=#:G416))))
                  (EXIT 'NIL)))
                #2# (EXIT #1#)))) 
...
(SDEFUN |SCNP;isNodeLeaf?;$B;5| ((|n| $) ($ |Boolean|))
        (SPROG ((#1=#:G420 NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (COND ((QEQCAR |n| 1) (PROGN (LETT #1# 'T) (GO #2=#:G419))))
                  (EXIT 'NIL)))
                #2# (EXIT #1#)))) 
...
(SDEFUN |SCNP;isNodeBranch?;$B;6| ((|n| $) ($ |Boolean|))
        (SPROG ((#1=#:G423 NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (COND ((QEQCAR |n| 2) (PROGN (LETT #1# 'T) (GO #2=#:G422))))
                  (EXIT 'NIL)))
                #2# (EXIT #1#)))) 

(SDEFUN |SCNP;getNames;$L;7| ((|n| $) ($ |List| (|String|)))
        (SPROG ((#1=#:G401 NIL) (#2=#:G427 NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (COND
                   ((QEQCAR |n| 0)
                    (PROGN (LETT #2# (QCDR (CDR |n|))) (GO #3=#:G426))))
                  (EXIT
                   (QCDR
                    (PROG2 (LETT #1# |n|)
                        (QCDR #1#)
...
(SDEFUN |SCNP;findPoint;$SPT;8| ((|n| $) (|ptName| |String|) ($ PT))
        (SPROG
         ((#1=#:G436 NIL) (#2=#:G399 NIL) (|s| (|String|)) (#3=#:G437 NIL)
          (|sNum| NIL) (|fst| ($)) (|c| (|List| $)) (#4=#:G401 NIL))
         (SEQ
          (EXIT
           (SEQ
            (COND
...
(SDEFUN |SCNP;addNode!;$SS$;10|
        ...
        (SPROG
         ((#1=#:G400 NIL) (#2=#:G448 NIL) (#3=#:G401 NIL) (|fst| ($))
          (|c| (|List| $)) (|scnd| ($)))
         (SEQ
          (EXIT
           (SEQ
                 ...
                 (SEQ
                  ...
                  (PROGN
                   (RPLACD
                    ...
                    (LIST "useNames"))
                   (QCDR #5#))
                  (EXIT (PROGN (LETT #2# |scnd|) (GO #6=#:G447))))))
               (LETT |fst| (SPADCALL |c| (QREFELT $ 24)))
               (COND
                ((SPADCALL |fst| (QREFELT $ 17))
                 (PROGN
...
(SDEFUN |SCNP;findNode;$SS;11| ((|n| $) (|ptName| |String|) ($ |Scene| PT))
        (SPROG
         ((#1=#:G455 NIL) (#2=#:G400 NIL) (#3=#:G456 NIL) (|name| NIL)
          (#4=#:G457 NIL) (|namei| NIL) (|fst| ($)) (|c| (|List| $))
          (#5=#:G401 NIL))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |SCNP;toString;$S;12| ((|n| $) ($ |String|))
        (SPROG
         ((|s| (|String|)) (#1=#:G477 NIL) (|l1| NIL) (#2=#:G478 NIL)
          (|ptr| NIL) (#3=#:G475 NIL) (|lst| NIL) (#4=#:G476 NIL)
          (#5=#:G472 NIL) (|lenPT| (|NonNegativeInteger|))
          (|lenNM| (|NonNegativeInteger|)) (#6=#:G473 NIL) (#7=#:G474 NIL))
         (SEQ
          (EXIT
           (SEQ (LETT |s| "")
                (COND
...
(SDEFUN |SCNP;coerce;$Of;16| ((|n| $) ($ |OutputForm|))
        (SPROG
         ((|s| (|OutputForm|)) (#1=#:G512 NIL) (|l1| NIL) (#2=#:G513 NIL)
          (|ptr| NIL) (#3=#:G510 NIL) (|lst| NIL) (#4=#:G511 NIL)
          (#5=#:G507 NIL) (|lenPT| (|NonNegativeInteger|))
          (|lenNM| (|NonNegativeInteger|)) (#6=#:G508 NIL) (#7=#:G509 NIL))
         (SEQ
          (EXIT
