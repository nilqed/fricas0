...
(SDEFUN |PGROEB;lexGroebner;LLL;1|
        ((|lp| |List| (|Polynomial| F)) (|lv| |List| (|Symbol|))
         ($ |List| (|Polynomial| F)))
        (SPROG
         ((#1=#:G385 NIL) (|pp| NIL) (#2=#:G384 NIL) (|gb| (|List| |DPoly|))
          (|b| (|List| |DPoly|)) (#3=#:G383 NIL) (|pol| NIL) (#4=#:G382 NIL)
          (OV
...
(SDEFUN |PGROEB;totalGroebner;LLL;2|
        ((|lp| |List| (|Polynomial| F)) (|lv| |List| (|Symbol|))
         ($ |List| (|Polynomial| F)))
        (SPROG
         ((#1=#:G393 NIL) (|pp| NIL) (#2=#:G392 NIL) (|gb| (|List| |HDPoly|))
          (|b| (|List| |HDPoly|)) (#3=#:G391 NIL) (|pol| NIL) (#4=#:G390 NIL)
          (OV
           (|Join| (|OrderedFinite|) (|ConvertibleTo| (|Symbol|))
                   (|ConvertibleTo| (|InputForm|))
                   (|ConvertibleTo| (|Pattern| (|Float|)))
