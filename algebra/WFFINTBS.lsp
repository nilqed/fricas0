...
(SDEFUN |WFFINTBS;iLocalIntegralBasis|
        ...
        (SPROG
         ((#1=#:G421 NIL) (#2=#:G422 NIL) (|oldIndex| (R)) (|indexChange| (R))
          (|rbinv| #3=(|Matrix| R)) (|rbden| (R)) (|rb| #3#) (|index| (R))
          (|idinv| (|Matrix| R)) (|id| (|Matrix| R)) (#4=#:G431 NIL) (|j| NIL)
          (#5=#:G430 NIL) (|vec| NIL) (|i| NIL) (#6=#:G429 NIL) (#7=#:G428 NIL)
          (|ns| (|List| (|Vector| |sae|))) (|frobPow| (|Matrix| |sae|))
          (#8=#:G427 NIL) (#9=#:G426 NIL) (#10=#:G425 NIL) (|r| NIL)
          (|tmpMat| (|Matrix| |sae|)) (|frob| (|Matrix| |sae|))
          (|pPows| (|Matrix| |sae|)) (|coMat| (|Matrix| R))
          (|coMat0| (|Union| (|Matrix| R) "failed")) (|denPow| (R))
          (#11=#:G398 NIL) (|coor0| (|Matrix| R)) (|bi| (F)) (#12=#:G424 NIL)
          (#13=#:G423 NIL) (|lp| (|NonNegativeInteger|))
         ...
         ((|runningRbinv| #1=(|Matrix| R)) (|runningRb| #1#)
          ...
          (|lb|
           (|Record| (|:| |basis| #3#) (|:| |basisDen| R) (|:| |basisInv| #2#)
                     (|:| |discr| R)))
          (#4=#:G442 NIL) (|prime| NIL) (|matrixOut| #5=(|Matrix| R))
...
(DEFUN |WildFunctionFieldIntegralBasis| (&REST #1=#:G452)
  (SPROG NIL
         (PROG (#2=#:G453)
           (RETURN
            (COND
