         ...
         ((|g| (|DistributedMultivariatePolynomial| |lv| F))
          (|linp|
           (|SparseUnivariatePolynomial|
            (|DistributedMultivariatePolynomial| |lv| F)))
          (|lc| (|DistributedMultivariatePolynomial| |lv| F)) (#2=#:G397 NIL)
          ...
          (#3=#:G399 NIL) (|df| (|NonNegativeInteger|)))
...
(SDEFUN |GROEBSOL;genPos|
        ...
        (SPROG
         ((#1=#:G404 NIL) (|testfail| (|Boolean|))
          ...
          (#3=#:G437 NIL) (|p| NIL) (#4=#:G436 NIL)
          (|val| #5=(|HomogeneousDistributedMultivariatePolynomial| |lv| F))
          (#6=#:G423 NIL) (#7=#:G422 #5#) (#8=#:G424 #5#) (#9=#:G434 NIL)
          (|vv| NIL) (#10=#:G435 NIL) (|rv| NIL)
          (|ranvals| (|List| (|Integer|))) (#11=#:G433 NIL) (#12=#:G432 NIL)
          (|count| NIL) (|rlvar| (|List| (|OrderedVariableList| |lv|)))
          (|x| (|OrderedVariableList| |lv|))
          (|lnp|
           (|List| (|HomogeneousDistributedMultivariatePolynomial| |lv| F)))
          (#13=#:G431 NIL) (|f| NIL) (#14=#:G430 NIL))
         ...
         ($
          . #1=(|List|
                (|List|
                 (|HomogeneousDistributedMultivariatePolynomial| |lv| F)))))
        (SPROG
         ((#2=#:G443 NIL) (#3=#:G442 #1#) (#4=#:G444 #1#) (#5=#:G449 NIL)
          (|lsel| NIL) (#6=#:G448 NIL) (#7=#:G447 NIL) (|f| NIL))
         (SEQ
          (COND
...
(SDEFUN |GROEBSOL;findCompon|
        ...
        (SPROG
         ((#1=#:G474 NIL) (|ll| NIL) (#2=#:G473 NIL)
          (|ans|
           (|List| #3=(|List| (|DistributedMultivariatePolynomial| |lv| F))))
          (#4=#:G472 NIL) (|p| NIL) (#5=#:G471 NIL) (#6=#:G470 NIL) (|lp| NIL)
          (#7=#:G469 NIL)
          (|val| #8=(|HomogeneousDistributedMultivariatePolynomial| |lv| F))
          (#9=#:G455 NIL) (#10=#:G454 #8#) (#11=#:G456 #8#) (#12=#:G467 NIL)
          (|vv| NIL) (#13=#:G468 NIL) (|rv| NIL)
          ...
          (|tlfact|
           (|List| (|HomogeneousDistributedMultivariatePolynomial| |lv| F)))
          (#14=#:G466 NIL) (|tfact| NIL)
          (|lfact|
           (|List| (|HomogeneousDistributedMultivariatePolynomial| |lv| F)))
          (#15=#:G465 NIL) (|ff| NIL) (#16=#:G464 NIL)
          (|fg|
           (|Factored|
            (|HomogeneousDistributedMultivariatePolynomial| |lv| F)))
...
(SDEFUN |GROEBSOL;zeroDim?|
        ...
        (SPROG
         ((|lvint1| #1#) (|x| (|OrderedVariableList| |lv|)) (#2=#:G477 NIL)
          (|g| (|HomogeneousDistributedMultivariatePolynomial| |lv| F))
          (#3=#:G485 NIL) (|f| NIL) (|n| (|NonNegativeInteger|)))
         (SEQ
          (COND ((NULL |lp|) NIL)
                (#4='T
        ...
        (SPROG
         ((|result|
          ...
          (|lfact|
           (|List|
            (|List| (|HomogeneousDistributedMultivariatePolynomial| |lv| F))))
          (#3=#:G506 NIL) (|ff| NIL) (#4=#:G505 NIL) (#5=#:G504 NIL)
          (|llf| NIL) (#6=#:G503 NIL) (#7=#:G499 NIL)
          (|llfact|
           (|List|
            (|Factored|
             (|HomogeneousDistributedMultivariatePolynomial| |lv| F))))
                      ...
                      (EXIT
                       (COND
                        ((EQL (SPADCALL |g| |x| (QREFELT $ 84))
                              (LENGTH |basis|))
                         (PROGN (LETT #7# |$NoValue|) (GO #11=#:G491))))))
...
(DEFUN |GroebnerSolve| (&REST #1=#:G519)
  (SPROG NIL
         (PROG (#2=#:G520)
           (RETURN
            (COND
