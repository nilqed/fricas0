...
(SDEFUN |SYMBOL;convert;$If;3| ((|s| $) ($ |InputForm|))
        (SPROG
         ((|d| (|InputForm|)) (G (|List| (|InputForm|))) (#1=#:G2283 NIL)
          (F NIL) (#2=#:G2282 NIL) (FF (|List| (|List| (|InputForm|))))
          (#3=#:G2281 NIL) (|e| NIL) (#4=#:G2280 NIL) (|b| #5=(|InputForm|))
          (|a| #5#) (E (|List| (|InputForm|))) (#6=#:G2279 NIL)
          (#7=#:G2278 NIL) (D (|List| (|InputForm|))) (#8=#:G2277 NIL)
          (#9=#:G2276 NIL) (C (|List| (|InputForm|))) (#10=#:G2275 NIL)
          (#11=#:G2274 NIL) (B (|List| (|InputForm|))) (#12=#:G2273 NIL)
          (#13=#:G2272 NIL) (A (|List| (|InputForm|))) (#14=#:G2271 NIL)
          (#15=#:G2270 NIL)
          (|ls|
...
(SDEFUN |SYMBOL;coerce;$Of;9| ((|x| $) ($ |OutputForm|))
        (SPROG
         ((|a| (|List| (|OutputForm|))) (|x0| (|OutputForm|))
          (|sl| (|List| (|OutputForm|))) (|se| (|OutputForm|)) (#1=#:G2298 NIL)
...
(SDEFUN |SYMBOL;scripts;$R;31|
        ((|sy| $)
         ($ |Record| (|:| |sub| (|List| (|OutputForm|)))
          ...
          (|:| |args| (|List| (|OutputForm|)))))
        (SPROG
         ((|allscripts| (|List| (|OutputForm|))) (|i| NIL) (#1=#:G2410 NIL)
          (|n| NIL) (|m| (|Integer|))
          (|nscripts| (|List| (|NonNegativeInteger|))) (#2=#:G2402 NIL)
          (#3=#:G2409 NIL) (|j| NIL) (|nstr| (|NonNegativeInteger|))
