...
(SDEFUN |MOMPKG;moment2freeCumulant;2S;4|
        ...
        (SPROG
         ((#1=#:G384 NIL) (|f1| #2=(|Union| (|Stream| R) "failed"))
...
(SDEFUN |MOMPKG;booleanCumulant2moment;2S;5|
        ...
        (SPROG
         ((#1=#:G389 NIL) (|boo| (|Union| (|Stream| R) "failed"))
          (|rec| (|Stream| R)))
         (SEQ
          (LETT |rec|
...
(SDEFUN |MOMPKG;moment2booleanCumulant;2S;6|
        ((|x| |Sequence| R) ($ |Sequence| R))
        (SPROG
         ((#1=#:G394 NIL) (|mom| (|Union| (|Stream| R) "failed"))
          (|boo| (|Stream| R)))
         (SEQ
          (LETT |boo|
...
(SDEFUN |MOMPKG;moment2nthJacobi;LR;8|
        ...
        (SPROG
         ((N (|Integer|)) (G (|List| R)) (#1=#:G414 NIL) (|h| NIL)
          (#2=#:G413 NIL) (H (|List| R)) (|Hk| (R)) (#3=#:G412 NIL) (|l| NIL)
          (#4=#:G411 NIL) (|k| NIL) (|bb| #5=(|List| R)) (|aa| #5#) (|bk| (R))
          (|ak| (R)))
...
(SDEFUN |MOMPKG;moment2jacobi2;SS;9!0| (($$ NIL))
        (PROG ($ |mom| R)
          ...
          (RETURN
           (PROGN
            (SPROG
             ((|gseries| NIL) (#1=#:G416 NIL) (|a| NIL) (|gseries1| NIL)
              (|b| NIL) (|b1| NIL))
             (SEQ
              (LETT |gseries|
                    (SPADCALL (|spadConstant| $ 17)
...
(SDEFUN |MOMPKG;moment2monotoneCumulantGenerator|
        ((|srm| |Record| (|:| |momt| (|List| (|SparseUnivariatePolynomial| R)))
         ...
         ($ |Record| (|:| |momt| (|List| (|SparseUnivariatePolynomial| R)))
          (|:| |cum| (|List| R)) (|:| |mom| (|Stream| R))))
        (SPROG
         ((#1=#:G454 NIL) (|mtnew| (|List| (|SparseUnivariatePolynomial| R)))
          (|rrnew| (|List| R)) (|mnt| (|SparseUnivariatePolynomial| R))
          (|rn| (R)) (|tmp| (|SparseUnivariatePolynomial| R)) (#2=#:G455 NIL)
          (|k| NIL) (#3=#:G456 NIL) (|r| NIL) (#4=#:G457 NIL) (|m| NIL)
...
(SDEFUN |MOMPKG;monotoneCumulant2momentGenerator|
        ((|srm| |Record| (|:| |cum| (|Stream| R))
         ...
         ($ |Record| (|:| |cum| (|Stream| R))
          (|:| |momt| (|List| (|SparseUnivariatePolynomial| R)))))
        (SPROG
         ((#1=#:G469 NIL) (|mtnew| (|List| (|SparseUnivariatePolynomial| R)))
          (|mnt| (|SparseUnivariatePolynomial| R)) (|rr| (|Stream| R))
          (|tmp| (|SparseUnivariatePolynomial| R)) (#2=#:G470 NIL) (|k| NIL)
          (#3=#:G471 NIL) (|m| NIL) (|n| (|Integer|))
          (|mt| (|List| (|SparseUnivariatePolynomial| R))))
         (SEQ
          (EXIT
