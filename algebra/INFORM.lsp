...
(SDEFUN |INFORM;conv| ((|ll| |List| $) ($ $)) (SPADCALL |ll| (QREFELT $ 18))) 
...
(SDEFUN |INFORM;flatten;2$;10| ((|s| $) ($ $))
        (SPROG
         ((#1=#:G412 NIL) (|u| NIL) (#2=#:G411 NIL) (#3=#:G410 NIL)
          (#4=#:G409 NIL)
          (|l2| (|List| (|Record| (|:| |lst| (|List| $)) (|:| |symb| $))))
          (|n| (|NonNegativeInteger|)) (#5=#:G408 NIL) (|l| (|List| $))
          (|x| NIL) (#6=#:G407 NIL) (|sy| (|Symbol|)))
         (SEQ
          (COND
...
(SDEFUN |INFORM;flatten0|
        ...
        (SPROG
         ((#1=#:G425 NIL) (|u| NIL) (#2=#:G424 NIL) (#3=#:G423 NIL)
          (#4=#:G422 NIL)
          (|l2| (|List| (|Record| (|:| |lst| (|List| $)) (|:| |symb| $))))
          (#5=#:G421 NIL) (|l| (|List| $)) (|x| NIL) (#6=#:G420 NIL) (|a| ($)))
         (SEQ
...
(SDEFUN |INFORM;unparse;$S;13| ((|x| $) ($ |String|))
        (SPROG ((#1=#:G433 NIL) (|a| NIL) (#2=#:G432 NIL) (|s| ($)))
               (SEQ
                (COND
...
(SDEFUN |INFORM;parse;S$;14| ((|s| |String|) ($ $)) (|ncParseFromString| |s|)) 
...
(SDEFUN |INFORM;tuplify| ((|l| |List| (|Symbol|)) ($ $))
        (SPROG ((#1=#:G446 NIL) (|x| NIL) (#2=#:G445 NIL))
               (SEQ
                (COND
...
(SDEFUN |INFORM;function;$LS$;20|
        ...
        (SPROG ((#1=#:G451 NIL) (|x| NIL) (#2=#:G450 NIL) (|nn| ($)))
               (SEQ
                (LETT |nn|
                      (SPADCALL
                       (SPADCALL (+ 1 (LENGTH |l|))
