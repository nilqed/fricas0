...
(SDEFUN |IEP;eigenvalues;MML;10|
        ((A |Matrix| F)
         ...
         ($ |List| (|Union| F (|SparseUnivariatePolynomial| F))))
        (SPROG
         ((#1=#:G434 NIL) (|ls| NIL) (#2=#:G433 NIL) (#3=#:G432 NIL) (|lr| NIL)
          (#4=#:G431 NIL) (|lsym| (|List| (|SparseUnivariatePolynomial| F)))
          (|lrat| (|List| F)) (|rv| (F))
          (|f1| (|SparseUnivariatePolynomial| F)) (#5=#:G430 NIL) (|fr| NIL)
...
(SDEFUN |IEP;intRatEig|
        ...
        (SPROG
         ((|sol| (|List| (|Vector| (|SparseUnivariatePolynomial| F))))
          (#1=#:G450 NIL) (|i| NIL)
          (|w| (|Vector| (|SparseUnivariatePolynomial| F))) (#2=#:G449 NIL)
          (|v| NIL) (#3=#:G448 NIL) (|j| NIL) (#4=#:G447 NIL) (B (|Matrix| F))
...
(SDEFUN |IEP;intAlgEig|
        ...
        (SPROG
         ((|sol| (|List| (|Vector| (|SparseUnivariatePolynomial| F))))
          (#1=#:G476 NIL) (|i| NIL)
          (|w| (|Vector| (|SparseUnivariatePolynomial| F))) (#2=#:G475 NIL)
          (|vec| NIL) (#3=#:G474 NIL) (|j| NIL) (#4=#:G473 NIL) (B (AM))
...
(SDEFUN |IEP;eigenvectors;MML;17|
        ...
        (SPROG
         ((|algSol|
          ...
          (|vec| (F)) (|pol| #2#) (#3=#:G506 NIL) (|fact| NIL)
          (|lff|
           (|List|
...
(DEFUN |InnerEigenPackage| (#1=#:G507)
  (SPROG NIL
         (PROG (#2=#:G508)
           (RETURN
            (COND
