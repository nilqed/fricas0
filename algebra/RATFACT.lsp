...
(SDEFUN |RATFACT;factor;RPF;1| ((|p| RP) ($ |Factored| RP))
        (SPROG
         ((#1=#:G395 NIL) (|u| NIL) (#2=#:G394 NIL)
          ...
          (|pden| (|Integer|)) (#3=#:G393 NIL) (|c| NIL) (#4=#:G392 NIL))
         (SEQ
          (COND
                     ...
                     (|:| |factors|
                          (|List|
                           (|Record|
                            ...
                            (|:| |pow| (|NonNegativeInteger|)))))))
          (|ipol| (|SparseUnivariatePolynomial| (|Integer|))) (|pol| (RP))
          (|pden| (|Integer|)) (#3=#:G411 NIL) (|c| NIL) (#4=#:G410 NIL))
         (SEQ
          (COND
           ((SPADCALL |p| (|spadConstant| $ 7) (QREFELT $ 11))
            (|spadConstant| $ 9))
...
(DEFUN |RationalFactorize| (#1=#:G414)
  (SPROG NIL
         (PROG (#2=#:G415)
           (RETURN
            (COND
