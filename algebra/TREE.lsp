...
(SDEFUN |TREE;count;S$Nni;6| ((|n| S) (|t| $) ($ |NonNegativeInteger|))
        (SPROG
         ((|i| #1=(|NonNegativeInteger|)) (#2=#:G410 NIL) (#3=#:G409 #1#)
          (#4=#:G411 #1#) (#5=#:G416 NIL) (|c| NIL))
         (SEQ
          (COND ((QEQCAR |t| 1) 0)
                (#6='T
                 (SEQ
...
(SDEFUN |TREE;count;M$Nni;7|
        ...
        (SPROG
         ((|i| #1=(|NonNegativeInteger|)) (#2=#:G418 NIL) (#3=#:G417 #1#)
          (#4=#:G419 #1#) (#5=#:G423 NIL) (|c| NIL))
         (SEQ
          (COND ((QEQCAR |t| 1) 0)
                (#6='T
                 (SEQ
...
(SDEFUN |TREE;map;M2$;8| ((|fn| |Mapping| S S) (|t| $) ($ $))
        (SPROG ((#1=#:G428 NIL) (|c| NIL) (#2=#:G427 NIL))
               (SEQ
                (COND ((QEQCAR |t| 1) |t|)
                      ('T
...
(SDEFUN |TREE;tree;L$;12| ((|ls| |List| S) ($ $))
        (SPROG ((#1=#:G440 NIL) (|s| NIL) (#2=#:G439 NIL))
               (SEQ
...
(SDEFUN |TREE;distance1| ((|t1| $) (|t2| $) ($ . #1=(|Integer|)))
        (SPROG
         ((#2=#:G448 NIL) (#3=#:G447 #1#) (#4=#:G449 #1#) (#5=#:G454 NIL)
          (#6=#:G378 NIL) (|u| (|List| #1#)) (|n| #1#) (#7=#:G453 NIL)
          (|t| NIL) (#8=#:G452 NIL))
         (SEQ
...
(SDEFUN |TREE;any?;M$B;18|
        ...
        (SPROG ((#2=#:G469 NIL) (#3=#:G470 NIL) (|c| NIL))
               (SEQ
                (EXIT
                 (COND ((QEQCAR |t| 1) NIL)
...
(SDEFUN |TREE;every?;M$B;19|
        ((|fn| |Mapping| #1=(|Boolean|) S) (|t| $) ($ . #1#))
        (SPROG ((#2=#:G477 NIL) (#3=#:G478 NIL) (|c| NIL))
               (SEQ
                (EXIT
                 (COND ((QEQCAR |t| 1) 'T)
...
(SDEFUN |TREE;parts;$L;21| ((|t| $) ($ |List| S))
        (SPROG
         ((#1=#:G489 NIL) (#2=#:G488 #3=(|List| S)) (#4=#:G490 #3#)
          (#5=#:G495 NIL) (#6=#:G379 NIL) (|u| (|List| #3#)) (#7=#:G494 NIL)
          (|c| NIL) (#8=#:G493 NIL))
         (SEQ
          (COND ((QEQCAR |t| 1) NIL)
                (#9='T
...
(SDEFUN |TREE;#;$Nni;24| ((|t| $) ($ |NonNegativeInteger|))
        (SPROG
         ((#1=#:G508 NIL) (#2=#:G507 #3=(|NonNegativeInteger|)) (#4=#:G509 #3#)
          (#5=#:G512 NIL) (|c| NIL))
         (SEQ
...
(SDEFUN |TREE;copy;2$;25| ((|t| $) ($ $))
        (SPROG ((#1=#:G517 NIL) (|c| NIL) (#2=#:G516 NIL))
               (SEQ
...
(DEFUN |Tree;| (|#1|)
  (SPROG
   ((|pv$| NIL) (#1=#:G527 NIL) (#2=#:G528 NIL) (#3=#:G529 NIL) ($ NIL)
    (|dv$| NIL) (DV$1 NIL))
   (PROGN
