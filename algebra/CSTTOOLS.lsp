...
(SDEFUN |CSTTOOLS;cycleElt;STU;1| ((|x| ST) ($ |Union| ST "failed"))
        (SPROG ((#1=#:G397 NIL) (#2=#:G398 NIL) (|y| (ST)) (|i| NIL))
               (SEQ
                (EXIT
                 (SEQ (LETT |y| |x|)
                      (EXIT
...
(SDEFUN |CSTTOOLS;computeCycleLength;STNni;2|
        ...
        (SPROG ((#1=#:G403 NIL) (#2=#:G404 NIL) (|y| (ST)) (|i| NIL))
               (SEQ
                (EXIT
                 (SEQ (LETT |y| |cycElt|)
                      (EXIT
...
(DEFUN |CyclicStreamTools| (&REST #1=#:G411)
  (SPROG NIL
         (PROG (#2=#:G412)
           (RETURN
            (COND
