          ...
          (|logs|
           (|List|
            (|Record| (|:| |scalar| (|Fraction| (|Integer|)))
                      ...
                      (|:| |logand|
                           (|SparseUnivariatePolynomial| (|Fraction| UP))))))
          (#2=#:G430 NIL) (|term| NIL) (#3=#:G429 NIL)
          (|rec|
...
(SDEFUN |INTTR;monomialIntPoly;UPMR;9|
        ...
        (SPROG
         ((|ans| (UP)) (|term| (UP)) (#1=#:G436 NIL) (|n| (|Integer|))
          (|l| (F)) (|d| (|Integer|)) (|dt| (UP)))
         (SEQ
          (LETT |d|
                (SPADCALL
        ...
        (SPROG
         ((|u2|
           (|Union|
            ...
            (|Record| (|:| |elem| (|LaurentPolynomial| F UP))
                      (|:| |notelem| (|LaurentPolynomial| F UP)))))
          (|special| (|LaurentPolynomial| F UP)) (#1=#:G485 NIL)
          (|i1| (|IntegrationResult| (|Fraction| UP)))
          (|rec|
           (|Record| (|:| |ir| (|IntegrationResult| (|Fraction| UP)))
                     (|:| |specpart| (|Fraction| UP)) (|:| |polypart| UP))))
...
(SDEFUN |INTTR;lambintegrate;FFMMMMR;15|
        ...
        (SPROG
         ((|ri2|
           (|Record| (|:| |answer| (|IntegrationResult| (|Fraction| UP)))
                     (|:| |a0| (|IntegrationResult| F))))
          (|sp| (|LaurentPolynomial| F UP)) (#1=#:G508 NIL) (|n| (|Integer|))
...
(SDEFUN |INTTR;lamintegratepoly|
        ((|p| |LaurentPolynomial| F UP) (|dx| F) (|n| |Integer|)
         ...
         ($ |Record| (|:| |answer| (|IntegrationResult| (|Fraction| UP)))
          (|:| |a0| (|IntegrationResult| F))))
        (SPROG
         ((#2=#:G542 NIL) (|answr| (|LaurentPolynomial| F UP)) (|clg0| (F))
          (|db1| (F)) (|b1| (F)) (#3=#:G543 NIL) (|i0| (|IntegrationResult| F))
...
(SDEFUN |INTTR;primintegratepoly|
        ((|p| UP)
         ...
         ($ |Union| (|Record| (|:| |answer| UP) (|:| |a0| F))
          (|Record| (|:| |elem| UP) (|:| |notelem| UP))))
        (SPROG
         ((|ans1| #1#) (|rp| (F)) (|ans| (UP)) (#2=#:G553 NIL) (#3=#:G560 NIL)
            ...
            (#4='T
             (SEQ (LETT |ans| (|spadConstant| $ 27))
                  (SEQ G190
                       ...
                       NIL (GO G190) G191 (EXIT NIL))
                  (LETT |ans1|
                        (SPADCALL (LETT |rp| (SPADCALL |p| (QREFELT $ 105)))
                                  |extendedint|))
                  (EXIT
...
(DEFUN |TranscendentalIntegration| (&REST #1=#:G561)
  (SPROG NIL
         (PROG (#2=#:G562)
           (RETURN
            (COND
...
(MAKEPROP '|TranscendentalIntegration| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) (|local| |#2|)
              ...
              (|Union| 109 '#1="failed") (|Mapping| 110 6)
              ...
              (|Mapping| 122 6) |INTTR;lambintegrate;FFMMMMR;15| (363 . ~=)
              (369 . |coerce|) (374 . |elem?|) (379 . *) (385 . +) (391 . -)
              (397 . |coerce|) (402 . *))
                       ...
                       (CONS
                        ...
                        (|makeByteWordVec2| 139
                                            '(0 8 0 9 2 8 0 0 11 12 2 8 0 0 0
                                              ...
                                              132 1 6 0 87 133 1 122 29 0 134 2
                                              6 0 0 0 135 2 6 0 0 0 136 2 93 0
                                              0 0 137 1 93 124 0 138 2 6 0 34 0
                                              139 4 0 106 8 11 108 111 112 2 0
                                              84 8 11 85 2 0 91 7 11 92 6 0 128
                                              8 6 129 11 111 130 131 4 0 106 8
                                              11 108 118 119)))))
           '|lookupComplete|)) 
