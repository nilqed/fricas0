...
(SDEFUN |SETLAT;complement;2$;4| ((|a| $) ($ $))
        (SPROG
         ((|r| (|List| S)) (|contains| (|Boolean|)) (#1=#:G387 NIL) (|c| NIL)
          (#2=#:G386 NIL) (|b| NIL))
         (SEQ (LETT |r| NIL)
...
(SDEFUN |SETLAT;complement;$L$;5| ((|a| $) (|pseudoTop| |List| S) ($ $))
        (SPROG
         ((|r| (|List| S)) (|contains| (|Boolean|)) (#1=#:G394 NIL) (|c| NIL)
          (#2=#:G393 NIL) (|b| NIL))
         (SEQ (LETT |r| NIL)
...
(SDEFUN |SETLAT;coerce;$Of;9| ((|s| $) ($ |OutputForm|))
        (SPROG
         ((|oup| (|List| (|OutputForm|))) (#1=#:G401 NIL) (|x| NIL)
          (|inp| ($)))
...
(DEFUN |SubsetLattice| (&REST #1=#:G402)
  (SPROG NIL
         (PROG (#2=#:G403)
           (RETURN
            (COND
