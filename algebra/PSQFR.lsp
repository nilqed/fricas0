...
(SDEFUN |PSQFR;pPolRoot| ((|f| P) ($ P))
        (SPROG
         ((|uf| (|SparseUnivariatePolynomial| P)) (#1=#:G387 NIL)
...
(SDEFUN |PSQFR;pthPower| ((|f| P) ($ |Factored| P))
        (SPROG
         ((#1=#:G415 NIL) (|u| NIL) (#2=#:G414 NIL) (#3=#:G413 NIL)
          (#4=#:G412 NIL) (|psqfr| (|Factored| P)) (|isSq| (|Boolean|))
...
(SDEFUN |PSQFR;finSqFr| ((|f| P) (|lvar| |List| |VarSet|) ($ |Factored| P))
        (SPROG
         ((|pfaclist|
          ...
          (|flistfin1| (|List| #1#)) (#3=#:G437 NIL) (|uu| NIL) (#4=#:G436 NIL)
          (|listfin1| #2#) (|uexp| (|NonNegativeInteger|)) (#5=#:G435 NIL)
          (|u| NIL) (|squf| (|Factored| (|SparseUnivariatePolynomial| P)))
          (|uf| (|SparseUnivariatePolynomial| P)) (#6=#:G417 NIL)
          (|mv| (|VarSet|)))
         (SEQ
          ...
          (|pfaclist|
           (|List|
            (|Record| (|:| |flag| (|Union| "nil" "sqfr" "irred" "prime"))
                      (|:| |factor| P)
                      (|:| |exponent| (|NonNegativeInteger|)))))
          (#1=#:G458 NIL) (|u| NIL) (#2=#:G457 NIL)
          (|squp| (|Factored| (|SparseUnivariatePolynomial| P)))
          (|up| (|SparseUnivariatePolynomial| P)) (#3=#:G443 NIL) (|cont| (P))
...
(DEFUN |PolynomialSquareFree| (&REST #1=#:G459)
  (SPROG NIL
         (PROG (#2=#:G460)
           (RETURN
            (COND
