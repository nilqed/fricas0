...
(SDEFUN |POLYCATQ;univ_root|
        ...
        (SPROG
         ((|nd| (F)) (|cofact| (|SparseUnivariatePolynomial| F))
          (|cf2| #1=(|SparseUnivariatePolynomial| F)) (#2=#:G392 NIL)
...
(DEFUN |PolynomialCategoryQuotientFunctions| (&REST #1=#:G483)
  (SPROG NIL
         (PROG (#2=#:G484)
           (RETURN
            (COND
