...
(SDEFUN |ISMITH;smith;MMM;1|
        ((|m| |Matrix| (|Integer|))
         ...
         ($ |Matrix| (|Integer|)))
        (SPROG
         ((#1=#:G386 NIL) (|i| NIL) (|nn2| #2=(|Integer|)) (#3=#:G385 NIL)
...
(SDEFUN |ISMITH;completeSmith;MMR;3|
        ((|m| |Matrix| (|Integer|))
         ...
         ($ |Record| (|:| |Smith| (|Matrix| (|Integer|)))
          ...
          (|:| |rightEqMat| (|Matrix| (|Integer|)))))
        (SPROG
         ((#1=#:G433 NIL) (|n| NIL) (#2=#:G432 NIL) (|pp| (|Integer|))
          (#3=#:G431 NIL) (|l| NIL) (#4=#:G430 NIL) (#5=#:G429 NIL)
          (#6=#:G428 NIL) (#7=#:G427 NIL) (|i| NIL)
          (|m16| #8=(|Matrix| (|Integer|))) (|m15| #9=(|Matrix| (|Integer|)))
          (|m14| #8#) (|m13| #9#) (#10=#:G425 NIL) (#11=#:G426 NIL)
          ...
          (|lk| (|List| (|Integer|))) (|s| (|Integer|)) (#15=#:G424 NIL)
          (#16=#:G423 NIL) (|lk0| (|List| (|Integer|))) (#17=#:G422 NIL)
          (#18=#:G421 NIL) (|lj2| (|List| (|Integer|))) (#19=#:G420 NIL)
          (#20=#:G419 NIL) (|lj1| (|List| (|Integer|))) (#21=#:G418 NIL)
          (#22=#:G417 NIL) (|lj0| (|List| (|Integer|))) (#23=#:G416 NIL)
          (#24=#:G415 NIL) (|m2| (|Matrix| (|Integer|)))
