...
(SDEFUN |SQMATRIX;matrix;L$;4| ((|l| |List| (|List| R)) ($ $))
        (SPROG
         ((#1=#:G397 NIL) (|j| NIL) (#2=#:G398 NIL) (|r| NIL) (#3=#:G395 NIL)
          (|i| NIL) (#4=#:G396 NIL) (|ll| NIL) (|ans| (|Matrix| R))
          (#5=#:G393 NIL) (#6=#:G394 NIL))
         (SEQ
          (COND
...
(SDEFUN |SQMATRIX;columnSpace;$L;18|
        ...
        (SPROG ((#1=#:G419 NIL) (|c| NIL) (#2=#:G418 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |SQMATRIX;nullSpace;$L;21|
        ((|x| $) ($ |List| (|DirectProduct| |ndim| R)))
        (SPROG ((#1=#:G425 NIL) (|c| NIL) (#2=#:G424 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(DEFUN |SquareMatrix| (&REST #1=#:G466)
  (SPROG NIL
         (PROG (#2=#:G467)
           (RETURN
            (COND
...
(DEFUN |SquareMatrix;| (|#1| |#2|)
  (SPROG
   ((|pv$| NIL) (#1=#:G463 NIL) (#2=#:G465 NIL) ($ NIL) (|dv$| NIL) (DV$2 NIL)
    (DV$1 NIL))
   (PROGN
