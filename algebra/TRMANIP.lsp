...
(SDEFUN |TRMANIP;simplifyLog1| ((|e| F) ($ F))
        (SPROG
         ((#1=#:G459 NIL) (#2=#:G458 (F)) (#3=#:G460 (F)) (#4=#:G471 NIL)
          (#5=#:G379 NIL) (|terms| (|List| F)) (|foundLog| (|Boolean|))
          (#6=#:G451 NIL) (#7=#:G450 (F)) (#8=#:G452 (F)) (#9=#:G470 NIL)
          (#10=#:G378 NIL) (|args| (|List| F)) (|i| (|NonNegativeInteger|))
          (|nterms| (|List| F)) (|exprs| (|List| F)) (#11=#:G469 NIL)
          (|term| NIL) (#12=#:G468 NIL) (#13=#:G467 NIL) (#14=#:G466 NIL)
          (|u| NIL) (#15=#:G465 NIL) (|kers| (|List| (|Kernel| F)))
          (|expt|
...
(SDEFUN |TRMANIP;termexp|
        ...
        (SPROG
         ((|coef| (|SparseMultivariatePolynomial| R (|Kernel| F)))
          (#1=#:G494 NIL) (|u| NIL) (#2=#:G493 NIL) (|exponent| (F))
          (|d| (|NonNegativeInteger|)) (#3=#:G492 NIL) (|k| NIL)
...
(SDEFUN |TRMANIP;simplifyExp;2F;48| ((|x| F) ($ F))
        (SPROG
         ((#1=#:G586 NIL) (|term| (F)) (#2=#:G590 NIL) (|k1| NIL)
          (#3=#:G587 NIL) (#4=#:G589 NIL) (|h| (|NonNegativeInteger|))
          (|args| (|List| F)) (|op| (|BasicOperator|)) (#5=#:G588 NIL)
...
(SDEFUN |TRMANIP;htrigs;2F;49| ((|f| F) ($ F))
        (SPROG
         ((|g1| (F)) (|b| (|Integer|)) (|g2| (F)) (|a| (F))
          ...
          (|num| #1#) (|arg| (|List| F)) (#2=#:G600 NIL) (|x| NIL)
          (#3=#:G599 NIL) (|op| (|BasicOperator|)) (|k| (|Kernel| F))
...
(SDEFUN |TRMANIP;exlog|
        ((|p| |SparseMultivariatePolynomial| R (|Kernel| F)) ($ F))
        (SPROG
         ((#1=#:G611 NIL) (#2=#:G610 (F)) (#3=#:G612 (F)) (#4=#:G614 NIL)
          (|r| NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
...
(SDEFUN |TRMANIP;logexpand| ((|k| |Kernel| F) ($ F))
        (SPROG
         ((#1=#:G620 NIL) (|x| (F)) (#2=#:G619 NIL) (|op| (|BasicOperator|)))
         (SEQ
          (COND
...
(SDEFUN |TRMANIP;kerexpand| ((|k| |Kernel| F) ($ F))
        (SPROG
         ((#1=#:G641 NIL) (|x| (F)) (#2=#:G640 NIL) (#3=#:G639 NIL)
          (#4=#:G638 NIL) (|ctb| (F)) (|cta| (F)) (|tb| (F)) (|ta| (F))
          (|a| (F)) (|b| (F))
...
(DEFUN |TranscendentalManipulations| (&REST #1=#:G685)
  (SPROG NIL
         (PROG (#2=#:G686)
           (RETURN
            (COND
