...
(SDEFUN |FRNAALG-;rank_polynomial|
        ...
        (SPROG
         ((|cijk| (R)) (|mxjk| (|Polynomial| R)) (#1=#:G412 NIL) (|k| NIL)
          (#2=#:G411 NIL) (|j| NIL) (|mo| (|Polynomial| R)) (#3=#:G410 NIL)
          (|i| NIL) (|mx| #4=(|Matrix| (|Polynomial| R))) (|x| #4#)
          (|symbolsForCoef| (|Vector| (|Symbol|))) (#5=#:G407 NIL)
          (#6=#:G409 NIL) (#7=#:G408 NIL) (|listOfNumbers| (|List| (|String|)))
          (#8=#:G406 NIL) (|q| NIL) (#9=#:G405 NIL)
...
(SDEFUN |FRNAALG-;leftUnitsInternal|
        (($ |Record| (|:| |particular| (|Union| (|Vector| R) "failed"))
          (|:| |basis| (|List| (|Vector| R)))))
        (SPROG
         ((#1=#:G424 NIL) (|j| NIL) (|addOn| (R)) (|z| (|Integer|))
          (#2=#:G423 NIL) (|i| NIL) (#3=#:G422 NIL) (|k| NIL)
...
(SDEFUN |FRNAALG-;rightUnitsInternal|
        (($ |Record| (|:| |particular| (|Union| (|Vector| R) "failed"))
          (|:| |basis| (|List| (|Vector| R)))))
        (SPROG
         ((#1=#:G463 NIL) (|j| NIL) (|addOn| (R)) (|z| (|Integer|))
          (#2=#:G462 NIL) (|i| NIL) (#3=#:G461 NIL) (|k| NIL)
        ...
        (SPROG
         ((#1=#:G496 NIL)
          (|res|
           (|Record| (|:| |particular| (|Union| (|Vector| R) "failed"))
                     (|:| |basis| (|List| (|Vector| R)))))
          (#2=#:G503 NIL) (|j| NIL) (|addOn| (R)) (|z| (|Integer|))
          (#3=#:G502 NIL) (|i| NIL) (#4=#:G501 NIL) (|k| NIL) (|u| (|Integer|))
          (|rhs| (|Vector| R)) (|cond| (|Matrix| R))
          (|gamma| (|Vector| (|Matrix| R))) (|b| (|Vector| S))
          (|n| (|PositiveInteger|)))
         (SEQ (LETT |n| (SPADCALL (QREFELT $ 11)))
