...
(SDEFUN |ODEPAL;rat_solve|
        ...
        (SPROG
         ((|bl| (|List| (|Fraction| UP))) (|s| (|Fraction| UP)) (#1=#:G407 NIL)
          (|k| NIL) (#2=#:G408 NIL) (|bf| NIL) (#3=#:G406 NIL) (|i| NIL)
          (|sl|
           (|List|
            (|Record| (|:| |ratpart| (|Fraction| UP))
                      (|:| |coeffs| (|Vector| (|Fraction| UP))))))
          (#4=#:G404 NIL) (#5=#:G405 NIL) (#6=#:G403 NIL)
          (|cv| (|Vector| (|Fraction| UP))) (#7=#:G399 NIL) (|i0| (|Integer|))
          (|j| (|Integer|)) (#8=#:G402 NIL) (|nr| (|NonNegativeInteger|))
          (|m3| (|Matrix| F)) (|nn1| (|NonNegativeInteger|)) (#9=#:G386 NIL)
          (|nc| (|NonNegativeInteger|)) (|nn| #10=(|NonNegativeInteger|))
          (|m1| (|Matrix| F)) (#11=#:G401 NIL) (|kv| NIL) (#12=#:G400 NIL)
...
(SDEFUN |ODEPAL;algDsolve;LodoLR;4|
        ...
        (SPROG
         ((|part|
          ...
          (#1=#:G428 NIL) (|be| NIL) (#2=#:G427 NIL) (|bas| (|List| R))
          (#3=#:G426 NIL) (|v| NIL) (#4=#:G425 NIL)
          (|sol|
           (|Record|
            (|:| |particular|
                 (|List|
...
(DEFUN |PureAlgebraicLODE| (&REST #1=#:G442)
  (SPROG NIL
         (PROG (#2=#:G443)
           (RETURN
            (COND
