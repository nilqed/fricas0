...
(SDEFUN |IBPTOOLS;mapMatrixIfCan;MMU;4|
        ...
        (SPROG
         ((#1=#:G432 NIL) (|poly| (|Union| R "failed")) (#2=#:G434 NIL)
          (|j| NIL) (#3=#:G433 NIL) (|i| NIL) (|matOut| (|Matrix| R))
...
(DEFUN |IntegralBasisPolynomialTools| (&REST #1=#:G441)
  (SPROG NIL
         (PROG (#2=#:G442)
           (RETURN
            (COND
