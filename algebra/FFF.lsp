...
(SDEFUN |FFF;createLowComplexityTable;PiU;2|
        ...
        (SPROG
         ((|l|
           (|List|
            (|Record| (|:| |value| GF) (|:| |index| (|SingleInteger|)))))
          (|term| #1#) (#2=#:G452 NIL) (|j| NIL)
          (|v| (|Vector| (|PrimeField| |p|))) (#3=#:G451 NIL) (|i| NIL)
          (|multtable|
           (|Vector|
            (|List|
             (|Record| (|:| |value| GF) (|:| |index| (|SingleInteger|))))))
          (|m| (|NonNegativeInteger|)) (|lvjh| (|Integer|)) (#4=#:G450 NIL)
          (#5=#:G449 NIL) (#6=#:G448 NIL) (#7=#:G447 NIL)
          (|help| (|PrimeField| |p1|)) (#8=#:G446 NIL) (#9=#:G445 NIL)
          (|lvj| (|Matrix| (|Integer|))) (#10=#:G444 NIL) (#11=#:G443 NIL)
          (|x| NIL) (|vec| (|Vector| (|Integer|))) (|vt| (|Integer|))
          (|jt| (|Integer|)) (|t| (|PrimeField| |p1|))
          (|pkn| (|PrimeField| |p1|)) (|p1| (|NonNegativeInteger|))
          (|multmat| (|Matrix| (|PrimeField| |p|))) (#12=#:G441 NIL)
          (|t1| (|PrimeField| (+ (* |k| |n|) (|One|))))
          (|k| (|NonNegativeInteger|)) (|a| (|Integer|)) (#13=#:G442 NIL)
...
(SDEFUN |FFF;sizeMultiplication;VNni;3|
        ((|m| |Vector|
         ...
         ($ |NonNegativeInteger|))
        (SPROG ((|s| (|NonNegativeInteger|)) (#1=#:G460 NIL) (|i| NIL))
               (SEQ (LETT |s| 0)
...
(SDEFUN |FFF;createMultiplicationTable;SupV;4|
        ...
        (SPROG
         ((|l|
           (|List|
            (|Record| (|:| |value| GF) (|:| |index| (|SingleInteger|)))))
          (|term| #1#) (#2=#:G486 NIL) (|j| NIL) (|v| (|Vector| GF))
          (#3=#:G485 NIL) (|i| NIL)
          (|multtable|
           (|Vector|
            (|List|
             (|Record| (|:| |value| GF) (|:| |index| (|SingleInteger|))))))
          (|mat| (|Matrix| GF)) (#4=#:G468 NIL)
        ...
        (SPROG
         ((|a|
           #1=(|SimpleAlgebraicExtension| GF (|SparseUnivariatePolynomial| GF)
                                          |f|))
          (#2=#:G500 NIL) (|i| NIL) (#3=#:G499 NIL) (#4=#:G498 NIL)
          (|primElement| #1#)
          (|helparr| #5=(|PrimitiveArray| (|SingleInteger|))) (|zechlog| #5#)
          (|qm1| (|SingleInteger|)) (|m| (|PositiveInteger|)) (#6=#:G487 NIL)
          (|sizeGF| (|NonNegativeInteger|)))
         (SEQ (LETT |sizeGF| (SPADCALL (QREFELT $ 17)))
              (LETT |m|
...
(SDEFUN |FFF;createMultiplicationMatrix;VM;6|
        ((|m| |Vector|
         ...
         ($ |Matrix| GF))
        (SPROG
         ((#1=#:G508 NIL) (|t| NIL) (#2=#:G507 NIL) (|i| NIL)
...
(DEFUN |FiniteFieldFunctions| (#1=#:G509)
  (SPROG NIL
         (PROG (#2=#:G510)
           (RETURN
            (COND
