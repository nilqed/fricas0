        ...
        (SPROG
         ((|qr|
           (|Record| (|:| |quotient| (|Integer|))
                     (|:| |remainder| (|Integer|))))
          (#1=#:G410 NIL) (|i| NIL) (|rnk| (|NonNegativeInteger|)))
         (SEQ
...
(SDEFUN |CARTEN;index2int| ((|indv| |Vector| (|Integer|)) ($ |Integer|))
        (SPROG ((|n| (|Integer|)) (|ix| (|Integer|)) (#1=#:G416 NIL) (|i| NIL))
               (SEQ (LETT |n| 0)
...
(SDEFUN |CARTEN;mkPerm|
        ((|n| |NonNegativeInteger|) (|l| |List| (|Integer|))
         ($ |Vector| (|Integer|)))
        (SPROG
         ((#1=#:G430 NIL) (#2=#:G433 NIL) (|e| NIL) (#3=#:G431 NIL) (|i| NIL)
          (#4=#:G432 NIL) (|seen| (|Vector| (|Boolean|)))
          (|p| (|Vector| (|Integer|))))
         (SEQ
          (COND
...
(SDEFUN |CARTEN;permsign!| ((|v| |Vector| (|Integer|)) ($ |Integer|))
        (SPROG
         ((#1=#:G452 NIL) (#2=#:G456 NIL) (|i| NIL) (|totTrans| (|Integer|))
          (|e| (|Integer|)) (|nTrans| (|Integer|)) (#3=#:G454 NIL)
          (#4=#:G455 NIL) (|j| NIL) (|n| (|Integer|)) (#5=#:G453 NIL)
          (|psum| (|Integer|)) (#6=#:G439 NIL) (|maxix| (|Integer|)))
         (SEQ
          (EXIT
...
(SDEFUN |CARTEN;unravel;L$;9| ((|l| |List| R) ($ $))
        (SPROG
         ((#1=#:G464 NIL) (|i| NIL) (#2=#:G465 NIL) (|r| NIL) (|z| ($))
...
(SDEFUN |CARTEN;kroneckerDelta;$;10| (($ $))
        (SPROG ((#1=#:G469 NIL) (|i| NIL) (#2=#:G470 NIL) (|zi| NIL) (|z| ($)))
               (SEQ
                (LETT |z|
...
(SDEFUN |CARTEN;leviCivitaSymbol;$;11| (($ $))
        (SPROG
         ((#1=#:G474 NIL) (|i| NIL) (|indv| (|Vector| (|Integer|))) (|z| ($))
          (|nz| (|NonNegativeInteger|)))
...
(SDEFUN |CARTEN;rank;$Nni;13| ((|x| $) ($ |NonNegativeInteger|))
        (SPROG ((|n| (|Integer|)))
               (SEQ (LETT |n| (SPADCALL |x| (QREFELT $ 28)))
...
(SDEFUN |CARTEN;elt;$LR;19| ((|x| $) (|i| |List| (|Integer|)) ($ R))
        (SPROG
         ((|n| (|Integer|)) (|ix| (|Integer|)) (#1=#:G494 NIL) (|ii| NIL))
         (SEQ
          (COND
...
(SDEFUN |CARTEN;coerce;L$;20| ((|lr| |List| R) ($ $))
        (SPROG ((#1=#:G499 NIL) (|r| NIL) (#2=#:G500 NIL) (|i| NIL) (|z| ($)))
               (SEQ
                (COND
...
(SDEFUN |CARTEN;coerce;L$;21| ((|lx| |List| $) ($ $))
        (SPROG
         ((#1=#:G512 NIL) (|i| NIL) (#2=#:G510 NIL) (|x| NIL) (#3=#:G511 NIL)
          (|offz| NIL) (|z| ($)) (|nx| (|NonNegativeInteger|)) (#4=#:G508 NIL)
          (#5=#:G509 NIL) (|rx| (|NonNegativeInteger|)))
         (SEQ
          (COND
...
(SDEFUN |CARTEN;mkOutf|
        ((|x| $) (|i0| |Integer|) (|rnk| |NonNegativeInteger|)
         ($ |OutputForm|))
        (SPROG
         ((#1=#:G533 NIL) (|j| NIL) (#2=#:G532 NIL) (#3=#:G531 NIL) (|i| NIL)
          (#4=#:G530 NIL) (|nskip| (|NonNegativeInteger|))
          (|rnk1| (|NonNegativeInteger|)) (#5=#:G529 NIL) (#6=#:G528 NIL))
         (SEQ
          (COND
           ((ODDP |rnk|)
            (SEQ (LETT |rnk1| (- |rnk| 1))
...
(SDEFUN |CARTEN;coerce;R$;27| ((|r| R) ($ $)) (SPADCALL 1 |r| (QREFELT $ 33))) 

(SDEFUN |CARTEN;coerce;Dp$;28| ((|v| |DirectProduct| |dim| R) ($ $))
        (SPROG ((#1=#:G541 NIL) (|i| NIL) (#2=#:G542 NIL) (|j| NIL) (|z| ($)))
               (SEQ
                (LETT |z|
                      (SPADCALL (QREFELT $ 7) (|spadConstant| $ 32)
                                (QREFELT $ 33)))
...
(SDEFUN |CARTEN;coerce;Sm$;29| ((|m| |SquareMatrix| |dim| R) ($ $))
        (SPROG
         ((|offz| (|NonNegativeInteger|)) (#1=#:G549 NIL) (|j| NIL)
          (#2=#:G548 NIL) (|i| NIL) (|z| ($)))
         (SEQ
          (LETT |z|
...
(SDEFUN |CARTEN;=;2$B;30| ((|x| $) (|y| $) ($ |Boolean|))
        (SPROG ((#1=#:G555 NIL) (#2=#:G556 NIL) (|i| NIL))
               (SEQ
                (EXIT
                 (COND
                          ...
                          (EXIT
                           (COND
                            ((SPADCALL (SPADCALL |x| |i| (QREFELT $ 29))
                                       ...
                                       (QREFELT $ 74))
                             (PROGN (LETT #1# NIL) (GO #3=#:G554))))))
                         (LETT |i| (|inc_SI| |i|)) (GO G190) G191 (EXIT NIL))
                    (EXIT 'T)))))
                #3# (EXIT #1#)))) 

(SDEFUN |CARTEN;+;3$;31| ((|x| $) (|y| $) ($ $))
        (SPROG ((#1=#:G561 NIL) (|i| NIL) (|z| ($)))
               (SEQ
                (COND
                 ((SPADCALL (SPADCALL |x| (QREFELT $ 28))
                            (SPADCALL |y| (QREFELT $ 28)) (QREFELT $ 22))
...
(SDEFUN |CARTEN;product;3$;38| ((|x| $) (|y| $) ($ $))
        (SPROG
         ((#1=#:G593 NIL) (|j| NIL) (#2=#:G591 NIL) (|i| NIL) (#3=#:G592 NIL)
...
(SDEFUN |CARTEN;contract;$2I$;40|
        ...
        (SPROG
         ((#3=#:G612 NIL) (|k| NIL) (#4=#:G613 NIL) (|xk| NIL) (#5=#:G609 NIL)
          (|l| NIL) (#6=#:G610 NIL) (|xl| NIL) (#7=#:G611 NIL) (|zl| NIL)
          (#8=#:G606 NIL) (|m| NIL) (#9=#:G607 NIL) (|xm| NIL) (#10=#:G608 NIL)
          (|zm| NIL) (#11=#:G603 NIL) (|h| NIL) (#12=#:G604 NIL) (|xh| NIL)
          (#13=#:G605 NIL) (|zh| NIL) (|z| ($))
...
(SDEFUN |CARTEN;contract;$I$I$;41|
        ...
        (SPROG
         ((#1=#:G634 NIL) (|k| NIL) (#2=#:G635 NIL) (|xk| NIL) (#3=#:G636 NIL)
          (|yk| NIL) (#4=#:G631 NIL) (|dyl| NIL) (#5=#:G632 NIL) (|yl| NIL)
          (#6=#:G633 NIL) (|zly| NIL) (#7=#:G628 NIL) (|dyh| NIL)
          (#8=#:G629 NIL) (|yh| NIL) (#9=#:G630 NIL) (|zhy| NIL)
          (#10=#:G625 NIL) (|dxl| NIL) (#11=#:G626 NIL) (|xl| NIL)
          (#12=#:G627 NIL) (|zlx| NIL) (#13=#:G622 NIL) (|dxh| NIL)
          (#14=#:G623 NIL) (|xh| NIL) (#15=#:G624 NIL) (|zhx| NIL) (|z| ($))
...
(SDEFUN |CARTEN;transpose;$2I$;43|
        ((|x| $) (|i| . #1=(|Integer|)) (|j| . #2=(|Integer|)) ($ $))
        (SPROG
         ((#3=#:G654 NIL) (|q| NIL) (#4=#:G655 NIL) (|zq| NIL) (#5=#:G656 NIL)
          (|xq| NIL) (#6=#:G651 NIL) (|p| NIL) (#7=#:G652 NIL) (|zp| NIL)
          (#8=#:G653 NIL) (|xp| NIL) (#9=#:G649 NIL) (|l| NIL) (#10=#:G650 NIL)
          (|zl| NIL) (#11=#:G647 NIL) (|m| NIL) (#12=#:G648 NIL) (|zm| NIL)
          (#13=#:G645 NIL) (|h| NIL) (#14=#:G646 NIL) (|zh| NIL) (|z| ($))
...
(DEFUN |CartesianTensor| (&REST #1=#:G662)
  (SPROG NIL
         (PROG (#2=#:G663)
           (RETURN
            (COND
