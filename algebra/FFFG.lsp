...
(SDEFUN |FFFG;ShiftC;NniL;2| ((|total| |NonNegativeInteger|) ($ |List| D))
        (SPROG ((#1=#:G391 NIL) (|i| NIL) (#2=#:G390 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |FFFG;qShiftC;DNniL;4|
        ...
        (SPROG ((#1=#:G396 NIL) (|i| NIL) (#2=#:G395 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |i| 0) (LETT #1# (- |total| 1)) G190
...
(SDEFUN |FFFG;generalCoefficient;MVNniVD;7|
        ...
        (SPROG
         ((|res| (D)) (#1=#:G411 NIL) (|l| NIL)
          (|b| (|SparseUnivariatePolynomial| D)) (|a| (V)) (#2=#:G410 NIL)
          (|i| NIL))
...
(SDEFUN |FFFG;nextVector!|
        ...
        (SPROG
         ((#1=#:G443 NIL) (#2=#:G448 NIL) (|sum| (|Integer|)) (#3=#:G436 NIL)
          (#4=#:G450 NIL) (|j| NIL) (#5=#:G449 NIL) (|i| NIL)
          ...
          (EXIT
           (SEQ (LETT |n| (SPADCALL |v| (QREFELT $ 48)))
                ...
                (EXIT
                 (COND
                  ((ZEROP |pos|)
                   (PROGN (LETT #2# (CONS 0 "failed")) (GO #6=#:G447)))
                  (#7='T
                   (SEQ
                    (COND
                     ((EQL |pos| 1)
...
(SDEFUN |FFFG;initialVector|
        ...
        (SPROG
         ((#1=#:G467 NIL) (#2=#:G465 NIL) (|entry| (|Integer|)) (#3=#:G473 NIL)
          (|i| NIL) (#4=#:G472 NIL))
         (SEQ
          (PROGN
           (LETT #4# NIL)
...
(SDEFUN |FFFG;interpolate;2LNniF;17|
        ...
        (SPROG
         ((M (|Matrix| (|SparseUnivariatePolynomial| D)))
          (|eta| (|List| (|NonNegativeInteger|))) (#1=#:G483 NIL)
          (|c|
           (|Mapping| D (|NonNegativeInteger|)
                      (|Vector| (|SparseUnivariatePolynomial| D))))
...
(SDEFUN |FFFG;recurrence|
        ((M |Matrix| (|SparseUnivariatePolynomial| D))
         ...
         ($ |Matrix| (|SparseUnivariatePolynomial| D)))
        (SPROG
         ((#1=#:G490 NIL) (|newMiPi| (|SparseUnivariatePolynomial| D))
          (|pl| (D)) (|Mil| (|SparseUnivariatePolynomial| D)) (|rl| (D))
          (#2=#:G499 NIL) (|l| NIL) (|MiPi| (|SparseUnivariatePolynomial| D))
          (#3=#:G498 NIL) (|i| NIL) (|polyf| (|SparseUnivariatePolynomial| D))
          (|rPi| (D)))
...
(SDEFUN |FFFG;fffg;LMVNniM;19|
        ...
        (SPROG
         ((|d| (D)) (M (|Matrix| (|SparseUnivariatePolynomial| D)))
          (#1=#:G504 NIL) (#2=#:G515 NIL) (|l| NIL)
          (|lambda| (|NonNegativeInteger|)) (|lambdaMax| (|Integer|))
          (|vdl| (|Integer|)) (#3=#:G514 NIL) (#4=#:G513 NIL) (|k| NIL)
          (|p| #5=(|Vector| D)) (|r| #5#)
...
(SDEFUN |FFFG;fffg;LMLM;20|
        ((C |List| D)
         ...
         ($ |Matrix| (|SparseUnivariatePolynomial| D)))
        (SPROG
         ((|vd| (|Vector| (|Integer|))) (#1=#:G524 NIL) (|ei| NIL)
          (#2=#:G523 NIL))
         (SEQ
          (LETT |vd|
                (SPADCALL
...
(DEFUN |FractionFreeFastGaussian| (&REST #1=#:G525)
  (SPROG NIL
         (PROG (#2=#:G526)
           (RETURN
            (COND
