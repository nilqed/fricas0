...
(SDEFUN |DPOLCAT-;differentiate;AMA;2| ((|p| A) (|d| |Mapping| R R) ($ A))
        (SPROG
         ((#1=#:G407 NIL) (|ans| (A)) (#2=#:G413 NIL) (#3=#:G412 (A))
          (#4=#:G414 (A)) (#5=#:G420 NIL) (|v| NIL) (#6=#:G410 NIL) (|lc| (R))
...
(SDEFUN |DPOLCAT-;order;ANni;3| ((|p| A) ($ |NonNegativeInteger|))
        (SPROG
         ((#1=#:G422 NIL) (#2=#:G421 #3=(|NonNegativeInteger|)) (#4=#:G423 #3#)
          (#5=#:G426 NIL) (|v| NIL))
         (SEQ
...
(SDEFUN |DPOLCAT-;order;ASNni;4| ((|p| A) (|s| S) ($ |NonNegativeInteger|))
        (SPROG
         ((#1=#:G429 NIL) (#2=#:G428 #3=(|NonNegativeInteger|)) (#4=#:G430 #3#)
          (#5=#:G436 NIL) (#6=#:G378 NIL) (|vv| (|List| #3#)) (#7=#:G435 NIL)
          (|v| NIL) (#8=#:G434 NIL))
         (SEQ
          (COND
...
(SDEFUN |DPOLCAT-;degree;ASNni;5| ((|p| A) (|s| S) ($ |NonNegativeInteger|))
        (SPROG
         ((|d| (|NonNegativeInteger|)) (#1=#:G439 NIL)
          (#2=#:G438 #3=(|NonNegativeInteger|)) (#4=#:G440 #3#) (#5=#:G448 NIL)
          (#6=#:G379 NIL) (|lv| (|List| V)) (#7=#:G447 NIL) (|v| NIL)
          (#8=#:G446 NIL) (#9=#:G445 NIL) (|lp| NIL))
         (SEQ (LETT |d| 0)
...
(SDEFUN |DPOLCAT-;weights;AL;6| ((|p| A) ($ |List| (|NonNegativeInteger|)))
        (SPROG
         ((|ws| (|List| (|NonNegativeInteger|)))
          (|w| #1=(|NonNegativeInteger|)) (#2=#:G451 NIL) (#3=#:G450 #1#)
          (#4=#:G452 #1#) (#5=#:G460 NIL) (#6=#:G462 NIL) (|v| NIL)
          (#7=#:G463 NIL) (|d| NIL) (#8=#:G461 NIL) (#9=#:G380 NIL)
          (|dv| (|List| (|NonNegativeInteger|))) (|lv| (|List| V))
          (#10=#:G459 NIL) (|lp| NIL) (|mp| (|List| A)))
         (SEQ (LETT |ws| NIL)
              (EXIT
...
(SDEFUN |DPOLCAT-;weight;ANni;7| ((|p| A) ($ |NonNegativeInteger|))
        (SPROG
         ((#1=#:G465 NIL) (#2=#:G464 #3=(|NonNegativeInteger|)) (#4=#:G466 #3#)
          (#5=#:G469 NIL) (#6=#:G381 NIL) (|ws| (|List| #3#)))
         (SEQ
...
(SDEFUN |DPOLCAT-;weights;ASL;8|
        ...
        (SPROG
         ((|ws| (|List| (|NonNegativeInteger|)))
          (|w| #1=(|NonNegativeInteger|)) (#2=#:G473 NIL) (#3=#:G472 #1#)
          (#4=#:G474 #1#) (#5=#:G484 NIL) (#6=#:G486 NIL) (|v| NIL)
          (#7=#:G487 NIL) (|d| NIL) (#8=#:G485 NIL) (#9=#:G382 NIL)
          (|dv| (|List| (|NonNegativeInteger|))) (|lv| (|List| V))
          (#10=#:G483 NIL) (#11=#:G482 NIL) (#12=#:G481 NIL) (|lp| NIL)
          (|mp| (|List| A)))
         (SEQ (LETT |ws| NIL)
              (EXIT
               (COND ((NULL (LETT |mp| (SPADCALL |p| (QREFELT $ 41)))) |ws|)
...
(SDEFUN |DPOLCAT-;weight;ASNni;9| ((|p| A) (|s| S) ($ |NonNegativeInteger|))
        (SPROG
         ((#1=#:G489 NIL) (#2=#:G488 #3=(|NonNegativeInteger|)) (#4=#:G490 #3#)
          (#5=#:G493 NIL) (#6=#:G383 NIL) (|ws| (|List| #3#)))
         (SEQ
...
(SDEFUN |DPOLCAT-;leader;AV;11| ((|p| A) ($ V))
        (SPROG
         ((#1=#:G496 NIL) (#2=#:G495 (V)) (#3=#:G497 (V)) (#4=#:G500 NIL)
          (#5=#:G384 NIL) (|vl| (|List| V)))
...
(SDEFUN |DPOLCAT-;differentialVariables;AL;16| ((|p| A) ($ |List| S))
        (SPROG ((#1=#:G515 NIL) (|v| NIL) (#2=#:G514 NIL))
               (SEQ
                (SPADCALL
                 (PROGN
                  (LETT #2# NIL)
...
(SDEFUN |DPOLCAT-;eval;ALLA;18| ((|p| A) (|sl| |List| S) (|rl| |List| R) ($ A))
        (SPROG
         ((|rrl| (|List| R)) (|t| (R)) (#1=#:G535 NIL) (|i| NIL)
          (#2=#:G534 NIL) (#3=#:G533 NIL) (|r| NIL) (|vl| (|List| V))
          (#4=#:G532 NIL) (|j| NIL) (#5=#:G531 NIL) (#6=#:G530 NIL) (|s| NIL)
          (#7=#:G529 NIL) (|ordp| (|NonNegativeInteger|)))
...
(SDEFUN |DPOLCAT-;eval;ALLA;19| ((|p| A) (|sl| |List| S) (|rl| |List| A) ($ A))
        (SPROG
         ((|rrl| (|List| A)) (|t| (A)) (#1=#:G553 NIL) (|i| NIL)
          (#2=#:G552 NIL) (#3=#:G551 NIL) (|r| NIL) (|vl| (|List| V))
          (#4=#:G550 NIL) (|j| NIL) (#5=#:G549 NIL) (#6=#:G548 NIL) (|s| NIL)
          (#7=#:G547 NIL) (|ordp| (|NonNegativeInteger|)))
         (SEQ (LETT |ordp| (SPADCALL |p| (QREFELT $ 77)))
              (LETT |vl|
                    (SPADCALL
                     (PROGN
...
(SDEFUN |DPOLCAT-;eval;ALA;20| ((|p| A) (|l| |List| (|Equation| A)) ($ A))
        (SPROG
         ((#1=#:G560 NIL) (|e| NIL) (#2=#:G559 NIL) (#3=#:G558 NIL)
          (#4=#:G557 NIL))
         (SEQ
          (SPADCALL |p|
                    (PROGN
