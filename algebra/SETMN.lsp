...
(SDEFUN |SETMN;coerce;$Of;2| ((|s| $) ($ |OutputForm|))
        (SPROG ((#1=#:G401 NIL) (|i| NIL) (#2=#:G400 NIL))
               (SEQ
                (SPADCALL
                 (PROGN
                  (LETT #2# NIL)
...
(SDEFUN |SETMN;reallyEnumerate| (($ |Vector| $))
        (SPROG
         ((#1=#:G404 NIL) (|i| NIL) (#2=#:G406 NIL) (|b| NIL) (#3=#:G405 NIL))
         (SEQ
          (PROGN
           (LETT #3#
                 (GETREFV
...
(SDEFUN |SETMN;enum|
        ...
        (SPROG
         ((#1=#:G424 NIL) (|s| NIL) (|l| (|List| (|Bits|))) (#2=#:G417 NIL)
          (|q1| (|NonNegativeInteger|)) (#3=#:G416 NIL) (#4=#:G423 NIL)
          (|i| NIL) (|b| (|Bits|)))
         (SEQ
...
(SDEFUN |SETMN;setOfMinN;L$;10| ((|l| |List| (|PositiveInteger|)) ($ $))
        (SPROG
         ((|count| (|NonNegativeInteger|)) (#1=#:G445 NIL) (|i| NIL)
          (|s| (|Bits|)))
...
(SDEFUN |SETMN;incrementKthElement;$PiU;12|
        ...
        (SPROG
         ((#1=#:G460 NIL) (|newb| (|Bits|)) (|i| (|NonNegativeInteger|))
...
(DEFUN |SetOfMIntegersInOneToN| (&REST #1=#:G483)
  (SPROG NIL
         (PROG (#2=#:G484)
           (RETURN
            (COND
