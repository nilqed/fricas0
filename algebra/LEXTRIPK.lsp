...
(SDEFUN |LEXTRIPK;trueVariables|
        ((|lp| |List|
         ...
         ($ |List| (|Symbol|)))
        (SPROG
         ((|truels| (|List| (|Symbol|))) (#1=#:G396 NIL) (#2=#:G402 NIL)
...
(SDEFUN |LEXTRIPK;zeroDimensional?;LB;2|
        ((|lp| |List|
         ...
         ($ |Boolean|))
        (SPROG
         ((|lq1| (|List| (|Polynomial| R))) (#1=#:G407 NIL) (|p| NIL)
          (#2=#:G406 NIL)
          (|fglmpack|
           (CATEGORY |package|
...
(SDEFUN |LEXTRIPK;fglmIfCan;LU;3|
        ((|lp| |List|
         ...
         ($ |Union|
          ...
          "failed"))
        (SPROG
         ((#1=#:G426 NIL) (|q1| NIL) (#2=#:G425 NIL) (#3=#:G422 NIL)
          (|foo| (|Union| (|List| (|Polynomial| R)) #4="failed"))
          (|lq1| (|List| (|Polynomial| R))) (#5=#:G424 NIL) (|p| NIL)
          (#6=#:G423 NIL)
          (|fglmpack|
           (CATEGORY |package|
            (SIGNATURE |zeroDimensional?|
          ...
          (EXIT
           (SEQ (LETT |truels| (|LEXTRIPK;trueVariables| |lp| $))
                ...
                (EXIT
                 (COND
                  ((QEQCAR |foo| 1)
                   (PROGN (LETT #3# (CONS 1 "failed")) (GO #7=#:G421)))
                  ('T
                   (SEQ
                    (LETT |lp|
                          (PROGN
...
(SDEFUN |LEXTRIPK;groebner;2L;4|
        ((|lp| |List|
         ...
         ($ |List|
          (|NewSparseMultivariatePolynomial| R (|OrderedVariableList| |ls|))))
        (SPROG
         ((#1=#:G434 NIL) (|q1| NIL) (#2=#:G433 NIL)
          (|lq1| (|List| (|Polynomial| R))) (#3=#:G432 NIL) (|p| NIL)
          (#4=#:G431 NIL)
          (|fglmpack|
           (CATEGORY |package|
            (SIGNATURE |zeroDimensional?|
...
(SDEFUN |LEXTRIPK;lexTriangular;LBL;5|
        ...
        (SPROG
         ((|toSee|
          ...
          (#2=#:G462 NIL) (|us| (|RegularChain| R |ls|))
          (|newlp|
           (|List|
            (|NewSparseMultivariatePolynomial| R
...
(DEFUN |LexTriangularPackage| (&REST #1=#:G500)
  (SPROG NIL
         (PROG (#2=#:G501)
           (RETURN
            (COND
