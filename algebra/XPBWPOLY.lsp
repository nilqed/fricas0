...
(SDEFUN |XPBWPOLY;prod1|
        ...
        (SPROG
         ((#1=#:G401 NIL) (#2=#:G400 ($)) (#3=#:G402 ($)) (#4=#:G404 NIL)
          (|t| NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
...
(SDEFUN |XPBWPOLY;prod2|
        ...
        (SPROG
         ((#1=#:G406 NIL) (#2=#:G405 ($)) (#3=#:G407 ($)) (#4=#:G409 NIL)
          (|t| NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
...
(SDEFUN |XPBWPOLY;prod11|
        ...
        (SPROG
         ((#1=#:G411 NIL) (#2=#:G410 ($)) (#3=#:G412 ($)) (#4=#:G415 NIL)
          (|t| NIL) (|limit| (|Integer|)))
...
(SDEFUN |XPBWPOLY;prod22|
        ((|p| $) (|b| |PoincareBirkhoffWittLyndonBasis| |VarSet|)
         (|n| |NonNegativeInteger|) ($ $))
        (SPROG
         ((#1=#:G417 NIL) (#2=#:G416 ($)) (#3=#:G418 ($)) (#4=#:G421 NIL)
          (|t| NIL) (|limit| (|Integer|)))
         (SEQ (LETT |limit| (- |n| (SPADCALL |b| (QREFELT $ 23))))
              (EXIT
               (PROGN
...
(SDEFUN |XPBWPOLY;Dexpand|
        ...
        (SPROG
         ((#1=#:G424 NIL) (#2=#:G423 #3=(|XDistributedPolynomial| |VarSet| R))
          (#4=#:G425 #3#) (#5=#:G427 NIL) (|l| NIL))
         (SEQ
          (COND
...
(SDEFUN |XPBWPOLY;process|
        ...
        (SPROG
         ((|r2| ($)) (#1=#:G448 NIL) (#2=#:G447 ($)) (#3=#:G449 ($))
          (#4=#:G457 NIL) (|t| NIL) (|r1| ($)) (#5=#:G445 NIL) (#6=#:G444 ($))
          (#7=#:G446 ($)) (#8=#:G456 NIL) (#9=#:G442 NIL) (#10=#:G441 ($))
          (#11=#:G443 ($)) (#12=#:G455 NIL) (|fd| (|LyndonWord| |VarSet|))
          (|rd| (|List| (|LyndonWord| |VarSet|))) (#13=#:G438 NIL)
          (#14=#:G437 ($)) (#15=#:G439 ($)) (#16=#:G454 NIL)
...
(SDEFUN |XPBWPOLY;coerce;$Of;13| ((|p| $) ($ |OutputForm|))
        (SPROG ((|le| (|List| (|OutputForm|))) (#1=#:G466 NIL) (|rec| NIL))
               (SEQ
                (COND
...
(SDEFUN |XPBWPOLY;coerce;$Xdp;16|
        ...
        (SPROG
         ((#1=#:G474 NIL) (#2=#:G473 #3=(|XDistributedPolynomial| |VarSet| R))
          (#4=#:G475 #3#) (#5=#:G477 NIL) (|t| NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
...
(SDEFUN |XPBWPOLY;coerce;$Xrp;17|
        ...
        (SPROG
         ((#1=#:G479 NIL) (#2=#:G478 #3=(|XRecursivePolynomial| |VarSet| R))
          (#4=#:G480 #3#) (#5=#:G482 NIL) (|t| NIL))
         (SEQ
          (COND
...
(SDEFUN |XPBWPOLY;*;3$;22| ((|x| $) (|y| $) ($ $))
        (SPROG
         ((#1=#:G492 NIL) (#2=#:G491 ($)) (#3=#:G493 ($)) (#4=#:G496 NIL)
          (|t| NIL))
         (SEQ
          (COND
...
(SDEFUN |XPBWPOLY;varList;$L;23| ((|p| $) ($ |List| |VarSet|))
        (SPROG
         ((|lv| #1=(|List| |VarSet|)) (#2=#:G498 NIL) (#3=#:G497 #1#)
          (#4=#:G499 #1#) (#5=#:G502 NIL) (|b| NIL))
         (SEQ
          (LETT |lv|
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |XPBWPOLY;product;2$Nni$;26|
        ...
        (SPROG
         ((#1=#:G507 NIL) (#2=#:G506 ($)) (#3=#:G508 ($)) (#4=#:G510 NIL)
          (|t| NIL))
         (SEQ
          (COND
...
(SDEFUN |XPBWPOLY;LiePolyIfCan;$U;29|
        ...
        (SPROG
         ((|lt|
          ...
          (#1=#:G539 NIL) (|t| NIL) (#2=#:G538 NIL) (#3=#:G527 NIL)
          (#4=#:G526 #5=(|Boolean|)) (#6=#:G528 #5#) (#7=#:G537 NIL))
         (SEQ
          (COND
           ((SPADCALL |p| (|spadConstant| $ 21) (QREFELT $ 65))
...
(SDEFUN |XPBWPOLY;mirror;2$;30| ((|p| $) ($ $))
        (SPROG
         ((#1=#:G541 NIL) (#2=#:G540 ($)) (#3=#:G542 ($)) (#4=#:G544 NIL)
          (|t| NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
...
(DEFUN |XPBWPolynomial| (&REST #1=#:G559)
  (SPROG NIL
         (PROG (#2=#:G560)
           (RETURN
            (COND
...
(DEFUN |XPBWPolynomial;| (|#1| |#2|)
  (SPROG
   ((|pv$| NIL) (#1=#:G558 NIL) ($ NIL) (|dv$| NIL) (DV$2 NIL) (DV$1 NIL))
   (PROGN
