...
(SDEFUN |MRING;index;Pi$;8| ((|i0| |PositiveInteger|) ($ $))
        (SPROG
         ((|i| (|Integer|)) (|ans| ($)) (|m| (M)) (#1=#:G445 NIL) (|cf| (R))
          (#2=#:G443 NIL) (|h| (|Integer|)) (|j| NIL) (|n| (|Integer|))
          (|p| (|Integer|)))
...
(SDEFUN |MRING;lookup;$Pi;9| ((|z| $) ($ |PositiveInteger|))
        (SPROG
         ((|res| (|Integer|)) (|co| (|Integer|))
          (|ex| #1=(|NonNegativeInteger|)) (|l| #1#) (#2=#:G458 NIL) (|te| NIL)
          (|n| (|Integer|)) (|p| (|Integer|))
...
(SDEFUN |MRING;monomials;$L;15| ((|a| $) ($ |List| $))
        (SPROG ((#1=#:G473 NIL) (|t| NIL) (#2=#:G472 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |MRING;coefficients;$L;16| ((|a| $) ($ |List| R))
        (SPROG ((#1=#:G478 NIL) (|t| NIL) (#2=#:G477 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |t| NIL) (LETT #1# |a|) G190
...
(SDEFUN |MRING;-;2$;20| ((|a| $) ($ $))
        (SPROG ((#1=#:G489 NIL) (|t| NIL) (#2=#:G488 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |t| NIL) (LETT #1# |a|) G190
...
(SDEFUN |MRING;*;R2$;21| ((|r| R) (|a| $) ($ $))
        (SPROG ((#1=#:G495 NIL) (|t| NIL) (#2=#:G494 NIL))
               (SEQ
                (COND
                 ((SPADCALL |r| (|spadConstant| $ 16) (QREFELT $ 18))
                  (|spadConstant| $ 15))
...
(SDEFUN |MRING;*;R2$;22| ((|r| R) (|a| $) ($ $))
        (SPROG ((|rt| (R)) (#1=#:G501 NIL) (|t| NIL) (#2=#:G500 NIL))
               (SEQ
                (COND
                 ((SPADCALL |r| (|spadConstant| $ 16) (QREFELT $ 18))
                  (|spadConstant| $ 15))
...
(SDEFUN |MRING;*;I2$;23| ((|n| |Integer|) (|a| $) ($ $))
        (SPROG ((#1=#:G506 NIL) (|t| NIL) (#2=#:G505 NIL))
               (SEQ
...
(SDEFUN |MRING;*;I2$;24| ((|n| |Integer|) (|a| $) ($ $))
        (SPROG ((|nt| (R)) (#1=#:G511 NIL) (|t| NIL) (#2=#:G510 NIL))
               (SEQ
                (COND ((EQL |n| 0) (|spadConstant| $ 15)) ((EQL |n| 1) |a|)
                      ('T
                       (PROGN
...
(SDEFUN |MRING;map;M2$;25| ((|f| |Mapping| R R) (|a| $) ($ $))
        (SPROG ((|ft| (R)) (#1=#:G517 NIL) (|t| NIL) (#2=#:G516 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |t| NIL) (LETT #1# |a|) G190
...
(SDEFUN |MRING;coerce;$Of;32| ((|a| $) ($ |OutputForm|))
        (SPROG ((#1=#:G572 NIL) (|t| NIL) (#2=#:G571 NIL))
               (SEQ
...
(SDEFUN |MRING;support;$L;39| ((|a| $) ($ |List| M))
        (SPROG ((#1=#:G593 NIL) (|t| NIL) (#2=#:G592 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |MRING;construct!|
        ((|x| |List| (|Record| (|:| |k| M) (|:| |c| R))) ($ $))
        (SPROG
         ((|res| (|List| (|Record| (|:| |k| M) (|:| |c| R)))) (#1=#:G613 NIL)
...
(SDEFUN |MRING;=;2$B;45| ((|a| $) (|b| $) ($ |Boolean|))
        (SPROG
         ((#1=#:G630 NIL) (#2=#:G631 NIL) (#3=#:G632 NIL) (|ta| NIL)
          (#4=#:G633 NIL) (|tb| NIL))
         (SEQ
          (EXIT
           (COND
                      ...
                      (EXIT
                       (COND
                        ((OR (SPADCALL (QCDR |ta|) (QCDR |tb|) (QREFELT $ 56))
                         ...
                         (PROGN
                          (LETT #1# (PROGN (LETT #2# NIL) (GO #5=#:G629)))
                          (GO #6=#:G626))))))
...
(SDEFUN |MRING;coefficient;$MR;47| ((|a| $) (|m| M) ($ R))
        (SPROG ((#1=#:G656 NIL) (#2=#:G657 NIL) (|t| NIL))
               (SEQ
                (EXIT
                 (SEQ
...
(SDEFUN |MRING;*;3$;48| ((|a| $) (|b| $) ($ $))
        (SPROG
         ((#1=#:G660 NIL) (#2=#:G659 ($)) (#3=#:G661 ($)) (#4=#:G666 NIL)
          (|tb| NIL) (#5=#:G665 NIL) (#6=#:G664 NIL) (|ta| NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
...
(SDEFUN |MRING;*;3$;49| ((|a| $) (|b| $) ($ $))
        (SPROG
         ((#1=#:G669 NIL) (#2=#:G668 ($)) (#3=#:G670 ($)) (|r| (R))
          (#4=#:G676 NIL) (|tb| NIL) (#5=#:G675 NIL) (#6=#:G674 NIL)
          (|ta| NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
...
(SDEFUN |MRING;*;3$;50| ((|a| $) (|b| $) ($ $))
        (SPROG
         ((#1=#:G689 NIL) (|tb| NIL) (#2=#:G688 NIL) (#3=#:G687 NIL) (|ta| NIL)
          (#4=#:G686 NIL))
         (SEQ
          (COND
...
(SDEFUN |MRING;=;2$B;51| ((|a| $) (|b| $) ($ |Boolean|))
        (SPROG ((#1=#:G697 NIL) (#2=#:G698 NIL) (#3=#:G699 NIL) (|t| NIL))
               (SEQ
                (EXIT
                 (COND
...
(SDEFUN |MRING;coefficient;$MR;52| ((|a| $) (|m| M) ($ R))
        (SPROG ((#1=#:G705 NIL) (#2=#:G706 NIL) (#3=#:G707 NIL) (|t| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ
...
(SDEFUN |MRING;+;3$;54| ((|a| $) (|b| $) ($ $))
        (SPROG
         ((#1=#:G725 NIL) (|m| NIL) (#2=#:G724 NIL) (#3=#:G723 NIL) (|t| NIL)
          (#4=#:G722 NIL) (|Tabl| (|AssociationList| M R)))
...
(SDEFUN |MRING;*;3$;55| ((|a| $) (|b| $) ($ $))
        (SPROG
         ((#1=#:G735 NIL) (|m| NIL) (#2=#:G734 NIL) (#3=#:G733 NIL) (|tb| NIL)
          (#4=#:G732 NIL) (|ta| NIL) (|Tabl| (|AssociationList| M R)))
         (SEQ (LETT |Tabl| (SPADCALL (QREFELT $ 111)))
...
(DEFUN |MonoidRing;| (|#1| |#2|)
  (SPROG
   ((|pv$| NIL) (#1=#:G736 NIL) (#2=#:G737 NIL) ($ NIL) (|dv$| NIL) (DV$2 NIL)
    (DV$1 NIL))
   (PROGN
