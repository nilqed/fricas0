...
(SDEFUN |GENPGCD;gcdPolynomial;3Sup;1|
        ...
        (SPROG
         ((|v2| #1=(|List| OV)) (|v| #1#) (#2=#:G451 NIL)
          ...
          (|cg| (|SparseUnivariatePolynomial| P)) (#5=#:G419 NIL)
...
(SDEFUN |GENPGCD;gcdSameVariables|
        ((|p1| . #1=(|SparseUnivariatePolynomial| P))
         ...
         ($ |SparseUnivariatePolynomial| P))
        (SPROG
         ((#5=#:G500 NIL) (#6=#:G501 NIL)
          (|ans| (|Union| (|SparseUnivariatePolynomial| P) "failed"))
          (|uu| (|SparseUnivariatePolynomial| R)) (|r| (R))
          (|count| #7=(|NonNegativeInteger|))
          (|up2| #8=(|SparseUnivariatePolynomial| R)) (#9=#:G482 NIL)
          (|up1| #8#) (#10=#:G467 NIL) (|dv| #11=(|NonNegativeInteger|))
          (|v| #12=(|SparseUnivariatePolynomial| R)) (|good_cnt| #7#)
          (|du| #11#) (|u| #12#) (|lr| (|List| R)) (#13=#:G505 NIL) (|vv| NIL)
          (#14=#:G504 NIL) (#15=#:G503 NIL) (#16=#:G502 NIL) (|gcdLC| (P))
...
(SDEFUN |GENPGCD;lift|
        ...
        (SPROG
         ((#1=#:G534 NIL) (#2=#:G535 NIL) (|pn| (P))
          ...
          (#5=#:G537 NIL) (|n| NIL) (|origFactors| (|List| #3#)) (|prime| (P))
          (|d| #6=(|NonNegativeInteger|)) (#7=#:G516 NIL) (#8=#:G515 #6#)
          (#9=#:G517 #6#) (#10=#:G536 NIL) (|c| NIL)
...
(SDEFUN |GENPGCD;recursivelyGCDCoefficients|
        ((|g| . #1=(|SparseUnivariatePolynomial| P)) (|v| . #2=(|List| OV))
         ...
         ($ |SparseUnivariatePolynomial| P))
        (SPROG
         ((#3=#:G548 NIL) (|oldv| #2#) (#4=#:G549 NIL) (|oldg| #1#)
          (|p1| (|SparseUnivariatePolynomial| P)) (#5=#:G551 NIL) (|i| NIL)
          (|d| #6=(|NonNegativeInteger|)) (#7=#:G539 NIL) (#8=#:G538 #6#)
          (#9=#:G540 #6#) (#10=#:G550 NIL) (|u| NIL) (|mv| (OV)))
         (SEQ
          (EXIT
...
(SDEFUN |GENPGCD;flatten|
        ((|p1| |SparseUnivariatePolynomial| P) (|lv| |List| OV)
         ($ |SparseUnivariatePolynomial| P))
        (SPROG
         ((|lr| (|List| R)) (#1=#:G562 NIL) (|vv| NIL) (#2=#:G561 NIL)
          (|ans| (|SparseUnivariatePolynomial| P))
          (|dg| (|NonNegativeInteger|)) (#3=#:G560 NIL) (#4=#:G559 NIL))
         (SEQ
...
(SDEFUN |GENPGCD;variables|
        ...
        (SPROG
         ((#1=#:G564 NIL) (#2=#:G563 #3=(|List| OV)) (#4=#:G565 #3#)
          (#5=#:G567 NIL) (|u| NIL))
         (SEQ
          (SPADCALL
           (PROGN
...
(DEFUN |GeneralPolynomialGcdPackage| (&REST #1=#:G586)
  (SPROG NIL
         (PROG (#2=#:G587)
           (RETURN
            (COND
