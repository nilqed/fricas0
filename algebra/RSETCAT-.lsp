...
(SDEFUN |RSETCAT-;purelyAlgebraic?;SB;5| ((|ts| S) ($ |Boolean|))
        (SPROG
         ((#1=#:G457 NIL) (|i| (|NonNegativeInteger|)) (#2=#:G446 NIL)
          (|v| (V)) (#3=#:G458 NIL) (|p| NIL) (|lp| (|List| P)))
         (SEQ
          (EXIT
           (COND
...
(SDEFUN |RSETCAT-;intersect;L2L;13|
        ...
        (SPROG
         ((|toSee| (|List| (|Record| (|:| |val| (|List| P)) (|:| |tower| S))))
          (#1=#:G529 NIL) (|us| NIL) (#2=#:G528 NIL) (|lus| (|List| S))
          (|p| (P)) (|toSave| (|List| S)) (|ts| (S))
          (|lpwt| (|Record| (|:| |val| (|List| P)) (|:| |tower| S)))
          (#3=#:G527 NIL) (#4=#:G526 NIL) (#5=#:G525 NIL) (#6=#:G524 NIL))
         (SEQ
