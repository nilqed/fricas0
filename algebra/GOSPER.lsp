           ...
           (SEQ
            (SEQ (LETT |q| (|GOSPER;RF2QIfCan| |aquo| $))
                 (EXIT
                  (COND
                   ((QEQCAR |q| 1)
                    (PROGN (LETT #1# (CONS 1 #2="failed")) (GO #3=#:G400)))
                   ('T
                    (SEQ
                     (LETT |u|
...
(SDEFUN |GOSPER;GosperF|
        ...
        (SPROG
         ((#1=#:G448 NIL)
          ...
          (#11=#:G437 NIL) (#12=#:G436 #10#) (#13=#:G438 #10#) (#14=#:G453 NIL)
...
(SDEFUN |GOSPER;GosperPQR|
        ...
        (SPROG
         ((|pn| (|SparseMultivariatePolynomial| (|Fraction| (|Integer|)) V))
          ...
          (#6=#:G468 #5#) (#7=#:G476 NIL) (|i| NIL) (|rn| #2#) (#8=#:G461 NIL)
          (|qn| #1#)
          (|gn| (|SparseMultivariatePolynomial| (|Fraction| (|Integer|)) V))
          (|rtp| (|SparseMultivariatePolynomial| (|Fraction| (|Integer|)) V))
          (#9=#:G475 NIL) (|rt| (|Union| (|Integer|) #10="failed"))
          (|js| (|List| (|Integer|))) (#11=#:G457 NIL) (#12=#:G474 NIL)
          (|fe| NIL) (#13=#:G473 NIL)
          (|fres|
           (|Factored|
            (|SparseMultivariatePolynomial| (|Fraction| (|Integer|)) V)))
...
(SDEFUN |GOSPER;GosperDegBd|
        ...
        (SPROG
         ((|k0| (|Union| (|Integer|) "failed")) (#1=#:G478 NIL)
        ...
        (SPROG
         ((|up|
           #1=(|SparseUnivariatePolynomial|
               (|SparseMultivariatePolynomial| (|Fraction| (|Integer|)) V)))
          (|pow| (|NonNegativeInteger|)) (|unom| #1#) (#2=#:G491 NIL) (|v| NIL)
          (|vlist| (|List| V)))
         (SEQ
          (COND
...
(SDEFUN |GOSPER;linearAndNNIntRoot|
        ...
        (SPROG
         ((|rt| (|Fraction| (|Integer|))) (#1=#:G504 NIL)
                   ...
                   (SEQ
                    (SEQ
                     ...
                     (EXIT
                      (COND
                       ((QEQCAR |p1| 1)
                        (PROGN (LETT #1# (CONS 1 #4="failed")) (GO #5=#:G501)))
                       (#3#
                        (SEQ
                         (LETT |p0|
...
(DEFUN |GosperSummationMethod| (&REST #1=#:G505)
  (SPROG NIL
         (PROG (#2=#:G506)
           (RETURN
            (COND
