...
(SDEFUN |JBUNDLE;CheckZeroIndex|
        ...
        (SPROG ((#1=#:G404 NIL) (#2=#:G405 NIL) (|i| NIL))
               (SEQ
                (EXIT
                 (SEQ
...
(SDEFUN |JBUNDLE;U;Pi$;8| ((|up| |PositiveInteger|) ($ $))
        (SPROG ((#1=#:G410 NIL) (|i| NIL) (#2=#:G409 NIL))
               (SEQ
...
(SDEFUN |JBUNDLE;coerce;S$;10| ((|s| |Symbol|) ($ $))
        (SPROG ((#1=#:G418 NIL) (#2=#:G415 NIL) (|pos| (|Integer|)))
...
(SDEFUN |JBUNDLE;D;SL$;11| ((|u| |Symbol|) (|der| |List| (|Symbol|)) ($ $))
        (SPROG
         ((#1=#:G426 NIL) (|lower| (|List| (|PositiveInteger|)))
          (#2=#:G422 NIL) (|pos| #3=(|Integer|)) (#4=#:G430 NIL) (|d| NIL)
          (|up| #3#))
...
(SDEFUN |JBUNDLE;name;$S;15| ((|jv| $) ($ |Symbol|))
        (SPROG
         ((|lower| (|List| (|OutputForm|))) (#1=#:G442 NIL) (|j| NIL)
...
(SDEFUN |JBUNDLE;coerce;$E;17| ((|jv| $) ($ |Expression| (|Integer|)))
        (SPROG
         ((|arg| (|List| (|Expression| (|Integer|)))) (#1=#:G450 NIL) (|i| NIL)
          (#2=#:G449 NIL) (|jop| (|BasicOperator|)) (|tmp| (|None|))
          (|opname| (|Symbol|)))
         (SEQ
          (COND
