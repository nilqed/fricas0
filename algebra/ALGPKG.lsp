...
(SDEFUN |ALGPKG;convVM| ((|v| |Vector| R) ($ |Matrix| R))
        (SPROG
         ((|z| (|Integer|)) (#1=#:G386 NIL) (|j| NIL) (#2=#:G385 NIL) (|i| NIL)
          (|cond| (|Matrix| R)))
         (SEQ
          (LETT |cond|
...
(SDEFUN |ALGPKG;basisOfLeftAnnihilator;AL;3| ((|a| A) ($ |List| A))
        (SPROG
         ((|cond| (|Matrix| R)) (#1=#:G396 NIL) (#2=#:G398 NIL) (|i| NIL)
          (#3=#:G397 NIL) (|ca| (|Matrix| R)))
         (SEQ
          (LETT |ca|
                (SPADCALL
...
(SDEFUN |ALGPKG;basisOfRightAnnihilator;AL;4| ((|a| A) ($ |List| A))
        (SPROG
         ((|cond| (|Matrix| R)) (#1=#:G405 NIL) (#2=#:G407 NIL) (|i| NIL)
          (#3=#:G406 NIL) (|ca| (|Matrix| R)))
         (SEQ
          (LETT |ca|
                (SPADCALL
                 (SPADCALL (SPADCALL |a| (QREFELT $ 32)) (QREFELT $ 33))
...
(SDEFUN |ALGPKG;basisOfLeftNucloid;L;5| (($ |List| (|Matrix| R)))
        (SPROG
         ((#1=#:G423 NIL) (|sol| NIL) (#2=#:G422 NIL) (|r2| (|Integer|))
          (|r1| (|Integer|)) (#3=#:G421 NIL) (|r| NIL) (|z| (|Integer|))
          (#4=#:G420 NIL) (|k| NIL) (#5=#:G419 NIL) (|j| NIL) (#6=#:G418 NIL)
...
(SDEFUN |ALGPKG;basisOfCommutingElements;L;6| (($ |List| A))
        (SPROG
         ((|cond| (|Matrix| R)) (|gam| (|Matrix| R)) (#1=#:G430 NIL)
          (#2=#:G432 NIL) (|i| NIL) (#3=#:G431 NIL))
         (SEQ
          (LETT |cond|
                (SPADCALL (ELT $ 35)
                          (PROGN
...
(SDEFUN |ALGPKG;basisOfLeftNucleus;L;7| (($ |List| A))
        (SPROG
         ((|entry| (R)) (#1=#:G447 NIL) (|l| NIL) (#2=#:G446 NIL) (|i| NIL)
          (|z| (|Integer|)) (#3=#:G445 NIL) (|s| NIL) (#4=#:G444 NIL) (|j| NIL)
          (#5=#:G443 NIL) (|k| NIL) (|condi| (|Matrix| R)))
         (SEQ
          (LETT |condi|
...
(SDEFUN |ALGPKG;basisOfRightNucleus;L;8| (($ |List| A))
        (SPROG
         ((|entry| (R)) (#1=#:G462 NIL) (|l| NIL) (#2=#:G461 NIL) (|i| NIL)
          (|z| (|Integer|)) (#3=#:G460 NIL) (|s| NIL) (#4=#:G459 NIL) (|j| NIL)
          (#5=#:G458 NIL) (|k| NIL) (|condo| (|Matrix| R)))
         (SEQ
          (LETT |condo|
                (MAKE_MATRIX1 (QREFELT $ 12) (QREFELT $ 10)
                              (|spadConstant| $ 16)))
...
(SDEFUN |ALGPKG;basisOfMiddleNucleus;L;9| (($ |List| A))
        (SPROG
         ((|entry| (R)) (#1=#:G477 NIL) (|l| NIL) (#2=#:G476 NIL) (|i| NIL)
          (|z| (|Integer|)) (#3=#:G475 NIL) (|s| NIL) (#4=#:G474 NIL) (|j| NIL)
          (#5=#:G473 NIL) (|k| NIL) (|conda| (|Matrix| R)))
         (SEQ
          (LETT |conda|
                (MAKE_MATRIX1 (QREFELT $ 12) (QREFELT $ 10)
                              (|spadConstant| $ 16)))
...
(SDEFUN |ALGPKG;basisOfNucleus;L;10| (($ |List| A))
        (SPROG
         ((|ent| (R)) (|enter| (R)) (|entry| (R)) (#1=#:G493 NIL) (|l| NIL)
          (#2=#:G492 NIL) (|i| NIL) (|w| (|Integer|)) (|u| (|Integer|))
          (|z| (|Integer|)) (#3=#:G491 NIL) (|s| NIL) (#4=#:G490 NIL) (|j| NIL)
          (#5=#:G489 NIL) (|k| NIL) (|condi| (|Matrix| R)))
         (SEQ
          (LETT |condi|
...
(SDEFUN |ALGPKG;basisOfCenter;L;11| (($ |List| A))
        (SPROG
         ((D #1=(|Matrix| R)) (|enter| (R)) (|entry| (R)) (#2=#:G512 NIL)
          (|l| NIL) (#3=#:G511 NIL) (|i| NIL) (|u| (|Integer|))
          (|z| (|Integer|)) (#4=#:G510 NIL) (|s| NIL) (#5=#:G509 NIL) (|j| NIL)
          (#6=#:G508 NIL) (|k| NIL) (|condi| (|Matrix| R)) (B #1#)
          (|cond| (|Matrix| R)) (|gammak| (|Matrix| R)) (#7=#:G507 NIL)
          (|gamma1| (|Matrix| R)))
...
(SDEFUN |ALGPKG;basisOfRightNucloid;L;12| (($ |List| (|Matrix| R)))
        (SPROG
         ((#1=#:G528 NIL) (|sol| NIL) (#2=#:G527 NIL) (|r2| (|Integer|))
          (|r1| (|Integer|)) (#3=#:G526 NIL) (|r| NIL) (|z| (|Integer|))
          (#4=#:G525 NIL) (|k| NIL) (#5=#:G524 NIL) (|j| NIL) (#6=#:G523 NIL)
          (|i| NIL) (|condo| #7=(|Matrix| R)) (|cond| #7#))
         (SEQ
          (LETT |cond|
                (MAKE_MATRIX1 (QREFELT $ 12) (QREFELT $ 11)
...
(SDEFUN |ALGPKG;basisOfCentroid;L;13| (($ |List| (|Matrix| R)))
        (SPROG
         ((#1=#:G544 NIL) (|sol| NIL) (#2=#:G543 NIL) (|r2| (|Integer|))
          (|r1| (|Integer|)) (#3=#:G542 NIL) (|r| NIL) (|u| (|Integer|))
          (|z| (|Integer|)) (#4=#:G541 NIL) (|k| NIL) (#5=#:G540 NIL) (|j| NIL)
          (#6=#:G539 NIL) (|i| NIL) (|condo| #7=(|Matrix| R)) (|cond| #7#))
         (SEQ
          (LETT |cond|
...
(SDEFUN |ALGPKG;doubleRank;ANni;14| ((|x| A) ($ |NonNegativeInteger|))
        (SPROG
         ((|enter| (R)) (|entry| (R)) (#1=#:G555 NIL) (|i| NIL)
          (|u| (|Integer|)) (|z| (|Integer|)) (#2=#:G554 NIL) (|j| NIL)
          (#3=#:G553 NIL) (|k| NIL) (|cond| (|Matrix| R)))
         (SEQ
          (LETT |cond|
...
(SDEFUN |ALGPKG;weakBiRank;ANni;15| ((|x| A) ($ |NonNegativeInteger|))
        (SPROG
         ((|entry| (R)) (#1=#:G569 NIL) (|s| NIL) (#2=#:G568 NIL) (|l| NIL)
          (#3=#:G567 NIL) (|k| NIL) (|z| (|Integer|)) (#4=#:G566 NIL) (|j| NIL)
          (#5=#:G565 NIL) (|i| NIL) (|cond| (|Matrix| R)))
         (SEQ
          (LETT |cond|
...
(SDEFUN |ALGPKG;biRank;ANni;16| ((|x| A) ($ |NonNegativeInteger|))
        (SPROG
         ((|enter| (R)) (|entry| (R)) (#1=#:G592 NIL) (|i| NIL) (#2=#:G591 NIL)
          (|k| NIL) (|w| (|Integer|)) (|u| (|Integer|)) (#3=#:G590 NIL)
          (|j| NIL) (|c| (|PositiveInteger|)) (#4=#:G589 NIL) (|s| NIL)
          (#5=#:G588 NIL) (|l| NIL) (#6=#:G587 NIL) (|z| (|Integer|))
          (#7=#:G586 NIL) (#8=#:G585 NIL) (|cond| (|Matrix| R)))
         (SEQ
          (LETT |cond|
...
(SDEFUN |ALGPKG;leftRank;ANni;17| ((|x| A) ($ |NonNegativeInteger|))
        (SPROG
         ((|entry| (R)) (#1=#:G601 NIL) (|i| NIL) (#2=#:G600 NIL) (|j| NIL)
          (#3=#:G599 NIL) (|k| NIL) (|cond| (|Matrix| R)))
         (SEQ
          (LETT |cond|
                (MAKE_MATRIX1 (QREFELT $ 10) (QREFELT $ 10)
                              (|spadConstant| $ 16)))
...
(SDEFUN |ALGPKG;rightRank;ANni;18| ((|x| A) ($ |NonNegativeInteger|))
        (SPROG
         ((|entry| (R)) (#1=#:G610 NIL) (|i| NIL) (#2=#:G609 NIL) (|j| NIL)
          (#3=#:G608 NIL) (|k| NIL) (|cond| (|Matrix| R)))
         (SEQ
          (LETT |cond|
                (MAKE_MATRIX1 (QREFELT $ 10) (QREFELT $ 10)
                              (|spadConstant| $ 16)))
...
(SDEFUN |ALGPKG;basis;2V;19| ((|va| |Vector| A) ($ |Vector| A))
        (SPROG
         ((#1=#:G623 NIL) (#2=#:G625 NIL) (|j| (|Integer|)) (#3=#:G624 NIL)
          (|finished?| (|Boolean|)) (|h| (|Integer|))
          (|lj| (|List| (|Integer|))) (|mCI| (|Integer|)) (|mRI| (|Integer|))
          (|m| (|Matrix| R)) (#4=#:G622 NIL) (|i| NIL) (|v| (|Vector| A)))
...
(DEFUN |AlgebraPackage| (&REST #1=#:G626)
  (SPROG NIL
         (PROG (#2=#:G627)
           (RETURN
            (COND
