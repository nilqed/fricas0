...
(SDEFUN |MAMA;fill_diagonal|
        ((B M) (A M) (|nr| |NonNegativeInteger|) (|nc| |NonNegativeInteger|)
         (|n| |Integer|) ($ |Void|))
        (SPROG
         ((#1=#:G398 NIL) (|i| NIL) (|sc| (|Integer|)) (|sr| (|Integer|))
          (|dl| (|Integer|)))
         (SEQ
          (COND
...
(SDEFUN |MAMA;bandMatrix;MLM;11| ((A M) (|ln| |List| (|Integer|)) ($ M))
        (SPROG
         ((#1=#:G405 NIL) (|n| NIL) (B (M)) (|nc| (|NonNegativeInteger|))
...
(SDEFUN |MAMA;subMatrix;M2LM;13|
        ...
        (SPROG
         ((#1=#:G413 NIL) (|j| NIL) (#2=#:G414 NIL) (|jj| NIL) (#3=#:G411 NIL)
          (|i| NIL) (#4=#:G412 NIL) (|ii| NIL) (|res| (M)) (|minC| (|Integer|))
...
(SDEFUN |MAMA;blockSplit;MLPiL;15|
        ((A M) (|lr| |List| (|NonNegativeInteger|)) (|nc| |PositiveInteger|)
         ($ |List| (|List| M)))
        (SPROG ((#1=#:G419 NIL) (X NIL) (#2=#:G418 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(DEFUN |MatrixManipulation| (&REST #1=#:G424)
  (SPROG NIL
         (PROG (#2=#:G425)
           (RETURN
            (COND
