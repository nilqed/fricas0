...
(SDEFUN |REP2;blockMultiply|
        ((|a| |Matrix| R) (|b| |Matrix| R) (|li| |List| (|Integer|))
         (|n| |Integer|) ($ |Matrix| R))
        (SPROG
         ((#1=#:G401 NIL) (#2=#:G400 (R)) (#3=#:G402 (R)) (#4=#:G410 NIL)
          (|s| NIL) (#5=#:G409 NIL) (|j| NIL) (#6=#:G408 NIL) (#7=#:G407 NIL)
          (|i| NIL) (#8=#:G406 NIL))
         (SEQ
          (SPADCALL
           (PROGN
...
(SDEFUN |REP2;fingerPrint|
        ((|i| |NonNegativeInteger|) (|a| |Matrix| R) (|b| |Matrix| R)
         (|x| |Matrix| R) ($ |Matrix| R))
        (SPROG
         ((#1=#:G426 NIL) (#2=#:G424 NIL) (#3=#:G422 NIL) (#4=#:G420 NIL)
          (#5=#:G418 NIL) (#6=#:G416 NIL))
         (SEQ
          (COND
           ((EQL
             (PROG1 (LETT #6# |i|)
...
(SDEFUN |REP2;completeEchelonBasis;VM;3|
        ...
        (SPROG
         ((#1=#:G441 NIL) (|j| NIL) (|newStart| #2=(|NonNegativeInteger|))
          (|indexOfVectorToBeScanned| #2#) (|row| #3=(|NonNegativeInteger|))
          (#4=#:G440 NIL) (|completedBasis| (|Matrix| R)) (#5=#:G439 NIL)
...
(SDEFUN |REP2;cyclicSubmodule;LVV;5|
        ...
        (SPROG
         ((#1=#:G458 NIL) (|i| NIL) (#2=#:G457 NIL)
          (|furtherElts| (|List| (|Vector| R)))
          (|updateFurtherElts| (|List| (|Vector| R))) (#3=#:G456 NIL)
          (#4=#:G455 NIL) (|basis| (|Matrix| R)) (|addedToBasis| (|Matrix| R))
          (|nextVector| (|Matrix| R)) (|w| (|Vector| R)) (#5=#:G454 NIL)
          (#6=#:G453 NIL))
         (SEQ
          (LETT |basis|
                (SPADCALL
...
(SDEFUN |REP2;standardBasisOfCyclicSubmodule;LVM;6|
        ...
        (SPROG
         ((|furtherElts| (|List| (|Vector| R)))
          (|updateFurtherElts| (|List| (|Vector| R))) (#1=#:G470 NIL) (|i| NIL)
          (#2=#:G469 NIL) (|basis| (|Matrix| R))
          (|standardBasis| (|List| (|List| R))) (|addedToBasis| (|Matrix| R))
          (|nextVector| (|Matrix| R)) (|w| (|Vector| R)) (#3=#:G468 NIL)
          (#4=#:G467 NIL) (|dim| (|NonNegativeInteger|)))
...
(SDEFUN |REP2;splitInternal|
        ...
        (SPROG
         ((|factormoduleRepresentation| (|List| (|Matrix| R)))
          ...
          (|helpMatrix| (|Matrix| R)) (#1=#:G487 NIL) (|i| NIL)
          (|inverseTransitionMatrix| (|Matrix| R)) (#2=#:G474 NIL)
          (|transitionMatrix| (|Matrix| R))
          (|factormoduleIndices| (|List| (|Integer|))) (#3=#:G486 NIL)
          (#4=#:G485 NIL) (|submoduleIndices| (|List| (|Integer|)))
          (#5=#:G484 NIL) (#6=#:G483 NIL) (|rankOfSubmodule| (|Integer|))
...
(SDEFUN |REP2;irreducibilityTestInternal|
        ((|algebraGenerators| |List| (|Matrix| R))
         ...
         ($ |List| (|List| (|Matrix| R))))
        (SPROG
         ((#1=#:G492 NIL) (|mat| (|Matrix| R)) (#2=#:G504 NIL) (|j| NIL)
          (#3=#:G503 NIL) (|i| NIL) (|result| (|List| (|List| (|Matrix| R))))
          (|kernel| (|List| (|Vector| R))) (|xt| (|Matrix| R))
          (|algebraGeneratorsTranspose| (|List| (|Matrix| R))) (#4=#:G502 NIL)
          (#5=#:G501 NIL))
         (SEQ
...
(SDEFUN |REP2;areEquivalent?;2LBIM;11|
        ...
        (SPROG
         ((|transitionM| (|Matrix| R)) (|result| #1=(|Boolean|))
          (#2=#:G536 NIL) (|j| NIL) (|foundResult| #1#) (#3=#:G517 NIL)
          (|baseChange1| #4=(|Matrix| R)) (|baseChange0| #4#)
          (|kernel1| #5=(|List| (|Vector| R))) (|kernel0| #5#)
          (|rk1| #6=(|NonNegativeInteger|)) (|rk0| #6#) (|x1| #7=(|Matrix| R))
          (|x0| #7#) (|randomIndex| (|Integer|)) (#8=#:G534 NIL) (|i| NIL)
          (#9=#:G535 NIL) (|n| (|NonNegativeInteger|))
          (|numberOfGenerators| (|NonNegativeInteger|)))
         (SEQ (LETT |result| NIL)
...
(SDEFUN |REP2;isAbsolutelyIrreducible?;LIB;13|
        ...
        (SPROG
         ((|result| #1=(|Boolean|)) (|kernel| (|List| (|Vector| R)))
          ...
          (|randomIndex| (|Integer|)) (#2=#:G546 NIL) (|i| NIL) (#3=#:G547 NIL)
...
(SDEFUN |REP2;split;LVL;15|
        ...
        (SPROG
         ((|factormoduleRepresentation| (|List| (|Matrix| R)))
          (|submoduleRepresentation| (|List| (|Matrix| R)))
          (|helpMatrix| (|Matrix| R)) (#1=#:G562 NIL) (|i| NIL)
          (|inverseTransitionMatrix| (|Matrix| R)) (#2=#:G552 NIL)
          (|transitionMatrix| (|Matrix| R))
          (|factormoduleIndices| (|List| (|Integer|))) (#3=#:G561 NIL)
          (#4=#:G560 NIL) (|submoduleIndices| (|List| (|Integer|)))
          (#5=#:G559 NIL) (#6=#:G558 NIL) (|rankOfSubmodule| (|Integer|))
          (|n| (|NonNegativeInteger|)))
...
(SDEFUN |REP2;my_min| ((|m| |Matrix| R) (|n| |Integer|) ($ |Smp|))
        (SPROG
         ((|xi| (|Smp|)) (|res| (|Smp|)) (#1=#:G581 NIL) (|i| NIL)
          (|x| (|Smp|)) (|j| (|Integer|)) (|depe| (|Matrix| R))
          (|depm| (|Matrix| R)) (#2=#:G580 NIL) (|v| #3=(|Vector| R))
          (#4=#:G579 NIL) (|depl| (|List| (|Vector| R))) (#5=#:G578 NIL)
          (#6=#:G577 NIL) (#7=#:G576 NIL) (|zz| #3#) (#8=#:G564 NIL))
         (SEQ
          (LETT |zz|
                (SPADCALL
                 (PROG1 (LETT #8# |n|)
                ...
                (SPADCALL
                 (PROGN
                  ...
                  (SEQ (LETT |v| NIL) (LETT #2# |depl|) G190
                       ...
                       (SEQ
                        (EXIT
                         (LETT #4# (CONS (SPADCALL |v| (QREFELT $ 75)) #4#))))
...
(SDEFUN |REP2;m_eval|
        ...
        (SPROG
         ((|old_deg| #1=(|NonNegativeInteger|)) (|res| (|Matrix| R))
          (#2=#:G592 NIL) (|i| NIL) (|ndeg| #1#) (|c0| (R)) (|id| (|Matrix| R))
          (#3=#:G589 NIL) (#4=#:G591 NIL) (#5=#:G590 NIL)
          (|nn| (|NonNegativeInteger|)) (#6=#:G582 NIL))
         (SEQ
          (LETT |nn|
                (PROG1 (LETT #6# |n|)
...
(SDEFUN |REP2;meatAxe1|
        ...
        (SPROG
         ((#1=#:G604 NIL) (|pres| (|List| (|List| (|Matrix| R))))
          (|v| (|Vector| R)) (|good| (|Boolean|))
          (|kernel| (|List| (|Vector| R))) (|xx| (|Matrix| R))
          (|mm| (|NonNegativeInteger|)) (|fpol| (|Smp|)) (#2=#:G605 NIL)
          (|fac| NIL)
          (|fl|
           (|List|
...
(SDEFUN |REP2;meatAxe;LB2IL;19|
        ((|algebraGenerators| |List| (|Matrix| R)) (|randomelements| |Boolean|)
         ...
         ($ |List| (|List| (|Matrix| R))))
        (SPROG
         ((|result| (|List| (|List| (|Matrix| R)))) (#1=#:G621 NIL)
          (#2=#:G623 NIL) (|j| NIL) (|numberOfTests| (|Integer|))
          ...
          (|randomIndex| (|Integer|)) (#3=#:G622 NIL) (|i| NIL)
          (|q| (|PositiveInteger|)) (#4=#:G606 NIL)
          (|numberOfGenerators| (|NonNegativeInteger|)))
         (SEQ
          (EXIT
...
(SDEFUN |REP2;scanOneDimSubspaces;LIV;23|
        ...
        (SPROG
         ((#1=#:G639 NIL) (|j| NIL) (|newAdd| (|Vector| R)) (#2=#:G638 NIL)
          (|i| (|Integer|)) (|result| #3=(|Vector| R)) (#4=#:G629 NIL)
          (#5=#:G637 NIL) (|iR| (|List| (|Integer|))) (|coefficients| #3#)
          (|nred| #6=(|Integer|)) (|pos| #6#) (#7=#:G636 NIL)
...
(DEFUN |RepresentationPackage2| (#1=#:G641)
  (SPROG NIL
         (PROG (#2=#:G642)
           (RETURN
            (COND
...
(DEFUN |RepresentationPackage2;| (|#1|)
  (SPROG ((|pv$| NIL) (#1=#:G640 NIL) ($ NIL) (|dv$| NIL) (DV$1 NIL))
         (PROGN
