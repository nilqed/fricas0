                                    ...
                                    (|Record| (|:| |k| (|NonNegativeInteger|))
                                              (|:| |c|
                                                   (|SparseMultivariatePolynomial|
                                                    R |VarSet1|))))))))
          (#3=#:G403 NIL) (|t0| NIL) (|pu1| #1#) (#4=#:G402 NIL)
...
(SDEFUN |SMPCOER;find_var|
        ...
        (SPROG ((#1=#:G409 NIL) (#2=#:G410 NIL) (|y| NIL))
               (SEQ
                (EXIT
                 (SEQ
         ...
         ((|pl2|
           (|List|
            (|Record| (|:| |elt1| |VarSet1|)
                      (|:| |elt2|
                           (|SparseMultivariatePolynomial| R |VarSet2|)))))
          (#1=#:G440 NIL) (|el1| NIL) (#2=#:G441 NIL) (|el2| NIL)
          (#3=#:G439 NIL) (#4=#:G438 NIL) (|x| NIL) (#5=#:G437 NIL)
          (#6=#:G436 NIL) (#7=#:G435 NIL)
          (|pl|
           (|List| (|Record| (|:| |elt1| |VarSet1|) (|:| |elt2| |VarSet2|))))
          (#8=#:G433 NIL) (#9=#:G434 NIL) (#10=#:G432 NIL)
...
(DEFUN |SparsePolynomialCoercionHelpers| (&REST #1=#:G442)
  (SPROG NIL
         (PROG (#2=#:G443)
           (RETURN
            (COND
