...
(SDEFUN |SCELL;separate|
        ...
        (SPROG
         ((|new_left| (|TheField|)) (|new_right| (|TheField|))
          ...
          (#1=#:G405 NIL) (|ll| (|List| |TheField|)) (|middle| (|TheField|)))
         (SEQ
          (EXIT
           (SEQ
            (LETT |middle|
...
(SDEFUN |SCELL;allSimpleCells;LSL;8|
        ...
        (SPROG
         ((|l1| (|List| |TheField|)) (|res| (|List| $))
          (|l| #1=(|List| |TheField|)) (#2=#:G413 NIL) (#3=#:G412 #1#)
          (#4=#:G414 #1#) (#5=#:G423 NIL) (|p| NIL) (|b| (|TheField|))
          (#6=#:G410 NIL) (#7=#:G409 (|TheField|)) (#8=#:G411 (|TheField|))
          (#9=#:G422 NIL) (|lp1| (|List| |ThePols|)))
