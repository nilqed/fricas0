...
(SDEFUN |SIMPC;simplicialComplex;LNniL$;1|
        ...
        (SPROG ((|res| (|List| (|OrientedFacet|))) (#1=#:G407 NIL) (|f| NIL))
               (SEQ (LETT |res| NIL)
...
(SDEFUN |SIMPC;simplicialComplex;LL$;2|
        ...
        (SPROG
         ((|numPoints| (|NonNegativeInteger|)) (|m| (|NonNegativeInteger|))
          (#1=#:G414 NIL) (|fac| NIL) (|facs| (|List| (|OrientedFacet|)))
          (#2=#:G413 NIL) (|f| NIL))
         (SEQ (LETT |facs| NIL)
...
(SDEFUN |SIMPC;simplicialComplexIfCan;DcBU;5|
        ...
        (SPROG
         ((|res| (|List| (|OrientedFacet|))) (#1=#:G449 NIL) (|r| NIL)
          (|orf| (|OrientedFacet|)) (#2=#:G443 NIL)
          ...
          (#3=#:G430 NIL) (#4=#:G448 NIL) (|i| NIL) (#5=#:G447 NIL)
          (|facet| NIL) (|thisPoint| #6=(|NonNegativeInteger|)) (#7=#:G446 NIL)
          (|NumPoints| #6#) (|lastMap| (|List| (|List| (|OrientedFacet|))))
          (#8=#:G444 NIL) (|map| NIL) (#9=#:G445 NIL) (|grade| NIL)
...
(SDEFUN |SIMPC;addSimplex;$Of$;6| ((|a| $) (|f| |OrientedFacet|) ($ $))
        (SPROG
         ((|numPoints| (|NonNegativeInteger|)) (|max| (|NonNegativeInteger|))
          (#1=#:G462 NIL) (|orf2| NIL) (|res2| (|List| (|OrientedFacet|)))
          (#2=#:G461 NIL) (|orf| NIL) (|res| (|List| (|OrientedFacet|)))
          (|found| (|Boolean|)) (|m| (|Integer|)) (#3=#:G460 NIL))
...
(SDEFUN |SIMPC;maxIndex;$Nni;7| ((|s| $) ($ |NonNegativeInteger|))
        (SPROG
         ((|res| (|NonNegativeInteger|)) (|m| (|NonNegativeInteger|))
          (#1=#:G467 NIL) (|fac| NIL) (|facs| (|List| (|OrientedFacet|))))
...
(SDEFUN |SIMPC;minIndex;$Nni;8| ((|s| $) ($ |NonNegativeInteger|))
        (SPROG
         ((|res| (|NonNegativeInteger|)) (|m| (|NonNegativeInteger|))
          (#1=#:G475 NIL) (|fac| NIL) (#2=#:G474 NIL)
          (|facs| (|List| (|OrientedFacet|))))
         (SEQ
          (EXIT
           (SEQ (LETT |res| 10000) (LETT |facs| (QVELT |s| 2))
                (COND
                 ((EQL (LENGTH |facs|) 0) (PROGN (LETT #2# 0) (GO #3=#:G473))))
                (SEQ (LETT |fac| NIL) (LETT #1# |facs|) G190
                     (COND
                      ((OR (ATOM #1#) (PROGN (LETT |fac| (CAR #1#)) NIL))
                       (GO G191)))
...
(SDEFUN |SIMPC;grade;$L;9| ((|s| $) ($ |List| (|List| (|OrientedFacet|))))
        (SPROG
         ((|gr| (|Integer|)) (#1=#:G486 NIL) (|face| NIL)
          (|res| (|List| (|List| (|OrientedFacet|)))) (#2=#:G485 NIL) (|a| NIL)
          (#3=#:G483 NIL) (|maxGrade| (|NonNegativeInteger|)) (#4=#:G484 NIL)
         ...
         (SEQ
          (EXIT
           (SEQ (LETT |simp| (QVELT |s| 2)) (LETT |maxGrade| 0)
                ...
                (LETT |res| NIL)
                (COND
                 ((< |maxGrade| 1) (PROGN (LETT #3# |res|) (GO #5=#:G482))))
...
(SDEFUN |SIMPC;orderedPermutation|
        ...
        (SPROG
         ((|reslt| (|List| (|List| (|Integer|)))) (|r1| (|List| (|Integer|)))
          (#1=#:G502 NIL) (#2=#:G494 NIL) (|x| NIL)
          (|rst| (|List| (|Integer|))) (|fst| (|Integer|)) (#3=#:G500 NIL)
          (#4=#:G501 NIL) (|y| NIL))
         (SEQ
          (EXIT
           (SEQ (COND ((< |len| 1) (PROGN (LETT #3# NIL) (GO #5=#:G499))))
                (COND
...
(SDEFUN |SIMPC;isNewFace?|
        ...
        (SPROG ((#1=#:G507 NIL) (#2=#:G508 NIL) (|a| NIL))
               (SEQ
                (EXIT
                 (SEQ
...
(SDEFUN |SIMPC;addImpliedFaces;$L;14|
        ...
        (SPROG
         ((|newFaces| (|List| (|OrientedFacet|)))
          (|len| (|NonNegativeInteger|)) (#1=#:G523 NIL) (|face| NIL)
          (|res| (|List| (|List| (|OrientedFacet|))))
          (|all_faces| (|List| (|OrientedFacet|))) (#2=#:G522 NIL) (|gr| NIL)
          (#3=#:G521 NIL) (|maxGrade| (|NonNegativeInteger|))
                 ...
                 ((< |maxGrade| 1)
                  (SEQ
                   (SPADCALL
                    ...
                    (QREFELT $ 33))
                   (EXIT (PROGN (LETT #3# |res|) (GO #4=#:G520))))))
...
(SDEFUN |SIMPC;boundary;2$;15| ((|s| $) ($ $))
        (SPROG
         ((|res| ($)) (#1=#:G530 NIL) (|y| NIL)
          (|x| (|List| (|OrientedFacet|))) (#2=#:G529 NIL) (|facet| NIL))
...
(SDEFUN |SIMPC;star;$Of$;16| ((|s| $) (|simplex| |OrientedFacet|) ($ $))
        (SPROG
         ((|res| (|List| (|OrientedFacet|))) (#1=#:G535 NIL) (|simp| NIL))
         (SEQ (LETT |res| NIL)
...
(SDEFUN |SIMPC;makeDisjoint;3$;20| ((|a| $) (|b| $) ($ $))
        (SPROG
         ((#1=#:G554 NIL) (|maxb| #2=(|NonNegativeInteger|))
         ...
         (SEQ
          (EXIT
           (SEQ (LETT |mina| (SPADCALL |a| (QREFELT $ 61)))
                ...
                (COND
                 ((< |maxa| |minb|) (PROGN (LETT #1# |b|) (GO #4=#:G553))))
...
(SDEFUN |SIMPC;simplicialJoin;2$B$;21|
        ...
        (SPROG
         ((|numPoints| (|NonNegativeInteger|)) (|verts| (|List| VS))
          ...
          (#1=#:G564 NIL) (|y| NIL) (#2=#:G563 NIL) (|x| NIL) (|b2| ($))
          (#3=#:G562 NIL))
         (SEQ
          (EXIT
           (SEQ
            (COND ((NULL (QVELT |a| 2)) (PROGN (LETT #3# |b|) (GO #4=#:G561))))
...
(SDEFUN |SIMPC;oneSkeleton;$Dg;25|
        ...
        (SPROG
         ((|edges|
          ...
          (|n| (|NonNegativeInteger|)) (#3=#:G597 NIL) (|x| NIL)
          (GS
...
(SDEFUN |SIMPC;product;3$;32| ((|a| $) (|b| $) ($ $))
        (SPROG
         ((|numPoints| (|NonNegativeInteger|))
          ...
          (#1=#:G621 NIL) (|l| (|NonNegativeInteger|)) (#2=#:G636 NIL)
          (|y| NIL) (|mul| (|Integer|))
          (|inds|
           (|List|
            (|Record| (|:| |left| (|NonNegativeInteger|))
                      (|:| |right| (|NonNegativeInteger|)))))
          (#3=#:G635 NIL) (|x| NIL) (|dimb| #4=(|NonNegativeInteger|))
          (|bz| (|NonNegativeInteger|)) (|dima| #4#)
          (|az| (|NonNegativeInteger|)) (#5=#:G634 NIL) (|z| NIL)
          (|res2| (|List| (|ProductFacet|))) (#6=#:G633 NIL) (|e| NIL)
          (|res| (|List| (|ProductFacet|))) (#7=#:G632 NIL) (|simpb| NIL)
          (#8=#:G631 NIL) (|simpa| NIL) (|vs| (|List| VS)) (|pp| (VS))
          (#9=#:G630 NIL) (|pb| NIL) (#10=#:G629 NIL) (|pa| NIL)
...
(SDEFUN |SIMPC;equalSimplex|
        ...
        (SPROG
         ((|offset| (|Integer|)) (#1=#:G644 NIL) (#2=#:G645 NIL) (|n| NIL)
...
(SDEFUN |SIMPC;=;2$B;34| ((|a| $) (|b| $) ($ |Boolean|))
        (SPROG
         ((#1=#:G657 NIL) (#2=#:G661 NIL) (|f| NIL)
          (|x| (|NonNegativeInteger|)) (#3=#:G660 NIL) (|a1| NIL)
          (|flags| (|List| (|Boolean|))) (#4=#:G659 NIL) (#5=#:G658 NIL)
...
(SDEFUN |SIMPC;coerce;$Of;35| ((|s| $) ($ |OutputForm|))
        (SPROG
         ((|res| (|OutputForm|)) (#1=#:G667 NIL) (|a| NIL) (#2=#:G666 NIL))
         (SEQ
          (EXIT
           (SEQ
            (LETT |res|
...
(DEFUN |FiniteSimplicialComplex| (#1=#:G669)
  (SPROG NIL
         (PROG (#2=#:G670)
           (RETURN
            (COND
