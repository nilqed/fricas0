...
(SDEFUN |PFUTIL;decompose;UP2L;1| ((|nn| UP) (|dens| |List| UP) ($ |List| UP))
        (SPROG
         ((#1=#:G393 NIL) (|res| (|List| UP)) (#2=#:G397 NIL) (|c| NIL)
          (#3=#:G396 NIL) (|fden| NIL) (|pfr| (|PartialFraction| UP))
          (|nd| (|Factored| UP)) (|fdens| (|List| (|Factored| UP)))
          (#4=#:G395 NIL) (|nden| NIL) (#5=#:G394 NIL))
         (SEQ
          (LETT |fdens|
                (PROGN
                 (LETT #5# NIL)
...
(DEFUN |PartialFractionUtilities| (&REST #1=#:G398)
  (SPROG NIL
         (PROG (#2=#:G399)
           (RETURN
            (COND
