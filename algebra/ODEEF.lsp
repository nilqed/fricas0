          ...
          (|u|
           (|Union|
            (|Record| (|:| |index| (|Integer|)) (|:| |row| (|Vector| F))
                      (|:| |rh| F))
            "failed"))
          (#2=#:G520 NIL) (|eq| NIL) (|lk1| (|List| (|Kernel| F)))
          (#3=#:G519 NIL) (|f| NIL) (#4=#:G518 NIL)
          (|lk0| (|List| (|Kernel| F))) (#5=#:G517 NIL) (#6=#:G516 NIL)
          (|lf| (|List| F)) (#7=#:G515 NIL) (|y| NIL) (#8=#:G514 NIL)
                  ...
                  (SEQ (LETT |eq| NIL) (LETT #2# |eqs|) G190
                       ...
                       (SEQ
                        ...
                        (EXIT
                         (COND
                          ((QEQCAR |u| 1)
                           (PROGN (LETT #1# (CONS 1 "failed")) (GO #9=#:G512)))
                          ('T
                           (SEQ (LETT |rec| (QCDR |u|))
...
(SDEFUN |ODEEF;parseSYSeq|
        ((|eq| F) (|l0| |List| (|Kernel| F)) (|l1| |List| (|Kernel| F))
         ...
         ($ |Union|
          ...
          "failed"))
        (SPROG
         ((|ci| (F)) (#1=#:G545 NIL) (|y| NIL) (|i| NIL) (|v| (|Vector| F))
          (|c| (F)) (|n| (|Integer|)) (|k| (|Kernel| F))
          (|l| (|List| (|Kernel| F))) (#2=#:G544 NIL) (#3=#:G543 NIL))
         (SEQ
          (LETT |l|
                (PROGN
                 (LETT #3# NIL)
...
(SDEFUN |ODEEF;parseODE|
        ...
        (SPROG
         ((|eqrhs| (F)) (|d| (F)) (|u| (|Union| F "failed")) (|k| (|Kernel| F))
          ...
          (#1=#:G570 NIL) (|i| NIL) (|n| (|NonNegativeInteger|))
          (#2=#:G553 NIL) (|m| (|NonNegativeInteger|)) (#3=#:G569 NIL))
         (SEQ
          (LETT |f|
...
(SDEFUN |ODEEF;parseLODE|
        ((|diffeq| F) (|l| |List| (|Kernel| F))
         ...
         ($ |Record| (|:| |left| (|SparseUnivariatePolynomial| F))
          (|:| |right| F)))
        (SPROG
         ((|d| (|Integer|)) (#1=#:G573 NIL) (|c| (F)) (#2=#:G578 NIL)
          (|k| NIL))
         (SEQ
          (COND
...
(SDEFUN |ODEEF;getfreelincoeff1|
        ...
        (SPROG ((#1=#:G585 NIL) (#2=#:G586 NIL) (|y| NIL) (|c| (F)))
               ...
               ((OR (QEQCAR |r| 1)
                    (>
                     (SPADCALL
                      ...
                      (QREFELT $ 94))
                     1))
                (PROGN (LETT #1# (CONS 1 "failed")) (GO #2=#:G600))))))
            (EXIT
             (CONS 0
...
(DEFUN |ElementaryFunctionODESolver| (&REST #1=#:G603)
  (SPROG NIL
         (PROG (#2=#:G604)
           (RETURN
            (COND
