...
(SDEFUN |RDETRS;SPDEsys|
        ((|a| UP) (|b| UP) (|h| UP) (|c1| UP) (|c2| UP) (|n| |Integer|)
         ...
         ($ |Union| (|List| UP) #1#))
        (SPROG
         ((#2=#:G486 NIL) (|rh| #3=(|Union| F "failed")) (|rb| #3#) (|ra| (F))
          ...
          (|u|
           (|Union|
            (|Record| (|:| |z1| UP) (|:| |z2| UP) (|:| |r1| UP) (|:| |r2| UP))
            "failed"))
          (|da| (|NonNegativeInteger|)) (#4=#:G457 NIL) (#5=#:G487 NIL)
...
(SDEFUN |RDETRS;DSPDEsys0|
        ...
        (SPROG
         ((|ans2| (UP)) (|ans1| (UP)) (|q2| (UP)) (|q1| (UP))
          (|lq| (|List| UP)) (#3=#:G512 NIL) (#4=#:G513 NIL) (|u| #1#)
          (#5=#:G506 NIL))
         (SEQ
          (EXIT
...
(SDEFUN |RDETRS;DSPDEhdom|
        ...
        (SPROG
         ((|q2| (UP)) (#1=#:G533 NIL) (|d2| #2=(|Integer|)) (|q1| (UP))
          (|d1| #2#))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |RDETRS;DSPDEbdom|
        ((|c1| UP) (|c2| UP) (|lb| F) (|lh| F) (|n| |NonNegativeInteger|)
         (|d| |Integer|) ($ |Union| (|List| UP) "failed"))
        (SPROG
         ((|q2| (UP)) (#1=#:G543 NIL) (|d1| #2=(|Integer|)) (|q1| (UP))
          (|d2| #2#))
         (SEQ
          (EXIT
           (SEQ
...
(DEFUN |TranscendentalRischDESystem| (&REST #1=#:G554)
  (SPROG NIL
         (PROG (#2=#:G555)
           (RETURN
            (COND
