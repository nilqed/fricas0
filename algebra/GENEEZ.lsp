...
(SDEFUN |GENEEZ;compBound;BPLNni;1|
        ...
        (SPROG
         ((#1=#:G403 NIL) (|normprod| #2=(|NonNegativeInteger|))
          (#3=#:G398 NIL) (#4=#:G397 #2#) (#5=#:G399 #2#) (#6=#:G401 NIL)
          (#7=#:G413 NIL) (|g| NIL) (#8=#:G414 NIL) (|df| NIL)
          (|nm| #9=(|NonNegativeInteger|)) (#10=#:G395 NIL) (#11=#:G394 #9#)
          (#12=#:G396 #9#) (#13=#:G412 NIL) (|u| NIL) (|normlist| (|List| #9#))
          (#14=#:G391 NIL) (#15=#:G390 #9#) (#16=#:G392 #9#) (#17=#:G411 NIL)
          (#18=#:G410 NIL) (|f| NIL) (#19=#:G409 NIL)
          (|n| #20=(|NonNegativeInteger|)) (#21=#:G388 NIL) (#22=#:G387 #20#)
          (#23=#:G389 #20#) (#24=#:G408 NIL) (|ldeg| (|List| #20#))
          (#25=#:G407 NIL) (#26=#:G406 NIL))
         (SEQ
          (LETT |ldeg|
                (PROGN
                 (LETT #26# NIL)
...
(SDEFUN |GENEEZ;compBound;BPLNni;2|
        ((|m| BP) (|listpolys| |List| BP) ($ |NonNegativeInteger|))
        (SPROG
         ((#1=#:G419 NIL) (#2=#:G418 #3=(|NonNegativeInteger|)) (#4=#:G420 #3#)
          (#5=#:G422 NIL) (#6=#:G421 #3#) (#7=#:G423 #3#) (#8=#:G427 NIL)
          (|u| NIL) (#9=#:G426 NIL) (|p| NIL) (#10=#:G416 NIL) (#11=#:G415 #3#)
          (#12=#:G417 #3#) (#13=#:G425 NIL))
         (SEQ
          (+
           (PROGN
            (LETT #10# NIL)
...
(SDEFUN |GENEEZ;reduceList| ((|lp| |List| BP) (|lmod| R) ($ |List| FP))
        (SPROG ((#1=#:G465 NIL) (|ff| NIL) (#2=#:G464 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |GENEEZ;coerceLFP| ((|lf| |List| FP) ($ |List| BP))
        (SPROG ((#1=#:G469 NIL) (|fm| NIL) (#2=#:G468 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |GENEEZ;liftSol|
        ...
        (SPROG
         ((#1=#:G443 NIL) (#2=#:G486 NIL) (|fs| (BP)) (#3=#:G479 NIL)
          (#4=#:G478 (BP)) (#5=#:G480 (BP)) (#6=#:G498 NIL) (|f| NIL)
          (#7=#:G499 NIL) (|g| NIL) (|nsol| (|List| BP)) (#8=#:G497 NIL)
          (|slp| NIL) (#9=#:G496 NIL) (#10=#:G494 NIL) (#11=#:G495 NIL)
          (#12=#:G493 NIL) (|sln| (|List| FP)) (#13=#:G491 NIL) (|pp| NIL)
          (#14=#:G492 NIL) (#15=#:G490 NIL) (|cc| (R)) (#16=#:G489 NIL)
          (|i| NIL) (#17=#:G488 NIL) (|xx| NIL) (#18=#:G487 NIL)
                 ...
                 (EXIT
                  (COND
                   ((> (SPADCALL |lmodk| (QREFELT $ 12)) |bound|)
                    (PROGN (LETT #2# (CONS 1 "failed")) (GO #19=#:G485)))
                   ('T
...
(SDEFUN |GENEEZ;makeProducts| ((|listPol| |List| BP) ($ |List| BP))
        (SPROG
         ((#1=#:G510 NIL) (|g| NIL) (#2=#:G509 NIL) (#3=#:G501 NIL)
          (#4=#:G500 (BP)) (#5=#:G502 (BP)) (#6=#:G508 NIL) (#7=#:G378 NIL)
          (|ll| (|List| BP)) (|f| (BP)))
         (SEQ
...
(SDEFUN |GENEEZ;testModulus;RLB;13|
        ...
        (SPROG
         ((#1=#:G520 NIL) (#2=#:G522 NIL) (#3=#:G525 NIL) (|rpol2| NIL)
          (|redListPol| (|List| FP)) (|rpol| (FP)) (#4=#:G521 NIL)
          (#5=#:G523 NIL) (|pol| NIL) (#6=#:G524 NIL))
         (SEQ
          (EXIT
                        ...
                        (EXIT
                         (COND
                          ((SPADCALL (SPADCALL |pol| (QREFELT $ 9))
                                     ...
                                     (QREFELT $ 56))
                           (PROGN
                            (LETT #4# (PROGN (LETT #2# NIL) (GO #7=#:G519)))
                            (GO #8=#:G512))))))
...
(SDEFUN |GENEEZ;tablePow;NniRLU;14|
        ...
        (SPROG
         ((#1=#:G539 NIL) (|tpol| NIL) (#2=#:G540 NIL) (|fpol| NIL)
          (#3=#:G538 NIL) (#4=#:G537 NIL) (|i| NIL) (|x| (BP))
...
(SDEFUN |GENEEZ;solveid;BPRVU;15|
        ...
        (SPROG
         ((|sln| (|List| BP)) (#1=#:G553 NIL) (|pp| NIL) (#2=#:G554 NIL)
          (|slp| NIL) (#3=#:G552 NIL) (#4=#:G551 NIL) (|i| NIL) (#5=#:G550 NIL)
          (|xx| NIL) (#6=#:G549 NIL) (|d| (|NonNegativeInteger|)))
...
(SDEFUN |GENEEZ;tablePow;NniRLU;16|
        ((|mdeg| |NonNegativeInteger|) (|pmod| R) (|listPol| |List| BP)
         ($ |Union| (|Vector| (|List| BP)) "failed"))
        (SPROG
         ((|ptable| (|Vector| (|List| BP))) (#1=#:G572 NIL) (|tpol| NIL)
          (#2=#:G573 NIL) (|fpol| NIL) (#3=#:G571 NIL) (#4=#:G570 NIL)
          (|i| NIL) (|x| (FP)) (|fl| (|List| FP))
          (|ftable| (|Vector| (|List| FP)))
          (|multiE| (|Union| (|List| FP) "failed")) (|listP| (|List| FP))
          (#5=#:G569 NIL) (|pol| NIL) (#6=#:G568 NIL))
         (SEQ
          (LETT |listP|
                (PROGN
                 (LETT #6# NIL)
...
(SDEFUN |GENEEZ;solveid;BPRVU;17|
        ((|m| BP) (|pmod| R) (|table| |Vector| (|List| BP))
         ($ |Union| (|List| BP) "failed"))
        (SPROG
         ((|a| (BP)) (#1=#:G443 NIL) (|bound| (|NonNegativeInteger|))
          (|fs| (BP)) (#2=#:G580 NIL) (#3=#:G579 (BP)) (#4=#:G581 (BP))
          (#5=#:G593 NIL) (|f| NIL) (#6=#:G594 NIL) (|g| NIL)
          (|soln| (|List| BP)) (#7=#:G592 NIL) (|slp| NIL) (#8=#:G591 NIL)
          (|sln| (|List| FP)) (#9=#:G589 NIL) (|pp| NIL) (#10=#:G590 NIL)
          (#11=#:G588 NIL) (#12=#:G587 NIL) (|i| NIL) (#13=#:G586 NIL)
          (|xx| NIL) (#14=#:G585 NIL) (|lpolys| (|List| BP))
