...
(SDEFUN |INBFF;inv;2V;1| ((|a| |Vector| GF) ($ |Vector| GF))
        (SPROG ((|erg| (|Vector| GF)) (|b| (|Vector| GF)) (#1=#:G395 NIL))
               (SEQ
                (LETT |b|
                      (SPADCALL
                       (SPADCALL |a|
...
(SDEFUN |INBFF;^;VIV;2| ((|a| |Vector| GF) (|ex| |Integer|) ($ |Vector| GF))
        (SPROG
         ((|mult| (|Integer|)) (|k| (|SingleInteger|))
          ...
          (|e| (|NonNegativeInteger|)) (#1=#:G406 NIL) (#2=#:G405 NIL))
         (SEQ
          (LETT |e|
                (PROG1
                    (LETT #1#
...
(SDEFUN |INBFF;dAndcExp;VNniSiV;4|
        ...
        (SPROG
         ((|i| #1#) (|erg| (|Vector| GF)) (#2=#:G430 NIL) (|j| NIL)
          (|ex| (|Integer|)) (|l| (|List| (|NonNegativeInteger|)))
          (|plist| (|List| (|Vector| GF))) (|b| (|Vector| GF)) (#3=#:G429 NIL)
          (|qk| (|Integer|)))
...
(SDEFUN |INBFF;*;3V;5| ((|a| |Vector| GF) (|b| |Vector| GF) ($ |Vector| GF))
        (SPROG
         ((|k| (|SingleInteger|)) (|x| (|SingleInteger|)) (|y| (GF))
          (#1=#:G445 NIL) (|t| NIL) (#2=#:G444 NIL) (|j| NIL) (#3=#:G443 NIL)
          (|i| NIL) (#4=#:G442 NIL) (#5=#:G441 NIL) (|erg| (|Vector| GF))
          (|e| (|SingleInteger|)))
...
(SDEFUN |INBFF;lookup;VPi;6| ((|x| |Vector| GF) ($ |PositiveInteger|))
        (SPROG ((#1=#:G448 NIL) (#2=#:G447 NIL) (|erg| (|Integer|)) (|j| NIL))
               (SEQ (LETT |erg| 0)
...
(SDEFUN |INBFF;expPot;V2SiV;8|
        ...
        (SPROG
         ((|qpot| #1#) (|erg| #2=(|Vector| GF)) (|k2| #1#) (|y| #2#)
          (#3=#:G464 NIL) (|k| NIL) (|deg| (|SingleInteger|)))
...
(SDEFUN |INBFF;qPot;VIV;9| ((|e| |Vector| GF) (|n| |Integer|) ($ |Vector| GF))
        (SPROG
         ((#1=#:G471 NIL) (|i| NIL) (#2=#:G470 NIL) (|e1| (|Vector| GF))
...
(SDEFUN |INBFF;random;PiV;11| ((|n| |PositiveInteger|) ($ |Vector| GF))
        (SPROG ((#1=#:G483 NIL) (|i| NIL) (|v| (|Vector| GF)))
...
(SDEFUN |INBFF;minimalPolynomial;VSup;16|
        ...
        (SPROG
         ((|v| (|Vector| GF)) (|y| (|Vector| GF)) (#1=#:G498 NIL) (|k| NIL)
          (#2=#:G497 NIL) (|j| NIL) (|dy| #3=(|NonNegativeInteger|))
          (#4=#:G496 NIL) (|i| NIL) (|m| (|Matrix| GF)) (|dx| #3#))
...
(SDEFUN |INBFF;basis;PiV;17|
        ...
        (SPROG
         ((|uniti| (|Vector| GF)) (#1=#:G503 NIL) (|i| NIL)
...
(SDEFUN |INBFF;index;2PiV;19|
        ...
        (SPROG
         ((|m| (|Integer|)) (#1=#:G510 NIL) (|j| NIL) (|erg| (|Vector| GF)))
...
(SDEFUN |INBFF;pol;VSup;20|
        ((|x| |Vector| GF) ($ |SparseUnivariatePolynomial| GF))
        (SPROG
         ((#1=#:G512 NIL) (#2=#:G511 #3=(|SparseUnivariatePolynomial| GF))
          (#4=#:G513 #3#) (#5=#:G514 NIL) (#6=#:G516 NIL) (|i| NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
...
(DEFUN |InnerNormalBasisFieldFunctions| (#1=#:G517)
  (SPROG NIL
         (PROG (#2=#:G518)
           (RETURN
            (COND
