...
(SDEFUN |JDE;adapt|
        ...
        (SPROG
         ((|resPro?| (|List| (|Boolean|)))
          ...
          (#1=#:G440 NIL) (|i| NIL) (#2=#:G439 NIL)
          (|j| (|NonNegativeInteger|)) (#3=#:G438 NIL) (#4=#:G437 NIL)
          (#5=#:G436 NIL) (|d| NIL) (#6=#:G435 NIL) (#7=#:G434 NIL)
          (#8=#:G433 NIL) (#9=#:G432 NIL))
         (SEQ
          (COND
           ((QEQCAR |dep| 0)
            (CONS
...
(SDEFUN |JDE;copy;2$;3| ((|De| $) ($ $))
        (SPROG
         ((|newOrd| (|List| (|NonNegativeInteger|)))
          (|newSys| (|List| |SysRec|)) (#1=#:G451 NIL) (|sys| NIL)
          (#2=#:G450 NIL))
         (SEQ
          (LETT |newSys|
                (PROGN
...
(SDEFUN |JDE;retract;$L;5| ((|De| $) ($ |List| D))
        (SPROG
         ((|LSys| (|List| (|List| D))) (#1=#:G460 NIL) (|sys| NIL)
          (#2=#:G459 NIL))
         (SEQ
          (LETT |LSys|
                (PROGN
...
(SDEFUN |JDE;jacobiMatrix;$L;6|
        ...
        (SPROG ((#1=#:G464 NIL) (|sys| NIL) (#2=#:G463 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |sys| NIL) (LETT #1# (QCAR |De|)) G190
...
(SDEFUN |JDE;printSys;LOf;7| ((|sys| |List| D) ($ |OutputForm|))
        (SPROG
         ((|tmp| (|List| (|OutputForm|))) (#1=#:G472 NIL) (|eq| NIL)
          (|leq| (|List| (|Equation| D))) (#2=#:G471 NIL) (#3=#:G470 NIL))
         (SEQ
...
(SDEFUN |JDE;display;$V;9| ((|De| $) ($ |Void|))
        (SPROG ((#1=#:G480 NIL) (|sys| NIL) (#2=#:G481 NIL) (|ord| NIL))
               (SEQ
...
(SDEFUN |JDE;makeSystem2|
        ...
        (SPROG
         ((|resSys| (|List| |SysRec|)) (|rec| (|SysRec|)) (#1=#:G502 NIL)
          (|ord| NIL) (|i| NIL) (|pos| (|Integer|)) (#2=#:G499 NIL) (|eq| NIL)
          (#3=#:G500 NIL) (#4=#:G501 NIL) (|q| NIL) (|j| NIL)
          (|vjm| (|Vector| (|SparseEchelonMatrix| JB D)))
          (|vder| (|Vector| (|List| (|NonNegativeInteger|))))
          (|vsys| (|Vector| (|List| D)))
          (|ljm| (|List| (|SparseEchelonMatrix| JB D))) (|inds| (|List| JB))
          (#5=#:G498 NIL) (|nord| (|NonNegativeInteger|))
          (|resOrd| (|List| (|NonNegativeInteger|)))
          (|lord| (|List| (|NonNegativeInteger|))) (#6=#:G497 NIL)
          (#7=#:G496 NIL))
         (SEQ
          (LETT |lord|
                (PROGN
...
(SDEFUN |JDE;makeSystem;L$;11| ((|sys| |List| D) ($ $))
        (SPROG
         ((|jm| (|SparseEchelonMatrix| JB D))
          (|der| (|List| (|NonNegativeInteger|))) (#1=#:G511 NIL) (|eq| NIL)
          (#2=#:G510 NIL) (|nsys| (|List| D)) (#3=#:G509 NIL) (#4=#:G508 NIL))
         (SEQ
...
(SDEFUN |JDE;dimension;$2Nni;14|
        ...
        (SPROG
         ((|res| (|NonNegativeInteger|)) (#1=#:G538 NIL)
          (|resSys| (|List| |SysRec|)) (|d| (|NonNegativeInteger|))
          (|simp?| (|Boolean|)) (|qq| (|Integer|)) (#2=#:G544 NIL) (|j| NIL)
          (#3=#:G542 NIL) (|sys| NIL) (#4=#:G543 NIL) (|ord| NIL)
...
(SDEFUN |JDE;simplify;$R;15|
        ...
        (SPROG
         ((|u?| (|Boolean|)) (#1=#:G596 NIL) (#2=#:G609 NIL)
          (|j| (|NonNegativeInteger|)) (#3=#:G610 NIL) (|lj| (|List| JB))
          (#4=#:G608 NIL) (|eq| NIL) (|i| NIL)
          ...
          (|o| (|NonNegativeInteger|)) (#9=#:G606 NIL) (#10=#:G607 NIL)
          (|pro?| NIL)
          (|ad|
           (|Record| (|:| |Der| (|List| (|NonNegativeInteger|)))
                     (|:| |Pro?| (|List| (|Boolean|)))))
...
(SDEFUN |JDE;prolong;$R;17|
        ...
        (SPROG
         ((|tmp| (|Record| (|:| |SDe| $) (|:| IC (|List| D)))) (|res| ($))
          ...
          (|lastOrd| #1=(|NonNegativeInteger|)) (#2=#:G663 NIL) (|j| NIL)
          (#3=#:G662 NIL) (|lastRec| (|SysRec|)) (|pRec| (|SysRec|))
          (#4=#:G661 NIL) (|i| NIL) (#5=#:G660 NIL) (#6=#:G659 NIL)
          (#7=#:G658 NIL) (|pJM| (|SparseEchelonMatrix| JB D))
          (|pIC| #8=(|List| D)) (|pJV| (|List| (|List| JB)))
          (|pDer| (|List| (|NonNegativeInteger|))) (|pEqs| #8#)
          (|FDiff| (|Record| (|:| |DPhi| D) (|:| |JVars| (|List| JB))))
          (#9=#:G628 NIL) (#10=#:G657 NIL)
          (|jmeq| (|SparseEchelonMatrix| JB D)) (#11=#:G654 NIL) (|eq| NIL)
          (#12=#:G655 NIL) (#13=#:G656 NIL) (|pro?| NIL) (|k| NIL)
          (#14=#:G652 NIL) (|rec| (|SysRec|)) (#15=#:G653 NIL) (|ord| NIL)
          (#16=#:G651 NIL) (#17=#:G650 NIL) (#18=#:G649 NIL) (#19=#:G648 NIL)
          (#20=#:G619 NIL) (#21=#:G647 NIL) (#22=#:G645 NIL) (#23=#:G646 NIL)
          (|q| #1#))
...
(SDEFUN |JDE;prolong;$NniR;18|
        ...
        (SPROG
         ((|tmp| (|Record| (|:| |SDe| $) (|:| IC (|List| D)))) (|res| ($))
          ...
          (|lastRec| (|SysRec|)) (#3=#:G712 NIL) (|j| NIL) (#4=#:G711 NIL)
          (|pRec| (|SysRec|)) (#5=#:G710 NIL) (|i| NIL) (#6=#:G709 NIL)
          (#7=#:G708 NIL) (#8=#:G707 NIL) (|pIC| #9=(|List| D))
          (|pJM| (|SparseEchelonMatrix| JB D)) (|pDer| #1#)
          (|pJV| (|List| (|List| JB))) (|pEqs| #9#)
          (|FDiff| (|Record| (|:| |DPhi| D) (|:| |JVars| (|List| JB))))
          (#10=#:G678 NIL) (#11=#:G706 NIL)
          (|jmeq| (|SparseEchelonMatrix| JB D)) (#12=#:G703 NIL) (|eq| NIL)
          (#13=#:G704 NIL) (#14=#:G705 NIL) (|pro?| NIL) (|k| NIL)
          (#15=#:G701 NIL) (|rec| (|SysRec|)) (#16=#:G702 NIL) (|ord| #2#)
          (#17=#:G700 NIL) (#18=#:G699 NIL) (#19=#:G668 NIL) (#20=#:G698 NIL)
          (#21=#:G696 NIL) (#22=#:G697 NIL)
          (|tord| (|List| (|NonNegativeInteger|))) (|tsys| (|List| |SysRec|))
          (|cDe| ($)))
         (SEQ (LETT |cDe| (SPADCALL |De| (QREFELT $ 37)))
              (LETT |tsys| (QCAR |cDe|)) (LETT |tord| (QCDR |cDe|))
...
(SDEFUN |JDE;analyseSymbol;SemR;20|
        ...
        (SPROG
         ((|LBeta| (|List| (|NonNegativeInteger|))) (#1=#:G729 NIL) (|k| NIL)
          (|MSum| #2=(|NonNegativeInteger|))
          (|LastClass| (|NonNegativeInteger|)) (|BetaI| #2#) (#3=#:G728 NIL)
          (|CurClass| (|NonNegativeInteger|)) (#4=#:G727 NIL) (|jv| NIL)
          (|pivs|
...
(SDEFUN |JDE;prolongSymbol;2Sem;21|
        ...
        (SPROG
         ((|ninds| (|List| JB)) (#1=#:G739 NIL) (#2=#:G752 NIL) (#3=#:G764 NIL)
          (|jv| NIL) (#4=#:G763 NIL) (|i| NIL)
          (|r|
           (|Record| (|:| |Indices| (|List| JB)) (|:| |Entries| (|List| D))))
          (#5=#:G762 NIL) (|j| NIL) (|res| (|SparseEchelonMatrix| JB D))
          (|newInds| (|List| JB)) (#6=#:G737 NIL) (#7=#:G761 NIL)
          (#8=#:G760 NIL) (|oldInds| (|List| JB)))
...
(SDEFUN |JDE;extPower|
        ...
        (SPROG
         ((|res| (D)) (|prod| (D)) (#1=#:G784 NIL) (|si| NIL) (#2=#:G785 NIL)
          (|mi| NIL) (#3=#:G783 NIL) (|s| NIL) (|q| (|NonNegativeInteger|))
...
(SDEFUN |JDE;tableau;SemJdSem;25|
        ...
        (SPROG
         ((|le| (|List| D)) (|li| (|List| JB)) (#1=#:G794 NIL) (#2=#:G809 NIL)
          (|i| NIL) (#3=#:G810 NIL) (|s| NIL)
          (|mu| (|List| (|NonNegativeInteger|))) (|a| #4=(|PositiveInteger|))
          (#5=#:G807 NIL) (|jv| NIL) (#6=#:G808 NIL) (|ent| NIL)
          (|sum| (|Vector| D))
          (|r|
           (|Record| (|:| |Indices| (|List| JB)) (|:| |Entries| (|List| D))))
          (#7=#:G806 NIL) (|k| NIL) (|res| (|SparseEchelonMatrix| JB D))
          (#8=#:G788 NIL) (#9=#:G805 NIL) (|cinds| (|List| #4#))
          (#10=#:G804 NIL) (|d| NIL) (#11=#:G803 NIL) (|coeffs| (|List| D))
          (|diffs| (|List| JB)))
        ...
        (SPROG
         ((|rres|
           #1=(|Record| (|:| |Indices| (|List| JB))
                        (|:| |Entries| (|List| D))))
          (|s| (D)) (|mu| #2=(|List| (|NonNegativeInteger|))) (#3=#:G832 NIL)
          (|jv| NIL) (#4=#:G833 NIL) (|ent| NIL) (|r| #1#) (#5=#:G831 NIL)
          (|k| NIL) (|nu| #2#) (|a| (|PositiveInteger|)) (#6=#:G830 NIL)
          (|vv| NIL) (|res| (|SparseEchelonMatrix| JB D)) (#7=#:G814 NIL)
          (#8=#:G829 NIL) (|j| NIL) (|i| NIL) (#9=#:G828 NIL) (|chi| NIL)
          (|mco| (|Matrix| D)) (|inds| (|List| JB)) (#10=#:G812 NIL)
...
(DEFUN |JetDifferentialEquation| (&REST #1=#:G834)
  (SPROG NIL
         (PROG (#2=#:G835)
           (RETURN
            (COND
