         ...
         ((|r|
          ...
          (|termRight|
           #1=(|List|
               (|Union| (|:| |const| (|Record| (|:| |val| (|Symbol|))))
                        (|:| |var| (|Record| (|:| |str| (|String|)))))))
          (|termLeft| #1#) (#2=#:G456 NIL) (|innerb| NIL) (#3=#:G455 NIL)
          (|innera| NIL) (#4=#:G454 NIL))
         (SEQ
          (EXIT
           (SEQ
            (COND
             ((SPADCALL |a| (QREFELT $ 17))
              (PROGN (LETT #4# |b|) (GO #5=#:G453))))
            (COND
...
(SDEFUN |LATJOFM;equalElements|
        ((|a| |Union| (|:| |const| (|Record| (|:| |val| (|Symbol|))))
         ...
         (|b| |Union| (|:| |const| (|Record| (|:| |val| (|Symbol|))))
          (|:| |var| (|Record| (|:| |str| (|String|)))))
         ($ |Boolean|))
        (SPROG ((#1=#:G480 NIL) (#2=#:G476 NIL) (#3=#:G477 NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (COND
        ...
        (SPROG
         ((|r|
           (|List|
            (|Union| (|:| |const| (|Record| (|:| |val| (|Symbol|))))
                     (|:| |var| (|Record| (|:| |str| (|String|)))))))
          (|match| (|Boolean|)) (#1=#:G496 NIL) (|e2| NIL) (#2=#:G497 NIL)
          (|ne2| NIL) (#3=#:G494 NIL) (|e1| NIL) (#4=#:G495 NIL) (|ne1| NIL))
         (SEQ (LETT |r| NIL)
...
(SDEFUN |LATJOFM;equalTerms|
        ((|a| |List|
         ...
         ($ |Boolean|))
        (SPROG
         ((#1=#:G513 NIL) (|found| (|Boolean|)) (#2=#:G515 NIL) (|b1| NIL)
          (#3=#:G514 NIL) (|a1| NIL))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |LATJOFM;subTerm|
        ((|a| |List|
         ...
         ($ |Boolean|))
        (SPROG
         ((#1=#:G531 NIL) (|found| (|Boolean|)) (#2=#:G533 NIL) (|b1| NIL)
          (#3=#:G532 NIL) (|a1| NIL))
         (SEQ
          (EXIT
           (SEQ
         ...
         ((|r|
           (|List|
            (|List|
             (|Union| (|:| |const| (|Record| (|:| |val| (|Symbol|))))
                      (|:| |var| (|Record| (|:| |str| (|String|))))))))
          (|modified| #1=(|Boolean|)) (|isSubTerm| #1#) (#2=#:G547 NIL)
          (|inner| NIL) (|match| #1#) (#3=#:G545 NIL) (#4=#:G546 NIL)
          (|innern| NIL)
          (|newinnerList|
           (|List|
            (|Union| (|:| |const| (|Record| (|:| |val| (|Symbol|))))
                     (|:| |var| (|Record| (|:| |str| (|String|)))))))
          (#5=#:G543 NIL) (|outer| NIL) (#6=#:G544 NIL) (|outern| NIL))
...
(SDEFUN |LATJOFM;stringVarOrLit|
        ((|a| |Union| (|:| |const| (|Record| (|:| |val| (|Symbol|))))
          (|:| |var| (|Record| (|:| |str| (|String|)))))
         ($ |String|))
        (SPROG ((#1=#:G561 NIL) (#2=#:G483 NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (COND
                   ((QEQCAR |a| 1)
                    (PROGN (LETT #1# (QCAR (CDR |a|))) (GO #3=#:G560))))
                  (COND
                   ((QEQCAR |a| 0)
                    (SEQ
                     (COND
...
(SDEFUN |LATJOFM;toStringUnwrapped;$S;27| ((|n| $) ($ |String|))
        (SPROG
         ((|r| (|String|)) (#1=#:G574 NIL) (|inner| NIL) (#2=#:G575 NIL)
          (|innern| NIL) (|innerList| (|List| (|String|))) (#3=#:G572 NIL)
          (|outer| NIL) (#4=#:G573 NIL) (|outern| NIL)
...
(SDEFUN |LATJOFM;coerce;$Of;29| ((|n| $) ($ |OutputForm|))
        (SPROG
         ((|r| (|OutputForm|)) (#1=#:G591 NIL) (|inner| NIL) (#2=#:G592 NIL)
          (|innern| NIL) (|innerList| (|List| (|OutputForm|))) (#3=#:G589 NIL)
          (|outer| NIL) (#4=#:G590 NIL) (|outern| NIL)
...
(SDEFUN |LATJOFM;coerce;$Lmoj;30| ((|n| $) ($ |LatticeMeetOfJoins|))
        (SPROG
         ((|r| #1=(|LatticeMeetOfJoins|)) (|term| #1#)
          (|ele| (|LatticeMeetOfJoins|)) (#2=#:G603 NIL) (|inner| NIL)
          (#3=#:G604 NIL) (|innern| NIL) (#4=#:G601 NIL) (|outer| NIL)
          (#5=#:G602 NIL) (|outern| NIL))
...
(SDEFUN |LATJOFM;coerce;Lmoj$;31| ((|n1| |LatticeMeetOfJoins|) ($ $))
        (SPROG
         ((|r| ($)) (|term| ($)) (|ele| ($)) (#1=#:G615 NIL) (|inner| NIL)
          (#2=#:G616 NIL) (|innern| NIL) (#3=#:G613 NIL) (|outer| NIL)
          (#4=#:G614 NIL) (|outern| NIL)
          (|n|
           (|List|
            (|List|
             (|Union| (|:| |const| (|Record| (|:| |val| (|Symbol|))))
