...
(SDEFUN |ODECONST;basisSol|
        ((|p| |SparseUnivariatePolynomial| F) (|n| |Integer|) (|x| F)
         ($ |List| F))
        (SPROG
         ((|xn| (F)) (|l| (|List| F)) (#1=#:G405 NIL) (|f| NIL) (#2=#:G404 NIL)
          (#3=#:G403 NIL) (|i| NIL) (|ll| (|List| F)))
...
(SDEFUN |ODECONST;quadSol|
        ((|p| |SparseUnivariatePolynomial| F) (|x| F) ($ |List| F))
        (SPROG
         ((#1=#:G422 NIL) (|a| (F)) (#2=#:G421 NIL) (#3=#:G420 NIL) (|i| (F))
...
(DEFUN |ConstantLODE| (&REST #1=#:G423)
  (SPROG NIL
         (PROG (#2=#:G424)
           (RETURN
            (COND
