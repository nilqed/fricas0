...
(SDEFUN |INVLAPLA;freeOf?|
        ...
        (SPROG
         ((#1=#:G393 NIL) (#2=#:G392 #3=(|Boolean|)) (#4=#:G394 #3#)
          (#5=#:G396 NIL) (|c| NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
...
(SDEFUN |INVLAPLA;iltsqfr|
        ((|r| |Fraction| (|SparseUnivariatePolynomial| F)) (|t| F) ($ F))
        (SPROG
         ((#1=#:G415 NIL) (#2=#:G414 (F)) (#3=#:G416 (F)) (#4=#:G422 NIL)
          (|a| NIL) (#5=#:G423 NIL) (|b| NIL)
          (|nl| (|List| (|SparseUnivariatePolynomial| F))) (#6=#:G412 NIL)
          (|ql| (|List| (|SparseUnivariatePolynomial| F))) (#7=#:G421 NIL)
          (|qq| NIL) (#8=#:G420 NIL) (|q| (|SparseUnivariatePolynomial| F))
...
(SDEFUN |INVLAPLA;iltirred|
        ...
        (SPROG
         ((#1=#:G429 NIL) (#2=#:G428 (F)) (#3=#:G430 (F)) (#4=#:G435 NIL)
...
(DEFUN |InverseLaplaceTransform| (&REST #1=#:G436)
  (SPROG NIL
         (PROG (#2=#:G437)
           (RETURN
            (COND
