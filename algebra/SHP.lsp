...
(SDEFUN |SHP;polsth1|
        ...
        (SPROG
         ((|List2| (|List| UP)) (|Pr6| (UP)) (#1=#:G487 NIL) (#2=#:G492 NIL)
          (|j| NIL) (|List1| (|List| UP)) (|Listf| (|List| UP)) (#3=#:G478 NIL)
          (|Pr5| (UP)) (#4=#:G477 NIL) (#5=#:G475 NIL) (|Pr4| (UP))
          (#6=#:G428 NIL) (|Pr3| (UP)) (#7=#:G414 NIL)
          (|r| (|NonNegativeInteger|)) (|c2| (R)) (|Pr2| (UP)) (#8=#:G399 NIL)
          (|Pr1| (UP)) (|sc1| (R)))
         (SEQ
...
(SDEFUN |SHP;polsth2|
        ((|p1| UP) (|p| |NonNegativeInteger|) (|p2| UP)
         (|q| |NonNegativeInteger|) (|c1| R) ($ |List| UP))
        (SPROG
         ((|List2| (|List| UP)) (|Pr5| (UP)) (#1=#:G501 NIL) (|Pr4| (UP))
          (#2=#:G499 NIL) (#3=#:G507 NIL) (|j| NIL)
...
(SDEFUN |SHP;polsth3|
        ((|p1| UP) (|p| |NonNegativeInteger|) (|p2| UP)
         (|q| |NonNegativeInteger|) (|c1| R) ($ |List| UP))
        (SPROG
         ((|List2| (|List| UP)) (|Pr3| (UP)) (#1=#:G519 NIL) (|Pr2| (UP))
          (#2=#:G517 NIL) (#3=#:G525 NIL) (#4=#:G510 NIL) (|j| NIL)
...
(SDEFUN |SHP;SturmHabichtCoefficients;2UPL;6|
        ((|p1| UP) (|p2| UP) ($ |List| R))
        (SPROG
         ((#1=#:G528 NIL) (#2=#:G533 NIL) (|p| NIL) (#3=#:G534 NIL) (|j| NIL)
          (#4=#:G532 NIL) (|qp| (|NonNegativeInteger|)) (|List1| (|List| UP)))
...
(SDEFUN |SHP;epsil|
        ...
        (SPROG
         ((|ct4| (|Integer|)) (|ct3| (|NonNegativeInteger|)) (#1=#:G545 NIL)
          (|ct2| #2=(|Integer|)) (|ct1| #2#))
         (SEQ
...
(SDEFUN |SHP;wfunctaux| ((|Lsig| . #1=(|List| R)) ($ |Integer|))
        (SPROG
         ((|ind4| (|Integer|)) (|ind3| (|Integer|)) (|ind2| (|Integer|))
          (|List1| #1#) (#2=#:G563 NIL) (|j| NIL)
          (|cont2| (|NonNegativeInteger|)) (|List2| (|List| R)) (#3=#:G562 NIL)
...
(SDEFUN |SHP;SturmHabicht;2UPI;15| ((|p1| UP) (|p2| UP) ($ |Integer|))
        (SPROG
         ((#1=#:G571 NIL) (|p| NIL) (#2=#:G570 NIL) (|List1| (|List| UP)))
         (SEQ
          (COND
...
(SDEFUN |SHP;SturmHabichtMultiple;2UPI;17| ((|p1| UP) (|p2| UP) ($ |Integer|))
        (SPROG
         ((#1=#:G596 NIL) (|f| NIL) (#2=#:G595 NIL)
          ...
          (SH (|List| UP)) (|ans| (|Integer|)) (#3=#:G573 NIL) (#4=#:G593 NIL)
          (|p| NIL) (#5=#:G594 NIL) (|j| NIL) (#6=#:G592 NIL)
...
(DEFUN |SturmHabichtPackage| (&REST #1=#:G598)
  (SPROG NIL
         (PROG (#2=#:G599)
           (RETURN
            (COND
