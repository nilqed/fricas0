...
(SDEFUN |PFOTOOLS;mix;LI;1|
        ((|l| |List|
         ...
         ($ |Integer|))
        (SPROG
         ((#1=#:G387 NIL) (|p| NIL) (#2=#:G386 NIL) (#3=#:G385 NIL)
          (#4=#:G384 NIL))
         (SEQ
          (SPADCALL
           (SPADCALL
...
(SDEFUN |PFOTOOLS;badNum;UPUPI;2| ((|p| UPUP) ($ |Integer|))
        (SPROG ((#1=#:G392 NIL) (|c| NIL) (#2=#:G391 NIL))
               (SEQ
                (SPADCALL
                 (PROGN
                  (LETT #2# NIL)
...
(SDEFUN |PFOTOOLS;polyred;2UPUP;3| ((|r| UPUP) ($ UPUP))
        (SPROG
         ((|ld| (|List| (|Integer|))) (#1=#:G397 NIL) (|c| NIL)
          (#2=#:G396 NIL))
         (SEQ
          (LETT |ld|
                (PROGN
...
(SDEFUN |PFOTOOLS;getGoodPrime;IPi;5| ((|n| |Integer|) ($ |PositiveInteger|))
        (SPROG ((|p| (|PositiveInteger|)) (#1=#:G405 NIL))
               (SEQ (LETT |p| 3)
...
(DEFUN |PointsOfFiniteOrderTools| (&REST #1=#:G414)
  (SPROG NIL
         (PROG (#2=#:G415)
           (RETURN
            (COND
