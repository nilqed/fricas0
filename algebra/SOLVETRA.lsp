...
(SDEFUN |SOLVETRA;solve;ESL;5|
        ((|lside| |Expression| R) (|x| |Symbol|)
         ($ |List| (|Equation| (|Expression| R))))
        (SPROG ((#1=#:G487 NIL) (|sol| NIL) (#2=#:G486 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |sol| NIL)
...
(SDEFUN |SOLVETRA;solveInner|
        ((|lside| |Expression| R) (|x| |Symbol|)
         ($ |List| (|Equation| (|Expression| R))))
        (SPROG
         ((#1=#:G517 NIL) (|sols| (|List| (|Equation| (|Expression| R))))
          (#2=#:G524 NIL) (|frec| NIL)
          (|lfacts|
           (|List|
            (|Record|
          ...
          (|newlist| (|List| (|Equation| (|Expression| R)))) (#8=#:G523 NIL)
          (|j| NIL) (|secondsol| #9=(|List| (|Expression| R))) (#10=#:G503 NIL)
          (#11=#:G502 #9#) (#12=#:G504 #9#) (#13=#:G522 NIL) (|ff| NIL)
          (|lfatt|
           (|List|
          ...
          (|elR| (|Expression| R)) (#14=#:G521 NIL) (|i| NIL) (#15=#:G498 NIL)
          (#16=#:G497 #17=(|List| (|Equation| (|Expression| R))))
          (#18=#:G499 #17#) (#19=#:G520 NIL) (|ri| NIL)
          (|bigX_back| (|Expression| R)) (#20=#:G493 NIL)
          (|r1| (|List| (|Expression| R)))
          (|finv| (|Union| (|Expression| R) #21="failed")) (#22=#:G519 NIL)
          (|lr| #9#) (#23=#:G490 NIL) (#24=#:G489 #9#) (#25=#:G491 #9#)
          (#26=#:G518 NIL) (|fatt| NIL) (|eq1| (|Expression| R))
...
(SDEFUN |SOLVETRA;solveRetract|
        ...
        (SPROG
         ((|nlexpr| (|List| (|Fraction| (|Polynomial| R)))) (#1=#:G547 NIL)
...
(SDEFUN |SOLVETRA;subsTan|
        ...
        (SPROG
         ((#1=#:G567 NIL) (|resultnew| #2=(|Expression| R))
           ...
           (SEQ (LETT Z (SPADCALL (QREFELT $ 31)))
                ...
                (COND
                 ((EQL (LENGTH |listofkern|) 1)
                  (COND
                   ((NULL |test|)
                    (PROGN (LETT #1# |exprvar|) (GO #5=#:G566)))))
...
(SDEFUN |SOLVETRA;logsumtolog| ((|var| |Expression| R) ($ |Expression| R))
        (SPROG
         ((|var2| (|Expression| R)) (#1=#:G599 NIL) (|i| NIL)
          (|kernelofvar| (|List| (|Kernel| (|Expression| R))))
          (|newexpr| (|Expression| R)) (|exprlist| (|List| (|Expression| R)))
          (#2=#:G598 NIL) (|gcdcoeff| (|Expression| R))
          (|listforgcd| (|List| R)) (|exprcoeff| (R)) (#3=#:G597 NIL)
...
(SDEFUN |SOLVETRA;buildnexpr|
        ...
        (SPROG
         ((|ansmant| (|Expression| R)) (|anscoeff| (|Expression| R))
          (#1=#:G622 NIL) (|i| NIL) (|n2list| (|List| (|Expression| R)))
...
(SDEFUN |SOLVETRA;combineLog|
        ...
        (SPROG
         ((|ansexpr| #1=(|Expression| R)) (#2=#:G640 NIL) (|i| NIL) (|ans| #1#)
...
(SDEFUN |SOLVETRA;tableXkernels|
        ...
        (SPROG
         ((|listkOfvar| (|List| (|Expression| R))) (#1=#:G652 NIL) (|i| NIL)
...
(SDEFUN |SOLVETRA;dropfun| ((|x| |Expression| R) ($ |Expression| R))
        (SPROG
         ((#1=#:G678 NIL) (|k| (|Union| (|Kernel| (|Expression| R)) "failed")))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |SOLVETRA;makeREpol|
        ...
        (SPROG
         ((|lval| (|List| (|Expression| R))) (#1=#:G741 NIL) (|v| NIL)
          (#2=#:G740 NIL) (|lvar| (|List| (|Symbol|))))
...
(SDEFUN |SOLVETRA;solve1Pol|
        ...
        (SPROG
         ((#1=#:G747 NIL) (|vsol| NIL) (#2=#:G746 NIL)
...
(SDEFUN |SOLVETRA;solve1Sys|
        ...
        (SPROG
         ((|sols| (|List| (|List| (|Equation| (|Expression| R)))))
          (#1=#:G749 NIL)
          (#2=#:G748 #3=(|List| (|List| (|Equation| (|Expression| R)))))
          (#4=#:G750 #3#) (#5=#:G756 NIL) (|sol| NIL) (#6=#:G754 NIL) (|p| NIL)
          (#7=#:G755 NIL) (|v| NIL) (|rlvar| (|List| (|Symbol|)))
...
(SDEFUN |SOLVETRA;tryLinear|
        ((|lexpr| |List| (|Expression| R)) (|lvar| |List| (|Symbol|))
         ($ |Union| (|List| (|List| (|Equation| (|Expression| R)))) "failed"))
        (SPROG
         ((|eqs| (|List| (|Equation| (|Expression| R)))) (#1=#:G821 NIL)
          (|i| NIL) (#2=#:G820 NIL) (|sym| (|Expression| R)) (#3=#:G819 NIL)
          (|p| NIL) (|zeron| (|Vector| (|Expression| R)))
          (|rhs| (|Vector| (|Expression| R))) (#4=#:G792 NIL)
          (|sol|
           (|Record|
            (|:| |particular|
                 (|Union| (|Vector| (|Expression| R)) #5="failed"))
            (|:| |basis| (|List| (|Vector| (|Expression| R))))))
          (|vece| (|Vector| (|Expression| R))) (#6=#:G818 NIL) (|q| NIL)
          (#7=#:G817 NIL) (|mate| (|Matrix| (|Expression| R))) (#8=#:G816 NIL)
          (#9=#:G815 NIL) (#10=#:G814 NIL) (|row| NIL) (#11=#:G813 NIL)
          (|r|
           (|Record|
            (|:| |mat|
                 (|Matrix|
          ...
          (|ps|
           (|List|
            (|SparseMultivariatePolynomial| R (|Kernel| (|Expression| R)))))
          (#12=#:G812 NIL) (|expr| NIL) (#13=#:G811 NIL) (#14=#:G803 NIL)
          (#15=#:G810 NIL) (|ker| NIL)
          (|kers| (|List| (|Kernel| (|Expression| R))))
          (|llk| (|List| (|List| (|Kernel| (|Expression| R)))))
          (#16=#:G809 NIL) (#17=#:G808 NIL) (#18=#:G763 NIL)
          (#19=#:G762 #20=(|Boolean|)) (#21=#:G764 #20#) (#22=#:G807 NIL)
          (#23=#:G760 NIL) (#24=#:G759 #25=(|Boolean|)) (#26=#:G761 #25#)
          (#27=#:G806 NIL) (|lvk| (|List| (|Kernel| (|Expression| R))))
          (#28=#:G805 NIL) (|v| NIL) (#29=#:G804 NIL))
         (SEQ
          (EXIT
           (SEQ
            (LETT |lvk|
...
(SDEFUN |SOLVETRA;solve;LLL;37|
        ((|leqs| |List| (|Equation| (|Expression| R)))
         ...
         ($ |List| (|List| (|Equation| (|Expression| R)))))
        (SPROG
         ((|lexpr| (|List| (|Expression| R))) (#1=#:G838 NIL) (|eq| NIL)
          (#2=#:G837 NIL))
         (SEQ
          (LETT |lexpr|
                (PROGN
...
(SDEFUN |SOLVETRA;solve;LLL;38|
        ((|leqs| |List| (|Equation| (|Expression| R)))
         ...
         ($ |List| (|List| (|Equation| (|Expression| R)))))
        (SPROG
         ((#1=#:G865 NIL) (|neq| NIL) (#2=#:G864 NIL) (#3=#:G863 NIL)
          (|sol| NIL) (#4=#:G862 NIL) (|lval2| (|List| (|Expression| R)))
          (#5=#:G861 NIL) (|k| NIL) (#6=#:G860 NIL)
          (|lker2| (|List| (|Kernel| (|Expression| R)))) (#7=#:G859 NIL)
          (|v| NIL) (#8=#:G858 NIL)
          (|ans| (|List| (|List| (|Equation| (|Expression| R)))))
          (|nlexpr| (|List| (|Expression| R))) (#9=#:G857 NIL) (|expr| NIL)
          (#10=#:G856 NIL) (|lval| (|List| (|Expression| R))) (#11=#:G855 NIL)
          (#12=#:G854 NIL) (|lvar| (|List| (|Symbol|))) (#13=#:G853 NIL)
          (#14=#:G852 NIL) (|lexpr| (|List| (|Expression| R))) (#15=#:G851 NIL)
          (|eq| NIL) (#16=#:G850 NIL))
         (SEQ
          (LETT |lexpr|
                (PROGN
...
(SDEFUN |SOLVETRA;solve;LLL;40|
        ((|leqs| |List| (|Equation| (|Expression| R)))
         ...
         ($ |List| (|List| (|Equation| (|Expression| R)))))
        (SPROG
         ((|lker| (|List| (|Kernel| (|Expression| R)))) (#1=#:G875 NIL)
          (|e| NIL) (#2=#:G874 NIL))
         (SEQ
          (LETT |lker|
                (PROGN
...
(DEFUN |TransSolvePackage| (#1=#:G876)
  (SPROG NIL
         (PROG (#2=#:G877)
           (RETURN
            (COND
