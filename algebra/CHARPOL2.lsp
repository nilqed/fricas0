...
(SDEFUN |CHARPOL2;danilewski;MR;1|
        ...
        (SPROG
         ((#1=#:G414 NIL) (|j| NIL) (#2=#:G413 NIL) (|i| NIL) (|s| (F))
          (#3=#:G412 NIL) (#4=#:G411 NIL) (|val| (F)) (#5=#:G410 NIL)
          (|cc| (F)) (#6=#:G409 NIL) (|piv| (F))
          (|blocks| (|List| (|Integer|))) (|nn| (|Integer|)) (#7=#:G406 NIL)
          (|has_block| (|Boolean|)) (#8=#:G408 NIL) (|kk| NIL)
          (|k1| (|Integer|)) (|n1| (|Integer|)) (#9=#:G407 NIL) (|nc| NIL)
...
(SDEFUN |CHARPOL2;char_pol;MSup;2|
        ...
        (SPROG
         ((|res| (|SparseUnivariatePolynomial| F))
          (|res1| (|SparseUnivariatePolynomial| F)) (#1=#:G420 NIL)
          (#2=#:G418 NIL) (#3=#:G426 NIL) (|i| NIL) (|i1| (|Integer|))
...
(DEFUN |CharacteristicPolynomial2| (#1=#:G427)
  (SPROG NIL
         (PROG (#2=#:G428)
           (RETURN
            (COND
