...
(SDEFUN |FINAALG-;leftCharacteristicPolynomial;SSup;1|
        ...
        (SPROG
         ((#1=#:G411 NIL) (|j| NIL) (#2=#:G410 NIL) (|i| NIL)
...
(SDEFUN |FINAALG-;leftTrace;SR;3| ((|a| S) ($ R))
        (SPROG ((|t| (R)) (#1=#:G421 NIL) (|i| NIL) (|ma| (|Matrix| R)))
...
(SDEFUN |FINAALG-;antiAssociative?;B;7| (($ |Boolean|))
        (SPROG
         ((#1=#:G435 NIL) (#2=#:G436 NIL) (#3=#:G439 NIL) (|k| NIL)
          (#4=#:G438 NIL) (|j| NIL) (#5=#:G437 NIL) (|i| NIL)
...
(SDEFUN |FINAALG-;jordanAdmissible?;B;8| (($ |Boolean|))
        (SPROG
         ((#1=#:G453 NIL) (#2=#:G454 NIL) (#3=#:G458 NIL) (|l| NIL)
          (#4=#:G457 NIL) (|k| NIL) (#5=#:G456 NIL) (|j| NIL) (#6=#:G455 NIL)
...
(SDEFUN |FINAALG-;lieAdmissible?;B;9| (($ |Boolean|))
        (SPROG
         ((#1=#:G466 NIL) (#2=#:G467 NIL) (#3=#:G470 NIL) (|k| NIL)
          (#4=#:G469 NIL) (|j| NIL) (#5=#:G468 NIL) (|i| NIL)
...
(SDEFUN |FINAALG-;structuralConstants;VV;10|
        ...
        (SPROG
         ((#1=#:G484 NIL) (|k| NIL) (|covec| (|Vector| R)) (#2=#:G483 NIL)
          (|j| NIL) (#3=#:G482 NIL) (|i| NIL) (|sC| (|Vector| (|Matrix| R)))
          (#4=#:G479 NIL) (#5=#:G481 NIL) (#6=#:G480 NIL)
          (|m| (|NonNegativeInteger|)) (#7=#:G471 NIL))
         (SEQ
          (LETT |m|
...
(SDEFUN |FINAALG-;leftRecip;SU;11| ((|x| S) ($ |Union| S "failed"))
        (SPROG
         ((#1=#:G501 NIL) (#2=#:G503 NIL) (|power| NIL) (#3=#:G504 NIL)
          (|i| NIL) (#4=#:G502 NIL) (|invCR| (R)) (|invC| (|Union| R "failed"))
...
(SDEFUN |FINAALG-;rightRecip;SU;12| ((|x| S) ($ |Union| S "failed"))
        (SPROG
         ((#1=#:G521 NIL) (#2=#:G523 NIL) (|power| NIL) (#3=#:G524 NIL)
          (|i| NIL) (#4=#:G522 NIL) (|invCR| (R)) (|invC| (|Union| R "failed"))
          (|vectorOfCoef| (|Vector| R)) (|cond| (|Matrix| R))
          (|listOfPowers| (|List| S)) (|xx| (S)) (|k| (|PositiveInteger|))
...
(SDEFUN |FINAALG-;leftMinimalPolynomial;SSup;14|
        ...
        (SPROG
         ((|res| (|SparseUnivariatePolynomial| R)) (#1=#:G538 NIL) (|i| NIL)
...
(SDEFUN |FINAALG-;rightMinimalPolynomial;SSup;15|
        ((|x| S) ($ |SparseUnivariatePolynomial| R))
        (SPROG
         ((|res| (|SparseUnivariatePolynomial| R)) (#1=#:G545 NIL) (|i| NIL)
          (|vectorOfCoef| (|Vector| R)) (|cond| (|Matrix| R)) (|xx| (S))
          (|k| (|PositiveInteger|)) (|b| (|Vector| S)))
         (SEQ
          (COND
...
(SDEFUN |FINAALG-;associatorDependence;L;16| (($ |List| (|Vector| R)))
        (SPROG
         ((|z| (|Integer|)) (#1=#:G557 NIL) (|r| NIL) (|a213| #2=(|Vector| R))
          (|a321| #2#) (|a132| #2#) (|a312| #2#) (|a231| #2#) (|a123| #2#)
          (#3=#:G556 NIL) (|k| NIL) (#4=#:G555 NIL) (|j| NIL) (#5=#:G554 NIL)
...
(SDEFUN |FINAALG-;jacobiIdentity?;B;17| (($ |Boolean|))
        (SPROG
         ((#1=#:G565 NIL) (#2=#:G566 NIL) (#3=#:G569 NIL) (|k| NIL)
          (#4=#:G568 NIL) (|j| NIL) (#5=#:G567 NIL) (|i| NIL)
          (|b| (|Vector| S)) (|n| (|PositiveInteger|)))
         (SEQ
          (EXIT
           (SEQ (LETT |n| (SPADCALL (QREFELT $ 9)))
...
(SDEFUN |FINAALG-;jordanAlgebra?;B;19| (($ |Boolean|))
        (SPROG
         ((#1=#:G588 NIL) (#2=#:G589 NIL) (#3=#:G593 NIL) (|l| NIL)
          (#4=#:G592 NIL) (|k| NIL) (#5=#:G591 NIL) (|j| NIL) (#6=#:G590 NIL)
          (|i| NIL) (|n| (|PositiveInteger|)) (|b| (|Vector| S)))
         (SEQ
          (EXIT
           (SEQ (LETT |b| (SPADCALL (QREFELT $ 11)))
...
(SDEFUN |FINAALG-;antiCommutative?;B;21| (($ |Boolean|))
        (SPROG
         ((#1=#:G609 NIL) (#2=#:G610 NIL) (#3=#:G612 NIL) (|j| NIL)
          (#4=#:G611 NIL) (|i| NIL) (|n| (|PositiveInteger|))
          (|b| (|Vector| S)))
         (SEQ
          (EXIT
           (SEQ (LETT |b| (SPADCALL (QREFELT $ 11)))
...
(SDEFUN |FINAALG-;commutative?;B;22| (($ |Boolean|))
        (SPROG
         ((#1=#:G619 NIL) (#2=#:G620 NIL) (#3=#:G622 NIL) (|j| NIL)
          (#4=#:G621 NIL) (|i| NIL) (|n| (|PositiveInteger|))
          (|b| (|Vector| S)))
         (SEQ
          (EXIT
           (SEQ (LETT |b| (SPADCALL (QREFELT $ 11)))
...
(SDEFUN |FINAALG-;associative?;B;23| (($ |Boolean|))
        (SPROG
         ((#1=#:G630 NIL) (#2=#:G631 NIL) (#3=#:G634 NIL) (|k| NIL)
          (#4=#:G633 NIL) (|j| NIL) (#5=#:G632 NIL) (|i| NIL)
          (|n| (|PositiveInteger|)) (|b| (|Vector| S)))
         (SEQ
          (EXIT
           (SEQ (LETT |b| (SPADCALL (QREFELT $ 11)))
...
(SDEFUN |FINAALG-;leftAlternative?;B;24| (($ |Boolean|))
        (SPROG
         ((#1=#:G642 NIL) (#2=#:G643 NIL) (#3=#:G646 NIL) (|k| NIL)
          (#4=#:G645 NIL) (|j| NIL) (#5=#:G644 NIL) (|i| NIL)
          (|n| (|PositiveInteger|)) (|b| (|Vector| S)))
         (SEQ
          (EXIT
           (SEQ (LETT |b| (SPADCALL (QREFELT $ 11)))
...
(SDEFUN |FINAALG-;rightAlternative?;B;25| (($ |Boolean|))
        (SPROG
         ((#1=#:G654 NIL) (#2=#:G655 NIL) (#3=#:G658 NIL) (|k| NIL)
          (#4=#:G657 NIL) (|j| NIL) (#5=#:G656 NIL) (|i| NIL)
          (|n| (|PositiveInteger|)) (|b| (|Vector| S)))
         (SEQ
          (EXIT
           (SEQ (LETT |b| (SPADCALL (QREFELT $ 11)))
...
(SDEFUN |FINAALG-;flexible?;B;26| (($ |Boolean|))
        (SPROG
         ((#1=#:G666 NIL) (#2=#:G667 NIL) (#3=#:G670 NIL) (|k| NIL)
          (#4=#:G669 NIL) (|j| NIL) (#5=#:G668 NIL) (|i| NIL)
          (|n| (|PositiveInteger|)) (|b| (|Vector| S)))
         (SEQ
          (EXIT
           (SEQ (LETT |b| (SPADCALL (QREFELT $ 11)))
...
(SDEFUN |FINAALG-;alternative?;B;27| (($ |Boolean|))
        (SPROG
         ((#1=#:G680 NIL) (#2=#:G681 NIL) (#3=#:G684 NIL) (|k| NIL)
          (#4=#:G683 NIL) (|j| NIL) (#5=#:G682 NIL) (|i| NIL)
          (|n| (|PositiveInteger|)) (|b| (|Vector| S)))
         (SEQ
          (EXIT
           (SEQ (LETT |b| (SPADCALL (QREFELT $ 11)))
...
(SDEFUN |FINAALG-;coordinates;2VM;30|
        ...
        (SPROG ((#1=#:G690 NIL) (|i| NIL) (|j| NIL) (|m| (|Matrix| R)))
               (SEQ
                (LETT |m|
...
(SDEFUN |FINAALG-;represents;VVS;31| ((|v| |Vector| R) (|b| |Vector| S) ($ S))
        (SPROG
         ((#1=#:G696 NIL) (#2=#:G698 NIL) (|i| NIL) (#3=#:G697 NIL)
          (|m| (|Integer|)))
...
(SDEFUN |FINAALG-;leftTraceMatrix;VM;32| ((|v| |Vector| S) ($ |Matrix| R))
        (SPROG
         ((#1=#:G705 NIL) (|j| NIL) (#2=#:G704 NIL) (#3=#:G703 NIL) (|i| NIL)
          (#4=#:G702 NIL))
         (SEQ
          (SPADCALL
           (PROGN
...
(SDEFUN |FINAALG-;rightTraceMatrix;VM;33| ((|v| |Vector| S) ($ |Matrix| R))
        (SPROG
         ((#1=#:G712 NIL) (|j| NIL) (#2=#:G711 NIL) (#3=#:G710 NIL) (|i| NIL)
          (#4=#:G709 NIL))
         (SEQ
          (SPADCALL
           (PROGN
...
(SDEFUN |FINAALG-;leftRegularRepresentation;SVM;34|
        ...
        (SPROG ((#1=#:G718 NIL) (|i| NIL) (#2=#:G717 NIL) (|m| (|Integer|)))
...
(SDEFUN |FINAALG-;rightRegularRepresentation;SVM;35|
        ((|x| S) (|b| |Vector| S) ($ |Matrix| R))
        (SPROG ((#1=#:G724 NIL) (|i| NIL) (#2=#:G723 NIL) (|m| (|Integer|)))
               (SEQ (LETT |m| (- (SPADCALL |b| (QREFELT $ 104)) 1))
                    (EXIT
                     (SPADCALL
                      (SPADCALL
