...
(SDEFUN |XDPOLYF;hankelIndices;XdpL;1|
        ...
        (SPROG
         ((|lst_col| (|List| #1=(|FreeMonoid| VAR))) (|u| #1#) (#2=#:G398 NIL)
          (|k| NIL) (#3=#:G397 NIL) (|f| NIL) (|lst_row| (|List| #1#))
          (#4=#:G396 NIL) (#5=#:G395 NIL) (#6=#:G394 NIL) (|m| NIL))
...
(SDEFUN |XDPOLYF;hankelMatrix;XdpM;2|
        ...
        (SPROG
         ((|j| #1=(|Integer|)) (|i| #1#) (|v| (|FreeMonoid| VAR))
          (#2=#:G401 NIL) (|u| (|FreeMonoid| VAR)) (#3=#:G412 NIL) (|k| NIL)
          (#4=#:G411 NIL) (|f| NIL) (|c| (F)) (|m| (|FreeMonoid| VAR))
          (#5=#:G410 NIL) (|l| NIL) (|lst_coe| (|List| F))
...
(SDEFUN |XDPOLYF;hankelMatrix;XdpVARM;3|
        ...
        (SPROG
         ((|u| (|FreeMonoid| VAR)) (|j| #1=(|Integer|)) (|i| #1#)
          (|v| (|FreeMonoid| VAR)) (#2=#:G415 NIL) (#3=#:G428 NIL) (|k| NIL)
          (#4=#:G427 NIL) (|f| NIL) (|c| (F)) (|m| (|FreeMonoid| VAR))
          (#5=#:G426 NIL) (|l| NIL) (|lst_coe| (|List| F))
          (|lst_sup| (|List| (|FreeMonoid| VAR))) (|mtx_wrk| (|Matrix| F))
          (|n| (|NonNegativeInteger|)) (|lst_idx| (|List| (|FreeMonoid| VAR))))
         (SEQ (LETT |lst_idx| (SPADCALL |p| (QREFELT $ 21)))
              (LETT |n| (LENGTH |lst_idx|))
...
(SDEFUN |XDPOLYF;hankelSystem;XdpR;4|
        ...
        (SPROG
         ((|j| #1=(|Integer|)) (|i| #1#) (|v| (|FreeMonoid| VAR))
          (#2=#:G441 NIL) (|u| #3=(|FreeMonoid| VAR)) (#4=#:G458 NIL) (|k| NIL)
          (#5=#:G457 NIL) (|f| NIL) (|c| (F)) (|m| (|FreeMonoid| VAR))
          (#6=#:G456 NIL) (|l| NIL) (|lst_coe| (|List| F))
          (|lst_sup| (|List| (|FreeMonoid| VAR))) (|mtx_wrk| (|Matrix| F))
          (|lst_col| (|List| #3#)) (|lst_row| (|List| #3#)) (#7=#:G455 NIL)
          (#8=#:G454 NIL) (#9=#:G453 NIL) (#10=#:G452 NIL) (#11=#:G451 NIL))
         (SEQ (LETT |lst_row| (LIST (|spadConstant| $ 9)))
              (LETT |lst_col| (LIST (|spadConstant| $ 9)))
...
(SDEFUN |XDPOLYF;display;ROf;5|
        ((|sys| |Record| (|:| |rows| (|List| (|FreeMonoid| VAR)))
         ...
         ($ |OutputForm|))
        (SPROG
         ((|lst_wrk| (|List| (|OutputForm|))) (#1=#:G468 NIL) (|j| NIL)
          (#2=#:G467 NIL) (|i| NIL) (#3=#:G466 NIL)
...
(SDEFUN |XDPOLYF;findNonZeroEntry;M2NniL;6|
        ...
        (SPROG
         ((#1=#:G477 NIL) (#2=#:G476 NIL) (|col_nz| #3=(|NonNegativeInteger|))
          (|row_nz| #3#) (|flg_nz| (|Boolean|)) (#4=#:G479 NIL) (|k| NIL)
          (#5=#:G478 NIL) (|l| NIL))
                ...
                (SEQ (LETT |l| |j|) (LETT #5# (ANCOLS A)) G190
                     ...
                     (SEQ
                      ...
                      (EXIT
                       (COND
                        (|flg_nz|
                         (PROGN (LETT #1# |$NoValue|) (GO #7=#:G473))))))
...
(SDEFUN |XDPOLYF;minimalMatrix;MNniM;8|
        ...
        (SPROG
         ((|n| (|NonNegativeInteger|)) (|m| (|NonNegativeInteger|))
          (#1=#:G491 NIL) (#2=#:G499 NIL) (|i| NIL) (#3=#:G498 NIL) (|j| NIL)
          (#4=#:G497 NIL) (#5=#:G485 NIL) (#6=#:G496 NIL) (B (|Matrix| F)))
...
(SDEFUN |XDPOLYF;transformationMatrices;ML;9|
        ...
        (SPROG
         ((#1=#:G519 NIL) (|k| NIL) (#2=#:G518 NIL) (#3=#:G517 NIL)
          (|beta| (F)) (|idx| (|List| (|NonNegativeInteger|))) (#4=#:G516 NIL)
          (|j| NIL) (B (|Matrix| F)) (#5=#:G515 NIL) (#6=#:G514 NIL) (|i| NIL)
...
(SDEFUN |XDPOLYF;minimalRepresentation;XdpR;10|
        ...
        (SPROG
         ((|mu_lst| (|List| (|Matrix| F))) (|mu_wrk| #1=(|Matrix| F))
          (H (|Matrix| F)) (#2=#:G529 NIL) (|sym| NIL) (|var_lst| (|List| VAR))
          (|b_wrk| #1#) (|a_wrk| #1#) (#3=#:G528 NIL) (|k| NIL)
...
(DEFUN |XDistributedPolynomialFunctions| (&REST #1=#:G530)
  (SPROG NIL
         (PROG (#2=#:G531)
           (RETURN
            (COND
