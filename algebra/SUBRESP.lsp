...
(SDEFUN |SUBRESP;primitivePart;UPRUP;1| ((|p| UP) (|q| R) ($ UP))
        (SPROG
         ((|rec| (|Record| (|:| |coef1| R) (|:| |coef2| R))) (#1=#:G390 NIL))
         (SEQ
          (LETT |rec|
                (PROG2
                    (LETT #1#
...
(SDEFUN |SUBRESP;subresultantVector;2UPPa;2|
        ...
        (SPROG
         ((|n| #1=(|NonNegativeInteger|)) (#2=#:G408 NIL) (|nextn| #1#)
          (|l| (|List| UP)) (F (UP)) (#3=#:G401 NIL) (#4=#:G396 NIL)
...
(DEFUN |SubResultantPackage| (&REST #1=#:G420)
  (SPROG NIL
         (PROG (#2=#:G421)
           (RETURN
            (COND
