...
(SDEFUN |FINRALG-;coordinates;2VM;2|
        ...
        (SPROG ((#1=#:G389 NIL) (|i| NIL) (|j| NIL) (|m| (|Matrix| R)))
               (SEQ
                (LETT |m|
...
(SDEFUN |FINRALG-;represents;VVS;3| ((|v| |Vector| R) (|b| |Vector| S) ($ S))
        (SPROG
         ((#1=#:G391 NIL) (#2=#:G390 (S)) (#3=#:G392 (S)) (#4=#:G395 NIL)
          (|i| NIL) (|m| (|Integer|)))
...
(SDEFUN |FINRALG-;traceMatrix;VM;4| ((|v| |Vector| S) ($ |Matrix| R))
        (SPROG
         ((#1=#:G402 NIL) (|j| NIL) (#2=#:G401 NIL) (#3=#:G400 NIL) (|i| NIL)
          (#4=#:G399 NIL))
         (SEQ
          (SPADCALL
           (PROGN
...
(SDEFUN |FINRALG-;regularRepresentation;SVM;5|
        ...
        (SPROG ((#1=#:G408 NIL) (|i| NIL) (#2=#:G407 NIL) (|m| (|Integer|)))
