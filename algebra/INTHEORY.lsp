...
(SDEFUN |INTHEORY;harmonic;IF;1| ((|n| |Integer|) ($ |Fraction| (|Integer|)))
        (SPROG
         ((|h| #1=(|Fraction| (|Integer|))) (#2=#:G407 NIL) (|k| NIL)
          (|s| #3=(|Integer|))
          (|#G3| (|Record| (|:| |Hn| #3#) (|:| |Hv| #1#))))
         (SEQ
          (COND
...
(SDEFUN |INTHEORY;carmichaelLambda;2I;3| ((|n| |Integer|) ($ |Integer|))
        (SPROG ((#1=#:G420 NIL) (|pk| NIL) (#2=#:G419 NIL))
               (SEQ
                (COND
                 ((<= |n| 0)
                  (|error|
...
(SDEFUN |INTHEORY;euler;2I;4| ((|n| |Integer|) ($ |Integer|))
        (SPROG
         ((|e| #1=(|Integer|)) (|t| #1#) (#2=#:G434 NIL) (|j| NIL)
          (#3=#:G433 NIL) (|i| NIL) (#4=#:G432 NIL) (#5=#:G422 NIL)
          (|l| (|Integer|)))
         (SEQ
...
(SDEFUN |INTHEORY;bernoulli;IF;5| ((|n| |Integer|) ($ |Fraction| (|Integer|)))
        (SPROG
         ((|b| (|Fraction| (|Integer|))) (|t| (|Integer|)) (#1=#:G448 NIL)
          (|j| NIL) (#2=#:G447 NIL) (|i| NIL) (#3=#:G446 NIL) (#4=#:G436 NIL)
          (|l| (|Integer|)))
         (SEQ
          (COND
...
(SDEFUN |INTHEORY;jacobi;3I;8| ((|a| |Integer|) (|b| |Integer|) ($ |Integer|))
        (SPROG
         ((|j| (|Integer|)) (|k| NIL) (#1=#:G475 NIL) (|#G40| (|Integer|))
          (|#G39| (|Integer|)))
...
(SDEFUN |INTHEORY;eulerPhi;2I;10| ((|n| |Integer|) ($ |Integer|))
        (SPROG ((|r| (|Fraction| (|Integer|))) (#1=#:G482 NIL) (|entry| NIL))
               (SEQ
                (COND ((EQL |n| 0) 0)
                      ('T
...
(SDEFUN |INTHEORY;divisors;IL;11| ((|n| |Integer|) ($ |List| (|Integer|)))
        (SPROG
         ((|oldList| #1=(|List| (|Integer|))) (|newList| #1#) (#2=#:G493 NIL)
          (|m| NIL) (|pow| (|Integer|)) (#3=#:G492 NIL) (|k| NIL)
          (#4=#:G491 NIL) (|f| NIL))
...
(SDEFUN |INTHEORY;numberOfDivisors;2I;12|
        ((|n| |Integer|) ($ . #1=(|Integer|)))
        (SPROG
         ((#2=#:G496 NIL) (#3=#:G495 #1#) (#4=#:G497 #1#) (#5=#:G499 NIL)
          (|entry| NIL))
         (SEQ
          (COND ((EQL |n| 0) 0)
                (#6='T
...
(SDEFUN |INTHEORY;sumOfDivisors;2I;13| ((|n| |Integer|) ($ |Integer|))
        (SPROG
         ((|r| #1=(|Fraction| (|Integer|))) (#2=#:G502 NIL) (#3=#:G501 #1#)
          (#4=#:G503 #1#) (#5=#:G506 NIL) (|entry| NIL))
         (SEQ
          (COND ((EQL |n| 0) 0)
                (#6='T
                 (SEQ
...
(SDEFUN |INTHEORY;sumOfKthPowerDivisors;INniI;14|
        ...
        (SPROG
         ((|r| #1=(|Fraction| (|Integer|))) (#2=#:G509 NIL) (#3=#:G508 #1#)
          (#4=#:G510 #1#) (#5=#:G513 NIL) (|entry| NIL))
         (SEQ
          (COND ((EQL |n| 0) 0)
                (#6='T
                 (SEQ
...
(SDEFUN |INTHEORY;moebiusMu;2I;15| ((|n| |Integer|) ($ |Integer|))
        (SPROG
         ((#1=#:G519 NIL) (#2=#:G520 NIL) (#3=#:G521 NIL) (|k| NIL)
          (|t| (|Factored| (|Integer|))))
         (SEQ
          (EXIT
           (COND ((EQL |n| 1) 1)
