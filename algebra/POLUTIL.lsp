...
(SDEFUN |POLUTIL;sylvesterSequence;2ThePolsL;2|
        ...
        (SPROG
         ((|res| (|List| |ThePols|)) (#1=#:G399 NIL) (|term| NIL)
          (#2=#:G398 NIL) (|#G8| (|ThePols|)) (|#G7| (|ThePols|)))
...
(SDEFUN |POLUTIL;boundOfCauchy;ThePolsTheField;3|
        ((|p| |ThePols|) ($ |TheField|))
        (SPROG
         ((#1=#:G402 NIL) (#2=#:G401 (|TheField|)) (#3=#:G403 (|TheField|))
          (#4=#:G408 NIL) (|t| NIL) (|l| (|List| |TheField|)) (#5=#:G407 NIL)
          (|term| NIL) (#6=#:G406 NIL) (|c| (|TheField|)))
         (SEQ
...
(SDEFUN |POLUTIL;sturmVariationsOf;LNni;4|
        ...
        (SPROG
         ((|ll| (|List| |TheField|)) (|ln| (|TheField|)) (#1=#:G415 NIL)
...
(DEFUN |RealPolynomialUtilitiesPackage| (&REST #1=#:G424)
  (SPROG NIL
         (PROG (#2=#:G425)
           (RETURN
            (COND
