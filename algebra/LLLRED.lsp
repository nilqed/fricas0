...
(SDEFUN |LLLRED;gram_step|
        ...
        (SPROG
         ((#1=#:G390 NIL) (|i| NIL) (#2=#:G389 NIL) (|v2| (|Vector| (|Float|)))
          (#3=#:G388 NIL) (|j| NIL) (#4=#:G387 NIL))
...
(SDEFUN |LLLRED;extendedLLL!;MNniM;2|
        ((L |Matrix| (|Integer|)) (N |NonNegativeInteger|)
         ($ |Matrix| (|Integer|)))
        (SPROG
         ((|k| (|NonNegativeInteger|)) (|tmp| (|Float|)) (#1=#:G414 NIL)
          (|i| NIL) (#2=#:G413 NIL) (|bs2| #3=(|Vector| (|Float|))) (|bs1| #3#)
          (|v2i| #4=(|Float|)) (|v1i| #5=(|Float|)) (#6=#:G412 NIL)
          (|m| #7=(|Float|)) (|nv2| #7#) (|nv1| #5#) (|k1| (|Integer|))
          (|del1| #4#) (#8=#:G411 NIL) (#9=#:G410 NIL) (|q| (|Integer|))
          (|j| NIL) (|kmax| (|Integer|)) (|iters| (|Integer|)) (#10=#:G409 NIL)
...
(SDEFUN |LLLRED;extendedLLL;MR;3|
        ((L |Matrix| (|Integer|))
         ($ |Record| (|:| |lll| (|Matrix| (|Integer|)))
          (|:| |trf| (|Matrix| (|Integer|)))))
        (SPROG
         ((#1=#:G430 NIL) (|j| NIL) (#2=#:G429 NIL) (#3=#:G428 NIL) (|i| NIL)
          (|t| #4=(|Matrix| (|Integer|))) (|l| #4#)
          (|m| (|Matrix| (|Integer|))) (#5=#:G427 NIL) (#6=#:G426 NIL) (LE #4#)
...
(SDEFUN |LLLRED;find_relation;LNniL;5|
        ...
        (SPROG
         ((#1=#:G440 NIL) (|i| NIL) (#2=#:G439 NIL)
          (|res| (|Matrix| (|Integer|))) (#3=#:G437 NIL) (#4=#:G438 NIL)
