...
(SDEFUN |FGLMICPK;zeroDim?|
        ...
        (SPROG
         ((|lv| (|List| (|OrderedVariableList| |ls|)))
          (|x| (|OrderedVariableList| |ls|)) (#1=#:G385 NIL)
          (|m| (|HomogeneousDistributedMultivariatePolynomial| |ls| R))
          (#2=#:G397 NIL) (|q2| NIL) (#3=#:G396 NIL) (|s| NIL) (#4=#:G395 NIL))
...
(SDEFUN |FGLMICPK;fglmIfCan;LU;3|
        ...
        (SPROG
         ((#1=#:G417 NIL) (|q3| NIL) (#2=#:G416 NIL)
          (|lq3| (|List| (|DistributedMultivariatePolynomial| |ls| R)))
          (|lq2|
           (|List| (|HomogeneousDistributedMultivariatePolynomial| |ls| R)))
          (#3=#:G415 NIL) (|q1| NIL) (#4=#:G414 NIL))
         (SEQ
          (LETT |lq2|
                (PROGN
                 (LETT #4# NIL)
...
(SDEFUN |FGLMICPK;groebner;2L;4|
        ...
        (SPROG
         ((#1=#:G433 NIL) (|q3| NIL) (#2=#:G432 NIL)
          (|lq3| (|List| (|DistributedMultivariatePolynomial| |ls| R)))
          (#3=#:G431 NIL) (#4=#:G430 NIL) (#5=#:G429 NIL) (|q1| NIL)
          (#6=#:G428 NIL)
          (|lq2|
           (|List| (|HomogeneousDistributedMultivariatePolynomial| |ls| R)))
          (#7=#:G427 NIL) (#8=#:G426 NIL))
         (SEQ
          (LETT |lq2|
                (PROGN
                 (LETT #8# NIL)
...
(DEFUN |FGLMIfCanPackage| (&REST #1=#:G434)
  (SPROG NIL
         (PROG (#2=#:G435)
           (RETURN
            (COND
