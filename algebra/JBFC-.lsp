...
(SDEFUN |JBFC-;dSubst;SJB2S;21| ((|f| S) (|jv| JB) (|exp| S) ($ S))
        (SPROG
         ((|nf| (S)) (|dexp| (S)) (|d| (|List| (|NonNegativeInteger|)))
          (#1=#:G479 NIL) (|jvar| NIL) (#2=#:G480 NIL) (|JVar| (|List| JB))
          (|of| (S)))
...
(SDEFUN |JBFC-;jacobiMatrix;LSem;24|
        ...
        (SPROG ((#1=#:G488 NIL) (|fun| NIL) (#2=#:G487 NIL))
               (SEQ
                (SPADCALL |funs|
                          (PROGN
                           (LETT #2# NIL)
...
(SDEFUN |JBFC-;jacobiMatrix;LLSem;25|
        ...
        (SPROG
         ((|inds| (|List| JB)) (|ents| (|List| S)) (|df| (S)) (#1=#:G504 NIL)
          (|jv| NIL) (#2=#:G502 NIL) (|f| NIL) (#3=#:G503 NIL) (|vars| NIL)
...
(SDEFUN |JBFC-;symbol;LSem;26|
        ...
        (SPROG
         ((|inds| #1=(|List| JB)) (|ents| (|List| S)) (|df| (S))
          (#2=#:G547 NIL) (|jv| NIL) (#3=#:G545 NIL) (|f| NIL) (#4=#:G546 NIL)
          (|ojl| #1#) (|i| NIL) (|symb| (|SparseEchelonMatrix| JB S))
          (|oJV| (|List| (|List| JB))) (|allJV| #1#) (|jl| (|List| JB))
          (#5=#:G544 NIL) (|ord| (|NonNegativeInteger|))
          (|ol| (|List| (|NonNegativeInteger|))) (#6=#:G543 NIL)
          (#7=#:G542 NIL) (JVL (|List| (|List| JB))) (#8=#:G541 NIL)
          (|fun| NIL) (#9=#:G540 NIL))
         (SEQ
          (LETT JVL
                (PROGN
...
(SDEFUN |JBFC-;formalDiff;SLS;30|
        ...
        (SPROG
         ((JV (|List| JB)) (|df| (S))
          ...
          (#1=#:G558 NIL) (|jm| (|SparseEchelonMatrix| JB S)) (#2=#:G567 NIL)
          (|k| NIL) (#3=#:G565 NIL) (|i| NIL) (#4=#:G566 NIL) (|j| NIL))
...
(SDEFUN |JBFC-;formalDiff2;LPiSemR;31|
        ...
        (SPROG
         ((LJV (|List| (|List| JB))) (JV (|List| JB)) (|LRes| (|List| S))
          (|res| (S)) (|djv| (|Union| JB "0")) (#1=#:G598 NIL) (|df| NIL)
          (#2=#:G599 NIL) (|jv| NIL)
          (|r|
           (|Record| (|:| |Indices| (|List| JB)) (|:| |Entries| (|List| S))))
          (#3=#:G597 NIL) (|l| NIL) (#4=#:G596 NIL) (|eq| NIL) (#5=#:G595 NIL)
          (#6=#:G594 NIL) (#7=#:G593 NIL) (|inds| (|List| JB)))
         (SEQ (LETT |inds| (SPADCALL JM (QREFELT $ 94)))
              (EXIT
               (COND
                ((NULL |inds|)
...
(SDEFUN |JBFC-;sortLD;2L;34| ((|sys| |List| S) ($ |List| S))
        (SPROG
         ((#1=#:G619 NIL) (|l| NIL) (#2=#:G618 NIL)
          (|sl|
           (|List|
            (|Record| (|:| LD JB) (|:| |Fake?| (|Boolean|))
                      (|:| |Dep| (|List| (|NonNegativeInteger|)))
                      (|:| |Fun| S))))
          (#3=#:G617 NIL) (|f| NIL) (#4=#:G616 NIL))
         (SEQ
          (LETT |sl|
                (PROGN
                 (LETT #4# NIL)
         ...
         ((|newL|
           (|List|
            (|Record| (|:| LD JB) (|:| |Fake?| (|Boolean|))
                      (|:| |Dep| (|List| (|NonNegativeInteger|)))
                      (|:| |Fun| S))))
          (|newld| (JB)) (#1=#:G665 NIL) (|eq| NIL) (#2=#:G666 NIL)
          (JV #3=(|List| JB)) (|sjv| (JB)) (#4=#:G663 NIL) (#5=#:G664 NIL)
          (|lJV| (|List| #3#)) (|minlen| #6=(|NonNegativeInteger|)) (|sj| #3#)
          (|seq|
           (|Record| (|:| LD JB) (|:| |Fake?| (|Boolean|))
                     (|:| |Dep| (|List| (|NonNegativeInteger|)))
                     (|:| |Fun| S)))
          (|len| #6#) (#7=#:G662 NIL) (|neweq| (S)) (#8=#:G627 NIL)
          (#9=#:G661 NIL) (|solvable?| (|Boolean|))
          (|s| (|Union| S #10="failed")) (#11=#:G659 NIL) (#12=#:G660 NIL)
          (|eqLD|
           (|List|
...
(SDEFUN |JBFC-;simplify;LSemR;36|
        ...
        (SPROG
         ((|r|
           (|Record| (|:| |Indices| (|List| JB)) (|:| |Entries| (|List| S))))
          (|tmp| (|SparseEchelonMatrix| JB S)) (#1=#:G702 NIL) (|eq| NIL)
          (#2=#:G703 NIL) (|dep| NIL) (|i| NIL)
          (|resJM| (|SparseEchelonMatrix| JB S)) (|inds| (|List| JB))
          (|resDep| (|List| #3=(|List| (|NonNegativeInteger|))))
          (#4=#:G701 NIL) (|l| NIL) (#5=#:G700 NIL) (|resSys| (|List| S))
          (#6=#:G699 NIL) (#7=#:G698 NIL)
          (|sl|
           (|List|
            (|Record| (|:| LD JB) (|:| |Fake?| (|Boolean|)) (|:| |Dep| #3#)
                      (|:| |Fun| S))))
          (#8=#:G697 NIL) (|f| NIL) (#9=#:G696 NIL) (|newSys| (|List| S))
          (|jmi| (|SparseEchelonMatrix| JB S)) (|neq| (S)) (#10=#:G695 NIL))
         (SEQ (LETT |newSys| NIL)
...
(SDEFUN |JBFC-;simpOne;2S;37| ((|f| S) ($ S)) (SPADCALL |f| (QREFELT $ 137))) 

(SDEFUN |JBFC-;simpMod;3L;38|
        ((|sys1| |List| S) (|sys2| |List| S) ($ |List| S))
        (SPROG
         ((|res| #1=(|List| S)) (|neq| (S)) (LS1 (|List| S)) (LD1 (|List| JB))
          (|ld| (JB)) (#2=#:G731 NIL) (#3=#:G730 NIL) (|eq1| NIL)
          (|newSys| (|List| S)) (LS #1#) (LD (|List| JB))
          (|i| (|NonNegativeInteger|)) (#4=#:G729 NIL) (|jv| NIL)
          (|ls| (|Union| S "failed")) (#5=#:G728 NIL) (|eq2| NIL))
         (SEQ
        ...
        ((|sys1| |List| S) (|jm| |SparseEchelonMatrix| JB S) (|sys2| |List| S)
         ($ |Record| (|:| |Sys| (|List| S))
          ...
          (|:| |Depend|
               (|Union| "failed" (|List| (|List| (|NonNegativeInteger|)))))))
        (SPROG
         ((#1=#:G774 NIL) (|i| (|NonNegativeInteger|)) (#2=#:G773 NIL)
          (|resSys| #3=(|List| S)) (|njm| (|SparseEchelonMatrix| JB S))
          (#4=#:G771 NIL) (|neq| (S)) (#5=#:G772 NIL) (|oeq| NIL)
          (|resJM| (|SparseEchelonMatrix| JB S)) (|res| #3#) (LS1 (|List| S))
          (LD1 (|List| JB)) (|ld| (JB)) (#6=#:G770 NIL) (#7=#:G769 NIL)
          (|eq1| NIL) (|newSys| (|List| S)) (LS #3#) (LD (|List| JB))
          (#8=#:G768 NIL) (|jv| NIL) (|ls| (|Union| S "failed"))
          (#9=#:G767 NIL) (|eq2| NIL) (|osys| (|List| S)) (#10=#:G766 NIL)
          (#11=#:G765 NIL))
         (SEQ
          (COND
...
(SDEFUN |JBFC-;reduceMod;3L;40|
        ...
        (SPROG
         ((|res| #1=(|List| S)) (LS1 (|List| S)) (LD1 (|List| JB)) (|neq| (S))
          (|ld| (JB)) (#2=#:G801 NIL) (|oeq| (S)) (|eq| (S)) (#3=#:G800 NIL)
          (|eq1| NIL) (|newSys| (|List| S)) (LS #1#) (LD (|List| JB))
          (|i| (|NonNegativeInteger|)) (#4=#:G799 NIL) (|jv| NIL)
          (|ls| (|Union| S "failed")) (#5=#:G798 NIL) (|eq2| NIL))
         (SEQ
          (COND ((OR (NULL |sys1|) (NULL |sys2|)) |sys1|)
                ('T
                 (SEQ (LETT LD NIL) (LETT LS NIL)
...
(SDEFUN |JBFC-;autoReduce;2L;41| ((|sys| |List| S) ($ |List| S))
        (SPROG
         ((#1=#:G859 NIL)
          ...
          (|tmp1|
           (|List|
            #4=(|Record| (|:| LD JB) (|:| |Fake?| (|Boolean|))
                         (|:| |Dep| (|List| (|NonNegativeInteger|)))
                         (|:| |Fun| S))))
          (|tmp2| (|List| #4#)) (#5=#:G857 NIL) (#6=#:G856 NIL) (#7=#:G855 NIL)
          (|eq| NIL) (#8=#:G854 NIL) (|nl| (|List| S)) (|ol| #9=(|List| S))
          (|seq| (S)) (#10=#:G853 NIL) (|sub| #2#) (#11=#:G852 NIL) (|nsl| #9#)
          (#12=#:G851 NIL) (#13=#:G850 NIL)
          (|sl|
           #14=(|List|
                (|Record| (|:| LD JB) (|:| |Fake?| (|Boolean|))
                          (|:| |Dep| (|List| (|NonNegativeInteger|)))
          ...
          (#15=#:G849 NIL) (#16=#:G847 NIL) (|osl| #14#)
          (|su| (|Union| S "failed")) (|ld| (JB)) (#17=#:G848 NIL))
         (SEQ
