...
(SDEFUN |TESTCNT;statistics;V;18| (($ |Void|))
        (SPROG
         ((#1=#:G519 NIL) (#2=#:G515 NIL) (#3=#:G511 NIL) (#4=#:G507 NIL)
          (#5=#:G503 NIL) (|stotalTests| #6=(|String|)) (|sfailedTests| #6#)
          (|stotalCases| #6#) (|sfailedCases| #6#)
          (|tsfailedTests| (|Integer|)) (|tstotalTests| (|Integer|))
          (|failedCases| (|Integer|)) (|totalCases| (|Integer|))
          (#7=#:G535 NIL) (|tstcase| NIL) (#8=#:G534 NIL) (|tstsuite| NIL)
          (#9=#:G533 NIL) (|f| NIL) (#10=#:G483 NIL) (#11=#:G532 NIL)
          (#12=#:G531 NIL) (|outstring| (|String|)) (#13=#:G529 NIL) (|o| NIL)
          (#14=#:G530 NIL) (|i| NIL) (#15=#:G528 NIL) (#16=#:G464 NIL)
          (#17=#:G527 NIL) (|xfpassedTests| (|Integer|))
          (|xfailedTests| (|Integer|)) (|failedTests| (|Integer|))
          (|totalTests| (|Integer|)) (|xfpassedCases| (|Integer|))
          (#18=#:G526 NIL) (#19=#:G525 NIL) (#20=#:G524 NIL) (|w| NIL))
         (SEQ
