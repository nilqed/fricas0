...
(SDEFUN |EUCDOM-;expressIdealMember;LSU;10|
        ...
        (SPROG
         ((#1=#:G489 NIL) (|v| NIL) (#2=#:G488 NIL) (|q| (|Union| S "failed"))
          (|pid| (|Record| (|:| |coef| (|List| S)) (|:| |generator| S)))
          (#3=#:G487 NIL) (#4=#:G486 NIL))
         (SEQ
          (COND
...
(SDEFUN |EUCDOM-;multiEuclidean;LSU;11|
        ...
        (SPROG
         ((|v2| #2=(|Union| (|List| S) #1#)) (|v1| #2#)
          ...
          (#3=#:G497 NIL) (#4=#:G496 (S)) (#5=#:G498 (S)) (#6=#:G509 NIL)
          (#7=#:G379 NIL) (#8=#:G494 NIL) (#9=#:G493 (S)) (#10=#:G495 (S))
          (#11=#:G508 NIL) (#12=#:G378 NIL) (|l2| (|List| S)) (|l1| (|List| S))
