...
(SDEFUN |EXTRED;denominatorFreeTopReduce|
        ((|x| |Record| (|:| |poly| R) (|:| |repr| (|Vector| R)) (|:| |mult| C))
         ...
         ($ |Record| (|:| |poly| R) (|:| |repr| (|Vector| R)) (|:| |mult| C)))
        (SPROG
         ((#2=#:G410 NIL) (|bas| #1#) (|f2| (R)) (|f1| (C)) (|a| (C))
         ...
         ((|x|
          ...
          (|bas|
           (|List|
            (|Record| (|:| |poly| R) (|:| |repr| (|Vector| R))
                      (|:| |mult| C))))
          (#1=#:G423 NIL) (|b| NIL) (#2=#:G424 NIL) (|i| NIL) (#3=#:G422 NIL)
...
(DEFUN |ExtendedPolynomialReduction| (&REST #1=#:G425)
  (SPROG NIL
         (PROG (#2=#:G426)
           (RETURN
            (COND
