...
(SDEFUN |ODESYS;solve;MLMR;1|
        ((|mm| |Matrix| F) (|lv| |List| (|Vector| F))
         ...
         ($ |Record|
          ...
          (|:| |basis| (|List| (|Vector| F)))))
        (SPROG
         ((#1=#:G432 NIL) (|bvec| NIL) (#2=#:G431 NIL) (#3=#:G429 NIL)
          (|np| NIL) (#4=#:G430 NIL) (|bv| NIL) (#5=#:G428 NIL)
          (|base_vecs| (|List| (|Vector| F))) (|cb| (|List| (|Vector| F)))
          (|pl| (|List| (|Vector| F))) (|k| #6=(|NonNegativeInteger|))
          (#7=#:G427 NIL) (|l| NIL) (|g1| #8=(|Vector| F)) (#9=#:G424 NIL)
          (|be| NIL) (#10=#:G425 NIL) (#11=#:G426 NIL) (|npl| (|List| #8#))
          (#12=#:G423 NIL) (#13=#:G422 NIL) (#14=#:G421 NIL)
          (|base_vec| (|Vector| F)) (#15=#:G420 NIL) (|s| NIL)
          (|nn| (|NonNegativeInteger|)) (|ncb| (|List| #8#)) (#16=#:G419 NIL)
          (#17=#:G418 NIL)
          (|np1|
           #18=(|List|
                (|Record| (|:| |ratpart| F) (|:| |coeffs| (|Vector| F)))))
          (|u| (|Record| (|:| |particular| #18#) (|:| |basis| (|List| F))))
          (|crh| (|List| F)) (#19=#:G417 NIL) (#20=#:G416 NIL) (#21=#:G415 NIL)
          (|e| NIL) (#22=#:G413 NIL) (|i| #6#) (#23=#:G414 NIL)
          (#24=#:G412 NIL) (|v| NIL) (#25=#:G411 NIL) (#26=#:G410 NIL)
          (#27=#:G409 NIL) (|n| (|NonNegativeInteger|)) (|mA| #28=(|Matrix| F))
...
(SDEFUN |ODESYS;solve;MVMU;3|
        ((|mm| |Matrix| F) (|v| |Vector| F)
         ...
         ($ |Union|
          ...
          "failed"))
        (SPROG
         ((|bm| (|Matrix| F)) (#1=#:G466 NIL) (|bv| NIL) (#2=#:G465 NIL)
          (|s1| (|Vector| F)) (|c1inv| (F))
          (|part1|
         ...
         ((|k| (|NonNegativeInteger|))
          (|ler|
           (|List|
            (|Record| (|:| C (|Matrix| F)) (|:| |lg| (|List| (|Vector| F)))
                      (|:| |eq| LO) (|:| |lrh| (|List| F)))))
          (|lh| (|List| F)) (|h0| (F)) (#1=#:G488 NIL) (|j| NIL)
          (#2=#:G487 NIL) (|sum| (|Vector| F)) (#3=#:G486 NIL) (|g| NIL)
          (|op| (LO)) (#4=#:G485 NIL) (|n| (|NonNegativeInteger|))
          (#5=#:G484 NIL) (|er| NIL)
          (|l|
           (|List|
            (|Record| (|:| C (|Matrix| F)) (|:| |lg| (|List| (|Vector| F))))))
          (#6=#:G483 NIL) (|v| NIL) (#7=#:G482 NIL)
          (|rat|
         ...
         ((|rec|
           (|Union|
            (|Record|
             ...
             (|:| |basis| (|List| (|Vector| F))))
            "failed"))
          (#1=#:G517 NIL) (|u| (|Union| (|Matrix| F) "failed")) (#2=#:G518 NIL)
          (#3=#:G520 NIL) (|i| NIL) (#4=#:G519 NIL)
...
(SDEFUN |ODESYS;M2F| ((|m| |Matrix| LO) ($ |Union| (|Matrix| F) "failed"))
        (SPROG
         ((#1=#:G532 NIL) (|u| (|Union| F "failed")) (#2=#:G534 NIL) (|j| NIL)
          (#3=#:G533 NIL) (|i| NIL) (|mf| (|Matrix| F)))
         (SEQ
          (EXIT
           (SEQ
            (LETT |mf|
...
(DEFUN |SystemODESolver| (&REST #1=#:G548)
  (SPROG NIL
         (PROG (#2=#:G549)
           (RETURN
            (COND
