...
(SDEFUN |LWORD;lyndon?;FmB;1| ((|w| |FreeMonoid| |VarSet|) ($ |Boolean|))
        (SPROG ((|f| (|FreeMonoid| |VarSet|)) (#1=#:G396 NIL))
               (SEQ
                (EXIT
...
(SDEFUN |LWORD;factor;FmL;6| ((|w| |FreeMonoid| |VarSet|) ($ |List| $))
        (SPROG ((|l| (|List| $)) (#1=#:G421 NIL) (|u| NIL) (#2=#:G420 NIL))
               (SEQ
                (COND ((SPADCALL |w| (|spadConstant| $ 9) (QREFELT $ 11)) NIL)
                      ('T
                       (SEQ
...
(SDEFUN |LWORD;LyndonWordsList1;LPiOda;10|
        ...
        (SPROG
         ((#1=#:G445 NIL) (|lbase1| (|List| $)) (#2=#:G453 NIL) (|b| NIL)
          (#3=#:G452 NIL) (|a| NIL) (#4=#:G451 NIL) (|i| NIL) (#5=#:G450 NIL)
          (#6=#:G449 NIL) (#7=#:G448 NIL) (|ll| NIL) (#8=#:G447 NIL) (|w| NIL)
          (#9=#:G446 NIL) (|base| (|OneDimensionalArray| (|List| $)))
          (#10=#:G427 NIL))
         (SEQ
          (EXIT
           (COND ((NULL |vl|) (|error| "empty list"))
                 ('T
                  (SEQ
                   ...
                   (EXIT (PROGN (LETT #1# |base|) (GO #11=#:G444)))))))
          #11# (EXIT #1#)))) 

(SDEFUN |LWORD;LyndonWordsList;LPiL;11|
        ((|vl| |List| |VarSet|) (|n| |PositiveInteger|) ($ |List| $))
        (SPROG
         ((#1=#:G455 NIL) (#2=#:G454 #3=(|List| $)) (#4=#:G456 #3#)
          (#5=#:G459 NIL) (|i| NIL) (|v| (|OneDimensionalArray| (|List| $))))
