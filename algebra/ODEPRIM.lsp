...
(SDEFUN |ODEPRIM;splitDenominator;LQLR;4|
        ...
        (SPROG
         ((#1=#:G396 NIL) (|g| NIL) (#2=#:G395 NIL) (|l| (L))
          (|f| (|Fraction| UP))
...
(SDEFUN |ODEPRIM;UPfact| ((|n| |NonNegativeInteger|) ($ UP))
        (SPROG
         ((#1=#:G412 NIL) (#2=#:G411 (UP)) (#3=#:G413 (UP)) (#4=#:G417 NIL)
          (#5=#:G410 NIL) (|i| NIL) (|z| (UP)))
         (SEQ
...
(SDEFUN |ODEPRIM;indicialEq|
        ((|c| UP) (|lamb| |List| (|NonNegativeInteger|)) (|lf| |List| UP)
         ($ UP))
        (SPROG
         ((|s| (|SparseUnivariatePolynomial| UP)) (#1=#:G421 NIL) (|i| NIL)
          (#2=#:G422 NIL) (|f| NIL) (|cc| (|SparseUnivariatePolynomial| UP))
          (|cp| (UP)))
...
(SDEFUN |ODEPRIM;NPbound| ((|c| UP) (|l| L) (|e| UP) ($ |NonNegativeInteger|))
        (SPROG
         ((#1=#:G436 NIL) (#2=#:G431 NIL) (|n| (|Integer|))
          (|rec|
           (|Record| (|:| |mu| (|Integer|))
                     (|:| |lambda| (|List| (|NonNegativeInteger|)))
                     (|:| |func| (|List| UP)))))
...
(SDEFUN |ODEPRIM;hdenom| ((|l| L) (|d| UP) (|e| UP) ($ UP))
        (SPROG
         ((#1=#:G441 NIL) (#2=#:G440 (UP)) (#3=#:G442 (UP)) (#4=#:G444 NIL)
          (|dd| NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
...
(SDEFUN |ODEPRIM;denom0|
        ...
        (SPROG
         ((#1=#:G447 NIL) (#2=#:G446 (UP)) (#3=#:G448 (UP)) (#4=#:G450 NIL)
          (#5=#:G452 NIL) (|hh| NIL))
         (SEQ
...
(SDEFUN |ODEPRIM;indicialEquations;LUPL;17|
        ((|op| L) (|p| UP)
         ($ |List| (|Record| (|:| |center| UP) (|:| |equation| UP))))
        (SPROG ((#1=#:G465 NIL) (|dd| NIL) (#2=#:G464 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |dd| NIL)
...
(SDEFUN |ODEPRIM;denomLODE;LLUP;19|
        ...
        (SPROG
         ((|h| (UP)) (|e| (UP)) (#1=#:G479 NIL) (#2=#:G478 (UP))
          (#3=#:G480 (UP)) (#4=#:G484 NIL) (|g| NIL) (|d| (UP))
          (#5=#:G476 NIL))
         (SEQ
          (COND
           ((NULL |lg|)
...
(DEFUN |PrimitiveRatDE| (&REST #1=#:G485)
  (SPROG NIL
         (PROG (#2=#:G486)
           (RETURN
            (COND
