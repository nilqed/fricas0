...
(SDEFUN |BALFACT;balSqfr1|
        ...
        (SPROG ((#1=#:G383 NIL) (|fa| (|Factored| UP)) (|g| (UP)))
...
(SDEFUN |BALFACT;balSqfr|
        ...
        (SPROG
         ((#1=#:G389 NIL) (#2=#:G388 #3=(|Factored| UP)) (#4=#:G390 #3#)
          (#5=#:G393 NIL) (|f| NIL) (|b| (UP)))
...
(SDEFUN |BALFACT;balancedFactorisation;UPLF;4|
        ...
        (SPROG
         ((#1=#:G397 NIL) (#2=#:G396 #3=(|Factored| UP)) (#4=#:G398 #3#)
          (#5=#:G402 NIL) (|f| NIL) (|sa| (|Factored| UP)) (|ll| (|List| UP)))
         (SEQ
          (COND
           ((NULL
             (LETT |ll|
...
(DEFUN |BalancedFactorisation| (&REST #1=#:G403)
  (SPROG NIL
         (PROG (#2=#:G404)
           (RETURN
            (COND
