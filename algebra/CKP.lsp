...
(SDEFUN |CKP;displayCartan|
        ...
        (SPROG ((#1=#:G427 NIL) (|cc| NIL) (#2=#:G426 NIL))
               (SEQ
...
(SDEFUN |CKP;stirling;4Nni;11|
        ...
        (SPROG
         ((|res| (|NonNegativeInteger|)) (#1=#:G458 NIL) (#2=#:G457 NIL)
          (#3=#:G456 NIL) (#4=#:G468 NIL) (|j| NIL) (#5=#:G467 NIL)
          (#6=#:G466 NIL) (#7=#:G465 NIL)
...
(SDEFUN |CKP;alpha;Nni2L;12|
        ...
        (SPROG
         ((#1=#:G469 NIL) (#2=#:G473 NIL) (|bi| NIL) (#3=#:G474 NIL) (|i| NIL)
          (#4=#:G472 NIL))
         (SEQ
          (PROGN
           (LETT #4# NIL)
...
(SDEFUN |CKP;hilbert;LSup;13|
        ...
        (SPROG
         ((|ifac| #1=(|Integer|))
          ...
          (|coeff| (|Fraction| (|Integer|))) (#2=#:G475 NIL) (|kfac| #1#)
          (#3=#:G483 NIL) (|k| NIL) (#4=#:G482 NIL) (|i| NIL))
...
(SDEFUN |CKP;alphaHilbert;SupL;14|
        ((|hilp| |SparseUnivariatePolynomial| (|Fraction| (|Integer|)))
         ($ |List| (|NonNegativeInteger|)))
        (SPROG
         ((|res| (|List| (|NonNegativeInteger|))) (#1=#:G592 NIL)
          (|ai| (|Integer|)) (#2=#:G590 NIL) (|kfac| #3=(|Integer|))
          (|sum| (|Fraction| (|Integer|))) (#4=#:G487 NIL) (#5=#:G486 NIL)
          (#6=#:G597 NIL) (|k| NIL) (|ifac| #3#) (|i| NIL))
         (SEQ (LETT |res| NIL)
...
(SDEFUN |CKP;arbFunctions;NniILL;15|
        ...
        (SPROG
         ((|res| (|List| (|Integer|))) (|t| (|Fraction| (|Integer|)))
          (#1=#:G635 NIL) (#2=#:G634 NIL) (#3=#:G625 NIL) (|kfac| (|Integer|))
          (|ki| (|NonNegativeInteger|)) (#4=#:G598 NIL) (#5=#:G642 NIL)
...
(SDEFUN |CKP;gauge;NniILL;16|
        ...
        (SPROG
         ((|res| (|List| (|Integer|))) (|t| (|Fraction| (|Integer|)))
          (#1=#:G662 NIL) (#2=#:G661 NIL) (|kfac| (|Integer|))
          (|ki| (|NonNegativeInteger|)) (#3=#:G652 NIL) (#4=#:G672 NIL)
          (|k| NIL) (|ifac| (|Integer|)) (#5=#:G650 NIL) (#6=#:G649 NIL)
          (#7=#:G670 NIL) (|l| NIL) (#8=#:G671 NIL) (|g| NIL) (|i| NIL)
...
(SDEFUN |CKP;gaugeHilbert;NniLSup;17|
        ...
        (SPROG
         ((|res| (|SparseUnivariatePolynomial| (|Fraction| (|Integer|))))
          (|t| (|NonNegativeInteger|)) (#1=#:G674 NIL) (#2=#:G673 NIL)
          (#3=#:G682 NIL) (|l| NIL) (#4=#:G683 NIL) (|g| NIL) (#5=#:G681 NIL)
...
(SDEFUN |CKP;bound;4Nni;18|
        ...
        (SPROG
         ((#1=#:G688 NIL) (#2=#:G685 NIL) (|tmp| (|NonNegativeInteger|))
          (#3=#:G684 NIL))
         (SEQ
          (COND
           ((EQL |qq| 1)
...
(SDEFUN |CKP;complete2;JdeR;20|
        ...
        (SPROG
         ((|Cartan| (|List| (|NonNegativeInteger|)))
          ...
          (#4=#:G713 NIL) (|ProjDe| (|JetDifferentialEquation| JB D))
          ...
          (#7=#:G700 NIL) (#8=#:G698 NIL) (#9=#:G722 NIL)
          (|solved?| (|Boolean|)))
...
(DEFUN |CartanKuranishi| (&REST #1=#:G723)
  (SPROG NIL
         (PROG (#2=#:G724)
           (RETURN
            (COND
