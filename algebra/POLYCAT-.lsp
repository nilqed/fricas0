...
(SDEFUN |POLYCAT-;eval;SLS;1| ((|p| S) (|l| |List| (|Equation| S)) ($ S))
        (SPROG
         ((#1=#:G424 NIL) (|e| NIL) (#2=#:G423 NIL) (|lvar| (|List| |VarSet|))
          (#3=#:G422 NIL) (#4=#:G421 NIL) (#5=#:G419 NIL) (#6=#:G420 NIL))
         (SEQ
          (COND ((NULL |l|) |p|)
                ('T
                 (SEQ
...
(SDEFUN |POLYCAT-;isTimes;SU;3| ((|p| S) ($ |Union| (|List| S) "failed"))
        (SPROG
         ((|r| (R)) (|l| (|List| S)) (#1=#:G443 NIL) (|v| NIL) (#2=#:G442 NIL)
          (|lv| (|List| |VarSet|)))
         (SEQ
          (COND
...
(SDEFUN |POLYCAT-;retractIfCan;SU;8| ((|p| S) ($ |Union| |VarSet| "failed"))
        (SPROG ((#1=#:G474 NIL) (|q| (|Union| |VarSet| "failed")))
               (SEQ
                (EXIT
                 (SEQ
...
(SDEFUN |POLYCAT-;totalDegreeSorted;SLNni;10|
        ...
        (SPROG
         ((|u| (|SparseUnivariatePolynomial| S))
          ...
          (#2=#:G497 NIL) (|v| (|VarSet|)) (#3=#:G486 NIL))
         (SEQ
          (EXIT
...
(SDEFUN |POLYCAT-;allMonoms| ((|l| |List| S) ($ |List| S))
        (SPROG ((#1=#:G508 NIL) (|p| NIL) (#2=#:G507 NIL))
               (SEQ
                (SPADCALL
                 (SPADCALL
                  (PROGN
...
(SDEFUN |POLYCAT-;P2R|
        ...
        (SPROG
         ((#1=#:G512 NIL) (|i| NIL) (#2=#:G513 NIL) (|bj| NIL)
          (|w| (|Vector| R)))
...
(SDEFUN |POLYCAT-;eq2R| ((|l| |List| S) (|b| |List| E) ($ |Matrix| R))
        (SPROG
         ((#1=#:G520 NIL) (|p| NIL) (#2=#:G519 NIL) (#3=#:G518 NIL) (|bj| NIL)
          (#4=#:G517 NIL))
         (SEQ
          (SPADCALL
           (PROGN
...
(SDEFUN |POLYCAT-;reducedSystem;MM;17| ((|m| |Matrix| S) ($ |Matrix| R))
        (SPROG
         ((|l| (|List| (|List| S))) (|mm| (|Matrix| R)) (|d| (|List| E))
          (#1=#:G534 NIL) (|bj| NIL) (#2=#:G533 NIL) (|b| (|List| S))
          (#3=#:G532 NIL) (|r| NIL) (#4=#:G531 NIL))
...
(SDEFUN |POLYCAT-;reducedSystem;MVR;18|
        ...
        (SPROG
         ((|r| (|List| S)) (|l| (|List| (|List| S))) (|w| (|Vector| R))
          ...
          (#1=#:G550 NIL) (|bj| NIL) (#2=#:G549 NIL) (|b| (|List| S))
          (#3=#:G548 NIL) (|s| NIL) (#4=#:G547 NIL))
         (SEQ (LETT |l| (SPADCALL |m| (QREFELT $ 88)))
...
(SDEFUN |POLYCAT-;factor;SF;29| ((|p| S) ($ |Factored| S))
        (SPROG
         ((#1=#:G590 NIL) (|ww| NIL) (#2=#:G589 NIL)
          (|ansSUP| (|Factored| (|SparseUnivariatePolynomial| S)))
          (|up| (|SparseUnivariatePolynomial| S)) (#3=#:G588 NIL) (|w| NIL)
          (#4=#:G587 NIL) (|ansR| (|Factored| R))
...
(SDEFUN |POLYCAT-;factor;SF;33| ((|p| S) ($ |Factored| S))
        (SPROG
         ((#1=#:G614 NIL) (|ww| NIL) (#2=#:G613 NIL)
          (|ansSUP| (|Factored| (|SparseUnivariatePolynomial| S)))
          (|up| (|SparseUnivariatePolynomial| S)) (#3=#:G612 NIL) (|w| NIL)
          (#4=#:G611 NIL) (|ansR| (|Factored| R))
          (|v| (|Union| |VarSet| "failed")))
         (SEQ (LETT |v| (SPADCALL |p| (QREFELT $ 38)))
              (EXIT
               (COND
...
(SDEFUN |POLYCAT-;conditionP;MU;34|
        ...
        (SPROG
         ((#2=#:G637 NIL) (#3=#:G636 (S)) (#4=#:G638 (S))
          (|i| (|NonNegativeInteger|)) (#5=#:G657 NIL) (|m| NIL)
          (#6=#:G654 NIL) (#7=#:G656 NIL) (|mons| #8=(|List| S))
          (#9=#:G655 NIL) (|ans| (|Union| (|Vector| R) #1#))
          (|monslist| (|List| (|List| S))) (|llR| (|List| (|List| R)))
          (#10=#:G652 NIL) (|u| NIL) (#11=#:G653 NIL) (|v| NIL)
          (#12=#:G651 NIL) (|redmons| (|List| S))
          (|deg1| (|List| (|NonNegativeInteger|))) (#13=#:G625 NIL)
          (#14=#:G643 NIL) (|nd| (|Union| (|Integer|) "failed"))
          (#15=#:G650 NIL) (|d| NIL) (#16=#:G649 NIL)
          (|degs| (|List| (|NonNegativeInteger|))) (|vars| (|List| |VarSet|))
          (#17=#:G648 NIL) (#18=#:G620 NIL) (#19=#:G619 #8#) (#20=#:G621 #8#)
          (#21=#:G647 NIL) (#22=#:G646 NIL) (|l| NIL) (|ch| (|Integer|))
          (#23=#:G645 NIL) (|z| NIL) (#24=#:G644 NIL)
          (|ll| (|List| (|List| S))))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |POLYCAT-;charthRootlv|
        ((|p| S) (|vars| |List| |VarSet|) (|ch| |NonNegativeInteger|)
         ($ |Union| S #1="failed"))
        (SPROG
         ((#2=#:G687 NIL) (|ansx| (|Union| S #1#)) (|ans| (S)) (#3=#:G679 NIL)
...
(SDEFUN |POLYCAT-;squareFreePart;2S;41| ((|p| S) ($ S))
        (SPROG
         ((#1=#:G697 NIL) (#2=#:G696 (S)) (#3=#:G698 (S)) (#4=#:G700 NIL)
          (|f| NIL) (|s| (|Factored| S)))
         (SEQ
          (SPADCALL
...
(SDEFUN |POLYCAT-;smaller?;2SB;45| ((|p| S) (|q| S) ($ |Boolean|))
        (SPROG ((#1=#:G721 NIL) (|lq| (R)) (|lp| (R)) (|dq| (E)) (|dp| (E)))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ G190
...
(SDEFUN |POLYCAT-;convert;SP;48| ((|x| S) ($ |Pattern| (|Integer|)))
        (SPROG
         ((|res| (|Pattern| (|Integer|))) (#1=#:G749 NIL) (|mx| NIL)
          (|lx| (|Union| (|List| S) "failed")) (#2=#:G748 NIL) (|tx| NIL)
          (|exr|
           (|Record| (|:| |var| |VarSet|)
                     (|:| |exponent| (|NonNegativeInteger|))))
          (|ex|
...
(SDEFUN |POLYCAT-;convert;SP;49| ((|x| S) ($ |Pattern| (|Float|)))
        (SPROG
         ((|res| (|Pattern| (|Float|))) (#1=#:G775 NIL) (|mx| NIL)
          (|lx| (|Union| (|List| S) "failed")) (#2=#:G774 NIL) (|tx| NIL)
          (|exr|
           (|Record| (|:| |var| |VarSet|)
                     (|:| |exponent| (|NonNegativeInteger|))))
          (|ex|
