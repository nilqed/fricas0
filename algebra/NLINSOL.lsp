...
(SDEFUN |NLINSOL;solveInField;LL;1|
        ...
        (SPROG
         ((#1=#:G384 NIL) (#2=#:G383 #3=(|List| (|Symbol|))) (#4=#:G385 #3#)
          (#5=#:G387 NIL) (|p| NIL))
         (SEQ
          (SPADCALL |l|
                    (PROGN
...
(SDEFUN |NLINSOL;solve;LL;2|
        ((|l| |List| (|Polynomial| R))
         ($ |List| (|List| (|Equation| (|Fraction| (|Polynomial| R))))))
        (SPROG
         ((#1=#:G389 NIL) (#2=#:G388 #3=(|List| (|Symbol|))) (#4=#:G390 #3#)
          (#5=#:G392 NIL) (|p| NIL))
         (SEQ
          (SPADCALL |l|
                    (PROGN
...
(SDEFUN |NLINSOL;solve;LLL;3|
        ((|lp| |List| (|Polynomial| R)) (|lv| |List| (|Symbol|))
         ($ |List| (|List| (|Equation| (|Fraction| (|Polynomial| R))))))
        (SPROG ((#1=#:G396 NIL) (|sol| NIL) (#2=#:G395 NIL))
               (SEQ
                (SPADCALL
                 (PROGN
                  (LETT #2# NIL)
...
(SDEFUN |NLINSOL;evalSol|
        ...
        (SPROG ((#1=#:G404 NIL) (|eq| NIL) (#2=#:G403 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |NLINSOL;allRoots|
        ((|l| |List| (|Polynomial| R))
         ($ |List| (|List| (|Equation| (|Fraction| (|Polynomial| R))))))
        (SPROG
         ((#1=#:G413 NIL) (|a| NIL) (#2=#:G412 NIL)
          (|s| (|Fraction| (|Polynomial| R))) (#3=#:G406 NIL)
          (|p| (|Polynomial| R))
...
(SDEFUN |NLINSOL;RIfCan|
        ...
        (SPROG ((#1=#:G443 NIL) (|d| #2=(|Union| R "failed")) (|n| #2#))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ
...
(DEFUN |NonLinearSolvePackage| (#1=#:G452)
  (SPROG NIL
         (PROG (#2=#:G453)
           (RETURN
            (COND
