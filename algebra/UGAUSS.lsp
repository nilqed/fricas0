...
(SDEFUN |UGAUSS;pre_gauss0|
        ...
        (SPROG
         ((#1=#:G406 NIL) (|l| NIL) (|pp| (|Integer|)) (#2=#:G405 NIL)
          (|n| NIL) (|ml| #3=(|Integer|)) (|l0| (|Integer|)) (#4=#:G402 NIL)
          (|pv| #3#) (#5=#:G404 NIL) (#6=#:G403 NIL) (|i| NIL)
...
(SDEFUN |UGAUSS;pre_lr;M2VM;2|
        ...
        (SPROG
         ((#1=#:G430 NIL) (|l| NIL) (#2=#:G429 NIL) (|pp| (|Integer|))
          (#3=#:G428 NIL) (|n| NIL) (|ml| #4=(|Integer|)) (|l0| (|Integer|))
          (#5=#:G425 NIL) (|pv| #4#) (#6=#:G427 NIL) (#7=#:G426 NIL) (|i| NIL)
          (|k| (|NonNegativeInteger|)) (|j| (|NonNegativeInteger|))
          (|m2| (|Matrix| (|Integer|))))
...
(SDEFUN |UGAUSS;pre_smith;2M;4|
        ((|m| |Matrix| (|Integer|)) ($ |Matrix| (|Integer|)))
        (SPROG
         ((|l0| #1=(|NonNegativeInteger|)) (#2=#:G448 NIL) (|l| NIL) (|i0| #1#)
          (#3=#:G447 NIL) (|i| NIL) (|ress| (|Matrix| (|Integer|)))
          (#4=#:G436 NIL) (#5=#:G435 NIL) (|count| #1#) (#6=#:G446 NIL)
