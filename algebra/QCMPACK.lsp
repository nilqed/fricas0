...
(SDEFUN |QCMPACK;squareFreeFactors| ((|lp| |List| P) ($ |List| P))
        (SPROG
         ((|lsflp| (|List| P)) (|lsfp| (|List| P)) (#1=#:G444 NIL) (|p| NIL))
         (SEQ (LETT |lsflp| NIL)
...
(SDEFUN |QCMPACK;moreAlgebraic?;2TSB;6| ((|ts| TS) (|us| TS) ($ |Boolean|))
        (SPROG ((#1=#:G472 NIL) (#2=#:G473 NIL) (#3=#:G474 NIL) (|p| NIL))
               (SEQ
                (EXIT
                 (COND
...
(SDEFUN |QCMPACK;internalSubQuasiComponent?;2TSU;13|
        ...
        (SPROG
         ((#1=#:G534 NIL) (#2=#:G537 NIL) (#3=#:G540 NIL) (|p| NIL)
          (|lsfp| (|List| P)) (#4=#:G535 NIL) (#5=#:G539 NIL) (#6=#:G536 NIL)
          (#7=#:G520 NIL) (#8=#:G538 NIL))
         (SEQ
          (EXIT
...
(SDEFUN |QCMPACK;subQuasiComponent?;TSLB;15|
        ...
        (SPROG ((#1=#:G552 NIL) (#2=#:G553 NIL) (#3=#:G554 NIL) (|us| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ
                          ...
                          (EXIT
                           (COND
                            ((SPADCALL |ts| |us| (QREFELT $ 61))
                             (PROGN
                              (LETT #1# (PROGN (LETT #2# 'T) (GO #4=#:G551)))
                              (GO #5=#:G549))))))
                         (LETT #3# (CDR #3#)) (GO G190) G191 (EXIT NIL)))
                   #5# (EXIT #1#))
                  (EXIT NIL)))
...
(SDEFUN |QCMPACK;removeAssociates| ((|lp| |List| P) ($ |List| P))
        (SPROG ((#1=#:G604 NIL) (|p| NIL) (#2=#:G603 NIL))
               (SEQ
                (SPADCALL
                 (PROGN
                  (LETT #2# NIL)
...
(SDEFUN |QCMPACK;branchIfCan;LTSL5BU;19|
        ((|leq| |List| P) (|ts| TS) (|lineq| |List| P) (|b1| |Boolean|)
         ...
         ($ |Union|
          ...
          "failed"))
        (SPROG
         ((|newleq| (|List| P)) (#1=#:G643 NIL) (|newp| (P)) (#2=#:G625 NIL)
          (|g| (P)) (#3=#:G647 NIL) (|q| NIL) (#4=#:G646 NIL) (|p| NIL)
          (#5=#:G640 NIL) (#6=#:G645 NIL) (#7=#:G641 NIL) (#8=#:G644 NIL)
          (|ps| (|GeneralPolynomialSet| R E V P)) (#9=#:G642 NIL))
         (SEQ
          (EXIT
           (SEQ
            (COND
          ...
          (|newBranch|
           #6=(|Union|
               (|Record| (|:| |eq| (|List| P)) (|:| |tower| TS)
                         (|:| |ineq| (|List| P)))
               "failed"))
          (|lineq| #2#) (|leq| #1#) (|ubf2| #6#) (|ubf1| #6#) (#7=#:G684 NIL)
          (|branch| NIL) (#8=#:G683 NIL) (|f| NIL) (|lsfp| (|List| P))
          (#9=#:G682 NIL) (|p| NIL) (#10=#:G681 NIL) (#11=#:G680 NIL))
         (SEQ
          (LETT |lp|
                (SPADCALL (ELT $ 16)
                          (SPADCALL (ELT $ 67)
...
(DEFUN |QuasiComponentPackage| (&REST #1=#:G687)
  (SPROG NIL
         (PROG (#2=#:G688)
           (RETURN
            (COND
