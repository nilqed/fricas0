...
(SDEFUN |LGROBP;reduceRow|
        ...
        (SPROG
         ((|a1| (F)) (#1=#:G389 NIL) (#2=#:G399 NIL) (|kk| NIL) (#3=#:G398 NIL)
          (|vk| (F)) (|b| (F)) (|k| (|Integer|)) (|mj| (|Vector| F))
          (#4=#:G397 NIL) (|j| NIL) (|dim| (|NonNegativeInteger|)))
...
(SDEFUN |LGROBP;totolex;LL;3|
        ...
        (SPROG
         ((|nBasis| (|List| #1=(|DistributedMultivariatePolynomial| |lv| F)))
          ...
          (#3=#:G422 NIL) (#4=#:G421 #2#) (#5=#:G423 #2#) (#6=#:G433 NIL)
          (|c| NIL) (#7=#:G434 NIL) (|b| NIL) (|cordlist| (|List| F))
          (#8=#:G432 NIL) (|k| NIL) (#9=#:G431 NIL)
          (|j| #10=(|NonNegativeInteger|)) (|lm| (|Vector| F)) (#11=#:G430 NIL)
          (|orecfmon|
           (|Record|
            (|:| |poly|
                 (|HomogeneousDistributedMultivariatePolynomial| |lv| F))
            (|:| |mult| F)))
          (|ofirstmon| #1#) (|veccoef| (|Vector| F)) (#12=#:G414 NIL)
          (#13=#:G411 NIL) (|cc| (F))
          (|recfmon|
           (|Record|
            (|:| |poly|
...
(SDEFUN |LGROBP;minPol;2LOvlHdmp;5|
        ...
        (SPROG
         ((#1=#:G454 NIL)
          ...
          (#2=#:G447 NIL) (#3=#:G457 NIL) (|k| NIL)
          (|j| (|NonNegativeInteger|)) (|lm| (|Vector| F)) (#4=#:G456 NIL)
          (|veccoef| (|Vector| F)) (|omult| (F)) (#5=#:G442 NIL)
          (|f| (|HomogeneousDistributedMultivariatePolynomial| |lv| F))
          (#6=#:G439 NIL) (|cc| (F))
          (|recf|
           (|Record|
            (|:| |poly|
                 (|HomogeneousDistributedMultivariatePolynomial| |lv| F))
            (|:| |mult| F)))
          (#7=#:G455 NIL) (|i| NIL) (|pivots| (|Vector| (|Integer|)))
          (|linmat| (|Matrix| F)) (|ndim1| (|NonNegativeInteger|))
          (|ndim| (|PositiveInteger|)) (#8=#:G437 NIL)
...
(SDEFUN |LGROBP;anticoord;LDmpLDmp;10|
        ...
        (SPROG ((#1=#:G483 NIL) (|f| NIL) (#2=#:G484 NIL) (|c| NIL))
               (SEQ
...
(SDEFUN |LGROBP;choosemon;DmpLDmp;11|
        ((|mf| |DistributedMultivariatePolynomial| |lv| F)
         ...
         ($ |DistributedMultivariatePolynomial| |lv| F))
        (SPROG
         ((#1=#:G488 NIL) (|dx| (|NonNegativeInteger|)) (#2=#:G494 NIL)
          (|xx| (|DistributedMultivariatePolynomial| |lv| F)) (#3=#:G495 NIL)
          (|x| NIL))
         (SEQ
          (EXIT
           (COND
...
(SDEFUN |LGROBP;linGenPos;LR;12|
        ...
        (SPROG
         ((|nBasis| (|List| #1=(|DistributedMultivariatePolynomial| |lv| F)))
          ...
          (|result| (|List| (|DistributedMultivariatePolynomial| |lv| F)))
          (|antc| #2=(|DistributedMultivariatePolynomial| |lv| F))
          (#3=#:G520 NIL) (#4=#:G519 #2#) (#5=#:G521 #2#) (#6=#:G535 NIL)
          (|c| (|Integer|)) (#7=#:G536 NIL) (|b| NIL) (|cordlist| (|List| F))
          (#8=#:G534 NIL) (|j| (|NonNegativeInteger|)) (#9=#:G533 NIL)
          (|lm| (|Vector| F)) (#10=#:G532 NIL)
          (|orecfmon|
           (|Record|
            (|:| |poly|
                 (|HomogeneousDistributedMultivariatePolynomial| |lv| F))
            (|:| |mult| F)))
          (|ofirstmon| #1#) (|veccoef| (|Vector| F)) (#11=#:G513 NIL)
          (#12=#:G510 NIL) (|cc| (F))
          (|recfmon|
           (|Record|
            (|:| |poly|
          ...
          (#13=#:G502 NIL)
          (#14=#:G501 #15=(|DistributedMultivariatePolynomial| |lv| F))
          (#16=#:G503 #15#) (#17=#:G530 NIL) (|r| NIL) (#18=#:G531 NIL)
          (|vv| NIL) (|rval| (|List| (|Integer|))) (#19=#:G529 NIL) (|ii| NIL)
...
(SDEFUN |LGROBP;groebgen;LR;13|
        ...
        (SPROG
         ((LL (|List| (|DistributedMultivariatePolynomial| |lv| F)))
          (#1=#:G551 NIL) (|f| NIL) (#2=#:G550 NIL)
          (|val| (|DistributedMultivariatePolynomial| |lv| F)) (#3=#:G541 NIL)
          (#4=#:G540 #5=(|DistributedMultivariatePolynomial| |lv| F))
          (#6=#:G542 #5#) (#7=#:G549 NIL) (|i| NIL) (|ll| (|List| (|Integer|)))
          (#8=#:G548 NIL) (#9=#:G547 NIL) (|nvar1| (|NonNegativeInteger|))
          (#10=#:G538 NIL) (|xn| (|OrderedVariableList| |lv|)))
...
(DEFUN |LinGroebnerPackage| (&REST #1=#:G554)
  (SPROG NIL
         (PROG (#2=#:G555)
           (RETURN
            (COND
...
(DEFUN |LinGroebnerPackage;| (|#1| |#2|)
  (SPROG
   ((#1=#:G385 NIL) (#2=#:G553 NIL) (|yx| NIL) (#3=#:G552 NIL) (|pv$| NIL)
