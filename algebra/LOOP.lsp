...
(SDEFUN |LOOP;latex;$S;4| ((|lp| $) ($ |String|))
        (SPROG
         ((|res| (|String|)) (|x| (|NonNegativeInteger|)) (#1=#:G400 NIL)
          (|i| NIL))
         (SEQ (LETT |res| "")
...
(SDEFUN |LOOP;=;2$B;5| ((|x| $) (|y| $) ($ |Boolean|))
        (SPROG ((#1=#:G406 NIL) (#2=#:G407 NIL) (|i| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (COND
...
(SDEFUN |LOOP;coerce;$Of;6| ((|lp| $) ($ |OutputForm|))
        (SPROG
         ((|res| (|OutputForm|)) (|x| (|NonNegativeInteger|)) (#1=#:G412 NIL)
          (|i| NIL))
