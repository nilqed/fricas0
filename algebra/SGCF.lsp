...
(SDEFUN |SGCF;numberOfImproperPartitionsInternal|
        ...
        (SPROG ((|s| (|Integer|)) (#1=#:G391 NIL) (|i| NIL))
               (SEQ
...
(SDEFUN |SGCF;numberOfImproperPartitions;3I;2|
        ...
        (SPROG ((|s| (|Integer|)) (#1=#:G396 NIL) (|i| NIL) (#2=#:G395 NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (COND
                   ((OR (< |n| 0) (< |m| 1))
                    (PROGN (LETT #2# 0) (GO #3=#:G394))))
                  (COND
                   ((OR (EQL |m| 1) (EQL |n| 0))
                    (PROGN (LETT #2# 1) (GO #3#))))
                  (LETT |s| 0)
...
(SDEFUN |SGCF;unrankImproperPartitions0;3IL;3|
        ((|n| |Integer|) (|m| |Integer|) (|k| |Integer|)
         ($ |List| (|Integer|)))
        (SPROG
         ((|l| (|List| (|Integer|))) (#1=#:G405 NIL) (|s| #2=(|Integer|))
          (|sOld| #2#) (#3=#:G407 NIL) (|y| NIL) (#4=#:G406 NIL) (|t| NIL))
         (SEQ (LETT |l| NIL)
              (EXIT
               (COND
...
(SDEFUN |SGCF;unrankImproperPartitions1;3IL;4|
        ((|n| |Integer|) (|m| . #1=(|Integer|)) (|k| |Integer|)
         ($ |List| (|Integer|)))
        (SPROG
         ((#2=#:G420 NIL) (|i| NIL) (|nonZeroPos| (|List| (|Integer|)))
          (|nonZeros| (|List| (|Integer|))) (#3=#:G419 NIL)
          (|s| #4=(|Integer|)) (|sOld| #4#) (|y| NIL) (|cm| #1#)
          (|partition| (|Vector| (|Integer|))) (#5=#:G409 NIL))
...
(SDEFUN |SGCF;subSet;3IL;5|
        ((|n| |Integer|) (|m| . #1=(|Integer|)) (|k| . #2=(|Integer|))
         ($ |List| (|Integer|)))
        (SPROG
         ((|s| #1#) (|mm| #2#) (|l| (|List| (|Integer|))) (#3=#:G429 NIL)
          (#4=#:G431 NIL) (|y| NIL) (#5=#:G430 NIL) (|t| NIL)
          (|bin| (|Integer|)))
         (SEQ
          (COND
...
(SDEFUN |SGCF;nextLatticePermutation;2LBL;6|
        ...
        (SPROG
         ((#2=#:G462 NIL) (|l| NIL) (|i| NIL)
          (|rightPosition| #3=(|NonNegativeInteger|)) (#4=#:G450 NIL)
          (|j| (|NonNegativeInteger|)) (#5=#:G461 NIL) (|ready| (|Boolean|))
          (|leftEntry| #6=(|NonNegativeInteger|)) (#7=#:G442 NIL)
          (|rightEntry| #6#) (#8=#:G460 NIL) (#9=#:G441 NIL)
          (|help| (|Vector| (|Integer|))) (|n| #3#) (#10=#:G440 NIL)
          (#11=#:G438 NIL) (#12=#:G437 #1#) (#13=#:G439 #1#) (#14=#:G459 NIL)
          (#15=#:G378 NIL) (|rows| (|NonNegativeInteger|)) (#16=#:G433 NIL)
          (|columns| (|NonNegativeInteger|)) (#17=#:G432 NIL)
          (|lprime| (|List| (|Integer|))))
...
(SDEFUN |SGCF;makeYoungTableau;2LM;7|
        ((|lambda| |List| (|Integer|)) (|gitter| |List| (|Integer|))
         ($ |Matrix| (|Integer|)))
        (SPROG
         ((|i| (|Integer|)) (|j| (|Integer|)) (#1=#:G469 NIL) (|l| NIL)
          (|help| (|Vector| (|Integer|))) (|ytab| (|Matrix| (|Integer|)))
          (|rows| (|NonNegativeInteger|)) (#2=#:G464 NIL)
          (|columns| (|NonNegativeInteger|)) (#3=#:G463 NIL)
          (|lprime| (|List| (|Integer|))))
         (SEQ (LETT |lprime| (SPADCALL |lambda| (QREFELT $ 23)))
              (LETT |columns|
...
(SDEFUN |SGCF;listYoungTableaus;LL;8|
        ...
        (SPROG
         ((|lattice| (|List| (|Integer|)))
          ...
          (|ytab| (|Matrix| (|Integer|))) (#1=#:G474 NIL))
...
(SDEFUN |SGCF;nextColeman;2L2M;9|
        ...
        (SPROG
         ((|vrest| #1=(|Vector| (|Integer|)))
          ...
          (#2=#:G490 NIL) (|i| (|NonNegativeInteger|)) (#3=#:G483 NIL)
          (|j| (|Integer|)) (#4=#:G476 NIL) (#5=#:G489 NIL) (#6=#:G475 NIL)
...
(SDEFUN |SGCF;nextPartition;LVIV;11|
        ((|gamma| |List| (|Integer|)) (|part| |Vector| (|Integer|))
         (|number| |Integer|) ($ |Vector| (|Integer|)))
        (SPROG
         ((#1=#:G504 NIL) (|k| NIL) (|j| (|NonNegativeInteger|))
          (|sum| (|Integer|)) (|i| (|NonNegativeInteger|)) (#2=#:G503 NIL)
...
(SDEFUN |SGCF;inverseColeman;2LML;12|
        ...
        (SPROG
         ((|pi| (|List| (|Integer|))) (#1=#:G516 NIL) (|k| NIL) (#2=#:G515 NIL)
          (|i| NIL) (#3=#:G514 NIL) (|j| NIL) (|sum| (|Integer|))
          (#4=#:G513 NIL) (|help| (|Vector| (|Integer|)))
...
(SDEFUN |SGCF;coleman;3LM;13|
        ...
        (SPROG
         ((#1=#:G534 NIL) (|j| NIL) (|betasum| #2=(|NonNegativeInteger|))
          (#3=#:G526 NIL) (|help| (|List| (|Integer|))) (#4=#:G524 NIL)
          (#5=#:G533 NIL) (|i| NIL) (|temp| (|List| (|List| (|Integer|))))
          (|alphasum| #2#) (#6=#:G520 NIL) (#7=#:G518 NIL) (#8=#:G532 NIL)
