...
(SDEFUN |DDFACT;ranpol| ((|d| |NonNegativeInteger|) ($ FP))
        (SPROG
         ((|u| (FP)) (#1=#:G396 NIL) (|j| NIL) (#2=#:G395 NIL)
...
(SDEFUN |DDFACT;notSqFr|
        ...
        (SPROG
         ((|factlist|
           (|List|
            (|Record| (|:| |irr| FP) (|:| |pow| (|NonNegativeInteger|)))))
          (#1=#:G410 NIL) (|pf| NIL) (#2=#:G409 NIL) (|fln| (|List| FP))
...
(SDEFUN |DDFACT;tracePowMod;FPNni2FP;5|
        ((|u| FP) (|k| |NonNegativeInteger|) (|v| FP) ($ FP))
        (SPROG ((|uu| (D)) (#1=#:G419 NIL) (|i| NIL) (|u1| (D)))
...
(SDEFUN |DDFACT;ddffact1|
        ...
        (SPROG
         ((#1=#:G432 NIL) (|du| (|NonNegativeInteger|)) (|u| (FP))
          (|ddfact|
           (|List|
            (|Record| (|:| |deg| (|NonNegativeInteger|)) (|:| |prod| FP))))
...
(SDEFUN |DDFACT;separateFactors;LL;10|
        ...
        (SPROG
         ((|aux| (|List| FP)) (|newaux| #1=(|List| FP)) (|ris| #1#) (|v| (FP))
          (|dg| (|NonNegativeInteger|)) (|g| (FP)) (#2=#:G452 NIL) (|u| NIL)
          (|t| (FP)) (#3=#:G440 NIL) (#4=#:G439 NIL)
          (|d| (|NonNegativeInteger|)) (|fprod| (FP)) (#5=#:G451 NIL)
...
(SDEFUN |DDFACT;distdfact;FPBR;12|
        ...
        (SPROG
         ((|factlist|
           (|List|
            (|Record| (|:| |irr| FP) (|:| |pow| (|NonNegativeInteger|)))))
          (#1=#:G468 NIL) (|pol| NIL) (#2=#:G467 NIL) (|fln| (|List| FP))
...
(DEFUN |DistinctDegreeFactorize| (&REST #1=#:G493)
  (SPROG NIL
         (PROG (#2=#:G494)
           (RETURN
            (COND
