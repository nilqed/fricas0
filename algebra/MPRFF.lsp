...
(SDEFUN |MPRFF;factor;PRFF;1| ((|p| PRF) ($ |Factored| PRF))
        (SPROG
         ((#1=#:G389 NIL) (#2=#:G388 #3=(|Factored| PRF)) (#4=#:G390 #3#)
          (#5=#:G398 NIL) (|ff| NIL)
          (|ffact|
           (|List|
            (|Record| (|:| |irr| PRF) (|:| |pow| (|NonNegativeInteger|)))))
          (#6=#:G397 NIL) (#7=#:G396 NIL) (|fcont| (PRF)) (#8=#:G395 NIL)
          (|x| NIL) (#9=#:G394 NIL) (|u| NIL) (#10=#:G393 NIL)
...
(SDEFUN |MPRFF;pushup;PRFOVPRF;4| ((|f| PRF) (|x| OV) ($ PRF))
        (SPROG
         ((|g| (|SparseUnivariatePolynomial| PRF)) (|v| (OV)) (#1=#:G407 NIL))
         (SEQ
          (COND
...
(SDEFUN |MPRFF;totalfract;PRFR;7|
        ((|p| PRF)
         ($ |Record| (|:| |sup| (|Polynomial| R))
          (|:| |inf| (|Polynomial| R))))
        (SPROG ((|g| (|Fraction| (|Polynomial| R))) (#1=#:G425 NIL) (|x| NIL))
               (SEQ
                (COND
...
(DEFUN |MPolyCatRationalFunctionFactorizer| (&REST #1=#:G426)
  (SPROG NIL
         (PROG (#2=#:G427)
           (RETURN
            (COND
