...
(SDEFUN |GCNAALG;eval|
        ...
        (SPROG
         ((|bot| #1=(|Polynomial| R)) (|top| #1#)
          (|lEq| (|List| (|Equation| (|Polynomial| R)))) (#2=#:G393 NIL)
          (|i| NIL) (#3=#:G392 NIL) (|s| NIL) (#4=#:G391 NIL)
...
(SDEFUN |GCNAALG;genericLeftDiscriminant;F;3| (($ |Fraction| (|Polynomial| R)))
        (SPROG
         ((|m| (|Matrix| (|Fraction| (|Polynomial| R)))) (#1=#:G402 NIL)
          (|a| NIL) (#2=#:G401 NIL) (#3=#:G400 NIL) (|b| NIL) (#4=#:G399 NIL)
          (|listBasis| (|List| $)))
         (SEQ
          (LETT |listBasis|
...
(SDEFUN |GCNAALG;genericRightDiscriminant;F;5|
        (($ |Fraction| (|Polynomial| R)))
        (SPROG
         ((|m| (|Matrix| (|Fraction| (|Polynomial| R)))) (#1=#:G411 NIL)
          (|a| NIL) (#2=#:G410 NIL) (#3=#:G409 NIL) (|b| NIL) (#4=#:G408 NIL)
          (|listBasis| (|List| $)))
         (SEQ
          (LETT |listBasis|
                (SPADCALL (SPADCALL (QREFELT $ 55)) (QREFELT $ 58)))
...
(SDEFUN |GCNAALG;generic;VV$;19|
        ...
        (SPROG
         ((|v| (|Vector| (|Polynomial| R))) (#1=#:G448 NIL) (#2=#:G450 NIL)
          (|i| NIL) (#3=#:G449 NIL))
         (SEQ
          (COND
...
(SDEFUN |GCNAALG;generic;SV$;20| ((|s| |Symbol|) (|ve| |Vector| $) ($ $))
        (SPROG
         ((|sFC| (|Vector| (|Symbol|))) (#1=#:G457 NIL) (#2=#:G459 NIL)
          (|i| NIL) (#3=#:G458 NIL) (|lON| (|List| (|String|))) (#4=#:G456 NIL)
          (|q| NIL) (#5=#:G455 NIL))
         (SEQ
          (LETT |lON|
                (PROGN
...
(SDEFUN |GCNAALG;generic;V$;21| ((|ve| |Vector| $) ($ $))
        (SPROG
         ((|v| (|Vector| (|Polynomial| R))) (#1=#:G471 NIL) (#2=#:G473 NIL)
          (|i| NIL) (#3=#:G472 NIL) (|sFC| (|Vector| (|Symbol|)))
          (#4=#:G468 NIL) (#5=#:G470 NIL) (#6=#:G469 NIL)
          (|lON| (|List| (|String|))) (#7=#:G467 NIL) (|q| NIL)
          (#8=#:G466 NIL))
         (SEQ
          (LETT |lON|
                (PROGN
...
(DEFUN |GenericNonAssociativeAlgebra| (&REST #1=#:G491)
  (SPROG NIL
         (PROG (#2=#:G492)
           (RETURN
            (COND
...
(DEFUN |GenericNonAssociativeAlgebra;| (|#1| |#2| |#3| |#4|)
  (SPROG
   ((|v| NIL) (#1=#:G488 NIL) (#2=#:G490 NIL) (|i| NIL) (#3=#:G489 NIL)
    (#4=#:G485 NIL) (#5=#:G487 NIL) (#6=#:G486 NIL) (#7=#:G484 NIL) (|q| NIL)
    (#8=#:G483 NIL) (|pv$| NIL) ($ NIL) (|dv$| NIL) (DV$4 NIL) (DV$3 NIL)
    (DV$2 NIL) (DV$1 NIL))
   (SEQ
    (PROGN
