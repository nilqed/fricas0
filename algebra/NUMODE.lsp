...
(SDEFUN |NUMODE;rk4a;VI4FIMV;1|
        ((|ystart| |Vector| (|Float|)) (|nvar| . #1=(|Integer|))
         ...
         ($ |Void|))
        (SPROG
         ((#3=#:G420 NIL) (|i| NIL) (#4=#:G416 NIL) (|x| #2#) (#5=#:G419 NIL)
          (#6=#:G418 NIL) (|iter| NIL) (#7=#:G417 NIL)
          (|outlist| (|List| (|OutputForm|))) (|m| #1#) (|tiny| (|Float|))
          (|step|
           (|Record| (|:| |to_try| (|Float|)) (|:| |did| (|Float|))
                     (|:| |next| (|Float|))))
          (|t6| #8=(|Vector| (|Float|))) (#9=#:G399 NIL) (|t5| #8#)
          (#10=#:G397 NIL) (|t4| #8#) (#11=#:G395 NIL) (|t3| #8#)
          (#12=#:G393 NIL) (|t2| #8#) (#13=#:G391 NIL) (|t1| #8#)
          (#14=#:G389 NIL) (|dydx| #8#) (#15=#:G387 NIL) (|yscal| #8#)
          (#16=#:G385 NIL) (|y| #8#) (#17=#:G383 NIL))
         (SEQ
          (LETT |y|
                (MAKEARR1
                 (PROG1 (LETT #17# |nvar|)
                 ...
                 (SEQ (SPADCALL |dydx| |y| |x| |derivs|)
                      ...
                      (COND
                       ((SPADCALL (SPADCALL |x| |x2| (QREFELT $ 21))
                                  (SPADCALL 0 0 10 (QREFELT $ 10))
                                  (QREFELT $ 26))
                        (PROGN (LETT #4# |$NoValue|) (GO #18=#:G409))))
...
(SDEFUN |NUMODE;rk4qc;VIFRFVMV;2|
        ((|y| |Vector| (|Float|)) (|n| |Integer|) (|x| |Float|)
         ...
         ($ |Void|))
        (SPROG
         ((|t7| #1=(|Vector| (|Float|))) (#2=#:G435 NIL) (|t6| #1#)
          (#3=#:G433 NIL) (|t5| #1#) (#4=#:G431 NIL) (|t4| #1#) (#5=#:G429 NIL)
          (|t3| #1#) (#6=#:G427 NIL) (|t2| #1#) (#7=#:G425 NIL) (|t1| #1#)
          (#8=#:G423 NIL))
         (SEQ
          (LETT |t1|
                (MAKEARR1
...
(SDEFUN |NUMODE;rk4qclocal|
        ...
        (SPROG
         ((#4=#:G471 NIL) (|i| NIL) (#5=#:G468 NIL) (|h| #3#)
          (|errmax| #6=(|Float|)) (#7=#:G470 NIL) (|hh| (|Float|))
          (#8=#:G469 NIL) (|m| #1#) (|errcon| #6#) (|shrink| #9=(|Float|))
...
(SDEFUN |NUMODE;rk4f;VI2FIMV;5|
        ((|y| |Vector| (|Float|)) (|nvar| |Integer|) (|x1| . #1=(|Float|))
         ...
         ($ |Void|))
        (SPROG
         ((|x| #1#) (#2=#:G489 NIL) (|i| NIL) (|h| (|Float|))
          (|ynew| #3=(|Vector| (|Float|))) (#4=#:G481 NIL) (|dydx| #3#)
          (#5=#:G479 NIL) (|dym| #3#) (#6=#:G477 NIL) (|dyt| #3#)
          (#7=#:G475 NIL) (|yt| #3#) (#8=#:G473 NIL))
         (SEQ
          (LETT |yt|
                (MAKEARR1
                 (PROG1 (LETT #8# |nvar|)
...
(SDEFUN |NUMODE;rk4;VI2FMV;6|
        ((|y| |Vector| (|Float|)) (|n| |Integer|) (|x| |Float|) (|h| |Float|)
         ...
         ($ |Void|))
        (SPROG
         ((|t4| #1=(|Vector| (|Float|))) (#2=#:G497 NIL) (|t3| #1#)
          (#3=#:G495 NIL) (|t2| #1#) (#4=#:G493 NIL) (|t1| #1#)
          (#5=#:G491 NIL))
         (SEQ
          (LETT |t1|
                (MAKEARR1
...
(SDEFUN |NUMODE;rk4local|
        ...
        (SPROG
         ((#2=#:G518 NIL) (|i| NIL) (#3=#:G517 NIL) (#4=#:G516 NIL)
          (#5=#:G515 NIL) (|m| #1#) (|xh| (|Float|)) (|h6| (|Float|))
          (|hh| (|Float|)))
         (SEQ
          (LETT |hh|
