...
(SDEFUN |RMATCAT-;random;S;2| (($ S))
        (SPROG
         ((#1=#:G398 NIL) (|i| NIL) (#2=#:G397 NIL) (#3=#:G396 NIL) (|j| NIL)
          (#4=#:G395 NIL))
         (SEQ
          (SPADCALL
           (PROGN
...
(SDEFUN |RMATCAT-;lookup;SPi;3| ((|x| S) ($ |PositiveInteger|))
        (SPROG
         ((#1=#:G402 NIL) (|pow| (|Integer|)) (|res| (|Integer|))
          (#2=#:G406 NIL) (|c| NIL) (#3=#:G405 NIL) (|r| NIL)
         ...
         ((|res| (|List| (|List| R)))
          (|old|
           (|Record| (|:| |quotient| (|Integer|))
                     (|:| |remainder| (|Integer|))))
          (|row| (|List| R)) (|el| (R)) (#1=#:G408 NIL) (#2=#:G416 NIL)
          (|j| NIL) (#3=#:G415 NIL) (|s| (|NonNegativeInteger|)))
