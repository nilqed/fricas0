...
(SDEFUN |DELTAC;dim1todim0|
        ((|dim1| |List| (|List| (|Integer|))) (|n| . #1=(|NonNegativeInteger|))
         ($ |List| (|List| (|Integer|))))
        (SPROG
         ((|res| (|List| (|List| (|Integer|)))) (#2=#:G414 NIL) (|x| NIL)
          (#3=#:G413 NIL) (|m3| (|NonNegativeInteger|)) (#4=#:G401 NIL)
          (#5=#:G412 NIL) (|m2| NIL) (#6=#:G411 NIL) (|smp| NIL)
          (|pointsUsed| (|List| (|Boolean|))) (|m| #1#) (#7=#:G397 NIL)
          (#8=#:G410 NIL) (#9=#:G409 NIL))
         (SEQ (LETT |m| |n|)
...
(SDEFUN |DELTAC;deltaComplex;FscB$;4|
        ...
        (SPROG
         ((|vs| #1=(|List| VS)) (|previousFaceList| (|List| (|OrientedFacet|)))
          ...
          (|newIndexes| (|List| (|Integer|))) (|i| (|Integer|)) (#2=#:G454 NIL)
          (|oldFaceLow| NIL) (|oldFacesLow| (|List| (|OrientedFacet|)))
          (#3=#:G453 NIL) (|oldFaceHigh| NIL) (#4=#:G452 NIL) (|x| NIL)
          (#5=#:G451 NIL) (|m3| (|NonNegativeInteger|)) (#6=#:G426 NIL)
          (#7=#:G450 NIL) (|m2| NIL) (#8=#:G449 NIL) (|smp| NIL)
          (|pointsUsed| (|List| (|Boolean|))) (|m| #9=(|NonNegativeInteger|))
          (#10=#:G422 NIL) (#11=#:G448 NIL) (#12=#:G447 NIL)
          (|map2| (|List| (|List| (|Integer|)))) (|fm| (|List| (|Integer|)))
          (#13=#:G446 NIL) (#14=#:G444 NIL) (|gradeList| NIL) (#15=#:G445 NIL)
          (|grn| NIL) (|allFacetsGraded| (|List| (|List| (|OrientedFacet|))))
          (#16=#:G443 NIL) (|l| NIL) (#17=#:G442 NIL)
...
(SDEFUN |DELTAC;deltaComplex;Fcc$;5| ((|fsc| |FiniteCubicalComplex| VS) ($ $))
        (SPROG
         ((|fp| (|List| (|List| (|List| (|Integer|)))))
          ...
          (|faceMaps| (|List| (|List| (|List| (|Integer|)))))
          (|map1| (|List| (|List| (|Integer|))))
          (|newIndexes| (|List| (|Integer|))) (|i| (|Integer|)) (#1=#:G471 NIL)
          (|oldFaceLow| NIL) (|oldFacesLow| (|List| (|CubicalFacet|)))
          (#2=#:G470 NIL) (|oldFaceHigh| NIL) (#3=#:G468 NIL) (|gradeList| NIL)
          (#4=#:G469 NIL) (|grn| NIL)
          (|allFacetsGraded| (|List| (|List| (|CubicalFacet|))))
          (#5=#:G467 NIL) (|gradedList| NIL)
...
(SDEFUN |DELTAC;faceMap;$NniL;8|
        ...
        (SPROG
         ((#1=#:G479 NIL) (|maps1| (|List| (|List| (|List| (|Integer|))))))
         (SEQ
          (EXIT
...
(SDEFUN |DELTAC;chain;$Cc;9| ((|s| $) ($ |ChainComplex|))
        (SPROG
         ((|res| (|List| (|Matrix| (|Integer|)))) (|m| (|Matrix| (|Integer|)))
          ...
          (|v2| (|Integer|)) (#1=#:G491 NIL) (|v| NIL) (#2=#:G489 NIL)
          (|u| NIL) (#3=#:G490 NIL) (|nu| NIL)
          (|n_cols| (|NonNegativeInteger|)) (#4=#:G488 NIL) (|faces| NIL)
...
(SDEFUN |DELTAC;oneSkeleton;$Ug;13|
        ...
        (SPROG
         ((|nodes|
          ...
          (|to1| #3=(|NonNegativeInteger|)) (|from1| #3#) (#4=#:G508 NIL)
...
(SDEFUN |DELTAC;linksInTree|
        ((|res| |List| (|List| (|Integer|))) (|a| |Tree| (|Integer|))
         ($ |List| (|List| (|Integer|))))
        (SPROG
         ((#1=#:G516 NIL) (|x| NIL) (|newLink| (|List| #2=(|Integer|)))
          (|toNode| #2#) (#3=#:G515 NIL) (|fromNode| #2#))
...
(SDEFUN |DELTAC;containsEdge?|
        ((|edge| |List| (|Integer|)) (|edges| |List| (|List| (|Integer|)))
         ($ |Boolean|))
        (SPROG
         ((#1=#:G527 NIL) (|t2| #2=(|Integer|)) (|s2| #2#) (#3=#:G528 NIL)
          (|e| NIL) (|t| #2#) (|s| #2#))
         (SEQ
          (EXIT
           (SEQ
            (COND
             ((< (LENGTH |edge|) 2) (PROGN (LETT #1# NIL) (GO #4=#:G526))))
...
(SDEFUN |DELTAC;fundamentalGroup;$2BGp;17|
        ((|s| $) (|simplify| |Boolean|) (|trace| |Boolean|)
         ($ |GroupPresentation|))
        (SPROG
         ((#1=#:G542 NIL) (|gp| (|GroupPresentation|))
          (|generators| (|List| (|NonNegativeInteger|))) (#2=#:G549 NIL)
          (|x| NIL) (|m| (|NonNegativeInteger|))
          (|rules| (|List| (|List| (|Integer|)))) (|rule| (|List| (|Integer|)))
          (#3=#:G548 NIL) (|vertn| NIL) (#4=#:G547 NIL) (|t| NIL)
          (|polygons| #5=(|List| (|List| (|Integer|)))) (#6=#:G545 NIL)
          (|edge| NIL) (#7=#:G546 NIL) (|edgen| NIL)
          (|edgesInTree| (|List| (|Boolean|))) (#8=#:G544 NIL) (|y| NIL)
          (#9=#:G543 NIL) (|res| (|List| (|List| (|Integer|)))) (|edges| #5#)
          (|span| (|Tree| (|Integer|)))
         ...
         (SEQ
          (EXIT
           (SEQ
            ...
            (COND ((NULL |simplify|) (PROGN (LETT #1# |gp|) (GO #10=#:G541))))
...
(SDEFUN |DELTAC;equalSimplex|
        ...
        (SPROG
         ((|offset| (|Integer|)) (#1=#:G557 NIL) (#2=#:G558 NIL) (|n| NIL)
...
(SDEFUN |DELTAC;=;2$B;19| ((|a| $) (|b| $) ($ |Boolean|))
        (SPROG
         ((#1=#:G562 NIL) (|len| (|NonNegativeInteger|))
