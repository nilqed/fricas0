...
(SDEFUN |MLIFT;corrPoly;SupLLLLMU;1|
        ...
        (SPROG
         ((|diff| (|SparseUnivariatePolynomial| P)) (#2=#:G435 NIL)
          (#3=#:G434 #4=(|SparseUnivariatePolynomial| P)) (#5=#:G436 #4#)
          (#6=#:G455 NIL) (|i| NIL)
          (|lcoef| (|List| (|SparseUnivariatePolynomial| P))) (#7=#:G454 NIL)
          (#8=#:G453 NIL) (|beta| (|List| (|SparseUnivariatePolynomial| P)))
          (#9=#:G443 NIL)
          (|fbeta|
           #10=(|Union| (|List| (|SparseUnivariatePolynomial| P)) "failed"))
          (|ddiff| #11=(|SparseUnivariatePolynomial| P))
          (|pol| (|SparseUnivariatePolynomial| P)) (#12=#:G452 NIL) (|l| NIL)
          (#13=#:G408 NIL) (#14=#:G407 #4#) (#15=#:G409 #4#) (#16=#:G451 NIL)
          (|polc| (|SparseUnivariatePolynomial| P))
          (|listcong| (|List| (|SparseUnivariatePolynomial| P)))
          (#17=#:G404 NIL) (#18=#:G403 #19=(|SparseUnivariatePolynomial| P))
          (#20=#:G405 #19#) (#21=#:G450 NIL) (#22=#:G449 NIL) (#23=#:G448 NIL)
          (|flcoef| #10#) (|um| #11#)
          (|listpolv| (|List| (|SparseUnivariatePolynomial| P)))
          (#24=#:G447 NIL) (|f1| NIL) (#25=#:G446 NIL) (|y| (OV)) (|a| (P))
          (|np| (|NonNegativeInteger|)) (|deg1| (|NonNegativeInteger|))
          (#26=#:G445 NIL) (|mp| NIL) (#27=#:G444 NIL)
           ...
           (COND
            ((EQL (LENGTH |lvar|) 0)
             (SEQ
              ...
              (COND
               ((QEQCAR |lp| 1)
                (PROGN (LETT #9# (CONS 1 "failed")) (GO #28=#:G442))))
              (EXIT
               (LETT |lcoef|
                     (CONS 0
                           (PROGN
...
(SDEFUN |MLIFT;lifting1|
        ((|m| |SparseUnivariatePolynomial| P) (|lvar| . #1=(|List| OV))
         ...
         ($ |Union| (|List| (|SparseUnivariatePolynomial| P)) "failed"))
        (SPROG
         ((#5=#:G488 NIL) (|idegj| (|Integer|)) (#6=#:G507 NIL) (|term| NIL)
          (#7=#:G505 NIL) (#8=#:G506 NIL) (|alpha| NIL) (#9=#:G504 NIL)
          (|lalpha| #10=(|List| (|SparseUnivariatePolynomial| P)))
          (|flalpha|
           (|Union| (|List| (|SparseUnivariatePolynomial| P)) "failed"))
          (|mc| (|SparseUnivariatePolynomial| P)) (#11=#:G487 NIL)
          (#12=#:G470 NIL) (#13=#:G469 #2#) (#14=#:G471 #2#) (#15=#:G503 NIL)
          (|pol| (P)) (#16=#:G502 NIL) (|k| NIL) (|polc| (P))
          (|mj| (|SparseUnivariatePolynomial| P)) (#17=#:G500 NIL) (|tpol| NIL)
          (#18=#:G501 NIL) (|clist| NIL) (#19=#:G499 NIL) (#20=#:G497 NIL)
          (|p| NIL) (#21=#:G498 NIL) (|lcp| NIL) (#22=#:G496 NIL)
          (|clv|
           (|List|
            (|List|
             (|Record| (|:| |expt| (|NonNegativeInteger|)) (|:| |pcoef| P)))))
          (|tlv| (|List| P)) (|#G41| #4#) (|#G40| #3#) (#23=#:G495 NIL)
          (#24=#:G494 NIL) (#25=#:G493 NIL) (#26=#:G492 NIL) (#27=#:G491 NIL)
          (#28=#:G490 NIL) (|subsval| (|List| R)) (|subsvar| (|List| OV))
          (|ldeg| (|List| (|NonNegativeInteger|)))
          (|degj| (|NonNegativeInteger|)) (|v| (R)) (|conglist| #10#)
          (|li| #1#) (|x| (OV)) (#29=#:G489 NIL) (|j| NIL)
         ...
         ((#1=#:G538 NIL)
          ...
          (|coeflist|
           (|List|
            (|List|
             (|Record| (|:| |expt| (|NonNegativeInteger|)) (|:| |pcoef| P)))))
          (#2=#:G526 NIL) (#3=#:G523 NIL)
          (#4=#:G522 #5=(|SparseUnivariatePolynomial| P)) (#6=#:G524 #5#)
          (#7=#:G543 NIL) (|pol| NIL)
          (|nplist| (|List| (|SparseUnivariatePolynomial| P))) (#8=#:G542 NIL)
          (|pp| NIL) (#9=#:G541 NIL)
                  ...
                  (SEQ
                   (COND
                    ((EQL (LENGTH |listdet|) (LENGTH |plist|))
                     (PROGN (LETT #1# (CONS 0 |listdet|)) (GO #12=#:G537))))
...
(SDEFUN |MLIFT;gen_solv|
        ...
        (SPROG
         ((|table| (|Vector| (|List| (|SparseUnivariatePolynomial| R))))
          ...
          (|ldeg| (|List| (|NonNegativeInteger|))) (#1=#:G563 NIL) (|p| NIL)
          (#2=#:G562 NIL))
         (SEQ
          (LETT |ldeg|
                (PROGN
...
(SDEFUN |MLIFT;subscoef|
        ...
        (SPROG
         ((|new| (|SparseUnivariatePolynomial| P)) (|i| (|NonNegativeInteger|))
          (#1=#:G586 NIL) (|k| NIL) (|dm| (|NonNegativeInteger|)))
...
(DEFUN |MultivariateLifting| (&REST #1=#:G593)
  (SPROG NIL
         (PROG (#2=#:G594)
           (RETURN
            (COND
