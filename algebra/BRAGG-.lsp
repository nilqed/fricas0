...
(SDEFUN |BRAGG-;isCycle?| ((|x| A) (|acc| |List| A) ($ |Boolean|))
        (SPROG ((#1=#:G469 NIL) (#2=#:G470 NIL) (#3=#:G471 NIL) (|y| NIL))
               (SEQ
                (EXIT
                 (COND ((SPADCALL |x| (QREFELT $ 15)) NIL)
...
(SDEFUN |BRAGG-;eqMember?| ((|y| A) (|l| |List| A) ($ |Boolean|))
        (SPROG ((#1=#:G476 NIL) (#2=#:G477 NIL) (#3=#:G478 NIL) (|x| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ
                          ...
                          (EXIT
                           (COND
                            ((SPADCALL |x| |y| (QREFELT $ 48))
                             (PROGN
                              (LETT #1# (PROGN (LETT #2# 'T) (GO #4=#:G475)))
                              (GO #5=#:G473))))))
