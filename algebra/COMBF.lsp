...
(SDEFUN |COMBF;K2fact| ((|k| |Kernel| F) (|l| |List| (|Symbol|)) ($ F))
        (SPROG
         ((|p| (F)) (|n| (F)) (|args| (|List| F)) (#1=#:G475 NIL) (|a| NIL)
          (#2=#:G474 NIL) (#3=#:G473 NIL) (|kf| (F)) (|v| NIL) (#4=#:G472 NIL))
         (SEQ
          (COND
           ((OR
             (NULL
...
(SDEFUN |COMBF;iidsum;LF;37| ((|l| |List| F) ($ F))
        (SPROG
         ((#1=#:G514 NIL) (#2=#:G513 (F)) (#3=#:G515 (F)) (#4=#:G519 NIL)
          (|i| NIL) (#5=#:G518 NIL) (|k| (|Union| (|Kernel| F) #6="failed"))
           ...
           (SEQ
            (SEQ (LETT |r1| (SPADCALL (|COMBF;fourth| |l| $) (QREFELT $ 100)))
                 (EXIT
                  (COND
                   ((QEQCAR |r1| 1)
                    (PROGN (LETT #5# (|COMBF;idsum| |l| $)) (GO #8=#:G516)))
                   (#9='T
                    (SEQ
                     (LETT |r2|
                           (SPADCALL (|COMBF;fourth| (CDR |l|) $)
...
(SDEFUN |COMBF;iidprod;LF;38| ((|l| |List| F) ($ F))
        (SPROG
         ((#1=#:G530 NIL) (#2=#:G529 (F)) (#3=#:G531 (F)) (#4=#:G535 NIL)
          (|i| NIL) (#5=#:G534 NIL) (|k| (|Union| (|Kernel| F) #6="failed"))
          (|r2| #7=(|Union| (|Integer|) #6#)) (|r1| #7#))
         (SEQ
          (EXIT
           (SEQ
            (SEQ (LETT |r1| (SPADCALL (|COMBF;fourth| |l| $) (QREFELT $ 100)))
                 (EXIT
                  (COND
                   ((QEQCAR |r1| 1)
                    (PROGN (LETT #5# (|COMBF;idprod| |l| $)) (GO #8=#:G532)))
                   (#9='T
                    (SEQ
                     (LETT |r2|
                           (SPADCALL (|COMBF;fourth| (CDR |l|) $)
...
(SDEFUN |COMBF;iiperm;LF;44| ((|l| |List| F) ($ F))
        (SPROG ((#1=#:G582 NIL) (|r2| #2=(|Union| R "failed")) (|r1| #2#))
               (SEQ
                (EXIT
                 (SEQ
...
(SDEFUN |COMBF;iibinom;LF;45| ((|l| |List| F) ($ F))
        (SPROG
         ((#1=#:G601 NIL) (|r2| #2=(|Union| R #3="failed")) (|r1| #2#)
          (|ans| (F)) (#4=#:G603 NIL) (|i| NIL) (|t| (|Union| (|Integer|) #3#))
          (|s| #2#) (#5=#:G602 NIL))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |COMBF;iibinom;LF;46| ((|l| |List| F) ($ F))
        (SPROG ((#1=#:G611 NIL) (|r2| #2=(|Union| R "failed")) (|r1| #2#))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ (LETT |r1| (SPADCALL (|SPADfirst| |l|) (QREFELT $ 116)))
...
(SDEFUN |COMBF;iibinom;LF;47| ((|l| |List| F) ($ F))
        (SPROG ((#1=#:G619 NIL) (|r2| #2=(|Union| R "failed")) (|r1| #2#))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ (LETT |r1| (SPADCALL (|SPADfirst| |l|) (QREFELT $ 116)))
...
(SDEFUN |COMBF;iipow;LF;51| ((|l| |List| F) ($ F))
        (SPROG ((#1=#:G630 NIL) (|r2| #2=(|Union| R "failed")) (|r1| #2#))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ (LETT |r1| (SPADCALL (|SPADfirst| |l|) (QREFELT $ 116)))
...
(DEFUN |CombinatorialFunction| (&REST #1=#:G685)
  (SPROG NIL
         (PROG (#2=#:G686)
           (RETURN
            (COND
