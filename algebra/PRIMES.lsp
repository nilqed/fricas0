...
(SDEFUN |PRIMES;primes;2IL;1| ((|m| I) (|n| I) ($ |List| I))
        (SPROG
         ((|ll| (|List| I)) (#1=#:G415 NIL) (|k| NIL) (#2=#:G414 NIL)
          (|m0| (I)))
         (SEQ
          (COND
...
(SDEFUN |PRIMES;rabinProvesCompositeSmall|
        ((|p| I) (|n| I) (|nm1| I) (|q| I) (|k| |NonNegativeInteger|)
         ($ |Boolean|))
        (SPROG
         ((#1=#:G422 NIL) (#2=#:G421 NIL) (|t| (I)) (|oldt| (I))
          (#3=#:G423 NIL) (|j| NIL))
         (SEQ
          (EXIT
...
(SDEFUN |PRIMES;rabinProvesComposite|
        ((|p| I) (|n| I) (|nm1| I) (|q| I) (|k| |NonNegativeInteger|)
         ($ |Boolean|))
        (SPROG
         ((#1=#:G431 NIL) (#2=#:G430 NIL) (|t| (I)) (|oldt| (I))
          (#3=#:G432 NIL) (|j| NIL))
         (SEQ
          (EXIT
           (SEQ (LETT |t| (SPADCALL |p| |q| |n| (QREFELT $ 43)))
...
(SDEFUN |PRIMES;prime?;IB;4| ((|n| I) ($ |Boolean|))
        (SPROG
         ((#1=#:G464 NIL) (#2=#:G467 NIL) (|probablySafe| (I))
          (|currPrime| (I)) (#3=#:G466 NIL) (|n9| (I)) (#4=#:G465 NIL)
          (#5=#:G468 NIL) (|i| NIL) (|mn| (|Integer|)) (|q| (I)) (|k| NIL)
          (|nm1| (I)))
         (SEQ
          (EXIT
           (SEQ
...
(DEFUN |IntegerPrimesPackage| (#1=#:G480)
  (SPROG NIL
         (PROG (#2=#:G481)
           (RETURN
            (COND
...
(DEFUN |IntegerPrimesPackage;| (|#1|)
  (SPROG
   ((#1=#:G408 NIL) (#2=#:G407 NIL) (#3=#:G409 NIL) (#4=#:G479 NIL)
    (#5=#:G378 NIL) (|pv$| NIL) ($ NIL) (|dv$| NIL) (DV$1 NIL))
   (SEQ
    (PROGN
