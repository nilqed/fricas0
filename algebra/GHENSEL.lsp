...
(SDEFUN |GHENSEL;GenExEuclid|
        ...
        (SPROG
         ((#1=#:G433 NIL) (|clp| NIL) (#2=#:G434 NIL) (|flp| NIL)
          (#3=#:G432 NIL))
         (SEQ
          (PROGN
           (LETT #3# NIL)
...
(SDEFUN |GHENSEL;genFact|
        ((|fln| |List| TP) (|factlist| |List| (|List| TP))
         ($ |List| (|List| TP)))
        (SPROG
         ((|auxfl| (|List| (|List| TP))) (#1=#:G505 NIL)
          (#2=#:G504 #3=(|NonNegativeInteger|)) (#4=#:G506 #3#) (#5=#:G520 NIL)
          (|f| NIL) (#6=#:G519 NIL) (|term| NIL) (|dp| #3#) (#7=#:G518 NIL)
          (#8=#:G517 NIL) (#9=#:G516 NIL) (|poly| NIL)
          (|maxd| (|NonNegativeInteger|)) (#10=#:G476 NIL) (#11=#:G475 #3#)
          (#12=#:G477 #3#) (#13=#:G515 NIL) (#14=#:G514 NIL) (|pol| NIL)
          (#15=#:G513 NIL))
         (SEQ
          (COND
...
(SDEFUN |GHENSEL;HenselLift1|
        ...
        (SPROG
         ((#1=#:G530 NIL) (|flp| NIL) (#2=#:G531 NIL) (|vlp| NIL)
          (#3=#:G529 NIL) (|vl| (|List| FP)) (|lcinv| (FP)) (|rhs| (FP))
          (#4=#:G522 NIL) (#5=#:G521 (TP)) (#6=#:G523 (TP)) (#7=#:G528 NIL)
          (#8=#:G378 NIL) (|lcp| (RP)))
...
(SDEFUN |GHENSEL;HenselLift;TPLRPPiR;10|
        ...
        (SPROG
         ((|fln| (|List| TP)) (|Modulus| (RP)) (#1=#:G565 NIL) (|err| (TP))
          (#2=#:G556 NIL) (#3=#:G555 (TP)) (#4=#:G557 (TP)) (#5=#:G570 NIL)
          (#6=#:G379 NIL) (|nfln| (|List| TP)) (|lcinv| (RP)) (#7=#:G569 NIL)
          (|ffl1| NIL) (#8=#:G568 NIL) (|cl1| (|List| FP)) (#9=#:G537 NIL)
          (|fl1| (|List| FP)) (#10=#:G567 NIL) (|ttl| NIL) (#11=#:G566 NIL)
          (|constp| (TP)))
                       ...
                       ((SPADCALL |fln| |nfln| (QREFELT $ 54))
                        (COND
                         ((SPADCALL
                           ...
                           (QREFELT $ 55))
                          (EXIT
                           (PROGN (LETT #1# |$NoValue|) (GO #12=#:G560)))))))
                      (LETT |fln| |nfln|)
                      (EXIT
                       (LETT |Modulus|
...
(SDEFUN |GHENSEL;completeHensel;TPLRPPiL;11|
        ...
        (SPROG
         ((|finallist| (|List| TP)) (|factlist| (|List| #1=(|List| TP)))
          (|fln| #2=(|List| TP)) (#3=#:G599 NIL) (|term| NIL) (#4=#:G598 NIL)
          (|auxfl| (|List| #1#)) (#5=#:G597 NIL) (#6=#:G596 NIL)
          (|aux| (|List| TP)) (#7=#:G595 NIL) (|poly| (TP))
          (|dfn| #8=(|NonNegativeInteger|)) (|mm| (TP)) (|lcm1| (RP))
          (|poly1| (TP)) (|u| (|Union| TP "failed")) (|pol| (TP))
          (#9=#:G576 NIL) (#10=#:G575 (TP)) (#11=#:G577 (TP)) (#12=#:G594 NIL)
          (|tc| (RP)) (#13=#:G573 NIL) (#14=#:G572 (RP)) (#15=#:G574 (RP))
          (#16=#:G593 NIL) (|auxl| (|List| TP)) (|nm| #8#) (|Modulus| (RP))
...
(DEFUN |GeneralHenselPackage| (&REST #1=#:G600)
  (SPROG NIL
         (PROG (#2=#:G601)
           (RETURN
            (COND
