...
(SDEFUN |VHPSOLV;hp_solve;LLNniM;2|
        ((|lv| |List|
         ...
         ($ |Matrix|
          (|SparseUnivariatePolynomial| (|Expression| (|Integer|)))))
        (SPROG
         ((#1=#:G412 NIL) (|j| NIL) (|i1| #2=(|NonNegativeInteger|))
          (#3=#:G411 NIL) (|i| NIL)
          (|res|
           (|Matrix|
            (|SparseUnivariatePolynomial| (|Expression| (|Integer|)))))
          (|n1| #2#) (#4=#:G410 NIL) (|n| (|NonNegativeInteger|))
          (|res1|
           (|Matrix|
            (|SparseUnivariatePolynomial| (|Expression| (|Integer|)))))
          (C (|List| (|Expression| (|Integer|)))) (#5=#:G409 NIL)
          (#6=#:G408 NIL) (|vd| (|Vector| (|Integer|))) (#7=#:G407 NIL)
          (|ei| NIL) (#8=#:G406 NIL)
          (|lpp|
