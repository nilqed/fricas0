        ...
        ((|a| |SparseUnivariatePolynomial| F)
         ...
         ($ |Union|
          ...
          (|Record| (|:| |ans| (|List| (|SparseUnivariatePolynomial| F)))
                    ...
                    (|:| |dpar| (|Integer|)))))
        (SPROG
         ((#1=#:G413 NIL) (|s1| NIL) (#2=#:G414 NIL)
          (|r| #3=(|SparseUnivariatePolynomial| F)) (#4=#:G412 NIL)
          (#5=#:G410 NIL) (|s2| NIL) (#6=#:G411 NIL) (#7=#:G409 NIL)
          (|dres|
           (|Record| (|:| |ans| (|List| (|SparseUnivariatePolynomial| F)))
                     (|:| |acoeff| (|SparseUnivariatePolynomial| F))
                     (|:| |eegen| (|SparseUnivariatePolynomial| F))
...
(SDEFUN |RDEAUX;SPDE1;2SupMR;2|
        ...
        (SPROG
         ((|q| (|SparseUnivariatePolynomial| F))
          (|qq| (|SparseUnivariatePolynomial| F)) (#1=#:G416 NIL)
          (#2=#:G422 NIL) (|n| (|Integer|)) (|lb| (F)) (|db| (|Integer|)))
         (SEQ
          (EXIT
                ...
                (SEQ G190
                     ...
                     (SEQ (LETT |n| (- (SPADCALL |c| (QREFELT $ 25)) |db|))
                          (EXIT
                           (COND
                            ((< |n| 0)
                             (PROGN (LETT #2# (CONS |q| |c|)) (GO #3=#:G421)))
                            ('T
                             (SEQ
                              (LETT |qq|
                                    (SPADCALL
