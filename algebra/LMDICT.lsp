...
(SDEFUN |LMDICT;duplicates?;$B;18| ((|s| $) ($ |Boolean|))
        (SPROG ((|q| (|List| S)) (|p| (|List| S)) (#1=#:G436 NIL))
               (SEQ
                (EXIT
...
(SDEFUN |LMDICT;duplicates;$L;21|
        ...
        (SPROG
         ((|ld|
           (|List|
            (|Record| (|:| |entry| S) (|:| |count| (|NonNegativeInteger|)))))
          (|n| (|NonNegativeInteger|)) (#1=#:G455 NIL) (|x| NIL))
         (SEQ (LETT |ld| NIL)
              (SEQ (LETT |x| NIL)
                   (LETT #1#
                         (SPADCALL (SPADCALL |lmd| (QREFELT $ 12))
...
(DEFUN |ListMultiDictionary| (#1=#:G501)
  (SPROG NIL
         (PROG (#2=#:G502)
           (RETURN
            (COND
...
(DEFUN |ListMultiDictionary;| (|#1|)
  (SPROG
   ((#1=#:G500 NIL) (#2=#:G499 NIL) (|pv$| NIL) (#3=#:G496 NIL) (#4=#:G497 NIL)
    (#5=#:G498 NIL) ($ NIL) (|dv$| NIL) (DV$1 NIL))
   (PROGN
