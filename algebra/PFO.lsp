...
(SDEFUN |PFO;kbadBadNum|
        ((|d| |SparseUnivariatePolynomial|
         ...
         ($ |Integer|))
        (SPROG ((#1=#:G435 NIL) (|c| NIL) (#2=#:G434 NIL))
               (SEQ
                (SPADCALL
                 (PROGN
                  (LETT #2# NIL)
...
(SDEFUN |PFO;cmult;LSmp;22|
        ...
        (SPROG
         ((#1=#:G463 NIL)
          (#2=#:G462 #3=(|SparseMultivariatePolynomial| R0 (|Kernel| F)))
          (#4=#:G464 #3#) (#5=#:G466 NIL) (#6=#:G378 NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
...
(SDEFUN |PFO;commonDen|
        ...
        (SPROG
         ((|l2| (|List| (|SparseMultivariatePolynomial| R0 (|Kernel| F))))
          (#1=#:G479 NIL) (|c| NIL) (#2=#:G478 NIL) (|l1| (|List| F)))
...
(SDEFUN |PFO;polyred| ((|f| UPUP) ($ UPUP))
        (SPROG ((#1=#:G590 NIL) (|c| NIL) (#2=#:G589 NIL))
               (SEQ
                (SPADCALL
                 (SPADCALL
                  (SPADCALL
...
(SDEFUN |PFO;aklist| ((|f| R) ($ |List| (|Kernel| F)))
        (SPROG
         ((#1=#:G595 NIL) (#2=#:G594 #3=(|List| (|Kernel| F))) (#4=#:G596 #3#)
          (#5=#:G599 NIL) (|c| NIL) (|r| (|Union| (|Fraction| UP) "failed")))
...
(SDEFUN |PFO;alglist0|
        ...
        (SPROG
         ((#1=#:G602 NIL) (#2=#:G601 #3=(|List| (|Kernel| F))) (#4=#:G603 #3#)
          (#5=#:G606 NIL) (|i| (|FractionalIdeal| UP (|Fraction| UP) UPUP R))
          (|n| (|Vector| R)))
         (SEQ
          (LETT |n|
...
(SDEFUN |PFO;alglist|
        ((|d| |FiniteDivisor| F UP UPUP R) ($ |List| (|Kernel| F)))
        (SPROG
         ((|l1| #1=(|List| (|Kernel| F))) (#2=#:G608 NIL) (#3=#:G607 #1#)
          (#4=#:G609 #1#) (#5=#:G612 NIL) (|c| NIL) (|f| (UPUP)))
...
(SDEFUN |PFO;alglist2| ((|f| UPUP) ($ |List| (|Kernel| F)))
        (SPROG
         ((#1=#:G614 NIL) (#2=#:G613 #3=(|List| (|Kernel| F))) (#4=#:G615 #3#)
          (#5=#:G617 NIL) (|c| NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
...
(SDEFUN |PFO;alglist1|
        ...
        (SPROG
         ((#1=#:G619 NIL) (#2=#:G618 #3=(|List| (|Kernel| F))) (#4=#:G620 #3#)
          (#5=#:G623 NIL) (|f| NIL) (|l2| (|List| UPUP)) (|l1| (|List| UPUP)))
...
(SDEFUN |PFO;handle_imaginary;FdR;33|
        ...
        (SPROG
         ((|nd| (UPUP)) (|nva| (|Vector| UPUP)) (#1=#:G838 NIL) (|vi| NIL)
          (#2=#:G837 NIL) (|n| (|Vector| R))
...
(SDEFUN |PFO;handle_imaginary;FdR;34|
        ((|fd| |FiniteDivisor| F UP UPUP R)
         ($ |Record| (|:| |ncurve| UPUP) (|:| |n_div_numer| (|Vector| UPUP))
          (|:| |n_div_denom| UPUP) (|:| |need_change| (|Boolean|))))
        (SPROG
         ((|nva| (|Vector| UPUP)) (#1=#:G844 NIL) (|vi| NIL) (#2=#:G843 NIL)
          (|d| (UP)) (|n| (|Vector| R))
...
(SDEFUN |PFO;handle_imaginary;FdR;35|
        ((|fd| |FiniteDivisor| F UP UPUP R)
         ($ |Record| (|:| |ncurve| UPUP) (|:| |n_div_numer| (|Vector| UPUP))
          (|:| |n_div_denom| UPUP) (|:| |need_change| (|Boolean|))))
        (SPROG
         ((|nva| (|Vector| UPUP)) (#1=#:G850 NIL) (|vi| NIL) (#2=#:G849 NIL)
          (|d| (UP)) (|n| (|Vector| R))
          (|id| (|FractionalIdeal| UP (|Fraction| UP) UPUP R)))
         (SEQ (LETT |id| (SPADCALL |fd| (QREFELT $ 129)))
              (LETT |n| (SPADCALL |id| (QREFELT $ 131)))
...
(SDEFUN |PFO;simplifyCoeffs;RLNni;41|
        ...
        (SPROG
         ((|ndiv| (|nFD|)) (|va| (|Vector| |nR|)) (#2=#:G905 NIL)
          (#3=#:G907 NIL) (|ni| NIL) (#4=#:G906 NIL) (|nd| (|nR|))
          (|nPFO|
           (CATEGORY |package|
            (SIGNATURE |order|
          ...
          (|nf| (UPUP)) (|lrhs| (|List| F)) (#5=#:G904 NIL) (|pol| NIL)
          (#6=#:G903 NIL) (|y| (F))
          (|rec|
           (|Record| (|:| |primelt| F)
                     (|:| |poly| (|List| (|SparseUnivariatePolynomial| F)))
                     (|:| |prim| (|SparseUnivariatePolynomial| F))))
          (#7=#:G902 NIL) (|k| NIL) (#8=#:G901 NIL)
          (|lp| (|List| (|SparseUnivariatePolynomial| F))) (#9=#:G900 NIL)
          (#10=#:G899 NIL))
         (SEQ
          (LETT |lp|
                (PROGN
                 ...
                 (SEQ (LETT |k| NIL) (LETT #9# |la|) G190
                      ...
                      (SEQ
                       (EXIT
                        (LETT #10#
                              (CONS (SPADCALL |k| (QREFELT $ 173)) #10#))))
          ...
          (LETT |va|
                (PROGN
                 (LETT #4#
                       (GETREFV
                        (SIZE
                         #11=(SPADCALL (QVELT |irec| 1) (QREFELT $ 143)))))
...
(SDEFUN |PFO;possibleOrder;FdNni;42|
        ...
        (SPROG
         ((|va| (|Vector| R)) (#1=#:G923 NIL) (#2=#:G925 NIL) (|ni| NIL)
          (#3=#:G924 NIL) (|nden| (R)) (#4=#:G922 NIL)
          (|la| (|List| (|Kernel| F)))
          (|irec|
           (|Record| (|:| |ncurve| UPUP) (|:| |n_div_numer| (|Vector| UPUP))
                     (|:| |n_div_denom| UPUP)
        ...
        ((|rec| |Record|
         ...
         ($ |Record| (|:| |prime| (|PositiveInteger|))
          (|:| |poly|
               (|SparseUnivariatePolynomial| (|Fraction| (|Integer|))))))
        (SPROG
         ((#1=#:G950 NIL) (|p| (|PositiveInteger|)) (#2=#:G952 NIL)
          (|u|
...
(SDEFUN |PFO;goodRed|
        ...
        (SPROG
         ((|md| (|SparseUnivariatePolynomial| (|Fraction| (|Integer|))))
          (|mdg| (|SparseUnivariatePolynomial| |gf|)) (#1=#:G972 NIL)
          (|ff| NIL) (|l| (|List| (|SparseUnivariatePolynomial| |gf|)))
          (#2=#:G971 NIL) (|f| NIL) (#3=#:G970 NIL)
          (|gf|
           (|Join| (|FiniteFieldCategory|) (|FiniteAlgebraicExtensionField| $)
                   (|ConvertibleTo| (|Integer|))
                   (CATEGORY |domain| (SIGNATURE |sqrt| ($ $))
...
(DEFUN |PointsOfFiniteOrder| (&REST #1=#:G980)
  (SPROG NIL
         (PROG (#2=#:G981)
           (RETURN
            (COND
