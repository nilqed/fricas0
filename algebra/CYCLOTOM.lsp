...
(SDEFUN |CYCLOTOM;cyclotomic;ISup;1|
        ...
        (SPROG
         ((|l| (|SparseUnivariatePolynomial| (|Integer|))) (#1=#:G385 NIL)
          (#2=#:G384 NIL) (#3=#:G382 NIL) (#4=#:G390 NIL) (|u| NIL)
          (|g|
           (|List|
...
(SDEFUN |CYCLOTOM;cyclotomicDecomposition;IL;2|
        ...
        (SPROG
         ((|l| (|List| (|SparseUnivariatePolynomial| (|Integer|))))
          ...
          (#1=#:G396 NIL) (#2=#:G409 NIL) (|z| NIL) (#3=#:G408 NIL)
          (#4=#:G407 NIL) (|rr| NIL) (#5=#:G394 NIL) (#6=#:G406 NIL)
          (#7=#:G405 NIL) (#8=#:G404 NIL) (|u| NIL)
          (|g|
           (|List|
            (|Record| (|:| |flag| (|Union| "nil" "sqfr" "irred" "prime"))
                      (|:| |factor| (|Integer|))
