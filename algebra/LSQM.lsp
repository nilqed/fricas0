...
(SDEFUN |LSQM;conv| ((|v| |DirectProduct| |n2| R) ($ |SquareMatrix| |n| R))
        (SPROG
         ((|z| (|Integer|)) (#1=#:G385 NIL) (|j| NIL) (#2=#:G384 NIL) (|i| NIL)
          (|cond| (|Matrix| R)))
         (SEQ
          (LETT |cond|
...
(SDEFUN |LSQM;canonical_coordinates| ((|a| $) ($ |Vector| R))
        (SPROG
         ((|z| (|Integer|)) (#1=#:G392 NIL) (|j| NIL) (#2=#:G391 NIL) (|i| NIL)
...
(SDEFUN |LSQM;coordinates;$VV;4| ((|a| $) (|b| |Vector| $) ($ |Vector| R))
        (SPROG
         ((|canonical| (|Boolean|)) (#1=#:G399 NIL) (|j| NIL)
          (|bv| (|Vector| R)) (#2=#:G398 NIL) (|i| NIL))
...
(SDEFUN |LSQM;basis;V;6| (($ |Vector| $))
        (SPROG
         ((|res| (|Vector| $)) (|ldp| (|List| (|DirectProduct| |n2| R)))
          (#1=#:G403 NIL) (#2=#:G409 NIL) (|i| NIL) (#3=#:G408 NIL))
...
(DEFUN |LieSquareMatrix| (&REST #1=#:G419)
  (SPROG NIL
         (PROG (#2=#:G420)
           (RETURN
            (COND
