...
(SDEFUN |LINCOMB;dehomogenize;LR;1|
        ...
        (SPROG
         ((|res3|
          ...
          (|bv| #1=(|Vector| F)) (|rp| (F)) (|c| (F)) (#2=#:G401 NIL)
          (|be| NIL) (|ppv| #1#) (|ppa| (F)) (|c1inv| (F))
          (|found| (|Boolean|))
          (|be1| (|Record| (|:| |ratpart| F) (|:| |coeffs| (|Vector| F))))
          (|res2|
           (|List| (|Record| (|:| |ratpart| F) (|:| |coeffs| (|Vector| F)))))
          (#3=#:G400 NIL) (|nn| (|NonNegativeInteger|)))
         (SEQ
...
(SDEFUN |LINCOMB;lin_comb;VLF;2| ((|v| |Vector| F) (|lf| |List| F) ($ F))
        (SPROG
         ((|res| (F)) (#1=#:G405 NIL) (|i| NIL) (#2=#:G406 NIL) (|f| NIL))
...
(SDEFUN |LINCOMB;lin_comb;VLF;3|
        ...
        (SPROG
         ((|res| (F)) (#1=#:G410 NIL) (|i| NIL) (#2=#:G411 NIL) (|f| NIL))
         (SEQ (LETT |res| (|spadConstant| $ 16))
              (SEQ (LETT |f| NIL) (LETT #2# |lf|) (LETT |i| 1)
                   (LETT #1# (QVSIZE |v|)) G190
                   (COND
...
(SDEFUN |LINCOMB;lin_comb!;2VLV;4|
        ((|u| |Vector| F) (|v| |Vector| F) (|lw| |List| (|Vector| F))
         ($ |Vector| F))
        (SPROG
         ((#1=#:G419 NIL) (|j| NIL) (|c| (F)) (#2=#:G417 NIL) (|i| NIL)
          (#3=#:G418 NIL) (|w| NIL) (|n| (|NonNegativeInteger|))
          (|res| (|Vector| F)))
...
(SDEFUN |LINCOMB;lin_comb;VLF;6|
        ...
        (SPROG
         ((|res| (|Fraction| UP)) (#1=#:G425 NIL) (|i| NIL) (#2=#:G426 NIL)
          (|f| NIL))
...
(SDEFUN |LINCOMB;lin_comb;VLF;7|
        ((|v| |Vector| (|Fraction| (|Integer|))) (|lg| |List| (|Fraction| UP))
         ($ |Fraction| UP))
        (SPROG
         ((|res| (|Fraction| UP)) (#1=#:G430 NIL) (|i| NIL) (#2=#:G431 NIL)
          (|g| NIL))
         (SEQ (LETT |res| (|spadConstant| $ 45))
...
(SDEFUN |LINCOMB;lin_comb;VLLp;8|
        ...
        (SPROG
         ((|res| (|LaurentPolynomial| F UP)) (#1=#:G435 NIL) (|i| NIL)
          (#2=#:G436 NIL) (|f| NIL))
...
(SDEFUN |LINCOMB;lin_comb;VLUP;9| ((|v| |Vector| F) (|lf| |List| UP) ($ UP))
        (SPROG
         ((|res| (UP)) (#1=#:G440 NIL) (|i| NIL) (#2=#:G441 NIL) (|f| NIL))
...
(DEFUN |LinearCombinationUtilities| (&REST #1=#:G442)
  (SPROG NIL
         (PROG (#2=#:G443)
           (RETURN
            (COND
