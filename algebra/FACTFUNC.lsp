...
(SDEFUN |FACTFUNC;nthRoot;FNniR;1|
        ((|ff| |Factored| M) (|n| |NonNegativeInteger|)
         ($ |Record| (|:| |exponent| (|NonNegativeInteger|)) (|:| |coef| M)
          (|:| |radicand| (|List| M))))
        (SPROG
         ((#1=#:G396 NIL) (|radi| (|List| M)) (|coeff| (M))
          (|qr|
           (|Record| (|:| |quotient| (|NonNegativeInteger|))
                     (|:| |remainder| (|NonNegativeInteger|))))
          (#2=#:G399 NIL) (|term| NIL) (|d| (|NonNegativeInteger|))
          (#3=#:G388 NIL) (#4=#:G398 NIL) (|t| NIL) (#5=#:G397 NIL)
          (|lf|
           (|List|
...
(SDEFUN |FACTFUNC;log;FL;2|
        ...
        (SPROG ((#1=#:G408 NIL) (|term| NIL) (#2=#:G407 NIL) (|ans| (M)))
...
(DEFUN |FactoredFunctions| (#1=#:G409)
  (SPROG NIL
         (PROG (#2=#:G410)
           (RETURN
            (COND
