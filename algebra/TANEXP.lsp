...
(SDEFUN |TANEXP;tanNa;RIR;3| ((|a| R) (|n| |Integer|) ($ R))
        (SPROG
         ((|t| (|Fraction| (|SparseUnivariatePolynomial| R))) (#1=#:G388 NIL))
...
(SDEFUN |TANEXP;tanSum;LR;4| ((|l| |List| R) ($ R))
        (SPROG
         ((#1=#:G396 NIL) (#2=#:G395 (R)) (#3=#:G397 (R)) (#4=#:G402 NIL)
          (|i| NIL) (#5=#:G393 NIL) (#6=#:G392 (R)) (#7=#:G394 (R))
          (#8=#:G401 NIL) (|m| (|Integer|)) (|v| (|Vector| R)))
         (SEQ
...
(SDEFUN |TANEXP;tanPIa|
        ...
        (SPROG
         ((#1=#:G407 NIL) (#2=#:G406 #3=(|SparseUnivariatePolynomial| R))
          (#4=#:G408 #3#) (#5=#:G412 NIL) (|i| NIL) (#6=#:G404 NIL)
          (#7=#:G403 #3#) (#8=#:G405 #3#) (#9=#:G411 NIL) (|m| (|Integer|))
...
(DEFUN |TangentExpansions| (#1=#:G413)
  (SPROG NIL
         (PROG (#2=#:G414)
           (RETURN
            (COND
