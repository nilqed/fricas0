...
(SDEFUN |LISTPKG;splitList;MLR;1|
        ...
        (SPROG
         ((|resno| #1=(|List| T$)) (|resyes| #1#) (#2=#:G399 NIL) (|t| NIL))
         (SEQ
...
(SDEFUN |LISTPKG;topologicalSort;L2L;4|
        ...
        (SPROG
         ((#1=#:G426 NIL) (|p| NIL) (#2=#:G425 NIL)
          ...
          (#4=#:G424 NIL) (|x| NIL) (|x0| (|NonNegativeInteger|))
          (#5=#:G423 NIL) (|n| NIL) (#6=#:G422 NIL))
         (SEQ
          (LETT |xi|
                (PROGN
                 (LETT #6# NIL)
...
(SDEFUN |LISTPKG;shiftLeft;2L;5| ((|xx| |List| T$) ($ |List| T$))
        (SPROG ((#1=#:G429 NIL))
               (SEQ
                (EXIT
                 (COND ((NULL |xx|) (PROGN (LETT #1# |xx|) (GO #2=#:G428)))
                       ('T
...
(SDEFUN |LISTPKG;minShift;2L;6| ((|xx| . #1=(|List| T$)) ($ |List| T$))
        (SPROG
         ((|res| #1#) (|xx1| #1#) (#2=#:G437 NIL) (|k| NIL) (#3=#:G436 NIL))
         (SEQ
          (EXIT
           (COND
            ((OR (NULL |xx|) (NULL (CDR |xx|)))
             (PROGN (LETT #3# |xx|) (GO #4=#:G435)))
            ('T
...
(SDEFUN |LISTPKG;cartesian;2L;7|
        ...
        (SPROG
         ((|res| (|List| (|List| T$))) (#1=#:G448 NIL) (|s| NIL)
          (#2=#:G447 NIL) (|x| NIL) (#3=#:G444 NIL) (#4=#:G446 NIL)
          (#5=#:G445 NIL))
         (SEQ
          (EXIT
           (COND
...
(SDEFUN |LISTPKG;cartesianPower;LNniL;8|
        ...
        (SPROG
         ((|res| (|List| (|List| T$))) (#1=#:G461 NIL) (|s| NIL)
          (#2=#:G460 NIL) (|x| NIL) (#3=#:G457 NIL) (#4=#:G459 NIL)
          (#5=#:G458 NIL))
         (SEQ
          (EXIT
           (COND
            ((OR (NULL S) (ZEROP |n|)) (PROGN (LETT #3# NIL) (GO #6=#:G456)))
            ('T
             (COND
              ((EQL |n| 1)
               (PROGN
