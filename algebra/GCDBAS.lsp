...
(SDEFUN |GCDBAS;splitNums|
        ((|a| R) (|b| R)
         ($ |Union|
          ...
          "failed"))
        (SPROG ((|b1| (R)) (#1=#:G391 NIL) (|a1| (R)) (|cf| (R)))
...
(SDEFUN |GCDBAS;gcdDecomposition;VR;4|
        ((|v| |Vector| R)
         ($ |Record| (|:| |basis| #1=(|Vector| R))
          (|:| |transform| #2=(|Matrix| (|Integer|)))))
        (SPROG
         ((#3=#:G452 NIL) (|i| NIL) (#4=#:G451 NIL)
          (|nv| (|Vector| (|Integer|))) (|a| (R)) (#5=#:G450 NIL) (|l| NIL)
          (#6=#:G449 NIL) (|m| (|NonNegativeInteger|))
          (|firstAdded| (|Boolean|)) (|c| (|Integer|)) (#7=#:G448 NIL)
          (|k| NIL) (|ov| (|Vector| (|Integer|)))
          (|n1| #8=(|NonNegativeInteger|)) (|ct1| #2#) (|cb1| #1#)
          (|dr1|
           (|Record| (|:| |basis| (|Vector| R))
                     (|:| |transform| (|Matrix| (|Integer|)))))
          (#9=#:G447 NIL) (#10=#:G446 NIL) (#11=#:G445 NIL) (|cf| (R))
          (|b1| (R)) (|a1| (R))
          ...
          (|sr1|
           (|Union|
            (|Record| (|:| |fac1| R) (|:| |fac2| R) (|:| |commonfac| R))
            "failed"))
          (#12=#:G442 NIL) (|pquo| (|Union| R "failed")) (|b| (R))
          (#13=#:G444 NIL) (|j| NIL) (|i0| (|NonNegativeInteger|))
          (#14=#:G443 NIL) (|ct| (|FlexibleArray| (|Vector| (|Integer|))))
