...
(SDEFUN |ODEINT;mkprod|
        ((|l| |List|
         ...
         ($ F))
        (SPROG
         ((#1=#:G398 NIL) (#2=#:G397 (F)) (#3=#:G399 (F)) (#4=#:G404 NIL)
          (|r| NIL)
          (|ll|
           (|List|
            (|Record| (|:| |coef| (|Fraction| (|Integer|))) (|:| |logand| F))))
...
(SDEFUN |ODEINT;isQ|
        ...
        (SPROG
         ((|prod| (|Fraction| (|Integer|))) (#1=#:G429 NIL)
          (|u| (|Union| (|Fraction| (|Integer|)) "failed")) (#2=#:G430 NIL)
          (|x| NIL))
         (SEQ
          (EXIT
...
(DEFUN |ODEIntegration| (&REST #1=#:G453)
  (SPROG NIL
         (PROG (#2=#:G454)
           (RETURN
            (COND
