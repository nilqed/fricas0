...
(SDEFUN |QALGSET;factorset| ((|y| |Dpoly|) ($ |List| |Dpoly|))
        (SPROG ((#1=#:G403 NIL) (|j| NIL) (#2=#:G402 NIL))
               (SEQ
...
(SDEFUN |QALGSET;simplify;2$;2| ((|x| $) ($ $))
        (SPROG
         ((#1=#:G415 NIL) (#2=#:G414 (|Dpoly|)) (#3=#:G416 (|Dpoly|))
          (#4=#:G427 NIL) (#5=#:G379 NIL) (|zro| (|List| |Dpoly|))
          (#6=#:G411 NIL) (#7=#:G410 (|Dpoly|)) (#8=#:G412 (|Dpoly|))
          (#9=#:G426 NIL) (#10=#:G378 NIL) (#11=#:G425 NIL) (|s| NIL)
          (#12=#:G424 NIL) (|mset| (|List| (|List| |Dpoly|))) (#13=#:G423 NIL)
          (#14=#:G422 NIL) (#15=#:G421 NIL) (|p| NIL) (#16=#:G420 NIL)
...
(SDEFUN |QALGSET;coerce;$Of;5| ((|x| $) ($ |OutputForm|))
        (SPROG ((#1=#:G448 NIL) (|f| NIL) (#2=#:G447 NIL))
               (SEQ
                (COND
...
(SDEFUN |QALGSET;minset|
        ...
        (SPROG ((#1=#:G495 NIL) (|s| NIL) (#2=#:G494 NIL))
               (SEQ
                (COND ((NULL |lset|) |lset|)
                      ('T
                       (PROGN
...
(SDEFUN |QALGSET;overset?|
        ...
        (SPROG
         ((#1=#:G497 NIL) (#2=#:G496 #3=(|Boolean|)) (#4=#:G498 #3#)
          (#5=#:G501 NIL) (|q| NIL))
         (SEQ
          (COND ((NULL |qlist|) NIL)
                (#6='T
...
(DEFUN |QuasiAlgebraicSet| (&REST #1=#:G502)
  (SPROG NIL
         (PROG (#2=#:G503)
           (RETURN
            (COND
