        ...
        (SPROG
         ((|toReturn|
           (|List|
            (|Record| (|:| |complexRoots| (|SparseUnivariatePolynomial| R))
                      (|:| |coordinates| (|List| (|Polynomial| R))))))
          (|lc| (|List| (|Polynomial| R))) (#1=#:G446 NIL)
          (|q|
           (|NewSparseMultivariatePolynomial| R (|OrderedVariableList| |lv|)))
          (#2=#:G445 NIL) (|g| (|SparseUnivariatePolynomial| R))
          (#3=#:G394 NIL) (#4=#:G444 NIL) (|us| NIL) (#5=#:G443 NIL)
          (|lus|
           (|List|
             ...
             (|:| |tower|
                  (|SquareFreeRegularTriangularSet| R
                                                    ...
                                                    (|NewSparseMultivariatePolynomial|
                                                     ...
                                                     (|OrderedVariableList|
                                                      |lv|)))))))
          (#10=#:G438 NIL) (#11=#:G437 NIL) (#12=#:G436 NIL) (|fq| NIL)
          (|lfq|
           (|List|
            (|NewSparseMultivariatePolynomial| R
                                               (|OrderedVariableList| |lv|))))
...
(DEFUN |RationalUnivariateRepresentationPackage| (&REST #1=#:G451)
  (SPROG NIL
         (PROG (#2=#:G452)
           (RETURN
            (COND
...
(DEFUN |RationalUnivariateRepresentationPackage;| (|#1| |#2|)
  (SPROG
   ((#1=#:G387 NIL) (|pv$| NIL) ($ NIL) (|dv$| NIL) (DV$2 NIL) (DV$1 NIL))
   (PROGN
