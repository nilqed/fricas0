...
(SDEFUN |MULDEP;logDependenceQ;LFU;2|
        ((|lq| |List| (|Fraction| (|Integer|))) (|q| |Fraction| (|Integer|))
         ($ |Union| (|Vector| (|Fraction| (|Integer|))) "failed"))
        (SPROG
         ((|qv| #1=(|Vector| (|Fraction| (|Integer|)))) (#2=#:G402 NIL)
          (|i| NIL) (#3=#:G401 NIL) (|m| (|Matrix| (|Fraction| (|Integer|))))
          (#4=#:G400 NIL) (|j| NIL) (#5=#:G399 NIL) (#6=#:G398 NIL)
          (#7=#:G397 NIL) (|tm| #8=(|Matrix| (|Integer|)))
          (|li| (|List| (|NonNegativeInteger|))) (#9=#:G396 NIL)
          (#10=#:G395 NIL) (|k0| (|NonNegativeInteger|))
