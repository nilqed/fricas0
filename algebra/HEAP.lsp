...
(SDEFUN |HEAP;siftUp| ((|r| $) (|i| |Integer|) (|n| |Integer|) ($ |Void|))
        (SPROG ((#1=#:G391 NIL) (|j| #2=(|Integer|)) (|k| #2#) (|t| (S)))
...
(SDEFUN |HEAP;insert!;S2$;5| ((|x| S) (|r| $) ($ $))
        (SPROG ((|j| (|Integer|)) (#1=#:G401 NIL) (|i| (|Integer|)))
...
(DEFUN |Heap;| (|#1|)
  (SPROG
   ((#1=#:G421 NIL) (#2=#:G422 NIL) (|pv$| NIL) (#3=#:G418 NIL) (#4=#:G419 NIL)
    (#5=#:G420 NIL) ($ NIL) (|dv$| NIL) (DV$1 NIL))
   (PROGN
