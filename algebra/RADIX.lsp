...
(SDEFUN |RADIX;wholePart;$I;23| ((|a| $) ($ |Integer|))
        (SPROG ((|n0| (|Integer|)) (#1=#:G458 NIL) (|r| NIL))
               (SEQ (LETT |n0| 0)
...
(SDEFUN |RADIX;fractionPart;$F;24| ((|a| $) ($ |Fraction| (|Integer|)))
        (SPROG
         ((|d| (|Integer|)) (|n| (|Integer|)) (|n1| (|Integer|))
          (#1=#:G465 NIL) (|r| NIL) (|n0| (|Integer|)) (#2=#:G464 NIL))
         (SEQ (LETT |n0| 0)
...
(SDEFUN |RADIX;intgroup| ((|li| |List| (|Integer|)) ($ |OutputForm|))
        (SPROG
         ((#1=#:G493 NIL) (|i| NIL) (#2=#:G492 NIL) (#3=#:G491 NIL)
          (#4=#:G490 NIL) (#5=#:G489 NIL) (#6=#:G488 NIL))
         (SEQ
         ...
         ((|rits|
           (|List|
            #1=(|Record| (|:| |quotient| (|Integer|))
                         (|:| |remainder| (|Integer|)))))
          (|ritscyc| (|List| (|Integer|))) (#2=#:G534 NIL) (|i| (|Integer|))
          (|ritspfx| (|List| (|Integer|))) (#3=#:G533 NIL) (|c| (|Integer|))
          (|cfound| (|Boolean|))
          (|ritsn|
           #4=(|List|
               (|Record| (|:| |quotient| (|Integer|))
          ...
          (|rn|
           (|Record| (|:| |quotient| (|Integer|))
                     (|:| |remainder| (|Integer|))))
          (#6=#:G531 NIL) (|p| #7=(|Integer|)) (|ritsi| #4#) (#8=#:G530 NIL)
          (|n| #7#) (|qr2i| #1#) (|qrt| #1#) (|qr1i| #1#) (#9=#:G529 NIL)
          (|qr| #1#))
...
(DEFUN |RadixExpansion;| (|#1|)
  (SPROG ((|pv$| NIL) (#1=#:G561 NIL) ($ NIL) (|dv$| NIL) (DV$1 NIL))
         (PROGN
            ...
            (CONS
             ...
             (CONS
              '#((|QuotientFieldCategory| 23) (|Field|) (|EuclideanDomain|)
                 ...
                 (|RetractableTo| 91) (|ConvertibleTo| 86)
                 (|ConvertibleTo| 104) (|ConvertibleTo| 103) (|PartialOrder|)
                 (|RetractableTo| 16) (|InnerEvalable| 91 23)
