...
(SDEFUN |SPLTREE;construct;VCL$;5|
        ...
        (SPROG ((#1=#:G443 NIL) (|s| NIL) (#2=#:G442 NIL))
               (SEQ
                (|SPLTREE;per|
...
(SDEFUN |SPLTREE;map;M2$;17|
        ...
        (SPROG ((#2=#:G481 NIL) (|c| NIL) (#3=#:G480 NIL) (|b| ($)))
               (SEQ
                (COND ((SPADCALL |a| (QREFELT $ 22)) |a|)
                      (#4='T
                       (SEQ
...
(SDEFUN |SPLTREE;map!;M2$;18|
        ((|foo| |Mapping| #1=(|SplittingNode| V C) #1#) (|a| $) ($ $))
        (SPROG ((#2=#:G488 NIL) (|c| NIL) (#3=#:G487 NIL))
               (SEQ
                (COND ((SPADCALL |a| (QREFELT $ 22)) |a|)
                      (#4='T
                       (SEQ
...
(SDEFUN |SPLTREE;nodes;$L;21| ((|a| $) ($ |List| $))
        (SPROG ((#1=#:G497 NIL) (|c| NIL) (#2=#:G496 NIL))
               (SEQ
                (COND ((SPADCALL |a| (QREFELT $ 22)) NIL)
...
(SDEFUN |SPLTREE;members;$L;23| ((|a| $) ($ |List| (|SplittingNode| V C)))
        (SPROG ((#1=#:G509 NIL) (|c| NIL) (#2=#:G508 NIL))
               (SEQ
                (COND ((SPADCALL |a| (QREFELT $ 22)) NIL)
                      ((SPADCALL |a| (QREFELT $ 41))
                       (LIST (SPADCALL |a| (QREFELT $ 25))))
...
(SDEFUN |SPLTREE;localCoerce|
        ...
        (SPROG
         ((|lo| (|List| (|OutputForm|))) (#1=#:G533 NIL) (|c| NIL)
          (#2=#:G532 NIL) (|ro| (|OutputForm|)) (|s| (|String|))
          (#3=#:G531 NIL) (|i| NIL))
...
(SDEFUN |SPLTREE;extractSplittingLeaf;$U;28|
        ((|a| $) ($ |Union| $ #1="failed"))
        (SPROG ((|la| (|List| $)) (#2=#:G547 NIL) (|esl| (|Union| $ #1#)))
               (SEQ
                (EXIT
                 (COND
...
(DEFUN |SplittingTree| (&REST #1=#:G611)
  (SPROG NIL
         (PROG (#2=#:G612)
           (RETURN
            (COND
...
(DEFUN |SplittingTree;| (|#1| |#2|)
  (SPROG
   ((|pv$| NIL) (#1=#:G608 NIL) (#2=#:G609 NIL) (#3=#:G610 NIL) ($ NIL)
