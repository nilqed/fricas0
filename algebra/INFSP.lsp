...
(SDEFUN |INFSP;makeEq;LLL;2|
        ...
        (SPROG
         ((#1=#:G393 NIL) (|x| NIL) (#2=#:G394 NIL) (|r| NIL) (#3=#:G392 NIL))
         (SEQ
          (PROGN
           (LETT #3# NIL)
...
(SDEFUN |INFSP;findGenZeros|
        ((|lp| |List| (|Polynomial| K)) (|rlvar| |List| (|Symbol|))
         (|eps| |Par|) ($ |List| (|List| F)))
        (SPROG
         ((|ebits| (|PositiveInteger|)) (|etol| (|Integer|)) (#1=#:G446 NIL)
          (|sol| (|List| (|List| F))) (|sol1| (|List| F)) (#2=#:G445 NIL)
          (|ok| (|Boolean|)) (|ppi| (|Complex| (|Interval| (|Float|))))
          (|pp| (|Union| (|Complex| (|Interval| (|Float|))) "failed"))
          (#3=#:G448 NIL) (|pol| NIL) (#4=#:G449 NIL) (|xvar| NIL)
          (#5=#:G447 NIL) (|z| NIL) (|lz| (|List| F)) (|nfeps| (|Float|))
...
(SDEFUN |INFSP;oldCoord|
        ...
        (SPROG
         ((#1=#:G451 NIL) (#2=#:G450 (F)) (#3=#:G452 (F)) (#4=#:G455 NIL)
          (|n| NIL) (#5=#:G456 NIL) (|nr| NIL) (|rnumres| (|List| F)))
...
(SDEFUN |INFSP;innerSolve;2LLParL;18|
        ...
        (SPROG
         ((|result| (|List| (|List| F))) (#1=#:G606 NIL) (|r| NIL)
          (#2=#:G605 NIL) (|lris| #3=(|List| (|List| F)))
          (|lgen1| (|List| (|Polynomial| K))) (#4=#:G604 NIL) (|pf| NIL)
          (#5=#:G603 NIL) (|neps| (|Par|)) (|lnorm| (|Integer|))
          (|laval| (|List| (|Integer|))) (#6=#:G602 NIL) (|i| NIL)
          (#7=#:G601 NIL) (|lval| #8=(|List| (|Integer|)))
          (|lgen| #9=(|List| (|DistributedMultivariatePolynomial| |lv| K)))
          (|genRecord| (|Record| (|:| |dpolys| #9#) (|:| |coords| #8#)))
          (#10=#:G600 NIL) (|gres| NIL)
          (|partRes|
           (|List| (|List| (|DistributedMultivariatePolynomial| |lv| K))))
          (#11=#:G599 NIL) (#12=#:G554 NIL) (#13=#:G553 #3#) (#14=#:G555 #3#)
          (#15=#:G598 NIL) (|res| NIL)
          (|listG| (|List| (|List| (|Polynomial| K)))) (#16=#:G597 NIL)
          (#17=#:G596 NIL) (#18=#:G595 NIL) (|pr| NIL) (#19=#:G594 NIL)
          (#20=#:G581 NIL) (|listGen| (|List| (|List| |dmp|))) (#21=#:G475 NIL)
          (#22=#:G474 #23=(|Boolean|)) (#24=#:G476 #23#) (#25=#:G547 NIL)
          (#26=#:G546 #27=(|NonNegativeInteger|)) (#28=#:G548 #27#)
          (#29=#:G593 NIL) (#30=#:G378 NIL) (#31=#:G592 NIL) (|f| NIL)
          (|res1| (|List| (|DistributedMultivariatePolynomial| |lv| K)))
          (#32=#:G591 NIL) (|rrlvv| (|List| OV)) (|rlv| (|List| (|Symbol|)))
          (#33=#:G469 NIL) (#34=#:G468 #35=(|Boolean|)) (#36=#:G470 #35#)
          (#37=#:G590 NIL) (|fq| NIL) (#38=#:G589 NIL) (#39=#:G588 NIL)
          (|gb|
           (CATEGORY |package|
          ...
          (|lq| (|List| |dmp|)) (#41=#:G587 NIL) (|q1| NIL) (#42=#:G586 NIL)
          (|dmp|
           (|Join|
          ...
          (DP
           (|DirectProductCategory| (|call| LENGTH |lv|)
                                    (|NonNegativeInteger|)))
          (|lvv| (|List| OV)) (#43=#:G463 NIL) (#44=#:G585 NIL) (|vv| NIL)
          (#45=#:G584 NIL)
          (OV
...
(DEFUN |InnerNumericFloatSolvePackage| (&REST #1=#:G607)
  (SPROG NIL
         (PROG (#2=#:G608)
           (RETURN
            (COND
