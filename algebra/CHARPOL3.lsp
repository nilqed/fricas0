...
(SDEFUN |CHARPOL3;char_pol_via_interpolation0|
        ...
        (SPROG
         ((#1=#:G386 NIL) (|j| NIL) (#2=#:G387 NIL) (|di| NIL)
          ...
          (|d1| (R)) (#3=#:G385 NIL) (|i| NIL) (|v| (|SingletonAsOrderedSet|))
...
(SDEFUN |CHARPOL3;char_pol_via_interpolation;MSup;2|
        ...
        (SPROG
         ((|p1| (|SparseUnivariatePolynomial| (|Fraction| R)))
          (|ld| (|List| R)) (#1=#:G393 NIL) (|i| NIL) (#2=#:G392 NIL))
         (SEQ
          (LETT |ld|
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |CHARPOL3;to_common_denominator|
        ...
        (SPROG
         ((|g1| (R)) (#1=#:G397 NIL) (|a| (|Fraction| R)) (#2=#:G407 NIL)
          (|j| NIL) (|lg| (|List| R)) (|g| (R)) (|lr| (|List| R))
          (#3=#:G406 NIL) (#4=#:G405 NIL) (|i| NIL) (B (|Matrix| R))
...
(DEFUN |CharacteristicPolynomial3| (#1=#:G417)
  (SPROG NIL
         (PROG (#2=#:G418)
           (RETURN
            (COND
