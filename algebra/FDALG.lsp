...
(SDEFUN |FDALG;qeltA|
        ((|p| |LinearMultivariateMatrixPencil| F) (|i| |NonNegativeInteger|)
...
(SDEFUN |FDALG;qeltu|
        ((|p| |LinearMultivariateMatrixPencil| F) (|j| |NonNegativeInteger|)
         (|l| |NonNegativeInteger|) ($ F))
        (SPADCALL |p| 1 (+ 1 |j|) |l| (QREFELT $ 13))) 

(SDEFUN |FDALG;qlstA|
        ((|p| |LinearMultivariateMatrixPencil| F) (|i| |NonNegativeInteger|)
         (|j| |NonNegativeInteger|) ($ |List| F))
...
(SDEFUN |FDALG;qsetA!|
        ((|p| |LinearMultivariateMatrixPencil| F) (|i| |NonNegativeInteger|)
         (|j| |NonNegativeInteger|) (|l| |NonNegativeInteger|) (|alpha| F)
         ($ F))
...
(SDEFUN |FDALG;qmtxu|
        ((|p| |LinearMultivariateMatrixPencil| F) (|j1| |NonNegativeInteger|)
         (|j2| |NonNegativeInteger|) (|l| |NonNegativeInteger|) ($ |Matrix| F))
        (SPADCALL |p| 1 1 (+ 1 |j1|) (+ 1 |j2|) |l| (QREFELT $ 20))) 

(SDEFUN |FDALG;qmtxA|
        ((|p| |LinearMultivariateMatrixPencil| F) (|i1| |NonNegativeInteger|)
         (|i2| |NonNegativeInteger|) (|j1| |NonNegativeInteger|)
         (|j2| |NonNegativeInteger|) (|l| |NonNegativeInteger|) ($ |Matrix| F))
...
(SDEFUN |FDALG;qmtxv|
        ((|p| |LinearMultivariateMatrixPencil| F) (|i1| |NonNegativeInteger|)
         (|i2| |NonNegativeInteger|) (|l| |NonNegativeInteger|) ($ |Matrix| F))
        (SPADCALL |p| (+ 1 |i1|) (+ 1 |i2|) 1 1 |l| (QREFELT $ 20))) 

(SDEFUN |FDALG;qscalev!|
        ((|p| |LinearMultivariateMatrixPencil| F) (|i1| |NonNegativeInteger|)
         (|i2| |NonNegativeInteger|) (|l| |NonNegativeInteger|) (|alpha| F)
...
(SDEFUN |FDALG;qsetmtxA!|
        ((|p| |LinearMultivariateMatrixPencil| F) (|i| |NonNegativeInteger|)
         (|j| |NonNegativeInteger|) (|l| |NonNegativeInteger|) (|a| |Matrix| F)
         ($ |Matrix| F))
...
(SDEFUN |FDALG;qzeroA?|
        ((|p| |LinearMultivariateMatrixPencil| F) (|i| |NonNegativeInteger|)
         (|j| |NonNegativeInteger|) ($ |Boolean|))
        (SPADCALL |p| (+ 1 |i|) (+ 1 |j|) (QREFELT $ 24))) 

(SDEFUN |FDALG;qzeromtxA?|
        ((|p| |LinearMultivariateMatrixPencil| F) (|i1| |NonNegativeInteger|)
         (|i2| |NonNegativeInteger|) (|j1| |NonNegativeInteger|)
         (|j2| |NonNegativeInteger|) ($ |Boolean|))
...
(SDEFUN |FDALG;qsemizeroA?|
        ((|p| |LinearMultivariateMatrixPencil| F) (|i1| |NonNegativeInteger|)
         (|i2| |NonNegativeInteger|) (|j1| |NonNegativeInteger|)
         (|j2| |NonNegativeInteger|) (|l| |NonNegativeInteger|) ($ |Boolean|))
        (SPADCALL |p| (+ 1 |i1|) (+ 1 |i2|) (+ 1 |j1|) (+ 1 |j2|) |l|
                  (QREFELT $ 26))) 

(SDEFUN |FDALG;qzerov?|
        ((|p| |LinearMultivariateMatrixPencil| F) (|i1| |NonNegativeInteger|)
         (|i2| |NonNegativeInteger|) ($ |Boolean|))
...
(SDEFUN |FDALG;interval;2NniL;21|
        ...
        (SPROG
         ((|lst_wrk| (|List| (|NonNegativeInteger|))) (#1=#:G645 NIL)
          (|k| NIL))
...
(SDEFUN |FDALG;new;LmmpL$;24|
        ...
        (SPROG
         ((|flg_ref| #1=(|Boolean|)) (|flg_min| #1#)
          (|n| (|NonNegativeInteger|)) (#2=#:G653 NIL) (#3=#:G658 NIL)
          (#4=#:G659 NIL) (|mon| NIL))
         (SEQ
          (SEQ
           (EXIT
...
(SDEFUN |FDALG;getSupport| ((|var| |List| VAR) ($ |List| (|FreeMonoid| VAR)))
        (SPROG
         ((#1=#:G664 NIL) (|k| NIL) (|lst_mon| (|List| (|FreeMonoid| VAR))))
         (SEQ
          (LETT |lst_mon|
...
(SDEFUN |FDALG;new;FmF$;27| ((|m| |FreeMonoid| VAR) (|c| F) ($ $))
        (SPROG
         ((#1=#:G686 NIL) (|k| NIL) (|l| (|NonNegativeInteger|))
          (#2=#:G685 NIL) (|i| NIL) (|pos| (|NonNegativeInteger|))
          (#3=#:G674 NIL) (#4=#:G684 NIL) (|fct| NIL) (|als| ($))
...
(SDEFUN |FDALG;copy;$F$;31| ((|f| $) (|alpha| F) ($ $))
        (SPROG
         ((|supp_new| (|List| (|FreeMonoid| VAR)))
          (|lmmp_new| (|LinearMultivariateMatrixPencil| F)) (#1=#:G698 NIL))
         (SEQ
          (EXIT
           (SEQ
            (COND
...
(SDEFUN |FDALG;qregular?;$2NniB;42|
        ((|f| $) (|i_min| |NonNegativeInteger|) (|i_max| |NonNegativeInteger|)
         ($ |Boolean|))
        (SPROG
         ((#1=#:G723 NIL) (#2=#:G724 NIL) (|i| NIL) (|lst_ele| (|List| F)))
         (SEQ
          (EXIT
           (SEQ
            (COND
...
(SDEFUN |FDALG;scalar?;$2NniB;43|
        ((|f| $) (|i| |NonNegativeInteger|) (|j| |NonNegativeInteger|)
         ($ |Boolean|))
        (SPROG
         ((#1=#:G731 NIL) (|flg_wrk| (|Boolean|)) (#2=#:G732 NIL) (|k| NIL)
          (|a_lst| (|List| F)))
...
(SDEFUN |FDALG;scalar?;$B;45| ((|f| $) ($ |Boolean|))
        (SPROG ((#1=#:G743 NIL) (#2=#:G744 NIL) (|k| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (COND
                   ((> (QVELT |f| 0) 1) (PROGN (LETT #1# NIL) (GO #3=#:G742))))
                  (COND
...
(SDEFUN |FDALG;polynomialForm?| ((|f| $) ($ |Boolean|))
        (SPROG
         ((#1=#:G757 NIL) (#2=#:G759 NIL) (|i| NIL) (|lst_ele| (|List| F))
          (#3=#:G758 NIL) (|k| NIL))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |FDALG;qelt;$2NniXdp;52|
        ...
        (SPROG
         ((|a_tmp| (|XDistributedPolynomial| VAR F)) (#1=#:G770 NIL) (|k| NIL))
...
(SDEFUN |FDALG;setelt!;$2Nni2Xdp;55|
        ...
        (SPROG
         ((|p_new| #1=(|List| F)) (|pos| (|NonNegativeInteger|))
          (#2=#:G787 NIL) (#3=#:G794 NIL) (|mon| NIL) (#4=#:G793 NIL) (|k| NIL)
          (|p_old| #1#))
         (SEQ
          (COND
           ((NULL (QVELT |f| 5))
...
(SDEFUN |FDALG;matrix;$FmM;58| ((|f| $) (|m| |FreeMonoid| VAR) ($ |Matrix| F))
        (SPROG ((|pos| (|NonNegativeInteger|)) (#1=#:G801 NIL))
               (SEQ
                (LETT |pos|
                      (PROG1
                          (LETT #1#
...
(SDEFUN |FDALG;matrix;$M;59|
        ((|f| $) ($ |Matrix| (|XDistributedPolynomial| VAR F)))
        (SPROG
         ((#1=#:G813 NIL) (|j| NIL) (#2=#:G812 NIL) (|i| NIL)
          (|A_tmp| (|Matrix| F)) (#3=#:G811 NIL) (|k| NIL)
...
(SDEFUN |FDALG;appendSupport!;$L$;60|
        ...
        (SPROG
         ((|lst_new| (|List| (|FreeMonoid| VAR)))
          (|pos| (|NonNegativeInteger|)) (#1=#:G814 NIL) (#2=#:G820 NIL)
          (|mon| NIL))
...
(SDEFUN |FDALG;qzero?;$4NniFmB;81|
        ((|f| $) (|i_min| |NonNegativeInteger|) (|i_max| |NonNegativeInteger|)
         (|j_min| |NonNegativeInteger|) (|j_max| |NonNegativeInteger|)
         (|m| |FreeMonoid| VAR) ($ |Boolean|))
        (SPROG ((|l| (|NonNegativeInteger|)) (#1=#:G911 NIL))
               (SEQ
                (LETT |l|
                      (PROG1
                          (LETT #1#
...
(SDEFUN |FDALG;blockStructure;$M;82|
        ...
        (SPROG
         ((|sze_tmp| (|NonNegativeInteger|)) (#1=#:G932 NIL) (#2=#:G941 NIL)
          (|k| NIL) (#3=#:G930 NIL) (#4=#:G940 NIL) (#5=#:G929 NIL)
          (#6=#:G939 NIL) (|idx_l| (|List| #7=(|NonNegativeInteger|)))
          (|blo_mtx| (|Matrix| (|NonNegativeInteger|)))
          (|m| (|NonNegativeInteger|)) (|flg_tmp| (|Boolean|)) (#8=#:G938 NIL)
          (#9=#:G921 NIL) (#10=#:G937 NIL) (|i| NIL)
          (|cnt_l| (|List| (|NonNegativeInteger|))) (#11=#:G918 NIL)
          (#12=#:G917 NIL) (|j_wrk| #7#))
         (SEQ (LETT |cnt_l| NIL)
...
(SDEFUN |FDALG;refined?;$B;83| ((|f| $) ($ |Boolean|))
        (SPROG ((#1=#:G946 NIL) (|blo_mtx| (|Matrix| (|NonNegativeInteger|))))
               (SEQ
                (EXIT
...
(SDEFUN |FDALG;blockElimination;$2LB2LBL;85|
        ((|f| $) (|rsrc| |List| (|NonNegativeInteger|))
         ...
         ($ |List| (|Matrix| F)))
        (SPROG
         ((#1=#:G989 NIL) (|k| NIL) (|lst_trn| (|List| (|Matrix| F)))
...
(SDEFUN |FDALG;toMatrix|
        ...
        (SPROG
         ((#1=#:G1003 NIL) (|j| NIL) (#2=#:G1002 NIL) (|i| NIL)
          (|A_tmp| (|Matrix| F)) (#3=#:G1001 NIL) (|k| NIL)
          (|A_wrk| (|Matrix| (|XDistributedPolynomial| VAR F)))
          (|n| (|NonNegativeInteger|)) (#4=#:G993 NIL)
          (|m| (|NonNegativeInteger|)) (#5=#:G992 NIL))
         (SEQ
          (COND
...
(SDEFUN |FDALG;display;$LOf;88|
        ...
        (SPROG
         ((#1=#:G1009 NIL) (|k| NIL) (|lst| (|List| (|List| (|OutputForm|))))
...
(SDEFUN |FDALG;display;$2Of;89| ((|f| $) (|sol| |OutputForm|) ($ |OutputForm|))
        (SPROG
         ((|als_of| (|OutputForm|))
...
(SDEFUN |FDALG;admissibleLinearSystem;$Of;90| ((|f| $) ($ |OutputForm|))
        (SPROG
         ((|als_of| (|OutputForm|)) (#1=#:G1022 NIL) (|j| NIL)
          (|row_a| (|List| (|OutputForm|))) (#2=#:G1021 NIL) (|i| NIL)
          (#3=#:G1020 NIL) (|k| NIL)
          (|blo_mtx| (|Matrix| (|NonNegativeInteger|)))
...
(SDEFUN |FDALG;linearization;$M;92| ((|f| $) ($ |Matrix| $))
        (SPROG
         ((#1=#:G1038 NIL) (|l| NIL)
          ...
          (|a_wrk| (F)) (#2=#:G1037 NIL) (|j| NIL) (#3=#:G1036 NIL) (|i| NIL)
...
(SDEFUN |FDALG;transformationMatrix;$M;96| ((|f| $) ($ |Matrix| F))
        (SPROG ((#1=#:G1048 NIL) (|k| NIL) (|trf_mtx| (|Matrix| F)))
               (SEQ
                (LETT |trf_mtx|
...
(SDEFUN |FDALG;transformColumns!;$M$;98| ((|f| $) (U |Matrix| F) ($ $))
        (SPROG
         ((|trf_mtx| (|Matrix| F)) (#1=#:G1065 NIL) (|flg_wrk| (|Boolean|))
          (#2=#:G1066 NIL) (|j| NIL))
         (SEQ
          (COND
                  ...
                  (EXIT
                   (COND
                    ((NULL (SPADCALL (QAREF2O U 1 |j| 1 1) (QREFELT $ 48)))
                     (SEQ (LETT |flg_wrk| NIL)
                          (EXIT
                           (PROGN (LETT #1# |$NoValue|) (GO #5=#:G1060))))))))
...
(SDEFUN |FDALG;normalizePLS!;2$;100| ((|f| $) ($ $))
        (SPROG
         ((|a_wrk| (F)) (#1=#:G1087 NIL) (|i_wrk| NIL) (#2=#:G1084 NIL)
          (|i_ref| (|NonNegativeInteger|)) (#3=#:G1086 NIL) (#4=#:G1085 NIL)
...
(SDEFUN |FDALG;normalizeDIAG!;2$;101| ((|f| $) ($ $))
        (SPROG
         ((#1=#:G1096 NIL) (#2=#:G1098 NIL) (|l| NIL) (|a_lst| (|List| F))
          (#3=#:G1097 NIL) (|i| NIL))
         (SEQ
...
(SDEFUN |FDALG;normalize!;2$;102| ((|f| $) ($ $))
        (SPROG
         ((#1=#:G1109 NIL) (|i_max| (|NonNegativeInteger|)) (#2=#:G1110 NIL)
...
(SDEFUN |FDALG;solutionVector;$M;105|
        ((|f| $) ($ |Matrix| (|XDistributedPolynomial| VAR F)))
        (SPROG
         ((|p_wrk| (|XDistributedPolynomial| VAR F)) (#1=#:G1126 NIL) (|j| NIL)
...
(SDEFUN |FDALG;addALS;3$;110| ((|f| $) (|g| $) ($ $))
        (SPROG
         ((|pos| (|NonNegativeInteger|)) (#1=#:G1152 NIL)
          (|mon| (|FreeMonoid| VAR)) (#2=#:G1160 NIL) (|k| NIL)
          (#3=#:G1149 NIL) (#4=#:G1159 NIL)
...
(SDEFUN |FDALG;multiplyALS;3$;111| ((|f| $) (|g| $) ($ $))
        (SPROG
         ((|pos| (|NonNegativeInteger|)) (#1=#:G1167 NIL)
          (|mon| (|FreeMonoid| VAR)) (#2=#:G1175 NIL) (|k| NIL)
          (#3=#:G1164 NIL) (#4=#:G1174 NIL)
          (|lp_new| #5=(|LinearMultivariateMatrixPencil| F)) (|lp_g| #5#)
          (|lp_f| #5#) (|als| ($)) (|lst| (|List| (|FreeMonoid| VAR)))
          (#6=#:G1173 NIL))
         (SEQ
...
(SDEFUN |FDALG;invertSTD;2$;113| ((|f| $) ($ $))
        (SPROG
         ((|blo_mtx| (|Matrix| (|NonNegativeInteger|))) (#1=#:G1183 NIL)
          (#2=#:G1182 NIL) (#3=#:G1190 NIL) (|k| NIL) (|U_wrk| #4=(|Matrix| F))
          (|T_wrk| #4#) (#5=#:G1189 NIL) (|f_inv| ($))
          (|n| (|NonNegativeInteger|)))
         (SEQ (LETT |n| (QVELT |f| 0))
              (LETT |f_inv| (SPADCALL (+ |n| 1) (QVELT |f| 1) (QREFELT $ 35)))
              (|FDALG;qsetv!| (QVELT |f_inv| 2) (+ |n| 1) 1
...
(SDEFUN |FDALG;factors;$L;114| ((|f| $) ($ |List| $))
        (SPROG
         ((|lst_fct| (|List| $)) (|n| (|NonNegativeInteger|)) (|als| ($))
          (#1=#:G1221 NIL) (|l| NIL) (|f_2| ($)) (|f_1| ($)) (#2=#:G1220 NIL)
          (#3=#:G1219 NIL) (|flg_01| #4=(|Boolean|)) (#5=#:G1199 NIL)
          (|flg_10| #4#) (|flg_00| #4#) (|flg_uv| (|Boolean|))
          (|flg_uc| (|Boolean|)) (|flg_ur| #4#) (|n_2| (|NonNegativeInteger|))
          (#6=#:G1196 NIL) (|n_1| (|NonNegativeInteger|)) (|k| NIL)
          (#7=#:G1194 NIL) (#8=#:G1218 NIL) (|m| (|NonNegativeInteger|))
          (|blo_mtx| (|Matrix| (|NonNegativeInteger|))))
         (SEQ
          (EXIT
                ...
                (COND
                 ((EQL |m| 1)
                  (SEQ
                   ...
                   (EXIT (PROGN (LETT #8# |lst_fct|) (GO #9=#:G1217))))))
                (LETT |n| (QVELT |als| 0))
                (SEQ
                 (LETT |k|
                       (PROG1 (LETT #7# (- |m| 1))
...
(SDEFUN |FDALG;summands;$L;115| ((|f| $) ($ |List| $))
        (SPROG
         ((|lst_sum| (|List| $)) (|n| (|NonNegativeInteger|)) (|als| ($))
          (|u_tmp| (F)) (#1=#:G1251 NIL) (|j| NIL) (|f_2| ($)) (#2=#:G1247 NIL)
          (|idx_u| (|NonNegativeInteger|)) (|u_wrk| (F)) (#3=#:G1250 NIL)
          (#4=#:G1249 NIL) (|l| NIL) (|f_1| ($))
          (|trn_wrk| (|List| (|Matrix| F)))
          (|lst_4| #5=(|List| (|NonNegativeInteger|))) (|lst_3| #5#)
          (|lst_2| #5#) (|lst_1| #5#)
          (|lst_tmp| (|List| #6=(|NonNegativeInteger|))) (|n_2| #6#)
          (#7=#:G1227 NIL) (|n_1| (|NonNegativeInteger|)) (|k| NIL)
          (#8=#:G1225 NIL) (#9=#:G1248 NIL) (|m| (|NonNegativeInteger|))
          (|blo_mtx| (|Matrix| (|NonNegativeInteger|))))
         (SEQ
          (EXIT
                ...
                (COND
                 ((EQL |m| 1)
                  (SEQ
                   ...
                   (EXIT (PROGN (LETT #9# |lst_sum|) (GO #10=#:G1246))))))
                (LETT |n| (QVELT |als| 0))
                (SEQ
                 (LETT |k|
                       (PROG1 (LETT #8# (- |m| 1))
...
(SDEFUN |FDALG;leftFamily;$L;117| ((|f| $) ($ |List| (|OutputForm|)))
        (SPROG
         ((#1=#:G1279 NIL) (|j| (|NonNegativeInteger|)) (|flg_wrk| (|Boolean|))
          (|i| NIL) (|s_lst| (|List| (|OutputForm|))) (#2=#:G1278 NIL)
          (#3=#:G1277 NIL) (|p_wrk| (|List| (|XDistributedPolynomial| VAR F)))
...
(SDEFUN |FDALG;ratexprInverse;$BOf;118|
        ...
        (SPROG
         ((|o_wrk| (|OutputForm|)) (#1=#:G1300 NIL) (|g| NIL) (#2=#:G1299 NIL)
...
(SDEFUN |FDALG;ratexpr;$Of;119| ((|f| $) ($ |OutputForm|))
        (SPROG
         ((|out_of| (|OutputForm|)) (#1=#:G1309 NIL) (#2=#:G1311 NIL)
          (|sum| NIL) (#3=#:G1310 NIL) (|fct| NIL) (|sum_f| (|List| $))
          (|fct_f| (|List| $)))
         (SEQ
          (EXIT
                         ...
                         (EXIT
                          (LETT |out_of|
                                (SPADCALL |out_of|
                                          ...
                                          (QREFELT $ 182)))))
                        (LETT #3# (CDR #3#)) (GO G190) G191 (EXIT NIL))
                   (EXIT (PROGN (LETT #1# |out_of|) (GO #4=#:G1308))))))
                (COND
...
(SDEFUN |FDALG;leftFactor;$Nni$;121| ((|f| $) (|k| |NonNegativeInteger|) ($ $))
        (SPROG
         ((#1=#:G1338 NIL) (|l| NIL) (|f_1| ($)) (|f_wrk| ($)) (#2=#:G1337 NIL)
          (|trn_wrk| (|List| (|Matrix| F)))
          (|lst_3| #3=(|List| (|NonNegativeInteger|))) (|lst_1| #3#)
          (|lst_4| #3#) (|lst_2| #3#) (|i_max| (|NonNegativeInteger|))
          (#4=#:G1330 NIL) (|n| (|NonNegativeInteger|)))
         (SEQ
          (EXIT
           (COND
...
(SDEFUN |FDALG;rightFactor;$Nni$;122|
        ((|f| $) (|k| |NonNegativeInteger|) ($ $))
        (SPROG
         ((#1=#:G1354 NIL) (|l| NIL) (|m| (|NonNegativeInteger|))
          (#2=#:G1349 NIL) (|f_2| ($)) (|f_wrk| ($)) (#3=#:G1353 NIL)
          (|trn_wrk| (|List| (|Matrix| F)))
          (|lst_3| #4=(|List| (|NonNegativeInteger|))) (|lst_1| #4#)
          (|lst_4| #4#) (|lst_2| #4#) (|i_max| (|NonNegativeInteger|))
          (#5=#:G1345 NIL) (|n| (|NonNegativeInteger|)))
         (SEQ
          (EXIT
           (COND
            ((OR (ZEROP |k|) (> |k| (QVELT |f| 0)))
...
(SDEFUN |FDALG;qfactorizationTransformations|
        ((|f| $) (|k_rows| |NonNegativeInteger|)
         ...
         (|sol| |List| (|Equation| (|Polynomial| F))) ($ |List| (|Matrix| F)))
        (SPROG
         ((|col_Q| #1=(|List| (|NonNegativeInteger|))) (|row_Q| #1#)
          (|col_P| #1#) (#2=#:G1358 NIL) (#3=#:G1357 NIL) (|row_P| #1#)
          (|j_min| (|NonNegativeInteger|)) (#4=#:G1356 NIL)
          (|n| (|NonNegativeInteger|)))
         (SEQ (LETT |n| (QVELT |f| 0))
              (LETT |j_min|
...
(SDEFUN |FDALG;factorize;$NniL;124|
        ...
        (SPROG
         ((#1=#:G1383 NIL) (|l| NIL) (|f_2| ($)) (|f_1| ($))
          (|n_2| (|NonNegativeInteger|)) (#2=#:G1377 NIL)
          (|n_1| (|NonNegativeInteger|)) (|trn_wrk| (|List| (|Matrix| F)))
          (#3=#:G1374 NIL) (#4=#:G1373 NIL) (#5=#:G1382 NIL)
          (|lst_sol| (|List| (|List| (|Equation| (|Polynomial| F)))))
          (#6=#:G1371 NIL) (#7=#:G1370 NIL)
          (|lst_3| #8=(|List| (|NonNegativeInteger|))) (|lst_1| #8#)
          (|lst_4| #8#) (|lst_2| #8#) (|i_max| (|NonNegativeInteger|))
          (#9=#:G1367 NIL) (|n| (|NonNegativeInteger|)) (|lst_fct| (|List| $))
          (|f_wrk| ($)))
         (SEQ
          (EXIT
           (COND
             ...
             (SEQ (LETT |f_wrk| (SPADCALL |f| (QREFELT $ 51)))
                  ...
                  (COND
                   ((OR (EQL |k| 1) (EQL |k| (QVELT |f| 0)))
                    (PROGN (LETT #5# |lst_fct|) (GO #10=#:G1381))))
                  (LETT |n| (QVELT |f| 0))
                  (LETT |i_max|
                        (PROG1 (LETT #9# (- |k| 1))
...
(SDEFUN |FDALG;factor;$L;125| ((|f| $) ($ |List| $))
        (SPROG
         ((|lst_fct| (|List| $)) (#1=#:G1399 NIL) (#2=#:G1398 NIL)
          (|elt_tmp| ($)) (|flg_irr| (|Boolean|)) (|lst_tmp| (|List| $))
          (#3=#:G1401 NIL) (#4=#:G1388 NIL) (|k| NIL) (#5=#:G1400 NIL)
...
(SDEFUN |FDALG;factorizationTransformations;$2NniLL;126|
        ...
        (SPROG
         ((|lst_trn| (|List| (|Matrix| F)))
          (|col_Q| #1=(|List| (|NonNegativeInteger|))) (|row_Q| #1#)
          (|col_P| #1#) (#2=#:G1405 NIL) (#3=#:G1404 NIL) (|row_P| #1#)
          (|j_min| (|NonNegativeInteger|)) (#4=#:G1403 NIL)
          (|n| (|NonNegativeInteger|)))
         (SEQ (LETT |n| (QVELT |f| 0))
              (LETT |j_min|
                    (PROG1 (LETT #4# (+ (- |n| |k_cols|) 1))
...
(SDEFUN |FDALG;factorizationEquations;$2NniL;127|
        ...
        (SPROG
         ((|lst_eqn| (|List| (|Polynomial| F)))
          ...
          (|col_Q| #2#) (|row_Q| #2#) (|col_P| #2#) (#3=#:G1411 NIL)
          (#4=#:G1410 NIL) (|row_P| #2#) (|j_min| (|NonNegativeInteger|))
          (#5=#:G1409 NIL) (|n| (|NonNegativeInteger|)))
         (SEQ (LETT |n| (QVELT |f| 0))
              (LETT |j_min|
...
(SDEFUN |FDALG;factorizationGroebner;$2NniL;128|
        ((|f| $) (|k_rows| |NonNegativeInteger|)
         (|k_cols| |NonNegativeInteger|) ($ |List| (|Polynomial| F)))
        (SPROG
         ((|lst_gro| (|List| (|Polynomial| F))) (#1=#:G1428 NIL) (|eqn| NIL)
          (#2=#:G1427 NIL) (|bas_gro| (|List| |tDMP|))
          (|eqn_wrk| (|List| |tDMP|)) (#3=#:G1426 NIL) (#4=#:G1425 NIL)
          (|var_wrk| (|List| |tOVL|)) (#5=#:G1416 NIL) (#6=#:G1424 NIL)
          (|var| NIL) (#7=#:G1423 NIL)
          (|tPRD|
...
(SDEFUN |FDALG;refineUR!;$Nni$;130|
        ...
        (SPROG
         ((|trn_wrk| (|List| (|Matrix| F)))
          ...
          (#2=#:G1449 NIL) (|rminb| #3=(|NonNegativeInteger|)) (|rmina| #3#)
          (|cmaxb| #4=(|NonNegativeInteger|)) (|cmaxa| #4#) (#5=#:G1437 NIL)
          (#6=#:G1451 NIL) (|k| NIL) (|j_ref| (|NonNegativeInteger|))
          (|blo_mtx| (|Matrix| (|NonNegativeInteger|))) (|lst_4| #1#)
          (|lst_2| #1#) (#7=#:G1450 NIL) (|n| #3#))
         (SEQ
          (EXIT
           (SEQ (LETT |n| (QVELT |f| 0))
                (COND ((<= |n| 2) (PROGN (LETT #7# |f|) (GO #8=#:G1448))))
...
(SDEFUN |FDALG;refineUR!;2$;131| ((|f| $) ($ $))
        (SPROG
         ((#1=#:G1459 NIL) (#2=#:G1454 NIL) (|k| NIL) (#3=#:G1458 NIL)
          (|n| (|NonNegativeInteger|)))
         (SEQ
          (EXIT
           (SEQ (LETT |n| (QVELT |f| 0))
                (COND ((<= |n| 2) (PROGN (LETT #3# |f|) (GO #4=#:G1457))))
                (SEQ (LETT |k| 1)
                     (LETT #1#
                           (PROG1 (LETT #2# (- |n| 2))
                             (|check_subtype2| (>= #2# 0)
...
(SDEFUN |FDALG;normalALS;2$;133| ((|f| $) ($ $))
        (SPROG
         ((|als| ($)) (#1=#:G1481 NIL) (|k| NIL) (|a_ref| (F))
          (|i_ref| (|NonNegativeInteger|)) (#2=#:G1473 NIL)
          (|n| (|NonNegativeInteger|))
          (|lst_tmp| (|List| (|NonNegativeInteger|))) (#3=#:G1480 NIL)
          (|i_max| (|NonNegativeInteger|)) (#4=#:G1477 NIL) (#5=#:G1479 NIL)
          (|i_min| (|NonNegativeInteger|)) (#6=#:G1478 NIL)
                  ...
                  (SEQ (LETT |k| 2)
                       ...
                       (SEQ
                        (COND
                         ((>= (SPADCALL |blo_mtx| |k| 2 (QREFELT $ 184))
                              |i_ref|)
                          (PROGN (LETT #4# |$NoValue|) (GO #10=#:G1470))))
                        (EXIT
                         (LETT |i_max|
                               (SPADCALL |blo_mtx| |k| 2 (QREFELT $ 184)))))
                       (LETT |k| (|inc_SI| |k|)) (GO G190) G191 (EXIT NIL)))
...
(SDEFUN |FDALG;leftMinimization;$2Nni$;134|
        ((|f| $) (|i_min| |NonNegativeInteger|) (|i_max| |NonNegativeInteger|)
         ($ $))
        (SPROG
         ((#1=#:G1489 NIL) (|g| ($)) (|trn_wrk| (|List| (|Matrix| F)))
          (|lst_2| (|List| (|NonNegativeInteger|))) (#2=#:G1491 NIL) (|i| NIL)
          (|lst_1| (|List| (|NonNegativeInteger|))) (#3=#:G1490 NIL))
         (SEQ
          (EXIT
           (COND
...
(SDEFUN |FDALG;rightMinimization;$2Nni$;135|
        ((|f| $) (|i_min| |NonNegativeInteger|) (|i_max| |NonNegativeInteger|)
         ($ $))
        (SPROG
         ((#1=#:G1503 NIL) (|g| ($)) (|trn_wrk| (|List| (|Matrix| F)))
          (|lst_2| (|List| (|NonNegativeInteger|))) (|i| NIL) (#2=#:G1496 NIL)
          (|lst_1| (|List| (|NonNegativeInteger|))) (#3=#:G1504 NIL))
         (SEQ
          (EXIT
           (COND
            ((OR (OR (> |i_min| |i_max|) (<= |i_min| 1))
                  ...
                  (COND
                   ((> (LENGTH |trn_wrk|) 0)
                    (SEQ
                     ...
                     (QSETVELT |g| 4 (QVELT |f| 4))
                     (EXIT (PROGN (LETT #1# |g|) (GO #4=#:G1502))))))
                  (EXIT |g|)))))
          #4# (EXIT #1#)))) 
...
(SDEFUN |FDALG;minimize;2$;136| ((|f| $) ($ $))
        (SPROG
         ((|n| (|NonNegativeInteger|)) (|m| (|NonNegativeInteger|))
          (|blo_mtx| (|Matrix| (|NonNegativeInteger|)))
          (|k| (|NonNegativeInteger|)) (|flg_wrk| (|Boolean|)) (#1=#:G1516 NIL)
          (|als| ($)) (#2=#:G1511 NIL) (#3=#:G1507 NIL)
          (|k_l| (|NonNegativeInteger|)) (#4=#:G1506 NIL))
         (SEQ (LETT |als| (SPADCALL |f| (QREFELT $ 51)))
...
(SDEFUN |FDALG;standardFirstColumn?| ((|f| $) ($ |Boolean|))
        (SPROG
         ((#1=#:G1562 NIL) (#2=#:G1563 NIL) (|l| NIL) (|a_ref| (|List| F))
          (|n| (|NonNegativeInteger|)))
         (SEQ
          (EXIT
           (SEQ (LETT |n| (QVELT |f| 0))
...
(SDEFUN |FDALG;standardLastRow?| ((|f| $) ($ |Boolean|))
        (SPROG
         ((#1=#:G1572 NIL) (#2=#:G1567 NIL) (#3=#:G1573 NIL) (|l| NIL)
...
(SDEFUN |FDALG;invertMIN;2$;155| ((|f| $) ($ $))
        (SPROG
         ((|f_inv| ($)) (#1=#:G1599 NIL) (#2=#:G1593 NIL) (#3=#:G1607 NIL)
          (|k| NIL) (#4=#:G1591 NIL) (#5=#:G1606 NIL) (|U_wrk| #6=(|Matrix| F))
          (|T_wrk| #6#) (#7=#:G1605 NIL) (#8=#:G1587 NIL) (#9=#:G1604 NIL)
          (#10=#:G1585 NIL) (#11=#:G1603 NIL) (#12=#:G1602 NIL)
          (#13=#:G1580 NIL) (#14=#:G1579 NIL) (#15=#:G1601 NIL)
          (#16=#:G1600 NIL) (|m| #17=(|NonNegativeInteger|)) (#18=#:G1577 NIL)
...
(SDEFUN |FDALG;^;$I$;160| ((|f| $) (|n| |Integer|) ($ $))
        (SPROG ((#1=#:G1627 NIL) (#2=#:G1623 NIL) (|g| ($)))
               (SEQ
                (EXIT
                 (SEQ
                  (COND
                   ((ZEROP |n|)
                    (PROGN (LETT #1# (|spadConstant| $ 14)) (GO #3=#:G1626))))
                  (COND
                   ((< |n| 0)
...
(SDEFUN |FDALG;refinementEquations;$3Nni2BL;163|
        ((|f| $) (|i_min| |NonNegativeInteger|) (|i_max| |NonNegativeInteger|)
         (|k_rows| |NonNegativeInteger|) (|flg_u| |Boolean|)
         (|flg_r| |Boolean|) ($ |List| (|Polynomial| F)))
        (SPROG
         ((|lst_eqn| (|List| (|Polynomial| F)))
          (|cex2| (|List| (|NonNegativeInteger|)))
          (|rex2| (|List| (|NonNegativeInteger|))) (#1=#:G1642 NIL)
          (|cex1| (|List| (|NonNegativeInteger|)))
          (|rex1| (|List| (|NonNegativeInteger|))) (#2=#:G1640 NIL)
          (|cdst| #3=(|List| (|NonNegativeInteger|))) (|rdst| #3#)
          (#4=#:G1639 NIL) (|j_max| (|NonNegativeInteger|)) (#5=#:G1638 NIL)
          (|j_min| (|NonNegativeInteger|)) (|col_Q| #3#) (|row_Q| #3#)
          (|col_P| #3#) (#6=#:G1637 NIL) (|row_P| #3#))
         (SEQ
...
(SDEFUN |FDALG;refinementGroebner;$3Nni2BL;164|
        ((|f| $) (|i_min| |NonNegativeInteger|) (|i_max| |NonNegativeInteger|)
         (|k_rows| |NonNegativeInteger|) (|flg_1| |Boolean|)
         (|flg_2| |Boolean|) ($ |List| (|Polynomial| F)))
        (SPROG
         ((|lst_gro| (|List| (|Polynomial| F))) (#1=#:G1660 NIL) (|eqn| NIL)
          (#2=#:G1659 NIL) (|bas_gro| (|List| |tDMP|))
          (|eqn_wrk| (|List| |tDMP|)) (#3=#:G1658 NIL) (#4=#:G1657 NIL)
          (|var_wrk| (|List| |tOVL|)) (#5=#:G1648 NIL) (#6=#:G1656 NIL)
          (|var| NIL) (#7=#:G1655 NIL)
          (|tPRD|
...
(SDEFUN |FDALG;refinementSolve;$3Nni2BL;165|
        ((|f| $) (|i_min| |NonNegativeInteger|) (|i_max| |NonNegativeInteger|)
         (|k_rows| |NonNegativeInteger|) (|flg_u| |Boolean|)
         (|flg_r| |Boolean|) ($ |List| (|List| (|Equation| (|Polynomial| F)))))
        (SPROG
         ((|lst_sol| (|List| (|List| (|Equation| (|Polynomial| F)))))
          (#1=#:G1667 NIL)
          (|sol_wrk| (|List| (|List| (|Equation| (|Polynomial| F)))))
...
(SDEFUN |FDALG;qrefinedGroebner?|
        ((|f| $) (|i_min| |NonNegativeInteger|) (|i_max| |NonNegativeInteger|)
         (|i| |NonNegativeInteger|) ($ |Boolean|))
        (SPROG ((#1=#:G1673 NIL) (|groe| (|List| (|Polynomial| F))))
               (SEQ
                (EXIT
                 (SEQ
                  (LETT |groe|
...
(SDEFUN |FDALG;qrefined?|
        ...
        (SPROG
         ((|flg_ref| (|Boolean|)) (#1=#:G1683 NIL) (#2=#:G1685 NIL)
          (#3=#:G1676 NIL) (|i| NIL) (|m| (|NonNegativeInteger|))
          (#4=#:G1684 NIL) (|k| NIL)
          (|blo_mtx| (|Matrix| (|NonNegativeInteger|))))
         (SEQ
          (EXIT
...
(SDEFUN |FDALG;refinePERM!|
        ((|f| $) (|i_min| |NonNegativeInteger|) (|i_max| |NonNegativeInteger|)
         ($ $))
        (SPROG
         ((#1=#:G1700 NIL) (|flg_tmp| (|Boolean|)) (#2=#:G1703 NIL) (|j| NIL)
          (#3=#:G1701 NIL) (#4=#:G1691 NIL) (#5=#:G1702 NIL) (#6=#:G1690 NIL)
...
(SDEFUN |FDALG;refine!;$B$;170| ((|f| $) (|flg| |Boolean|) ($ $))
        (SPROG
         ((|blo_mtx| (|Matrix| (|NonNegativeInteger|))) (#1=#:G1730 NIL)
          (|lst_trn| (|List| (|Matrix| F)))
          (|lst_sol| (|List| (|List| (|Equation| (|Polynomial| F)))))
          (#2=#:G1734 NIL) (#3=#:G1717 NIL) (|i| NIL)
          (|i_max| #4=(|NonNegativeInteger|)) (|i_min| #4#) (|m| #4#)
          (#5=#:G1733 NIL) (|k| NIL) (|num_blo| (|NonNegativeInteger|))
          (#6=#:G1715 NIL) (#7=#:G1731 NIL) (#8=#:G1732 NIL) (#9=#:G1708 NIL)
          (|n| (|NonNegativeInteger|)))
         (SEQ
          (EXIT
           (SEQ (LETT |n| (QVELT |f| 0))
                ...
                (COND
                 ((OR (EQL |n| 1)
                  ...
                  (SEQ (QSETVELT |f| 4 'T)
                       (EXIT (PROGN (LETT #7# |f|) (GO #10=#:G1729))))))
                (LETT |num_blo|
                      (PROG1
...
(SDEFUN |FDALG;zero?;$B;173| ((|f| $) ($ |Boolean|))
        (SPROG ((#1=#:G1753 NIL) (|als| ($)))
               (SEQ
                (EXIT
                 (SEQ
                  (COND
                   ((|FDALG;qzerov?| (QVELT |f| 2) 1 (QVELT |f| 0) $)
                    (PROGN (LETT #1# 'T) (GO #2=#:G1752))))
                  (COND
                   ((NULL (SPADCALL |f| (QREFELT $ 71)))
...
(SDEFUN |FDALG;=;2$B;174| ((|f| $) (|g| $) ($ |Boolean|))
        (SPROG
         ((#1=#:G1768 NIL) (|trn_wrk| (|List| (|Matrix| F)))
           ...
           (SEQ
            ...
            (LETT |trn_wrk|
                  (SPADCALL |als| |lst_2| |lst_1| |lst_1| |lst_2|
                            (QREFELT $ 166)))
            (COND
             ((> (LENGTH |trn_wrk|) 0) (PROGN (LETT #1# 'T) (GO #3=#:G1767))))
            (COND ((QVELT |f| 3) (COND ((QVELT |g| 3) (EXIT NIL)))))
            (EXIT (SPADCALL |als| (QREFELT $ 338)))))
          #3# (EXIT #1#)))) 

(SDEFUN |FDALG;coerce;$Xdp;175| ((|f| $) ($ |XDistributedPolynomial| VAR F))
        (SPADCALL |f| (QREFELT $ 217))) 

(SDEFUN |FDALG;coerce;Xdp$;176| ((|p| |XDistributedPolynomial| VAR F) ($ $))
        (SPROG ((|f_wrk| ($)) (#1=#:G1774 NIL) (|trm| NIL))
...
(DEFUN |FreeDivisionAlgebra| (&REST #1=#:G1779)
  (SPROG NIL
         (PROG (#2=#:G1780)
           (RETURN
            (COND
