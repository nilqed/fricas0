...
(SDEFUN |FRIMOD;getintmat| (($ |Boolean|))
        (SPROG
         ((#1=#:G404 NIL) (|j| NIL) (#2=#:G403 NIL) (|i| NIL)
          (|m| (|Matrix| F)))
...
(SDEFUN |FRIMOD;vectProd| ((|v1| |Vector| A) (|v2| |Vector| A) ($ |Vector| A))
        (SPROG
         ((|k| (|Integer|)) (#1=#:G415 NIL) (|j| NIL) (#2=#:G414 NIL) (|i| NIL)
          (|v| (|Vector| A)))
         (SEQ
          (LETT |k|
                (SPADCALL
...
(SDEFUN |FRIMOD;*;3$;14| ((|m1| $) (|m2| $) ($ $))
        (SPROG
         ((|u| (A)) (#1=#:G423 NIL) (|i| NIL) (#2=#:G422 NIL)
          (|m| (|Matrix| R))
...
(DEFUN |FractionalIdealAsModule| (&REST #1=#:G425)
  (SPROG NIL
         (PROG (#2=#:G426)
           (RETURN
            (COND
