...
(SDEFUN |IR;neselect|
        ((|l| |List| (|Record| (|:| |integrand| F) (|:| |intvar| F))) (|x| F)
         ($ F))
        (SPROG
         ((#1=#:G423 NIL) (#2=#:G422 (F)) (#3=#:G424 (F)) (#4=#:G426 NIL)
          (|ne| NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
...
(SDEFUN |IR;nesimp|
        ...
        (SPROG
         ((|u| (F)) (#1=#:G443 NIL) (#2=#:G445 NIL) (|ne| NIL) (#3=#:G444 NIL)
          (|x| NIL) (#4=#:G442 NIL))
         (SEQ
          (PROGN
           (LETT #4# NIL)
...
(SDEFUN |IR;retractIfCan;$U;18| ((|u| $) ($ |Union| F "failed"))
        (SPROG
         ((#1=#:G452 NIL) (#2=#:G451 (F)) (#3=#:G453 (F)) (#4=#:G459 NIL)
          (|ne| NIL))
         (SEQ
          (COND
...
(SDEFUN |IR;differentiate;$MF;24| ((|u| $) (|derivation| |Mapping| F F) ($ F))
        (SPROG
         ((#1=#:G493 NIL) (#2=#:G492 (F)) (#3=#:G494 (F)) (#4=#:G498 NIL)
          (|ne| NIL) (#5=#:G488 NIL) (#6=#:G487 (F)) (#7=#:G489 (F))
          (#8=#:G497 NIL) (|log| NIL))
         (SEQ
          (SPADCALL
...
(SDEFUN |IR;pLogDeriv|
        ...
        (SPROG
         ((|ans| (F)) (|algans| #1=(|SparseUnivariatePolynomial| F))
          ...
          (#3=#:G512 NIL) (|numlog| (|SparseUnivariatePolynomial| F)) (|c| (F))
...
(SDEFUN |IR;coerce;$Of;27| ((|u| $) ($ |OutputForm|))
        (SPROG
         ((|l| (|List| (|OutputForm|))) (#1=#:G541 NIL) (|f| NIL)
          (#2=#:G540 NIL) (#3=#:G539 NIL) (#4=#:G538 NIL)
          (|r| (|Union| F "failed")))
...
(DEFUN |IntegrationResult| (#1=#:G548)
  (SPROG NIL
         (PROG (#2=#:G549)
           (RETURN
            (COND
...
(DEFUN |IntegrationResult;| (|#1|)
  (SPROG ((|pv$| NIL) (#1=#:G547 NIL) ($ NIL) (|dv$| NIL) (DV$1 NIL))
         (PROGN
