...
(SDEFUN |RINTERP;interpolate;2L2NniF;1|
        ...
        (SPROG
         ((|reslist| (|List| (|List| (|Polynomial| F)))) (#1=#:G413 NIL)
          (|i| NIL) (#2=#:G412 NIL) (#3=#:G411 NIL) (#4=#:G410 NIL)
          (|res| (|List| (|Vector| F))) (|collist| (|List| (|List| F)))
          (#5=#:G409 NIL) (#6=#:G408 NIL) (#7=#:G407 NIL) (|j| NIL)
          (#8=#:G406 NIL) (#9=#:G405 NIL) (#10=#:G404 NIL)
          (|tempvec| (|List| F)) (#11=#:G403 NIL) (#12=#:G402 NIL)
          (#13=#:G401 NIL) (#14=#:G400 NIL) (#15=#:G399 NIL) (#16=#:G398 NIL))
         (SEQ
          (COND
...
(DEFUN |RationalInterpolation| (&REST #1=#:G414)
  (SPROG NIL
         (PROG (#2=#:G415)
           (RETURN
            (COND
