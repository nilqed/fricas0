...
(SDEFUN |PLEQN;inconsistent?;LB;1| ((|pl| |List| GR) ($ |Boolean|))
        (SPROG ((#1=#:G416 NIL) (#2=#:G417 NIL) (#3=#:G418 NIL) (|p| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ
                          ...
                          (EXIT
                           (COND
                            ((SPADCALL |p| (QREFELT $ 11))
                             (PROGN
                              (LETT #1# (PROGN (LETT #2# 'T) (GO #4=#:G415)))
                              (GO #5=#:G413))))))
...
(SDEFUN |PLEQN;inconsistent?;LB;2|
        ...
        (SPROG ((#1=#:G423 NIL) (#2=#:G424 NIL) (#3=#:G425 NIL) (|p| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ
                          ...
                          (EXIT
                           (COND
                            ((SPADCALL |p| (QREFELT $ 15))
                             (PROGN
                              (LETT #1# (PROGN (LETT #2# 'T) (GO #4=#:G422)))
                              (GO #5=#:G420))))))
                         (LETT #3# (CDR #3#)) (GO G190) G191 (EXIT NIL)))
                   #5# (EXIT #1#))
                  (EXIT NIL)))
...
(SDEFUN |PLEQN;B1solve;RR;3|
        ...
        (SPROG
         ((|pbas| (|List| (|Vector| (|Fraction| (|Polynomial| R)))))
          (|pb| #1=(|Vector| (|Fraction| (|Polynomial| R)))) (#2=#:G450 NIL)
          (|j| NIL) (|j1| NIL) (#3=#:G449 NIL) (|i| NIL) (|i1| NIL)
          (#4=#:G448 NIL) (#5=#:G447 NIL)
          (|augmat| (|Matrix| (|Fraction| (|Polynomial| R)))) (#6=#:G446 NIL)
          (#7=#:G445 NIL) (#8=#:G444 NIL) (|p| #1#)
        ...
        (SPROG
         ((|test|
           (|Record| (|:| |sysok| (|Boolean|)) (|:| |z0| (|List| GR))
                     (|:| |n0| (|List| GR))))
          (|yzero| (|List| GR)) (#3=#:G486 NIL) (|pw| NIL) (#4=#:G485 NIL)
          (|wcd| (|List| (|Polynomial| R))) (#5=#:G477 NIL)
          (|wnum| (|Polynomial| R)) (|weqn| #6=(|Fraction| (|Polynomial| R)))
          (#7=#:G462 NIL) (#8=#:G461 #6#) (#9=#:G463 #6#) (#10=#:G484 NIL)
          (|j| NIL) (#11=#:G483 NIL) (|i| NIL) (|frows| (|List| (|Integer|)))
          ...
          (|sys|
           (|Record| (|:| |mat| (|Matrix| (|Fraction| (|Polynomial| R))))
                     ...
                     (|:| |cols| (|List| (|Integer|)))))
          (|nss| #2#) (|rss| #1#)
          (|nc| (|Matrix| (|Fraction| (|Polynomial| R)))) (#13=#:G455 NIL)
          (#14=#:G454 (GR)) (#15=#:G456 (GR)) (#16=#:G482 NIL) (#17=#:G378 NIL)
          (#18=#:G481 NIL) (|x| NIL) (#19=#:G480 NIL) (#20=#:G479 NIL)
          (#21=#:G478 NIL) (|ydetf| (|List| GR)))
         (SEQ
          (EXIT
                     ...
                     (|:| |bsoln|
                          (|Record|
                           ...
                           (|:| |basis|
                                (|List|
                                 (|Vector| (|Fraction| (|Polynomial| R)))))))))
          (#1=#:G508 NIL) (|y| NIL) (|psbf| (|List| (|List| GR)))
          (#2=#:G507 NIL) (|x| NIL) (#3=#:G506 NIL) (|psb| #4=(|List| GR))
          (|pc|
           #5=(|List|
...
(SDEFUN |PLEQN;factorset;GRL;6| ((|y| GR) ($ |List| GR))
        (SPROG ((#1=#:G514 NIL) (|j| NIL) (#2=#:G513 NIL))
               (SEQ
        ...
        (SPROG
         ((|rcl|
          ...
          (|test|
           (|Record| (|:| |sysok| (|Boolean|)) (|:| |z0| (|List| GR))
                     (|:| |n0| (|List| GR))))
          (|p| (GR)) (#4=#:G532 NIL) (|rc| NIL) (#5=#:G533 NIL)
          (|maxrk| (|Integer|))
          (|pc|
           (|List|
            (|Record| (|:| |det| GR) (|:| |rows| (|List| (|Integer|)))
                      (|:| |cols| (|List| (|Integer|))))))
          (#6=#:G530 NIL) (|k| NIL) (#7=#:G531 NIL)
...
(SDEFUN |PLEQN;redpps;RLR;8|
        ...
        (SPROG
         ((#3=#:G551 NIL) (|i| NIL)
          (|pbj| (|Vector| (|Fraction| (|Polynomial| R)))) (#4=#:G550 NIL)
          (|j| NIL) (#5=#:G549 NIL) (|denmat| #6=(|Matrix| GR)) (|nummat| #6#)
          (#7=#:G548 NIL) (#8=#:G547 NIL) (#9=#:G546 NIL)
...
(SDEFUN |PLEQN;dmp2rfi;MM;9|
        ...
        (SPROG
         ((#1=#:G557 NIL) (|j| NIL) (#2=#:G556 NIL) (|i| NIL)
...
(SDEFUN |PLEQN;dmp2rfi;LL;10|
        ...
        (SPROG ((#1=#:G561 NIL) (|v| NIL) (#2=#:G560 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
                    ...
                    (|:| |bsoln|
                         (|Record|
                          ...
                          (|:| |basis|
                               (|List|
                                (|Vector| (|Fraction| (|Polynomial| R))))))))))
        (SPROG ((#1=#:G575 NIL) (|i| NIL) (#2=#:G574 NIL))
               (SEQ
                (QCAR
                 (SPADCALL |mat|
                           (PROGN
                    ...
                    (|:| |bsoln|
                         (|Record|
                          ...
                          (|:| |basis|
                               (|List|
                                (|Vector| (|Fraction| (|Polynomial| R))))))))))
        (SPROG ((#1=#:G588 NIL) (|i| NIL) (#2=#:G587 NIL))
               (SEQ
                (QCAR
                 (SPADCALL |mat|
                           (PROGN
...
(SDEFUN |PLEQN;nextSublist;2IL;20|
        ...
        (SPROG
         ((|mslist| (|List| (|List| (|Integer|)))) (#1=#:G602 NIL) (|ms| NIL))
         (SEQ
...
(SDEFUN |PLEQN;hasoln;2LR;24|
        ((|zro| |List| GR) (|nzro| |List| GR)
         ($ |Record| (|:| |sysok| (|Boolean|)) (|:| |z0| (|List| GR))
          (|:| |n0| (|List| GR))))
        (SPROG
         ((#1=#:G645 NIL) (|p| NIL) (#2=#:G644 NIL) (#3=#:G643 NIL)
          (#4=#:G642 NIL) (#5=#:G620 NIL) (#6=#:G619 (GR)) (#7=#:G621 (GR))
          (#8=#:G641 NIL) (#9=#:G380 NIL) (#10=#:G640 NIL) (|x| NIL)
          (#11=#:G639 NIL) (|psbf| (|List| (|List| GR))) (#12=#:G638 NIL)
          (#13=#:G637 NIL) (#14=#:G636 NIL) (#15=#:G635 NIL) (|pnzro| (GR))
          (#16=#:G615 NIL) (#17=#:G614 (GR)) (#18=#:G616 (GR)) (#19=#:G634 NIL)
          (#20=#:G379 NIL))
         (SEQ
...
(SDEFUN |PLEQN;se2rfi;LL;25|
        ...
        (SPROG ((#1=#:G649 NIL) (|wi| NIL) (#2=#:G648 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |PLEQN;wrregime;LSI;27|
        ((|lrec3| |List|
         ...
         (|outname| |String|) ($ |Integer|))
        (SPROG
         ((|count| (|Integer|)) (#1=#:G657 NIL) (|rec3| NIL)
          (|rksoln|
           (|File|
            (|Record| (|:| |eqzro| (|List| GR)) (|:| |neqzro| (|List| GR))
                      (|:| |wcond| (|List| (|Polynomial| R)))
...
(SDEFUN |PLEQN;maxrank;LNni;30|
        ((|rcl| |List|
         ...
         ($ |NonNegativeInteger|))
        (SPROG
         ((#2=#:G671 NIL) (#3=#:G670 #1#) (#4=#:G672 #1#) (#5=#:G675 NIL)
          (|j| NIL))
         (SEQ
          (COND ((NULL |rcl|) 0)
                (#6='T
...
(SDEFUN |PLEQN;minrank;LNni;31|
        ((|rcl| |List|
         ...
         ($ |NonNegativeInteger|))
        (SPROG
         ((#2=#:G678 NIL) (#3=#:G677 #1#) (#4=#:G679 #1#) (#5=#:G682 NIL)
          (|j| NIL))
         (SEQ
          (COND ((NULL |rcl|) 0)
                (#6='T
...
(SDEFUN |PLEQN;minset;2L;32|
        ...
        (SPROG ((#1=#:G688 NIL) (|x| NIL) (#2=#:G687 NIL))
               (SEQ
                (COND ((NULL |lset|) |lset|)
                      ('T
                       (PROGN
...
(SDEFUN |PLEQN;sqfree;2GR;33| ((|p| GR) ($ GR))
        (SPROG
         ((#1=#:G691 NIL) (#2=#:G690 (GR)) (#3=#:G692 (GR)) (#4=#:G694 NIL)
          (|j| NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
...
(SDEFUN |PLEQN;ParCond;MNniL;34|
        ...
        (SPROG
         ((|DetEqn|
          ...
          (|matsub| (|SquareMatrix| |j| GR)) (#3=#:G707 NIL) (|nss| NIL)
          (#4=#:G708 NIL) (#5=#:G705 NIL) (|rss| NIL) (#6=#:G706 NIL)
...
(SDEFUN |PLEQN;redmat;MLM;36|
        ...
        (SPROG
         ((|p| (GR)) (#1=#:G721 NIL) (|j| NIL) (#2=#:G720 NIL) (|i| NIL)
...
(DEFUN |ParametricLinearEquations| (&REST #1=#:G722)
  (SPROG NIL
         (PROG (#2=#:G723)
           (RETURN
            (COND
