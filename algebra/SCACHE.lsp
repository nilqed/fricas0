...
(SDEFUN |SCACHE;expandCache| ((|x| S) ($ |Void|))
        (SPROG ((#1=#:G393 NIL) (|k| NIL) (|ocache| (|PrimitiveArray| S)))
               (SEQ
                (COND
...
(SDEFUN |SCACHE;insertBefore| ((|l| |NonNegativeInteger|) (|x| S) ($ |Void|))
        (SPROG ((#1=#:G397 NIL) (|k| NIL) (|vscan| (|PrimitiveArray| S)))
...
(SDEFUN |SCACHE;shiftCache|
        ...
        (SPROG
         ((|x| (S)) (#1=#:G402 NIL) (|k| NIL) (|vscan| (|PrimitiveArray| S)))
...
(SDEFUN |SCACHE;clearCache;V;4| (($ |Void|))
        (SPROG
         ((|x| (S)) (#1=#:G407 NIL) (|k| NIL) (|vscan| (|PrimitiveArray| S)))
         (SEQ (LETT |vscan| (QREFELT $ 7))
              (SEQ (LETT |k| 0) (LETT #1# (- (QREFELT $ 9) 1)) G190
                   (COND ((|greater_SI| |k| #1#) (GO G191)))
                   (SEQ (LETT |x| (QAREF1 |vscan| |k|))
...
(SDEFUN |SCACHE;linearSearch;SMU;6|
        ...
        (SPROG
         ((#1=#:G425 NIL) (|k| (|Integer|)) (|vscan| (|PrimitiveArray| S))
          (|y| (S)))
         (SEQ
          (EXIT
           (SEQ (LETT |k| 0)
                     ...
                     (SEQ (LETT |vscan| (QREFELT $ 7))
                          ...
                          (EXIT
                           (COND
                            ((SPADCALL |y| |equal?|)
                             (SEQ
                              (SPADCALL |x| (SPADCALL |y| (QREFELT $ 13))
                                        (QREFELT $ 14))
                              (EXIT
                               (PROGN
                                (LETT #1# (CONS 0 |y|))
...
(SDEFUN |SCACHE;enterInCache;SMS;8|
        ...
        (SPROG
         ((#1=#:G451 NIL) (|pos| (|NonNegativeInteger|)) (#2=#:G457 NIL)
