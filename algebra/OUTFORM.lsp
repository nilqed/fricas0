...
(SDEFUN |OUTFORM;convert;$If;14| ((|a| $) ($ |InputForm|))
        (SPROG
         ((#1=#:G1933 NIL) (|b| (|SExpression|)) (|d| (|String|))
          (|l| (|Integer|)) (|c| (|String|)))
         (SEQ
          (EXIT
           (SEQ (LETT |b| |a|)
...
(SDEFUN |OUTFORM;matrix;L$;26| ((|ll| |List| (|List| $)) ($ $))
        (SPROG ((|lv| (|List| $)) (#1=#:G1951 NIL) (|l| NIL) (#2=#:G1950 NIL))
               (SEQ
                 ...
                 (SEQ
                  (LETT |e|
                        (COND ((IDENTP |a|) |a|) ((STRINGP |a|) (INTERN |a|))
                              (#2='T (PROGN (LETT #1# NIL) (GO #3=#:G2005)))))
...
(SDEFUN |OUTFORM;prime;2$;78| ((|a| $) ($ $)) (SPADCALL |a| 1 (QREFELT $ 120))) 
...
(SDEFUN |OUTFORM;differentiate;$Nni$;91|
        ...
        (SPROG ((|s| (|String|)) (|r| (|String|)) (#1=#:G2038 NIL))
               (SEQ
                (COND ((ZEROP |nn|) |a|)
