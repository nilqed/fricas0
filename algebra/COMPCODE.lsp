...
(SDEFUN |COMPCODE;genFuncDeclar|
        ((|content| |ILogic|) (|numb| |NonNegativeInteger|)
         ($ |List| (|String|)))
        (SPROG
         ((|resStr| (|String|)) (|notfst| (|Boolean|)) (#1=#:G394 NIL)
          (|thisTerm| NIL) (|resType| (|ILogic|))
          (|deduct| (|List| (|ILogic|))) (#2=#:G393 NIL)
          (|fac| (|List| (|ILogic|))))
         (SEQ
          (EXIT
...
(SDEFUN |COMPCODE;genLambdaTerm|
        ...
        (SPROG
         ((|s| (|String|)) (|ch| (|List| (|Lambda| (|Typed|))))
          ...
          (#1=#:G408 NIL) (|i| (|NonNegativeInteger|)))
         (SEQ
          (EXIT
           (SEQ (LETT |s| "")
                (COND
...
(SDEFUN |COMPCODE;genFuncDefn|
        ((|content| |Lambda| (|Typed|)) (|numb| |NonNegativeInteger|)
         ($ |List| (|String|)))
        (SPROG
         ((#1=#:G413 NIL) (|lhst| (|String|)) (|lhsn| (|String|))
...
(SDEFUN |COMPCODE;writeCategory;L3SV;8|
        ...
        (SPROG
         ((#1=#:G421 NIL) (|line| NIL) (|lines| (|List| (|String|)))
          (|fnNum| (|NonNegativeInteger|)) (#2=#:G420 NIL) (|thisEq| NIL)
          (|f1| (|TextFile|)))
         (SEQ
          (LETT |f1|
...
(SDEFUN |COMPCODE;writePackage;L4SV;9|
        ((|content| |List| (|Lambda| (|Typed|))) (|filename| |String|)
         ...
         ($ |Void|))
        (SPROG
         ((#1=#:G428 NIL) (|line| NIL) (|lines| (|List| (|String|)))
          (|fnNum| (|NonNegativeInteger|)) (#2=#:G427 NIL) (|thisEq| NIL)
          (|f1| (|TextFile|)))
         (SEQ
          (LETT |f1|
                (SPADCALL (SPADCALL |filename| (QREFELT $ 36)) "output"
