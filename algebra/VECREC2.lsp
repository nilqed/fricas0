...
(SDEFUN |VECREC2;empty;I$;2| ((|nint| |Integer|) ($ $))
        (SPROG ((|intvec| (|PrimitiveArray| (|Integer|))) (#1=#:G397 NIL))
               (SEQ
                (LETT |intvec|
                      (MAKEARR1
                       (PROG1 (LETT #1# |nint|)
...
(SDEFUN |VECREC2;chinese_update;UvI$V;3|
        ...
        (SPROG
         ((|nmp| #1=(|Integer|)) (|cor| #2=(|Integer|)) (|ii| (|Integer|))
          (#3=#:G418 NIL) (|i| NIL) (|mpfact| #1#) (|nbmp| #1#)
          (|mpcor| (|Integer|)) (|mpval| #2#) (|bmp| (|Integer|))
          (|bintvec| (|PrimitiveArray| (|Integer|))) (#4=#:G417 NIL)
          (#5=#:G403 NIL) (#6=#:G416 NIL)
...
(SDEFUN |VECREC2;hensel_update;UvI$V;4|
        ((|vec| |U32Vector|) (|p| |Integer|) (|statearg| $) ($ |Void|))
        (SPROG
         ((#1=#:G423 NIL) (|i| NIL) (|intvec| (|PrimitiveArray| (|Integer|)))
...
(SDEFUN |VECREC2;rational_reconstruction2|
        ((|statearg| $) (|block_offsets| |Vector| (|Integer|))
         ($ |Union|
          ...
          "failed"))
        (SPROG
         ((#1=#:G478 NIL) (|cden| #2=(|Integer|))
          (|ppr| (|Record| (|:| |num| (|Integer|)) (|:| |den| (|Integer|))))
          (|pp|
           (|Union| (|Record| (|:| |num| (|Integer|)) (|:| |den| #2#))
                    "failed"))
          (|r1| (|Integer|)) (|co| (|Integer|)) (|cb| (|Integer|))
          (|j| #3=(|Integer|)) (#4=#:G477 NIL) (|ctmp| (|Integer|))
          (#5=#:G479 NIL) (|jj| NIL) (|dens| (|PrimitiveArray| (|Integer|)))
          (|nums| (|PrimitiveArray| (|Integer|))) (#6=#:G457 NIL)
          (#7=#:G455 NIL) (|mm| (|NonNegativeInteger|)) (|n| (|Integer|))
...
(SDEFUN |VECREC2;lcm|
        ((|nums| |PrimitiveArray| (|Integer|)) (|lo| |Integer|)
         (|hi| |Integer|) ($ |Integer|))
        (SPROG ((|res| (|Integer|)) (#1=#:G488 NIL) (|i| NIL))
...
(SDEFUN |VECREC2;remove_denoms;V3Pa;10|
        ...
        (SPROG
         ((#1=#:G495 NIL) (#2=#:G507 NIL) (|i| NIL) (|cfactor| (|Integer|))
          (|tmpp2| (|Integer|)) (#3=#:G506 NIL) (|cden| (|Integer|))
          (|hi| #4=(|Integer|)) (|li| #4#) (#5=#:G505 NIL) (|ib| NIL)
          ...
          (EXIT
           (SEQ
            ...
            (EXIT
             (COND
              ((QEQCAR |pp| 1)
               (PROGN (LETT #1# (CONS 1 "failed")) (GO #2=#:G516)))
              ('T
