...
(SDEFUN |XPFACT;top_split;XdpL;2|
        ...
        (SPROG
         ((|p2| #1=(|XDistributedPolynomial| |vl| F)) (|p1| #1#)
          ...
          (#3=#:G419 NIL) (|r| NIL) (#4=#:G418 NIL) (|lt1| (|List| #2#))
          (#5=#:G417 NIL) (#6=#:G416 NIL) (|lt| (|List| #2#))
...
(SDEFUN |XPFACT;left_ext_GCD;2XdpU;5|
        ...
        (SPROG
         ((|v| #1=(|XDistributedPolynomial| |vl| F))
          ...
          (|#G16| (|XDistributedPolynomial| |vl| F)) (#5=#:G448 NIL) (|r| #4#)
                     ...
                     (SEQ
                      ...
                      (COND
                       ((NULL
                        ...
                        (EXIT
                         (PROGN (LETT #5# (CONS 1 "failed")) (GO #7=#:G447)))))
                      (PROGN
                       (LETT |#G16| |b|)
                       (LETT |#G17| |r|)
                       (LETT |a| |#G16|)
...
(SDEFUN |XPFACT;homo_fact;XdpL;7|
        ...
        (SPROG
         ((|res| (|List| (|XDistributedPolynomial| |vl| F)))
          (|p1| (|XDistributedPolynomial| |vl| F)) (#1=#:G469 NIL)
...
(SDEFUN |XPFACT;eval_sup|
        ((|p1| |SparseUnivariatePolynomial| F)
         ...
         ($ |XDistributedPolynomial| |vl| F))
        (SPROG
         ((|res| (|XDistributedPolynomial| |vl| F)) (#1=#:G492 NIL) (|i| NIL)
          (|od| (|Integer|)) (#2=#:G491 NIL) (|nd| (|NonNegativeInteger|))
          (|c| (F)))
...
(SDEFUN |XPFACT;firstn|
        ((|w| |FreeMonoid| |vl|) (|j| |Integer|) ($ |FreeMonoid| |vl|))
        (SPROG ((|res| (|FreeMonoid| |vl|)) (#1=#:G501 NIL) (|i| NIL))
...
(SDEFUN |XPFACT;rational_solution|
        ...
        (SPROG
         ((|sol| (|List| F)) (|v| (|Symbol|)) (#1=#:G515 NIL)
          (|sol1| (|List| (|Fraction| (|Polynomial| F)))) (#2=#:G516 NIL)
          (|eq| NIL) (#3=#:G517 NIL) (|s| NIL))
         (SEQ
          (EXIT
           (SEQ (LETT |sol| NIL)
...
(SDEFUN |XPFACT;get_rational_solution|
        ((|lsol| |List| (|List| (|Equation| (|Fraction| (|Polynomial| F)))))
         (|ls| |List| (|Symbol|)) ($ |List| F))
        (SPROG ((#1=#:G522 NIL) (|sol| (|List| F)) (#2=#:G523 NIL) (|leq| NIL))
               (SEQ
                (EXIT
                 (SEQ
...
(SDEFUN |XPFACT;my_mul|
        ((|l| |List| (|XDistributedPolynomial| |vl| F))
         ($ |XDistributedPolynomial| |vl| F))
        (SPROG
         ((|res| (|XDistributedPolynomial| |vl| F)) (#1=#:G540 NIL) (|p| NIL))
...
(SDEFUN |XPFACT;overlap_steps|
        ...
        (SPROG
         ((|d| (|NonNegativeInteger|)) (|res| (|List| (|Integer|)))
          (#1=#:G541 NIL) (#2=#:G547 NIL) (|p2| NIL) (#3=#:G548 NIL) (|k| NIL)
...
(SDEFUN |XPFACT;dc_fact11|
        ...
        (SPROG
         ((#1=#:G589 NIL) (|w| (|XDistributedPolynomial| |vl| F))
          ...
          (|ueqs| (|List| (|SparseUnivariatePolynomial| F))) (#6=#:G591 NIL)
          (|eq| NIL) (#7=#:G590 NIL))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |XPFACT;dc_fact1|
        ...
        (SPROG
         ((|rf| (|XDistributedPolynomial| |vl| F))
          ...
          (|ts| (|List| (|XDistributedPolynomial| |vl| F))) (#3=#:G672 NIL)
          (|lr1| NIL) (#4=#:G673 NIL) (|rr1| NIL) (#5=#:G671 NIL)
          (#6=#:G670 NIL) (|j| NIL)
          (|rrl| (|List| (|XDistributedPolynomial| |vl| (|Polynomial| F))))
          (|rf1| #7=(|XDistributedPolynomial| |vl| (|Polynomial| F)))
          (#8=#:G668 NIL) (#9=#:G669 NIL) (#10=#:G667 NIL) (#11=#:G666 NIL)
          (|lrl| (|List| (|XDistributedPolynomial| |vl| (|Polynomial| F))))
          (|lf1| #12=(|XDistributedPolynomial| |vl| (|Polynomial| F)))
          (#13=#:G664 NIL) (#14=#:G665 NIL) (#15=#:G663 NIL) (#16=#:G662 NIL)
          ...
          (|#G122|
           (|Record| (|:| |l_fac| #12#) (|:| |r_fac| #7#)
                     (|:| |residual|
                          (|XDistributedPolynomial| |vl| (|Polynomial| F)))
                     (|:| |nsym| #18#)))
          (#19=#:G660 NIL) (#20=#:G661 NIL) (#21=#:G659 NIL)
          (|lovl| (|List| (|Integer|))) (|ovls| (|Integer|)) (|o_case| #17#)
          (#22=#:G658 NIL) (|md| (|NonNegativeInteger|))
...
(DEFUN |XPolynomialFactor| (&REST #1=#:G695)
  (SPROG NIL
         (PROG (#2=#:G696)
           (RETURN
            (COND
