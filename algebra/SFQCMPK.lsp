...
(SDEFUN |SFQCMPK;squareFreeFactors| ((|lp| |List| P) ($ |List| P))
        (SPROG
         ((|lsflp| (|List| P)) (|lsfp| (|List| P)) (#1=#:G447 NIL) (|p| NIL))
         (SEQ (LETT |lsflp| NIL)
...
(SDEFUN |SFQCMPK;moreAlgebraic?;2TSB;6| ((|ts| TS) (|us| TS) ($ |Boolean|))
        (SPROG ((#1=#:G475 NIL) (#2=#:G476 NIL) (#3=#:G477 NIL) (|p| NIL))
               (SEQ
                (EXIT
                 (COND
...
(SDEFUN |SFQCMPK;internalSubQuasiComponent?;2TSU;13|
        ...
        (SPROG
         ((#1=#:G539 NIL) (|b| (|Boolean|)) (#2=#:G542 NIL) (|p| NIL)
          (|lsfp| (|List| P)) (#3=#:G537 NIL) (#4=#:G541 NIL) (#5=#:G538 NIL)
          (#6=#:G523 NIL) (#7=#:G540 NIL))
         (SEQ
          (EXIT
...
(SDEFUN |SFQCMPK;internalSubQuasiComponent?;2TSU;14|
        ((|ts| TS) (|us| TS) ($ |Union| (|Boolean|) "failed"))
        (SPROG
         ((#1=#:G557 NIL) (#2=#:G559 NIL) (#3=#:G561 NIL) (|p| NIL)
          (#4=#:G558 NIL) (#5=#:G548 NIL) (#6=#:G560 NIL))
         (SEQ
          (EXIT
           (COND ((SPADCALL |us| |ts| (QREFELT $ 52)) (CONS 0 'T))
                 ((NULL (SPADCALL |ts| |us| (QREFELT $ 46))) (CONS 0 NIL))
...
(SDEFUN |SFQCMPK;subQuasiComponent?;TSLB;16|
        ...
        (SPROG ((#1=#:G573 NIL) (#2=#:G574 NIL) (#3=#:G575 NIL) (|us| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ
                          ...
                          (EXIT
                           (COND
                            ((SPADCALL |ts| |us| (QREFELT $ 61))
                             (PROGN
                              (LETT #1# (PROGN (LETT #2# 'T) (GO #4=#:G572)))
                              (GO #5=#:G570))))))
                         (LETT #3# (CDR #3#)) (GO G190) G191 (EXIT NIL)))
                   #5# (EXIT #1#))
                  (EXIT NIL)))
...
(SDEFUN |SFQCMPK;removeAssociates| ((|lp| |List| P) ($ |List| P))
        (SPROG ((#1=#:G625 NIL) (|p| NIL) (#2=#:G624 NIL))
               (SEQ
                (SPADCALL
                 (PROGN
                  (LETT #2# NIL)
...
(SDEFUN |SFQCMPK;branchIfCan;LTSL5BU;20|
        ((|leq| |List| P) (|ts| TS) (|lineq| |List| P) (|b1| |Boolean|)
         ...
         ($ |Union|
          ...
          "failed"))
        (SPROG
         ((|newleq| (|List| P)) (#1=#:G664 NIL) (|newp| (P)) (#2=#:G646 NIL)
          (|g| (P)) (#3=#:G668 NIL) (|q| NIL) (#4=#:G667 NIL) (|p| NIL)
          (#5=#:G661 NIL) (#6=#:G666 NIL) (#7=#:G662 NIL) (#8=#:G665 NIL)
          (|ps| (|GeneralPolynomialSet| R E V P)) (#9=#:G663 NIL))
         (SEQ
          (EXIT
           (SEQ
            (COND
          ...
          (|newBranch|
           #6=(|Union|
               (|Record| (|:| |eq| (|List| P)) (|:| |tower| TS)
                         (|:| |ineq| (|List| P)))
               "failed"))
          (|lineq| #2#) (|leq| #1#) (|ubf2| #6#) (|ubf1| #6#) (#7=#:G705 NIL)
          (|branch| NIL) (#8=#:G704 NIL) (|f| NIL) (|lsfp| (|List| P))
          (#9=#:G703 NIL) (|p| NIL) (#10=#:G702 NIL) (#11=#:G701 NIL))
         (SEQ
          (LETT |lp|
                (SPADCALL (ELT $ 16)
                          (SPADCALL (ELT $ 67)
...
(DEFUN |SquareFreeQuasiComponentPackage| (&REST #1=#:G708)
  (SPROG NIL
         (PROG (#2=#:G709)
           (RETURN
            (COND
