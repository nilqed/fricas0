...
(SDEFUN |FACUTIL;degree;SupLL;4|
        ...
        (SPROG
         ((|ldeg| #1#) (#2=#:G388 NIL) (#3=#:G387 #4=(|NonNegativeInteger|))
          (#5=#:G389 #4#) (#6=#:G395 NIL) (|fc| NIL) (#7=#:G394 NIL) (|xx| NIL)
          (#8=#:G393 NIL) (|coefs| (|List| P)))
...
(SDEFUN |FACUTIL;variables;SupL;5|
        ...
        (SPROG
         ((#1=#:G397 NIL) (#2=#:G396 #3=(|List| OV)) (#4=#:G398 #3#)
          (#5=#:G400 NIL) (|cf| NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
...
(DEFUN |FactoringUtilities| (&REST #1=#:G411)
  (SPROG NIL
         (PROG (#2=#:G412)
           (RETURN
            (COND
