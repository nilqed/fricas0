...
(SDEFUN |ASSOCEQ;makeMatrix|
        ...
        (SPROG ((#1=#:G383 NIL) (|i| NIL) (#2=#:G382 NIL))
               (SEQ
                (SPADCALL
                 (PROGN
                  (LETT #2# NIL)
...
(SDEFUN |ASSOCEQ;associatedSystem;LPiR;2|
        ...
        (SPROG
         ((|u| (|Union| S #1="failed")) (#2=#:G405 NIL) (#3=#:G400 NIL)
          (#4=#:G420 NIL) (|j| NIL) (#5=#:G393 NIL) (#6=#:G419 NIL) (|k| NIL)
          (|wi| (S)) (|eq| (|Vector| R)) (#7=#:G418 NIL) (|i| NIL)
          (|a| (|Vector| R)) (#8=#:G389 NIL) (#9=#:G417 NIL) (#10=#:G416 NIL)
          (|an| (R)) (|m1| (|PositiveInteger|)) (#11=#:G387 NIL)
...
(SDEFUN |ASSOCEQ;uncouplingMatrices;MV;3|
        ...
        (SPROG
         ((#2=#:G427 NIL) (#3=#:G429 NIL) (|i| NIL) (#4=#:G428 NIL) (|mi| #1#)
          (#5=#:G426 NIL) (|v| (|Vector| (|Matrix| R)))
...
(SDEFUN |ASSOCEQ;makeeq|
        ((|v| |Vector| (|List| (|PositiveInteger|))) (|m| |Matrix| R)
         ...
         ($ |Record| (|:| |minor| (|List| (|PositiveInteger|))) (|:| |eq| L)
          ...
          (|:| |ops| (|List| L))))
        (SPROG
         ((#1=#:G437 NIL) (|j| NIL) (#2=#:G436 NIL) (#3=#:G435 NIL)
          (#4=#:G434 NIL))
         (SEQ
           ...
           (|Join| (|Finite|)
                   (CATEGORY |domain|
                    ...
                    (SIGNATURE |delta|
                     ((|NonNegativeInteger|) $ (|PositiveInteger|)
                      (|PositiveInteger|))))))
          (#3=#:G442 NIL) (|v| (|Union| (|Matrix| R) "failed"))
...
(SDEFUN |ASSOCEQ;computeIt|
        ((|op| L) (|m| |PositiveInteger|) (|k| |NonNegativeInteger|)
         ($ |Record| (|:| |minor| (|List| (|PositiveInteger|))) (|:| |eq| L)
          ...
          (|:| |ops| (|List| L))))
        (SPROG
         ((#1=#:G459 NIL) (#2=#:G460 NIL) (|u| (|Union| (|Matrix| R) "failed"))
          (#3=#:G461 NIL) (|i| NIL) (|n| (|NonNegativeInteger|))
          (|a| (|Vector| (|Matrix| R)))
          (|rec|
           (|Record| (|:| |mat| (|Matrix| R))
                     (|:| |vec| (|Vector| (|List| (|PositiveInteger|)))))))
...
(DEFUN |AssociatedEquations| (&REST #1=#:G466)
  (SPROG NIL
         (PROG (#2=#:G467)
           (RETURN
            (COND
