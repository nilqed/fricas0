...
(SDEFUN |CDEN;clearDenominator;2A;1| ((|l| A) ($ A))
        (SPROG ((|d| (R)))
               (SEQ
                (LETT |d| (SPADCALL |l| (QREFELT $ 9))
                      |CDEN;clearDenominator;2A;1|)
                (EXIT
                 (SPADCALL
                  (CONS #'|CDEN;clearDenominator;2A;1!0| (VECTOR $ |d|)) |l|
                  (QREFELT $ 14)))))) 
...
(SDEFUN |CDEN;splitDenominator;AR;2|
        ...
        (SPROG ((|d| (R)))
               (SEQ
                (LETT |d| (SPADCALL |l| (QREFELT $ 9))
                      |CDEN;splitDenominator;AR;2|)
                (EXIT
                 (CONS
                  (SPADCALL
                   (CONS #'|CDEN;splitDenominator;AR;2!0| (VECTOR $ |d|)) |l|
                   (QREFELT $ 14))
                  |d|))))) 
...
(DEFUN |CommonDenominator| (&REST #1=#:G707)
  (SPROG NIL
         (PROG (#2=#:G708)
           (RETURN
            (COND
