...
(SDEFUN |PSETPK;removeAssociates| ((|lp| |List| P) ($ |List| P))
        (SPROG ((#1=#:G487 NIL) (|p| NIL) (#2=#:G486 NIL))
               (SEQ
                (SPADCALL
                 (PROGN
                  (LETT #2# NIL)
...
(SDEFUN |PSETPK;removeRoughlyRedundantFactorsInPols;2LBL;12|
        ...
        (SPROG
         ((|newlp| (|List| P)) (|stop| (|Boolean|)) (|p| (P)) (#1=#:G558 NIL)
...
(SDEFUN |PSETPK;interReduce;2L;18| ((|lp| |List| P) ($ |List| P))
        (SPROG
         ((|rs| (|List| P)) (|ps| (|List| P)) (#1=#:G601 NIL) (|r| (P))
          (|p| (P)))
         (SEQ
          (EXIT
                ...
                (EXIT
                 (SEQ G190 NIL
                      (SEQ
                       (EXIT
                        (COND
                         ((NULL |ps|) (PROGN (LETT #1# |rs|) (GO #2=#:G600)))
                         ('T
                          (SEQ
                           (LETT |ps|
...
(SDEFUN |PSETPK;crushedSet;2L;22| ((|lp| |List| P) ($ |List| P))
        (SPROG
         ((|finished| #1=(|Boolean|)) (#2=#:G630 NIL) (|contradiction| #1#)
          (|rec|
           (|Union|
...
(SDEFUN |PSETPK;rewriteSetByReducingWithParticularGenerators;LMMML;23|
        ((|ps| |List| P) (|pred?| |Mapping| (|Boolean|) P)
         ...
         ($ |List| P))
        (SPROG
         ((|rs| (|List| P)) (|contradiction| #1=(|Boolean|)) (#2=#:G647 NIL)
          (|stop| #1#) (|bs1| (|GeneralTriangularSet| R E V P))
          (|bs2| (|GeneralTriangularSet| R E V P)) (#3=#:G646 NIL)
                            ...
                            (COND
                             ((QEQCAR |ar| 0)
                              (SEQ
                               ...
                               (EXIT
                                (LETT |rs|
                                      (SPADCALL (SPADCALL |bs2| (QREFELT $ 75))
                                                |rs| (QREFELT $ 65))))))
                             ('T
                              (LETT |rs|
                                    (SPADCALL
...
(SDEFUN |PSETPK;irreducibleFactors;2L;26| ((|lp| |List| P) ($ |List| P))
        (SPROG
         ((|newlp| (|List| P)) (|lf| (|List| P)) (#1=#:G684 NIL) (|rrz| NIL)
          (#2=#:G683 NIL)
          (|lrrz|
           (|List|
...
(SDEFUN |PSETPK;lazyIrreducibleFactors;2L;27| ((|lp| |List| P) ($ |List| P))
        (SPROG
         ((|newlp| (|List| P)) (|lf| (|List| P)) (#1=#:G694 NIL) (|rrz| NIL)
          (#2=#:G693 NIL)
          (|lrrz|
           (|List|
            (|Record| (|:| |flag| (|Union| "nil" "sqfr" "irred" "prime"))
...
(SDEFUN |PSETPK;squareFreeFactors;PL;29| ((|p| P) ($ |List| P))
        (SPROG
         ((|lsf| (|List| P)) (#1=#:G704 NIL) (|foo| NIL) (#2=#:G703 NIL)
          (|sfp| (|Factored| P)))
...
(SDEFUN |PSETPK;removeSquaresIfCan;2L;32| ((|lp| |List| P) ($ |List| P))
        (SPROG ((#1=#:G725 NIL) (|p| NIL) (#2=#:G724 NIL))
               (SEQ
                (COND ((NULL |lp|) |lp|)
                      ('T
                       (SPADCALL
...
(SDEFUN |PSETPK;removeRoughlyRedundantFactorsInContents;3L;34|
        ...
        (SPROG
         ((|newps| (|List| P)) (|newp| (P)) (|newcp| (P)) (#1=#:G734 NIL)
          (|test| (|Union| P "failed")) (|copylf| (|List| P)) (|f| (P))
          (#2=#:G751 NIL) (#3=#:G750 NIL) (|cp| (P)) (|p| (P)))
         (SEQ
          (COND ((NULL |ps|) |ps|)
                ('T
                 (SEQ (LETT |newps| NIL)
...
(SDEFUN |PSETPK;removeRedundantFactorsInContents;3L;35|
        ...
        (SPROG
         ((|newps| (|List| P)) (|newp| (P)) (|newcp| (P)) (#2=#:G754 NIL)
...
(SDEFUN |PSETPK;removeRedundantFactorsInPols;3L;36|
        ((|ps| |List| P) (|lf| . #1=(|List| P)) ($ |List| P))
        (SPROG
         ((|newps| (|List| P)) (|newp| (P)) (#2=#:G770 NIL) (|g| (P))
...
(SDEFUN |PSETPK;unprotectedRemoveRedundantFactors;2PL;42|
        ((|a| P) (|b| P) ($ |List| P))
        (SPROG
         ((#1=#:G819 NIL) (|d| (P)) (|#G102| (P)) (|#G101| (P)) (#2=#:G812 NIL)
          (|c| (|Union| P #3="failed")))
         (SEQ
          (EXIT
           (SEQ (LETT |c| (SPADCALL |b| |a| (QREFELT $ 45)))
...
(SDEFUN |PSETPK;removeRedundantFactors;2L;43| ((|lp| |List| P) ($ |List| P))
        (SPROG
         ((|top| (|List| P)) (|base| (|List| P)) (|p| (P)) (#1=#:G835 NIL)
          (#2=#:G834 NIL) (#3=#:G833 NIL) (#4=#:G832 NIL))
...
(DEFUN |PolynomialSetUtilitiesPackage| (&REST #1=#:G862)
  (SPROG NIL
         (PROG (#2=#:G863)
           (RETURN
            (COND
