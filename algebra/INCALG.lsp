...
(SDEFUN |INCALG;*;P2$;7| ((|p| |Permutation| (|Integer|)) (A $) ($ $))
        (SPROG
         ((|newA| (|Matrix| R)) (|indic| (|List| (|Integer|))) (#1=#:G411 NIL)
          (|i| NIL) (#2=#:G410 NIL) (|newindices| (|OneDimensionalArray| S))
          (#3=#:G409 NIL) (#4=#:G408 NIL) (|n| (|Integer|))
          (|mp| (|Set| (|Integer|))))
...
(DEFUN |IncidenceAlgebra| (&REST #1=#:G428)
  (SPROG NIL
         (PROG (#2=#:G429)
           (RETURN
            (COND
