...
(SDEFUN |MATCAT2;map;MM1M2;1| ((|f| |Mapping| R2 R1) (|m| M1) ($ M2))
        (SPROG
         ((#1=#:G385 NIL) (|j| NIL) (#2=#:G386 NIL) (|l| NIL) (#3=#:G383 NIL)
          (|i| NIL) (#4=#:G384 NIL) (|k| NIL) (|ans| (M2)))
         (SEQ
          (LETT |ans|
...
(SDEFUN |MATCAT2;map;MM1U;2|
        ((|f| |Mapping| (|Union| R2 "failed") R1) (|m| M1)
         ($ |Union| M2 "failed"))
        (SPROG
         ((#1=#:G391 NIL) (#2=#:G405 NIL) (|r| (|Union| R2 #3="failed"))
          (#4=#:G408 NIL) (|j| NIL) (#5=#:G409 NIL) (|l| NIL) (#6=#:G406 NIL)
          (|i| NIL) (#7=#:G407 NIL) (|k| NIL) (|ans| (M2)))
         (SEQ
          (EXIT
           (SEQ
            (LETT |ans|
...
(SDEFUN |MATCAT2;reduce;MM12R2;3|
        ...
        (SPROG ((|s| (R2)) (#1=#:G416 NIL) (|j| NIL) (#2=#:G415 NIL) (|i| NIL))
               (SEQ (LETT |s| |ident|)
...
(DEFUN |MatrixCategoryFunctions2| (&REST #1=#:G417)
  (SPROG NIL
         (PROG (#2=#:G418)
           (RETURN
            (COND
