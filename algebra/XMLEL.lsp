...
(SDEFUN |XMLEL;outputStructured| ((|rp| $) ($ |List| (|String|)))
        (SPROG
         ((|res| (|List| #1=(|String|))) (#2=#:G398 NIL) (|el| NIL)
          (|atts| #1#) (#3=#:G397 NIL) (|s| NIL) (#4=#:G396 NIL))
         (SEQ
          (LETT |atts|
                (SPADCALL
                 (PROGN
...
(SDEFUN |XMLEL;outputUnstructured| ((|rp| $) ($ |List| (|String|)))
        (SPROG
         ((|res| (|List| #1=(|String|))) (|atts| #1#) (#2=#:G403 NIL) (|s| NIL)
          (#3=#:G402 NIL))
         (SEQ
          (LETT |atts|
                (SPADCALL
...
(SDEFUN |XMLEL;outputVRML;$TfV;7| ((|rp| $) (|f1| |TextFile|) ($ |Void|))
        (SPROG
         ((#1=#:G428 NIL) (|el| NIL) (#2=#:G427 NIL) (|att| NIL)
          (#3=#:G425 NIL) (#4=#:G426 NIL))
         (SEQ
          (EXIT
           (SEQ
            (COND
             ((OR (EQUAL (QVELT |rp| 0) "X3D") (EQUAL (QVELT |rp| 0) "Scene"))
              (SEQ
               ...
               (EXIT (PROGN (LETT #3# (|Void|)) (GO #5=#:G424))))))
