...
(SDEFUN |SPACE3;convertSpace| ((|space| $) ($ $))
        (SPROG
         ((|lllipt| (|List| (|List| (|List| (|NonNegativeInteger|)))))
          ...
          (|tmplipt| (|List| (|NonNegativeInteger|))) (#1=#:G422 NIL)
          (|point| NIL) (|tmplprop| (|List| (|SubSpaceComponentProperty|)))
          (#2=#:G421 NIL) (|curve| NIL)
          (|lprop| (|List| (|SubSpaceComponentProperty|))) (#3=#:G420 NIL)
          (|component| NIL))
         (SEQ
...
(SDEFUN |SPACE3;polygon;$L$;2|
        ...
        (SPROG ((#1=#:G427 NIL) (|p| NIL) (|pt| (|SubSpace| 3 R)))
               (SEQ
                (COND
                 ((< (LENGTH |points|) 3)
...
(SDEFUN |SPACE3;merge;L$;7| ((|listOfThreeSpaces| |List| $) ($ $))
        (SPROG
         ((#1=#:G442 NIL) (|ts| NIL) (|newspace| ($)) (#2=#:G441 NIL)
          (#3=#:G440 NIL))
         (SEQ
          (LETT |newspace|
                (SPADCALL
...
(SDEFUN |SPACE3;composite;L$;9| ((|listOfThreeSpaces| |List| $) ($ $))
        (SPROG ((#1=#:G448 NIL) (|s| NIL) (#2=#:G447 NIL) (|space| ($)))
...
(SDEFUN |SPACE3;components;$L;10| ((|space| $) ($ |List| $))
        (SPROG ((#1=#:G452 NIL) (|s| NIL) (#2=#:G451 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |s| NIL)
...
(SDEFUN |SPACE3;copy;2$;12| ((|space| $) ($ $))
        (SPROG ((#1=#:G461 NIL) (|s| NIL) (#2=#:G460 NIL) (|spc| ($)))
               (SEQ
                (LETT |spc|
...
(SDEFUN |SPACE3;curve;$L;22| ((|space| $) ($ |List| (|Point| R)))
        (SPROG
         ((#1=#:G489 NIL) (|s| NIL) (#2=#:G488 NIL) (|spc| (|SubSpace| 3 R)))
         (SEQ
          (COND
...
(SDEFUN |SPACE3;curve;$L$;24| ((|space| $) (|points| |List| (|Point| R)) ($ $))
        (SPROG
         ((#1=#:G494 NIL) (|p| NIL) (|path| (|List| (|NonNegativeInteger|))))
         (SEQ
...
(SDEFUN |SPACE3;closedCurve;$L;27| ((|space| $) ($ |List| (|Point| R)))
        (SPROG
         ((#1=#:G508 NIL) (|s| NIL) (#2=#:G507 NIL) (|spc| (|SubSpace| 3 R)))
         (SEQ
          (COND
...
(SDEFUN |SPACE3;closedCurve;$L$;29|
        ((|space| $) (|points| |List| (|Point| R)) ($ $))
        (SPROG
         ((#1=#:G513 NIL) (|p| NIL) (|path| (|List| (|NonNegativeInteger|))))
         (SEQ
          (SPADCALL (QVELT |space| 0) NIL (|SPADfirst| |points|)
                    (QREFELT $ 50))
          (LETT |path|
...
(SDEFUN |SPACE3;mesh;$L;36| ((|space| $) ($ |List| (|List| (|Point| R))))
        (SPROG
         ((|llp| (|List| (|List| (|Point| R)))) (#1=#:G548 NIL) (|s| NIL)
          (#2=#:G547 NIL) (#3=#:G546 NIL) (|lpSpace| NIL))
         (SEQ
          (COND
...
(SDEFUN |SPACE3;mesh;$LLSscp$;39|
        ((|space| $) (|llpoints| |List| (|List| (|List| R)))
         ...
         ($ $))
        (SPROG
         ((|pts| (|List| (|List| (|Point| R)))) (#2=#:G557 NIL) (|points| NIL)
          (#3=#:G556 NIL))
         (SEQ
          (LETT |pts|
                (PROGN
...
(SDEFUN |SPACE3;mesh;$LLSscp$;40|
        ((|space| $) (|llp| |List| (|List| (|Point| R)))
         ...
         ($ $))
        (SPROG
         ((#2=#:G567 NIL) (|p| NIL) (|path| (|List| (|NonNegativeInteger|)))
          (#3=#:G565 NIL) (|lp| NIL) (#4=#:G566 NIL) (|aProp| NIL)
          (|count| NIL) (#5=#:G564 NIL))
         (SEQ
...
(SDEFUN |SPACE3;mesh;$L2B$;41|
        ...
        (SPROG
         ((|pts| (|List| (|List| (|Point| R)))) (#2=#:G574 NIL) (|points| NIL)
          (#3=#:G573 NIL))
         (SEQ
          (LETT |pts|
                (PROGN
...
(SDEFUN |SPACE3;mesh;$L2B$;42|
        ((|space| $) (|llp| |List| (|List| (|Point| R)))
         (|prop1| . #1=(|Boolean|)) (|prop2| . #1#) ($ $))
        (SPROG
         ((#2=#:G583 NIL) (|p| NIL) (|path| (|List| (|NonNegativeInteger|)))
          (#3=#:G582 NIL) (|lp| NIL) (|count| NIL) (#4=#:G581 NIL)
