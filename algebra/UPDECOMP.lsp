...
(SDEFUN |UPDECOMP;rightFactorIfCan0|
        ...
        (SPROG
         ((|q| (UP)) (#1=#:G389 NIL) (#2=#:G399 NIL)
          (|cquo| (|Union| R "failed")) (|c| (R)) (#3=#:G401 NIL) (|i| NIL)
          (#4=#:G400 NIL) (|k| NIL) (|lcp| (R)) (|s| (|NonNegativeInteger|))
...
(SDEFUN |UPDECOMP;rightFactorIfCan;UPNniRU;2|
        ((|p| UP) (|dq| |NonNegativeInteger|) (|lcq| R)
         ($ |Union| UP "failed"))
        (SPROG
         ((|q| (UP)) (#1=#:G424 NIL) (|cu| #2=(|Union| R "failed")) (|c| (R))
          (#3=#:G426 NIL) (|j| NIL) (|k| (|NonNegativeInteger|))
          (|k1| (|NonNegativeInteger|)) (|p1| (UP)) (|qn| (UP)) (|qn1| (UP))
          (#4=#:G425 NIL) (|i| NIL) (|cc2| (R)) (|cc1| (R)) (|cc0| (R))
          (|cc0u| #2#) (|lcn1| (R)) (|lcn| (R)) (|n1| (|NonNegativeInteger|))
          (#5=#:G407 NIL) (|nr| (R)) (|n| (|NonNegativeInteger|))
...
(SDEFUN |UPDECOMP;monicDecomposeIfCan;UPU;5|
        ...
        (SPROG
         ((#1=#:G458 NIL) (|g| (|Union| UP "failed"))
          (|h| (|Union| UP "failed")) (#2=#:G459 NIL) (#3=#:G446 NIL)
...
(DEFUN |UnivariatePolynomialDecompositionPackage| (&REST #1=#:G476)
  (SPROG NIL
         (PROG (#2=#:G477)
           (RETURN
            (COND
