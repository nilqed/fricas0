...
(SDEFUN |GDMP;totalDegree;$Nni;2| ((|p| $) ($ |NonNegativeInteger|))
        (SPROG
         ((#1=#:G406 NIL) (#2=#:G405 #3=(|NonNegativeInteger|)) (#4=#:G407 #3#)
          (#5=#:G412 NIL) (|t| NIL))
         (SEQ
...
(SDEFUN |GDMP;monomial;$OvlNni$;3|
        ((|p| $) (|v| |OrderedVariableList| |vl|) (|e| |NonNegativeInteger|)
         ($ $))
        (SPROG
         ((#1=#:G417 NIL) (#2=#:G419 NIL) (|z| NIL) (#3=#:G418 NIL)
...
(SDEFUN |GDMP;listCoef| ((|p| $) ($ |List| R))
        (SPROG ((#1=#:G425 NIL) (|rec| NIL) (#2=#:G424 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |GDMP;mainVariable;$U;6|
        ...
        (SPROG
         ((#2=#:G437 NIL) (|vv| (|OrderedVariableList| |vl|)) (#3=#:G427 NIL)
          (#4=#:G438 NIL) (|v| NIL))
         (SEQ
          (EXIT
                         ...
                         (EXIT
                          (COND
                           ((> (SPADCALL |p| |vv| (QREFELT $ 35)) 0)
                            (PROGN (LETT #2# (CONS 0 |vv|)) (GO #5=#:G436))))))
...
(SDEFUN |GDMP;degree;$LL;13|
        ...
        (SPROG ((#1=#:G465 NIL) (|v| NIL) (#2=#:G464 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |GDMP;maxNorm| ((|p| $) ($ R))
        (SPROG ((|m| (R)) (#1=#:G478 NIL) (|r| NIL) (|l| (|List| R)))
...
(SDEFUN |GDMP;variables;$L;19|
        ...
        (SPROG
         ((#1=#:G488 NIL) (#2=#:G494 NIL) (|i| NIL) (#3=#:G493 NIL)
          (#4=#:G492 NIL) (|tdeg| (E))
...
(SDEFUN |GDMP;reorder;$L$;20| ((|p| $) (|perm| |List| (|Integer|)) ($ $))
        (SPROG
         ((|q| ($)) (#1=#:G504 NIL) (#2=#:G506 NIL) (|j| NIL) (#3=#:G505 NIL)
          (#4=#:G503 NIL) (|term| NIL) (#5=#:G502 NIL))
         (SEQ
          (COND
...
(SDEFUN |GDMP;eval;$LL$;26|
        ((|p| $) (|Lvar| |List| (|OrderedVariableList| |vl|))
         (|Lpval| |List| $) ($ $))
        (SPROG
         ((|nlpval| (|List| $)) (#1=#:G531 NIL) (|mvar| NIL) (#2=#:G530 NIL)
...
(SDEFUN |GDMP;content;$R;30| ((|p| $) ($ R))
        (SPROG
         ((#1=#:G546 NIL) (#2=#:G545 (R)) (#3=#:G547 (R)) (#4=#:G550 NIL)
          (|t| NIL))
         (SEQ
...
(SDEFUN |GDMP;coerce;$Of;34| ((|p| $) ($ |OutputForm|))
        (SPROG
         ((|lt| (|List| #1=(|OutputForm|))) (|l| (|List| #1#)) (#2=#:G587 NIL)
          (|i| NIL) (#3=#:G586 NIL) (|t| NIL) (|vl1| (|List| (|OutputForm|)))
          (#4=#:G585 NIL) (|v| NIL) (#5=#:G584 NIL))
         (SEQ
          (COND
...
(DEFUN |GeneralDistributedMultivariatePolynomial| (&REST #1=#:G623)
  (SPROG NIL
         (PROG (#2=#:G624)
           (RETURN
            (COND
...
(DEFUN |GeneralDistributedMultivariatePolynomial;| (|#1| |#2| |#3|)
  (SPROG
   ((#1=#:G622 NIL) (|pv$| NIL) (#2=#:G614 NIL) (#3=#:G615 NIL) (#4=#:G616 NIL)
    (#5=#:G617 NIL) (#6=#:G618 NIL) (#7=#:G619 NIL) (#8=#:G620 NIL)
    (#9=#:G621 NIL) ($ NIL) (|dv$| NIL) (DV$3 NIL) (DV$2 NIL) (DV$1 NIL))
   (PROGN
...
(MAKEPROP '|GeneralDistributedMultivariatePolynomial| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL (|PolynomialRing| 7 8) (|local| |#1|)
              ...
              (|Factored| $) (|Factored| 45) (|Union| 162 '#1#) (|List| 45)
              (|Union| 157 '#2="failed") (|Union| 43 '#2#)
              (|Record| (|:| |quotient| $) (|:| |remainder| $)) (|Matrix| 7)
              (|Record| (|:| |mat| 166) (|:| |vec| (|Vector| 7)))
              (|Equation| $) (|List| 168)
              (|Record| (|:| |var| 23) (|:| |exponent| 17))
              (|Union| 170 '#3="failed") (|Union| 102 '#3#) (|Mapping| 8 8)
             ...
             (CONS
              ...
              (|makeByteWordVec2| 145
                                  '(1 8 14 0 15 0 0 0 16 2 17 0 0 0 18 3 14 17
                                    ...
                                    142 0 143 2 132 0 0 0 144 1 48 12 0 13 1 0
                                    54 0 72 2 0 45 0 23 46 1 0 111 0 117 1 0 17
                                    0 21 1 0 41 0 42 1 0 7 0 40 2 0 0 0 76 77 1
                                    0 0 0 67 1 0 17 0 57 2 0 0 45 23 51 2 0 0
                                    111 23 122 1 0 12 0 58 3 0 0 0 23 17 30 2 0
                                    0 7 8 28 2 0 17 0 23 49 2 0 53 0 54 56 1 0
                                    36 0 37 1 0 7 0 39 1 0 12 0 38 1 0 7 0 115
                                    2 14 0 0 0 128 3 0 0 0 54 102 103 3 0 0 0
                                    54 86 87 3 0 0 0 23 0 82 3 0 0 0 23 7 84 2
                                    4 0 0 23 52 2 0 53 0 54 55 2 0 17 0 23 35 1
                                    0 8 0 66 1 14 7 0 124 1 12 0 23 31 1 0 0 7
                                    83 1 0 132 0 145 2 46 0 0 17 108 0 48 0 16
                                    0 46 0 25 2 18 0 0 7 64 2 0 0 0 0 110 2 0 0
                                    7 0 63 2 0 0 0 0 29)))))
           '|lookupIncomplete|)) 
