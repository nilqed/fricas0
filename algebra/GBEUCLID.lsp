          ...
          (D
           (|List|
            #2=(|Record| (|:| |lcmfij| |Expon|) (|:| |lcmcij| |Dom|)
                         (|:| |poli| |Dpol|) (|:| |polj| |Dpol|))))
          (|dd1| (|List| #2#)) (#3=#:G490 NIL) (|x| NIL) (#4=#:G489 NIL)
          (|leh| (|Dom|)) (|e| (|Expon|)) (|eh| (|Dpol|)) (|ep| (|Dpol|))
          (D0
           (|Record| (|:| |lcmfij| |Expon|) (|:| |lcmcij| |Dom|)
                     (|:| |poli| |Dpol|) (|:| |polj| |Dpol|)))
          (#5=#:G488 NIL) (#6=#:G487 NIL) (|lch| (|Dom|)) (|en| (|Expon|))
...
(SDEFUN |GBEUCLID;updatH|
        ...
        (SPROG
         ((|hp| (|Dpol|)) (|hpp| (|List| |Dpol|)) (#1=#:G515 NIL)
          (|plc|
...
(SDEFUN |GBEUCLID;esPol|
        ((|p| |Record| (|:| |lcmfij| |Expon|) (|:| |lcmcij| |Dom|)
         ...
         ($ |Dpol|))
        (SPROG
         ((#1=#:G542 NIL) (#2=#:G539 NIL) (|lij| (|Dom|)) (|fj| (|Dpol|))
          (|fi| (|Dpol|)) (|Tij| (|Expon|)))
...
(SDEFUN |GBEUCLID;eRed|
        ...
        (SPROG
         ((|q1| (|Dom|))
          ...
          (#1=#:G555 NIL) (|e| (|Union| |Expon| "failed")) (|ls| (|Dom|))
...
(SDEFUN |GBEUCLID;ecritM|
        ...
        (SPROG ((#1=#:G568 NIL) (|en| (|Union| |Expon| "failed")))
               (SEQ
                (EXIT
                 (SEQ
...
(DEFUN |EuclideanGroebnerBasisPackage| (&REST #1=#:G604)
  (SPROG NIL
         (PROG (#2=#:G605)
           (RETURN
            (COND
