...
(SDEFUN |PRIMELT;findUniv|
        ...
        (SPROG ((#1=#:G417 NIL) (#2=#:G418 NIL) (#3=#:G419 NIL) (|p| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ
         ...
         ((|ll| (|List| (|SparseUnivariatePolynomial| F)))
          (|bc|
           (|Union|
            ...
            "failed"))
          (#1=#:G449 NIL) (#2=#:G450 NIL)
          (|p| (|SparseUnivariatePolynomial| (|Polynomial| F)))
          (|u| (|Union| (|Polynomial| F) "failed")) (#3=#:G451 NIL) (|v| NIL)
