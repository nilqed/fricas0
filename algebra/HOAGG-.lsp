...
(SDEFUN |HOAGG-;any?;MAB;3|
        ...
        (SPROG ((#1=#:G398 NIL) (#2=#:G399 NIL) (|x| NIL))
               (SEQ
                (EXIT
                 (SEQ
...
(SDEFUN |HOAGG-;every?;MAB;4|
        ((|f| |Mapping| (|Boolean|) S) (|c| A) ($ |Boolean|))
        (SPROG ((#1=#:G404 NIL) (#2=#:G405 NIL) (|x| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ (LETT |x| NIL) (LETT #2# (SPADCALL |c| (QREFELT $ 14)))
...
(SDEFUN |HOAGG-;count;MANni;5|
        ...
        (SPROG
         ((#1=#:G407 NIL) (#2=#:G406 #3=(|NonNegativeInteger|)) (#4=#:G408 #3#)
          (#5=#:G410 NIL) (|x| NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
...
(SDEFUN |HOAGG-;max;MAS;7| ((|p| |Mapping| (|Boolean|) S S) (|u| A) ($ S))
        (SPROG ((|r| (S)) (#1=#:G418 NIL) (|x| NIL) (|l| (|List| S)))
               (SEQ
                (COND
...
(SDEFUN |HOAGG-;=;2AB;12| ((|x| A) (|y| A) ($ |Boolean|))
        (SPROG
         ((#1=#:G430 NIL) (#2=#:G431 NIL) (|a| NIL) (#3=#:G432 NIL) (|b| NIL))
         (SEQ
          (EXIT
           (COND
