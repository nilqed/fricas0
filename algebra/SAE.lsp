...
(SDEFUN |SAE;random;$;2| (($ $))
        (SPROG ((#1=#:G393 NIL) (|i| NIL) (#2=#:G392 NIL))
               (SEQ
                (SPADCALL
                 (PROGN
...
(SDEFUN |SAE;coordinates;$V;17| ((|x| $) ($ |Vector| R))
        (SPROG ((#1=#:G412 NIL) (|i| NIL) (#2=#:G411 NIL))
               (SEQ
                (PROGN
                 (LETT #2# (GETREFV (|inc_SI| #3=(QREFELT $ 21))))
                 (SEQ (LETT |i| 0) (LETT #1# #3#) G190
...
(SDEFUN |SAE;coordinates;$VV;25| ((|x| $) (|bas| |Vector| $) ($ |Vector| R))
        (SPROG
         ((|xi| (|qf|)) (#1=#:G437 NIL) (|i| NIL) (|vec| (|Vector| R))
...
(SDEFUN |SAE;trace;$R;32| ((|x| $) ($ R))
        (SPROG ((|ans| (R)) (|xn| ($)) (#1=#:G460 NIL) (|n| NIL))
               (SEQ (LETT |xn| |x|)
                    (LETT |ans|
...
(DEFUN |SimpleAlgebraicExtension| (&REST #1=#:G522)
  (SPROG NIL
         (PROG (#2=#:G523)
           (RETURN
            (COND
...
(DEFUN |SimpleAlgebraicExtension;| (|#1| |#2| |#3|)
  (SPROG
   ((#1=#:G521 NIL) (|i| NIL) (#2=#:G520 NIL) (#3=#:G386 NIL) (#4=#:G383 NIL)
    (|pv$| NIL) (#5=#:G517 NIL) (#6=#:G518 NIL) (#7=#:G519 NIL) ($ NIL)
