...
(SDEFUN |REAL0;makeSqfr| ((F |Pol|) ($ |Pol|))
        (SPROG
         ((#1=#:G396 NIL) (#2=#:G395 (|Pol|)) (#3=#:G397 (|Pol|))
          (#4=#:G400 NIL) (|s| NIL) (|sqfr| (|Factored| |Pol|)))
...
(SDEFUN |REAL0;realZeros;PolFL;6|
        ((F |Pol|) (|rn| |Fraction| (|Integer|))
         ($ |List|
          (|Record| (|:| |left| (|Fraction| (|Integer|)))
                    (|:| |right| (|Fraction| (|Integer|))))))
        (SPROG ((#1=#:G406 NIL) (|int| NIL) (#2=#:G405 NIL))
...
(SDEFUN |REAL0;realZeros;PolRFL;8|
        ((F |Pol|)
         ...
         ($ |List|
          (|Record| (|:| |left| (|Fraction| (|Integer|)))
                    (|:| |right| (|Fraction| (|Integer|))))))
        (SPROG ((#1=#:G419 NIL) (|int| NIL) (#2=#:G418 NIL))
               (SEQ (LETT F (|REAL0;makeSqfr| F $))
                    (EXIT
                     (PROGN
                      (LETT #2# NIL)
        ...
        (SPROG
         ((L
           (|List|
            (|Record| (|:| |left| (|Fraction| (|Integer|)))
                      (|:| |right| (|Fraction| (|Integer|))))))
          (#1=#:G436 NIL) (|int| NIL) (#2=#:G435 NIL) (|b| (|Integer|)))
        ...
        (SPROG
         ((K
           (|List|
            (|Record| (|:| |left| (|Fraction| (|Integer|)))
                      (|:| |right| (|Fraction| (|Integer|))))))
          (#1=#:G450 NIL) (|int| NIL) (#2=#:G449 NIL)
          (J
           (|List|
            (|Record| (|:| |left| (|Fraction| (|Integer|)))
                      (|:| |right| (|Fraction| (|Integer|))))))
          (#3=#:G448 NIL) (#4=#:G447 NIL) (G (|Pol|))
...
(SDEFUN |REAL0;transAdd1| ((F |Pol|) ($ |Pol|))
        (SPROG
         ((|ans| (|Pol|)) (#1=#:G475 NIL) (|i| NIL) (#2=#:G474 NIL) (|j| NIL)
          (#3=#:G473 NIL) (|v| (|Vector| (|Integer|)))
...
(SDEFUN |REAL0;invert| ((F |Pol|) ($ |Pol|))
        (SPROG ((G (|Pol|)) (#1=#:G482 NIL) (|n| (|NonNegativeInteger|)))
               (SEQ (LETT G (|spadConstant| $ 35))
...
(SDEFUN |REAL0;refine;PolRFR;20|
        ...
        (SPROG
         ((|xfl| (|Boolean|)) (|ad| #1=(|Integer|)) (|an| #2=(|Integer|))
          ...
          (|mid| (|Fraction| (|Integer|))) (|u| #3#) (#4=#:G503 NIL))
