...
(SDEFUN |TRIMAT;UpTriBddDenomInv;MRM;1| ((A M) (|denom| R) ($ M))
        (SPROG
         ((#1=#:G379 NIL) (#2=#:G389 NIL) (#3=#:G388 (R)) (#4=#:G390 (R))
          (#5=#:G399 NIL) (|k| NIL) (#6=#:G398 NIL) (|j| NIL) (#7=#:G397 NIL)
          (|i| NIL) (#8=#:G395 NIL) (#9=#:G396 NIL) (|offset| (|Integer|))
          (AI (M)))
         (SEQ
          (LETT AI
...
(SDEFUN |TRIMAT;LowTriBddDenomInv;MRM;2| ((A M) (|denom| R) ($ M))
        (SPROG
         ((#1=#:G401 NIL) (#2=#:G411 NIL) (#3=#:G410 (R)) (#4=#:G412 (R))
          (#5=#:G421 NIL) (|k| NIL) (#6=#:G420 NIL) (|j| NIL) (#7=#:G419 NIL)
          (|i| NIL) (#8=#:G417 NIL) (#9=#:G418 NIL) (|offset| (|Integer|))
          (AI (M)))
         (SEQ
          (LETT AI
                (SPADCALL (SPADCALL A (QREFELT $ 11))
...
(DEFUN |TriangularMatrixOperations| (&REST #1=#:G422)
  (SPROG NIL
         (PROG (#2=#:G423)
           (RETURN
            (COND
