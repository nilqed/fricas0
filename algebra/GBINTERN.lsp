...
(SDEFUN |GBINTERN;gbasisExtend;2L2IL;6|
        ...
        (SPROG
         ((#1=#:G466 NIL) (|x| NIL) (#2=#:G465 NIL) (|xx| (|Integer|))
          (|redPols| (|List| |Dpol|))
          (|basPols|
           (|List|
          ...
          (D
           (|List|
            #3=(|Record| (|:| |lcmfij| |Expon|)
                         ...
                         (|:| |poli| |Dpol|) (|:| |polj| |Dpol|))))
          (D1 (|List| #3#)) (#4=#:G464 NIL) (#5=#:G463 NIL) (#6=#:G456 NIL)
          (|h| (|Dpol|)) (|s| (|Dpol|))
          (D0
           (|Record| (|:| |lcmfij| |Expon|)
                     (|:| |totdeg| (|NonNegativeInteger|)) (|:| |poli| |Dpol|)
                     (|:| |polj| |Dpol|)))
          (#7=#:G462 NIL) (#8=#:G461 NIL) (#9=#:G460 NIL) (#10=#:G459 NIL)
          (|toth| (|NonNegativeInteger|)) (|Pol1| (|List| |Dpol|))
          (|sgb|
           (|List|
            (|Record| (|:| |totdeg| (|NonNegativeInteger|))
                      (|:| |pol| |Dpol|))))
          (#11=#:G458 NIL) (#12=#:G457 NIL))
         (SEQ
          (LETT |sgb|
                (PROGN
                 (LETT #12# NIL)
                       ...
                       (COND
                        ...
                        ((SPADCALL (SPADCALL |h| (QREFELT $ 16))
                         ...
                         (SEQ (LETT D NIL)
                              ...
                              (EXIT
                               (PROGN (LETT #6# |$NoValue|) (GO #13=#:G450)))))
                        ('T
                         (SEQ
                          (LETT D1
                                (PROGN
        ...
        ((|e| |Expon|)
         ...
         ($ |List|
          (|Record| (|:| |lcmfij| |Expon|)
                    (|:| |totdeg| (|NonNegativeInteger|)) (|:| |poli| |Dpol|)
                    (|:| |polj| |Dpol|))))
        (SPROG ((#1=#:G472 NIL) (|x| NIL) (#2=#:G471 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
        ...
        ((|h| |Dpol|)
         ...
         ($ |List|
          (|Record| (|:| |lcmfij| |Expon|)
                    (|:| |totdeg| (|NonNegativeInteger|)) (|:| |poli| |Dpol|)
                    (|:| |polj| |Dpol|))))
        (SPROG ((#1=#:G486 NIL) (|x| NIL) (#2=#:G485 NIL) (|d| (|Expon|)))
...
(SDEFUN |GBINTERN;updatF;DpolNni2L;10|
        ((|h| |Dpol|) (|deg| |NonNegativeInteger|)
         ...
         ($ |List|
          (|Record| (|:| |totdeg| (|NonNegativeInteger|)) (|:| |pol| |Dpol|))))
        (SPROG ((#1=#:G493 NIL) (|f| NIL) (#2=#:G492 NIL) (|d| (|Expon|)))
               (SEQ (LETT |d| (SPADCALL |h| (QREFELT $ 16)))
                    (EXIT
                     (SPADCALL
                      (PROGN
...
(SDEFUN |GBINTERN;sPol;RDpol;13|
        ((|p| |Record| (|:| |lcmfij| |Expon|)
         ...
         ($ |Dpol|))
        (SPROG
         ((#1=#:G519 NIL) (|cc| (|Record| (|:| |co1| |Dom|) (|:| |co2| |Dom|)))
...
(DEFUN |GroebnerInternalPackage| (&REST #1=#:G589)
  (SPROG NIL
         (PROG (#2=#:G590)
           (RETURN
            (COND
