...
(SDEFUN |CLINDEP;kmap|
        ...
        (SPROG
         ((#1=#:G411 NIL) (|a| NIL) (#2=#:G410 NIL)
          ...
          (|op| (|BasicOperator|)) (#5=#:G405 NIL) (|is_const| (|Boolean|))
          (#6=#:G409 NIL) (|d| NIL) (|kf| (F)) (#7=#:G406 NIL) (#8=#:G407 NIL)
          (|dmvar| NIL) (#9=#:G408 NIL) (|dmval| NIL))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |CLINDEP;constant_subspace;LLR;15|
        ((|b| |List| (|Vector| F)) (|ld| |List| (|Mapping| F F))
         ($ |Record| (|:| |transform| (|Matrix| F))
          (|:| |basis| (|List| (|Vector| F)))))
        (SPROG
         ((#1=#:G482 NIL) (|bv| NIL) (#2=#:G481 NIL) (|m2| #3=(|Matrix| F))
          (#4=#:G480 NIL) (|i| NIL) (#5=#:G479 NIL) (#6=#:G478 NIL)
          (#7=#:G477 NIL) (|l3| (|List| (|Vector| F))) (#8=#:G476 NIL)
          (#9=#:G475 NIL) (|s1| (|List| (|Vector| F))) (|m| (|Matrix| F))
          (|lr| (|List| (|Vector| F))) (|ll| (|List| (|List| F)))
          (|ll1| (|List| F)) (#10=#:G474 NIL) (|d1| NIL)
          (|lpiv1| (|List| (|Integer|))) (|kk| (|Integer|)) (#11=#:G473 NIL)
          (|j| NIL) (#12=#:G472 NIL) (|lpiv| (|List| (|Integer|)))
          (|lri| (|List| (|Integer|))) (|k| #13=(|Integer|)) (|k1| #13#)
          (#14=#:G471 NIL) (|m1| (|Matrix| F)) (|m0| (|Matrix| F)) (|m0b| #3#)
          (#15=#:G470 NIL) (#16=#:G469 NIL) (|nr| (|NonNegativeInteger|))
...
(DEFUN |ConstantLinearDependence| (&REST #1=#:G483)
  (SPROG NIL
         (PROG (#2=#:G484)
           (RETURN
            (COND
