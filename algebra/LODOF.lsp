...
(SDEFUN |LODOF;expsols|
        ((|l| |LinearOrdinaryDifferentialOperator1| (|Fraction| UP))
         ...
         ($ |List| (|Fraction| UP)))
        (SPROG
         ((|sol| (|List| (|Fraction| UP))) (#1=#:G406 NIL) (|f| NIL)
          (#2=#:G405 NIL))
         (SEQ
          (LETT |sol|
                (PROGN
...
(SDEFUN |LODOF;zro|
        ...
        (SPROG ((#1=#:G471 NIL) (|r| NIL) (#2=#:G470 NIL))
               (SEQ
                (SPADCALL
                 (PROGN
                  (LETT #2# NIL)
...
(DEFUN |LinearOrdinaryDifferentialOperatorFactorizer| (&REST #1=#:G491)
  (SPROG NIL
         (PROG (#2=#:G492)
           (RETURN
            (COND
