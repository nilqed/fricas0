...
(SDEFUN |HEUGCD;height| ((|f| BP) ($ |PositiveInteger|))
        (SPROG ((|k| (|PositiveInteger|)) (#1=#:G401 NIL))
               (SEQ (LETT |k| 1)
                    (SEQ G190
                         (COND
                          ((NULL
...
(SDEFUN |HEUGCD;lintgcd;LI;7| ((|lval| |List| (|Integer|)) ($ |Integer|))
        (SPROG ((|val| (|Integer|)) (#1=#:G420 NIL) (|val1| NIL))
               (SEQ
...
(SDEFUN |HEUGCD;content;LL;8| ((|listf| |List| BP) ($ |List| (|Integer|)))
        (SPROG ((#1=#:G424 NIL) (|f| NIL) (#2=#:G423 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |HEUGCD;contprim|
        ...
        (SPROG
         ((#1=#:G427 NIL) (|c| (|Integer|)) (#2=#:G432 NIL) (|f| NIL)
          (#3=#:G431 NIL))
         (SEQ
          (PROGN
           (LETT #3# NIL)
...
(SDEFUN |HEUGCD;constcase|
        ((|listdeg| |List| (|NonNegativeInteger|)) (|listf| |List| BP)
         ($ |List| BP))
        (SPROG
         ((#1=#:G448 NIL) (|lcf| NIL) (#2=#:G447 NIL) (|d| (|Integer|))
          (|lclistf| (|List| (|Integer|))) (#3=#:G446 NIL) (|f| NIL)
          (#4=#:G445 NIL) (#5=#:G436 NIL) (#6=#:G435 #7=(|Boolean|))
          (#8=#:G437 #7#) (#9=#:G444 NIL) (|n| NIL) (|lind| (|List| BP)))
         (SEQ
          (LETT |lind|
...
(SDEFUN |HEUGCD;testDivide|
        ...
        (SPROG
         ((|result| (|List| BP)) (#1=#:G460 NIL) (|f1| (|Union| BP "failed"))
          (#2=#:G461 NIL) (|f| NIL))
         (SEQ
          (EXIT
           (SEQ (LETT |result| NIL)
...
(SDEFUN |HEUGCD;lincase|
        ((|listdeg| |List| (|NonNegativeInteger|)) (|listf| |List| BP)
         ($ |List| BP))
        (SPROG
         ((|result| (|List| BP)) (#1=#:G474 NIL) (|f1| (|Union| BP "failed"))
          (#2=#:G475 NIL) (|f| NIL) (|g| (BP)) (|n| (|Integer|)))
         (SEQ
          (EXIT
...
(SDEFUN |HEUGCD;localgcd| ((|listf| |List| BP) ($ |List| BP))
        (SPROG
         ((#1=#:G492 NIL) (#2=#:G511 NIL) (|f| NIL) (#3=#:G510 NIL) (|gg| (BP))
          (|answr| (|PositiveInteger|)) (#4=#:G497 NIL)
          (|nvalue| (|NonNegativeInteger|)) (#5=#:G504 NIL)
          (|result| (|List| BP)) (|flag| (|Boolean|))
          (|f1| (|Union| BP "failed")) (#6=#:G509 NIL) (|d| (BP))
          (|contd| (|Integer|)) (|dd| (BP)) (|dval| (|Integer|))
          (|listval| (|List| (|Integer|))) (#7=#:G508 NIL) (#8=#:G507 NIL)
          (|k| NIL) (|minf| (BP)) (#9=#:G488 NIL) (#10=#:G487 (BP))
          (#11=#:G489 (BP)) (#12=#:G506 NIL) (|hgt| #13=(|PositiveInteger|))
          (#14=#:G484 NIL) (#15=#:G483 #13#) (#16=#:G485 #13#)
          (#17=#:G505 NIL))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |HEUGCD;internal|
        ...
        (SPROG
         ((|ans| (|List| BP)) (#1=#:G556 NIL) (|p| NIL) (#2=#:G557 NIL)
          (|q| NIL) (#3=#:G555 NIL) (|result| (BP)) (|#G53| (|List| BP))
          (|#G52| (BP)) (#4=#:G544 NIL) (|fa| #5=(|U32Vector|)) (|ga| #5#)
          (#6=#:G543 NIL) (|lcg| (|Integer|)) (#7=#:G554 NIL) (|g| NIL)
          (|f| (BP)) (|listdeg| (|List| (|NonNegativeInteger|)))
          (#8=#:G553 NIL) (#9=#:G552 NIL) (|minpol| (BP)) (#10=#:G551 NIL)
          (|term| NIL) (#11=#:G550 NIL) (|contgcd| (|Integer|))
          (|Cgcd| (|List| (|Integer|))) (#12=#:G549 NIL) (#13=#:G548 NIL)
          (|contlistf|
           (|List| (|Record| (|:| |cont| (|Integer|)) (|:| |prim| BP))))
          (#14=#:G521 NIL) (#15=#:G547 NIL) (#16=#:G546 NIL) (|minpol1| (BP))
          (|mdeg| #17=(|NonNegativeInteger|)) (#18=#:G518 NIL)
          (#19=#:G517 #17#) (#20=#:G519 #17#) (#21=#:G545 NIL)
