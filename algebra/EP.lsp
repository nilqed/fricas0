        ...
        ((|m| |Matrix| (|Fraction| (|Polynomial| R)))
         ($ |List|
          (|Record|
           ...
           (|:| |eigvec| (|List| (|Matrix| (|Fraction| (|Polynomial| R))))))))
        (SPROG
         ((#1=#:G445 NIL) (|v| NIL) (#2=#:G444 NIL) (#3=#:G443 NIL) (|ri| NIL)
          (#4=#:G442 NIL)
          (|res1|
           (|List|
            (|Record|
         ...
         ($ |List|
          (|Record|
           ...
           (|:| |geneigvec|
                (|List| (|Matrix| (|Fraction| (|Polynomial| R))))))))
        (SPROG
         ((#1=#:G457 NIL) (|v| NIL) (#2=#:G456 NIL) (#3=#:G455 NIL) (|ri| NIL)
          (#4=#:G454 NIL)
          (|res1|
           (|List|
            (|Record|
