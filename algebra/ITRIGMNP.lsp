...
(SDEFUN |ITRIGMNP;KG2F| ((|k| |Kernel| FG) ($ F))
        (SPROG ((#1=#:G432 NIL) (|a| NIL) (#2=#:G431 NIL))
               (SEQ
                (SPADCALL
...
(SDEFUN |ITRIGMNP;KF2FG| ((|k| |Kernel| F) ($ FG))
        (SPROG
         ((#1=#:G440 NIL) (|a| NIL) (#2=#:G439 NIL) (|op| (|BasicOperator|))
          (|akl| (|List| F)))
...
(SDEFUN |ITRIGMNP;ker2explogs|
        ...
        (SPROG
         ((|e| (FG)) (|z| (FG)) (|args| (|List| FG)) (#1=#:G453 NIL) (|a| NIL)
          (#2=#:G452 NIL) (|kf| (FG)))
...
(SDEFUN |ITRIGMNP;ker2trigs|
        ((|op| |BasicOperator|) (|arg| |List| (|Complex| F)) ($ |Complex| F))
        (SPROG
         ((#1=#:G513 NIL) (|x| NIL) (#2=#:G512 NIL) (#3=#:G511 NIL)
          (#4=#:G510 NIL) (|a| (|Complex| F)) (#5=#:G509 NIL) (#6=#:G508 NIL)
          (#7=#:G471 NIL) (#8=#:G470 #9=(|Boolean|)) (#10=#:G472 #9#)
          (#11=#:G507 NIL))
         (SEQ
          (COND
           ((PROGN
         ...
         ((|g| #1=(|Complex| F)) (|b| (|Integer|)) (|gi| #1#) (|y| (F))
          ...
          (|den|
           #2=(|SparseUnivariatePolynomial|
               (|SparseMultivariatePolynomial| (|Complex| R) (|Kernel| FG))))
          (|num| #2#) (|arg| (|List| (|Complex| F))) (#3=#:G529 NIL) (|x| NIL)
          (#4=#:G528 NIL) (|op| (|BasicOperator|)) (|k| (|Kernel| FG))
...
(DEFUN |InnerTrigonometricManipulations| (&REST #1=#:G543)
  (SPROG NIL
         (PROG (#2=#:G544)
           (RETURN
            (COND
