...
(SDEFUN |FRIDEAL;agcd| ((|l| |List| A) ($ R))
        (SPROG ((#1=#:G408 NIL) (|a| NIL) (#2=#:G407 NIL))
               (SEQ
                (SPADCALL (ELT $ 39)
                          (PROGN
                           (LETT #2# NIL)
...
(SDEFUN |FRIDEAL;oldnorm| ((|i| $) ($ F))
        (SPROG ((#1=#:G418 NIL) (|u| NIL) (#2=#:G417 NIL))
               (SEQ
                (SPADCALL
                 (SPADCALL
                  (PROGN
...
(SDEFUN |FRIDEAL;norm;$F;11| ((|i| $) ($ F))
        (SPROG
         ((#1=#:G432 NIL) (|j| NIL) (#2=#:G431 NIL)
          (|dv| (|SingletonAsOrderedSet|))
          (|pp| (|SparseUnivariatePolynomial| A)) (#3=#:G430 NIL)
...
(SDEFUN |FRIDEAL;tryRange|
        ((|range| |NonNegativeInteger|) (|nm| |Vector| A) (|nrm| R) (|i| $)
         ($ |Union| $ "failed"))
        (SPROG
         ((#1=#:G443 NIL) (#2=#:G444 NIL) (#3=#:G437 NIL) (|a| (A)) (|j| NIL))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |FRIDEAL;summat| ((|i| $) ($ |Matrix| UP))
        (SPROG
         ((#1=#:G452 NIL) (|j| NIL) (#2=#:G451 NIL) (|m| (|Integer|))
          (|v| (|Vector| A)))
         (SEQ
          (LETT |m|
...
(SDEFUN |FRIDEAL;inv;2$;14| ((|i| $) ($ $))
        (SPROG
         ((#1=#:G588 NIL) (|j| NIL) (#2=#:G587 NIL)
          (|d| (|NonNegativeInteger|)) (#3=#:G586 NIL) (|p| NIL)
          (#4=#:G585 NIL) (|invd| (F))
          (|cd2| (|Record| (|:| |num| (|List| R)) (|:| |den| R)))
          (|cd| (|Record| (|:| |num| (|Matrix| UP)) (|:| |den| UP)))
          (|m| (|Matrix| (|Fraction| UP))) (#5=#:G460 NIL))
         (SEQ
          (LETT |m|
                (PROG2
                    (LETT #5#
...
(SDEFUN |FRIDEAL;ideal;V$;15| ((|v| |Vector| A) ($ $))
        (SPROG
         ((#1=#:G603 NIL) (|i| NIL) (#2=#:G602 NIL) (|d| (R)) (#3=#:G601 NIL)
          (#4=#:G600 NIL))
         (SEQ
          (LETT |d|
                (SPADCALL (ELT $ 110)
...
(SDEFUN |FRIDEAL;intIdeal| ((|l| |List| A) (|d| R) ($ $))
        (SPROG
         ((|va| (|Vector| A)) (#1=#:G618 NIL) (#2=#:G620 NIL) (|m| NIL)
          (#3=#:G619 NIL) (|invb| (F)) (|a| (A)) (|b| (R)) (|g| (R)) (|r| (R))
...
(SDEFUN |FRIDEAL;vgcd| ((|v| |Vector| F) ($ R))
        (SPROG ((#1=#:G624 NIL) (|i| NIL) (#2=#:G623 NIL))
               (SEQ
                (SPADCALL
                 (PROGN
                  (LETT #2# NIL)
...
(SDEFUN |FRIDEAL;poly| ((|i| $) ($ |SparseUnivariatePolynomial| A))
        (SPROG
         ((#1=#:G626 NIL) (#2=#:G625 #3=(|SparseUnivariatePolynomial| A))
          (#4=#:G627 #3#) (#5=#:G630 NIL) (|m| (|Integer|)) (|v| (|Vector| A)))
         (SEQ
          (LETT |m|
                (SPADCALL (LETT |v| (SPADCALL |i| (QREFELT $ 15)))
                          (QREFELT $ 58)))
...
(SDEFUN |FRIDEAL;^;$I$;20| ((|i| $) (|m| |Integer|) ($ $))
        (SPROG
         ((#1=#:G638 NIL) (|j| NIL) (#2=#:G637 NIL) (|v| (|Vector| A))
          (|n| (|NonNegativeInteger|)) (#3=#:G633 NIL))
         (SEQ
          (COND
           ((< |m| 0)
...
(SDEFUN |FRIDEAL;num2O| ((|v| |Vector| A) ($ |OutputForm|))
        (SPROG ((#1=#:G642 NIL) (|i| NIL) (#2=#:G641 NIL))
               (SEQ
                (SPADCALL
                 (PROGN
                  (LETT #2# NIL)
...
(SDEFUN |FRIDEAL;basis;$V;22| ((|i| $) ($ |Vector| A))
        (SPROG
         ((#1=#:G647 NIL) (#2=#:G649 NIL) (|j| NIL) (#3=#:G648 NIL) (|d| (F))
          (|v| (|Vector| A)))
         (SEQ (LETT |v| (SPADCALL |i| (QREFELT $ 15)))
              (LETT |d|
                    (SPADCALL
...
(SDEFUN |FRIDEAL;randomLC;NniVA;24|
        ...
        (SPROG
         ((#1=#:G654 NIL) (#2=#:G653 (A)) (#3=#:G655 (A)) (#4=#:G657 NIL)
          (|j| NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
...
(SDEFUN |FRIDEAL;randomLC;NniVA;25|
        ((|m| |NonNegativeInteger|) (|v| |Vector| A) ($ A))
        (SPROG
         ((#1=#:G659 NIL) (#2=#:G658 (A)) (#3=#:G660 (A)) (#4=#:G662 NIL)
          (|j| NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
...
(SDEFUN |FRIDEAL;minimize;2$;26| ((|i| $) ($ $))
        (SPROG
         ((#1=#:G671 NIL) (#2=#:G672 NIL) (|u| (|Union| $ "failed"))
...
(DEFUN |FractionalIdeal| (&REST #1=#:G673)
  (SPROG NIL
         (PROG (#2=#:G674)
           (RETURN
            (COND
