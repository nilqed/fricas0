...
(SDEFUN |REDORDER;ReduceOrder;LLR;3|
        ...
        (SPROG
         ((|rec| (|Record| (|:| |eq| L) (|:| |op| (|List| F)))) (#1=#:G387 NIL)
          (|s| NIL) (#2=#:G386 NIL) (|neweq| (L)) (|sol| (F)))
         (SEQ
...
(SDEFUN |REDORDER;ReduceOrder;LFL;5| ((|eq| L) (|sol| F) ($ L))
        (SPROG
         ((|ans| (L)) (#1=#:G401 NIL) (#2=#:G396 NIL) (|i| NIL) (|si| (F))
          (#3=#:G400 NIL) (#4=#:G393 NIL) (|s| (|PrimitiveArray| F))
...
(DEFUN |ReductionOfOrder| (&REST #1=#:G402)
  (SPROG NIL
         (PROG (#2=#:G403)
           (RETURN
            (COND
