...
(SDEFUN |REP1;calcCoef|
        ...
        (SPROG ((|prod| (|Integer|)) (#1=#:G383 NIL) (|i| NIL))
               (SEQ (LETT |prod| 1)
...
(SDEFUN |REP1;invContent|
        ...
        (SPROG
         ((|i| (|NonNegativeInteger|)) (#2=#:G399 NIL) (|k| NIL)
          (|j| (|Integer|)) (#3=#:G398 NIL) (|og| NIL)
          (|f| (|Vector| (|Integer|))) (|n| (|NonNegativeInteger|))
          (#4=#:G390 NIL) (#5=#:G388 NIL) (#6=#:G387 #1#) (#7=#:G389 #1#)
          (#8=#:G397 NIL) (#9=#:G378 NIL))
         (SEQ
          (LETT |n|
                (PROG1
                    (LETT #4#
...
(SDEFUN |REP1;antisymmetricTensors;MPiM;3|
        ...
        (SPROG
         ((#1=#:G425 NIL) (|t| NIL) (#2=#:G426 NIL) (|tt| NIL) (#3=#:G423 NIL)
          (|r| NIL) (#4=#:G424 NIL) (|rr| NIL) (|c| #5=(|Matrix| R))
          (#6=#:G421 NIL) (|j| NIL) (#7=#:G422 NIL) (|lt| NIL) (#8=#:G419 NIL)
          (|i| NIL) (#9=#:G420 NIL) (|lr| NIL) (|b| #5#) (#10=#:G405 NIL)
          (#11=#:G404 NIL) (|ilc| (|List| (|List| (|Integer|))))
          (#12=#:G418 NIL) (#13=#:G417 NIL)
          (|ilr| (|List| (|List| (|Integer|)))) (#14=#:G416 NIL)
          (#15=#:G415 NIL) (|mc| #16=(|Integer|)) (|mr| #16#)
...
(SDEFUN |REP1;antisymmetricTensors;LPiL;4|
        ((|la| |List| (|Matrix| R)) (|k| |PositiveInteger|)
         ($ |List| (|Matrix| R)))
        (SPROG ((#1=#:G430 NIL) (|ma| NIL) (#2=#:G429 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |REP1;symmetricTensors;MPiM;5|
        ...
        (SPROG
         ((|colemanMatrix| (|Matrix| (|Integer|))) (|help| (R)) (#1=#:G434 NIL)
          (#2=#:G433 NIL) (#3=#:G447 NIL) (|k| NIL)
          (|gamma| (|List| (|Integer|))) (|g| #4=(|Vector| (|Integer|)))
          (|beta| #5=(|List| (|Integer|))) (#6=#:G446 NIL) (|j| NIL) (|f| #4#)
          (|alpha| #5#) (#7=#:G445 NIL) (|i| NIL)
          (|nullMatrix| (|Matrix| (|Integer|))) (|c| (|Matrix| R))
          (|dimc| (|NonNegativeInteger|)) (#8=#:G432 NIL)
          (|dimr| (|NonNegativeInteger|)) (#9=#:G431 NIL)
...
(SDEFUN |REP1;symmetricTensors;LPiL;6|
        ((|la| |List| (|Matrix| R)) (|k| |PositiveInteger|)
         ($ |List| (|Matrix| R)))
        (SPROG ((#1=#:G451 NIL) (|ma| NIL) (#2=#:G450 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |ma| NIL) (LETT #1# |la|) G190
...
(SDEFUN |REP1;tensorProduct;3L;8|
        ((|la| |List| (|Matrix| R)) (|lb| |List| (|Matrix| R))
         ($ |List| (|Matrix| R)))
        (SPROG ((#1=#:G456 NIL) (|i| NIL) (#2=#:G455 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |REP1;permutationRepresentation;PIM;11|
        ((|p| |Permutation| (|Integer|)) (|n| |Integer|)
         ($ |Matrix| (|Integer|)))
        (SPROG
         ((#1=#:G466 NIL) (|i| NIL) (|a| (|Matrix| (|Integer|)))
          (#2=#:G462 NIL) (#3=#:G461 NIL))
         (SEQ
          (LETT |a|
                (SPADCALL
                 (PROG1 (LETT #3# |n|)
...
(SDEFUN |REP1;permutationRepresentation;LM;12|
        ...
        (SPROG
         ((#1=#:G474 NIL) (|i| NIL) (|a| (|Matrix| (|Integer|)))
          (#2=#:G470 NIL) (#3=#:G469 NIL) (|n| (|Integer|)))
         (SEQ (LETT |n| (LENGTH |p|))
              (LETT |a|
                    (SPADCALL
                     (PROG1 (LETT #3# |n|)
...
(SDEFUN |REP1;permutationRepresentation;LIL;13|
        ((|listperm| |List| (|Permutation| (|Integer|))) (|n| |Integer|)
         ($ |List| (|Matrix| (|Integer|))))
        (SPROG ((#1=#:G478 NIL) (|perm| NIL) (#2=#:G477 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |REP1;createGenericMatrix;NniM;15|
        ...
        (SPROG
         ((|sy| (|Symbol|)) (|le| (|List| (|OutputForm|)))
          (|jof| #1=(|OutputForm|)) (|iof| #1#) (#2=#:G489 NIL) (|j| NIL)
          (#3=#:G488 NIL) (|i| NIL) (|res| (|Matrix| (|Polynomial| R))))
...
(DEFUN |RepresentationPackage1| (#1=#:G490)
  (SPROG NIL
         (PROG (#2=#:G491)
           (RETURN
            (COND
