...
(SDEFUN |ROIRC;evalOne| ((|p| |ThePolDom|) ($ |TheField|))
        (SPROG
         ((#1=#:G473 NIL) (#2=#:G472 (|TheField|)) (#3=#:G474 (|TheField|))
          (#4=#:G476 NIL) (#5=#:G378 NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
...
(SDEFUN |ROIRC;sturmNthRoot|
        ((|lp| |List| |ThePolDom|) (|l| |TheField|) (|r| |TheField|)
         ...
         ($ |Union| (|Record| (|:| |low| |TheField|) (|:| |high| |TheField|))
          "failed"))
        (SPROG
         ((#1=#:G490 NIL) (|o| (|Integer|)) (|vi| (|NonNegativeInteger|))
          (|lt| (|List| |TheField|)) (#2=#:G494 NIL) (|t| NIL)
          (|int| (|TheField|)) (|nv| (|NonNegativeInteger|)) (#3=#:G488 NIL))
         (SEQ
          (LETT |nv|
                (PROG1 (LETT #3# (- |vl| |vr|))
...
(SDEFUN |ROIRC;sturmIsolate|
        ...
        (SPROG
         ((|vi| (|NonNegativeInteger|)) (#1=#:G504 NIL) (|t| NIL)
          (#2=#:G503 NIL) (|int| (|TheField|)) (|n| (|NonNegativeInteger|))
          (#3=#:G496 NIL))
         (SEQ
          (COND
...
(SDEFUN |ROIRC;isolate|
        ...
        (SPROG
         ((|l2| #1=(|List| |TheField|)) (|l1| #2=(|List| |TheField|))
          ...
          (|#G38| #3#) (#4=#:G510 NIL) (|t| NIL) (|#G36| #1#) (|#G35| #2#)
          (|b| (|TheField|)))
...
(SDEFUN |ROIRC;rootOf;ThePolDomPiU;14|
        ...
        (SPROG
         ((|res|
          ...
          (|#G51| #3#) (#4=#:G528 NIL) (|t| NIL) (|#G49| #1#) (|#G48| #2#)
...
(SDEFUN |ROIRC;allRootsOf;ThePolDomL;15| ((|pol| |ThePolDom|) ($ |List| $))
        (SPROG
         ((#1=#:G536 NIL) (|term| NIL) (#2=#:G535 NIL)
          (|ls| (|List| |ThePolDom|)))
         (SEQ
...
(SDEFUN |ROIRC;hasVarsl| ((|l| |List| |TheField|) ($ |Boolean|))
        (SPROG ((#1=#:G542 NIL) (#2=#:G543 NIL) (|term| NIL) (|f| (|Integer|)))
               (SEQ
                (EXIT
                 (COND ((NULL |l|) NIL)
                       ('T
        ...
        (SPROG
         ((|d|
           (|Record| (|:| |coef1| |ThePolDom|) (|:| |coef2| |ThePolDom|)
                     (|:| |generator| |ThePolDom|)))
          (#2=#:G573 NIL) (|c| (|TheField|)) (|newPol| (|ThePolDom|)))
         (SEQ
          (COND
...
(DEFUN |RightOpenIntervalRootCharacterization| (&REST #1=#:G634)
  (SPROG NIL
         (PROG (#2=#:G635)
           (RETURN
            (COND
