...
(SDEFUN |SMATCAT-;diagonal;SRow;5| ((|x| S) ($ |Row|))
        (SPROG
         ((#1=#:G404 NIL) (|i| NIL) (#2=#:G405 NIL) (|j| NIL) (#3=#:G406 NIL)
          (|k| NIL) (|v| (|Vector| R)))
...
(SDEFUN |SMATCAT-;equation2R| ((|v| |Vector| S) ($ |Matrix| R))
        (SPROG
         ((#1=#:G419 NIL) (|j| NIL) (#2=#:G418 NIL) (|i| NIL)
          (|ans| (|Matrix| |Col|)))
         (SEQ
          (LETT |ans|
...
(SDEFUN |SMATCAT-;reducedSystem;MM;9| ((|x| |Matrix| S) ($ |Matrix| R))
        (SPROG ((#1=#:G426 NIL) (|i| NIL) (#2=#:G425 NIL))
               (SEQ
                (COND
...
(SDEFUN |SMATCAT-;trace;SR;11| ((|x| S) ($ R))
        (SPROG ((|tr| (R)) (#1=#:G436 NIL) (|i| NIL) (#2=#:G437 NIL) (|j| NIL))
...
(SDEFUN |SMATCAT-;diagonalProduct;SR;12| ((|x| S) ($ R))
        (SPROG ((|pr| (R)) (#1=#:G441 NIL) (|i| NIL) (#2=#:G442 NIL) (|j| NIL))
               (SEQ
                (LETT |pr|
