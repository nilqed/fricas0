...
(SDEFUN |GDMP;monomial;$OvlNni$;3|
        ((|p| $) (|v| |OrderedVariableList| |vl|) (|e| |NonNegativeInteger|)
         ($ $))
        (SPROG
         ((#1=#:G738 NIL) (#2=#:G740 NIL) (|z| NIL) (#3=#:G739 NIL)
...
(SDEFUN |GDMP;listCoef| ((|p| $) ($ |List| R))
        (SPROG ((#1=#:G746 NIL) (|rec| NIL) (#2=#:G745 NIL))
               (SEQ
                (PROGN
...
(SDEFUN |GDMP;mainVariable;$U;6|
        ...
        (SPROG
         ((#2=#:G758 NIL) (|vv| (|OrderedVariableList| |vl|)) (#3=#:G748 NIL)
          (#4=#:G759 NIL) (|v| NIL))
         (SEQ
          (EXIT
...
(SDEFUN |GDMP;degree;$LL;13|
        ...
        (SPROG ((#1=#:G787 NIL) (|v| NIL) (#2=#:G786 NIL))
               (SEQ
                (PROGN
...
(SDEFUN |GDMP;minimumDegree;$LL;14|
        ((|p| $) (|lv| |List| (|OrderedVariableList| |vl|))
         ($ |List| (|NonNegativeInteger|)))
        (SPROG ((#1=#:G791 NIL) (|v| NIL) (#2=#:G790 NIL))
               (SEQ
                (PROGN
...
(SDEFUN |GDMP;maxNorm| ((|p| $) ($ R))
        (SPROG ((|m| (R)) (#1=#:G800 NIL) (|r| NIL) (|l| (|List| R)))
...
(SDEFUN |GDMP;variables;$L;19|
        ...
        (SPROG
         ((#1=#:G808 NIL) (#2=#:G814 NIL) (|i| NIL) (#3=#:G813 NIL)
          (#4=#:G812 NIL) (|tdeg| (E))
...
(SDEFUN |GDMP;reorder;$L$;20| ((|p| $) (|perm| |List| (|Integer|)) ($ $))
        (SPROG
         ((|q| ($)) (#1=#:G824 NIL) (#2=#:G826 NIL) (|j| NIL) (#3=#:G825 NIL)
          (#4=#:G823 NIL) (|term| NIL) (#5=#:G822 NIL))
         (SEQ
          (COND
...
(SDEFUN |GDMP;univariate;$OvlSup;21|
        ...
        (SPROG
         ((|nexp| (E)) (|deg| (|NonNegativeInteger|)) (#1=#:G833 NIL)
          (#2=#:G835 NIL) (|i| NIL) (#3=#:G834 NIL)
...
(SDEFUN |GDMP;eval;$LL$;26|
        ((|p| $) (|Lvar| |List| (|OrderedVariableList| |vl|))
         (|Lpval| |List| $) ($ $))
        (SPROG
         ((|nlpval| (|List| $)) (#1=#:G864 NIL) (|mvar| NIL) (#2=#:G863 NIL)
...
(SDEFUN |GDMP;content;$R;30| ((|p| $) ($ R))
        (SPROG
         ((#1=#:G879 NIL) (#2=#:G878 (R)) (#3=#:G880 (R)) (#4=#:G883 NIL)
          (|t| NIL))
         (SEQ
...
(SDEFUN |GDMP;coerce;$Of;34| ((|p| $) ($ |OutputForm|))
        (SPROG
         ((|lt| #1=(|List| (|OutputForm|))) (|l| #1#) (#2=#:G925 NIL) (|i| NIL)
          (#3=#:G924 NIL) (|t| NIL) (|vl1| (|List| (|OutputForm|)))
          (#4=#:G923 NIL) (|v| NIL) (#5=#:G922 NIL))
         (SEQ
          (COND
...
(DEFUN |GeneralDistributedMultivariatePolynomial| (&REST #1=#:G975)
  (SPROG NIL
         (PROG (#2=#:G976)
           (RETURN
            (COND
...
(DEFUN |GeneralDistributedMultivariatePolynomial;| (|#1| |#2| |#3|)
  (SPROG
   ((#1=#:G974 NIL) (|pv$| NIL) (#2=#:G964 NIL) (#3=#:G965 NIL) (#4=#:G966 NIL)
    (#5=#:G967 NIL) (#6=#:G968 NIL) (#7=#:G969 NIL) (#8=#:G970 NIL)
    (#9=#:G971 NIL) (#10=#:G972 NIL) (#11=#:G973 NIL) ($ NIL) (|dv$| NIL)
    (DV$3 NIL) (DV$2 NIL) (DV$1 NIL))
   (PROGN
    (LETT DV$1 (|devaluate| |#1|)
          . #12=(|GeneralDistributedMultivariatePolynomial|))
...
(MAKEPROP '|GeneralDistributedMultivariatePolynomial| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL (|PolynomialRing| 7 8) (|local| |#1|)
              ...
              (|InputForm|) (|Pattern| (|Float|)) (|Pattern| 44) (|Matrix| 44)
              (|Record| (|:| |mat| 152) (|:| |vec| (|Vector| 44))) (|Vector| $)
              ...
              (|Record| (|:| |mat| 168) (|:| |vec| (|Vector| 7))) (|Matrix| 7)
              (|List| 170) (|Equation| $)
            ...
            (CONS
             ...
             (CONS
              '#((|PolynomialCategory| 7 8 (|OrderedVariableList| 6))
                 ...
                 (|Algebra| 158) (|Algebra| 7) (|FullyLinearlyExplicitOver| 7)
                 (|Algebra| $$) (|LeftOreRing|) (|Module| 158)
                 ...
                 (|BiModule| 7 7) (|BiModule| 158 158) (|BiModule| $$ $$)
                 (|Ring|) (|LeftModule| 7) (|RightModule| 7) (|LeftModule| 158)
                 (|RightModule| 158) (|RightModule| $$) (|LeftModule| $$)
              ...
              (|makeByteWordVec2| 146
                                  '(1 8 14 0 15 0 0 0 16 2 17 0 0 0 18 3 14 17
                                    ...
                                    55 12 0 13 1 0 55 0 73 2 0 46 0 23 47 1 0
                                    ...
                                    0 39 1 0 7 0 116 2 13 0 0 0 129 3 0 0 0 23
                                    0 83 3 0 0 0 55 103 104 3 0 0 0 23 7 85 3 0
                                    0 0 55 87 88 2 4 0 0 23 53 2 0 54 0 55 56 2
                                    0 17 0 23 35 1 0 8 0 67 1 13 7 0 125 1 11 0
                                    23 31 1 0 0 7 84 1 0 133 0 146 2 51 0 0 17
                                    109 0 55 0 16 0 51 0 25 2 17 0 0 7 65 2 0 0
                                    0 0 111 2 0 0 7 0 64 2 0 0 0 0 29)))))
           '|lookupIncomplete|)) 
