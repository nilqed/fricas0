...
(SDEFUN |FRIMOD;getinvintmat| (($ |Boolean|))
        (SPROG
         ((#1=#:G721 NIL) (|j| NIL) (#2=#:G720 NIL) (|i| NIL)
...
(SDEFUN |FRIMOD;getintmat| (($ |Boolean|))
        (SPROG
         ((#1=#:G727 NIL) (|j| NIL) (#2=#:G726 NIL) (|i| NIL)
          (|m| (|Matrix| F)))
         (SEQ
...
(SDEFUN |FRIMOD;vectProd| ((|v1| |Vector| A) (|v2| |Vector| A) ($ |Vector| A))
        (SPROG
         ((|k| (|Integer|)) (#1=#:G739 NIL) (|j| NIL) (#2=#:G738 NIL) (|i| NIL)
          (|v| (|Vector| A)))
         (SEQ
          (LETT |k|
                (SPADCALL
...
(SDEFUN |FRIMOD;*;3$;14| ((|m1| $) (|m2| $) ($ $))
        (SPROG
         ((|u| (A)) (#1=#:G747 NIL) (|i| NIL) (#2=#:G746 NIL)
          (|m| (|Matrix| R))
...
(DEFUN |FractionalIdealAsModule| (&REST #1=#:G749)
  (SPROG NIL
         (PROG (#2=#:G750)
           (RETURN
            (COND
