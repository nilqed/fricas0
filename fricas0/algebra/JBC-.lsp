...
(SDEFUN |JBC-;m2r;LL;1|
        ...
        (SPROG
         ((|k| (|PositiveInteger|)) (|ri| (|List| (|PositiveInteger|)))
          (#1=#:G744 NIL) (|j| NIL) (#2=#:G743 NIL) (|i| NIL))
...
(SDEFUN |JBC-;r2m;LL;2|
        ...
        (SPROG
         ((#1=#:G756 NIL) (|i| NIL) (|mi| (|List| (|NonNegativeInteger|))))
         (SEQ
...
(SDEFUN |JBC-;allRepeated;LL;3|
        ...
        (SPROG
         ((|res| (|List| (|List| (|PositiveInteger|))))
          (|tmp| (|List| (|List| (|PositiveInteger|)))) (#1=#:G757 NIL)
          (|nu| (|List| (|NonNegativeInteger|))) (#2=#:G781 NIL) (|i| NIL)
          (#3=#:G782 NIL) (|k| NIL))
...
(SDEFUN |JBC-;class;LNni;5|
        ...
        (SPROG ((|res| (|PositiveInteger|)) (#1=#:G787 NIL) (|i| NIL))
...
(SDEFUN |JBC-;order;SNni;7| ((|jv| S) ($ |NonNegativeInteger|))
        (SPROG ((|sum| (|NonNegativeInteger|)) (#1=#:G799 NIL) (|i| NIL))
               (SEQ
                (COND
...
(SDEFUN |JBC-;dimJ;2Nni;18|
        ((|q| |NonNegativeInteger|) ($ |NonNegativeInteger|))
        (SPROG
         ((|res| (|NonNegativeInteger|)) (#1=#:G826 NIL) (#2=#:G830 NIL)
...
(SDEFUN |JBC-;dimS;2Nni;19|
        ((|q| |NonNegativeInteger|) ($ |NonNegativeInteger|))
        (SPROG
         ((|res| (|NonNegativeInteger|)) (#1=#:G837 NIL) (#2=#:G841 NIL)
...
(SDEFUN |JBC-;derivativeOf?;2SL;21|
        ...
        (SPROG
         ((|res| (|List| (|NonNegativeInteger|))) (#1=#:G859 NIL)
          (#2=#:G865 NIL) (#3=#:G866 NIL) (|i1| NIL) (#4=#:G867 NIL) (|i2| NIL)
          (|jt| (|Symbol|)))
         (SEQ
          (EXIT
           (COND
...
(SDEFUN |JBC-;integrateIfCan;SPiU;22|
        ...
        (SPROG
         ((|rind| (|List| (|PositiveInteger|))) (|pos| (|Integer|))
          (#1=#:G871 NIL) (|mi| (|NonNegativeInteger|))
...
(SDEFUN |JBC-;<;2SB;27| ((|jv1| S) (|jv2| S) ($ |Boolean|))
        (SPROG
         ((#1=#:G903 NIL) (#2=#:G904 NIL) (|i1| NIL) (#3=#:G905 NIL) (|i2| NIL)
...
(SDEFUN |JBC-;variables;NniL;29| ((|q| |NonNegativeInteger|) ($ |List| S))
        (SPROG
         ((#1=#:G940 NIL) (#2=#:G957 NIL) (|i| NIL) (#3=#:G956 NIL)
          (#4=#:G937 NIL) (#5=#:G955 NIL) (#6=#:G954 NIL) (JV (|List| S))
          (#7=#:G921 NIL) (#8=#:G953 NIL) (|k| NIL) (#9=#:G952 NIL) (|ind| NIL)
          (|IndList| (|List| (|List| (|PositiveInteger|))))
          (|OIndList| (|List| (|List| (|PositiveInteger|))))
          (|NIndList| (|List| (|List| (|PositiveInteger|)))) (#10=#:G915 NIL)
          (#11=#:G951 NIL) (|j| NIL) (#12=#:G950 NIL) (#13=#:G949 NIL)
          (|qq| NIL) (#14=#:G912 NIL) (#15=#:G948 NIL) (#16=#:G910 NIL)
          (#17=#:G947 NIL) (#18=#:G946 NIL) (#19=#:G908 NIL) (#20=#:G945 NIL))
         (SEQ
          (COND
           ((ZEROP |q|)
            (PROGN
...
(SDEFUN |JBC-;variables;NniPiL;30|
        ...
        (SPROG
         ((JV (|List| S)) (#1=#:G967 NIL) (#2=#:G979 NIL) (|k| NIL)
          (#3=#:G978 NIL) (|ind| NIL)
          (|OIndList| (|List| (|List| (|PositiveInteger|))))
          (|NIndList| (|List| (|List| (|PositiveInteger|)))) (#4=#:G961 NIL)
          (#5=#:G977 NIL) (|j| NIL) (#6=#:G976 NIL) (#7=#:G975 NIL) (|qq| NIL)
          (#8=#:G958 NIL) (#9=#:G974 NIL) (|i| NIL) (#10=#:G973 NIL))
         (SEQ
          (COND ((ZEROP |q|) NIL)
                ('T
                 (SEQ
