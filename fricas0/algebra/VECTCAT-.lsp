...
(SDEFUN |VECTCAT-;zero?;SB;3| ((|y| S) ($ |Boolean|))
        (SPROG ((#1=#:G718 NIL) (#2=#:G719 NIL) (|i| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ
...
(SDEFUN |VECTCAT-;dot;2SR;9| ((|u| S) (|v| S) ($ R))
        (SPROG
         ((#1=#:G729 NIL) (#2=#:G728 (R)) (#3=#:G730 (R)) (#4=#:G733 NIL)
          (|i| NIL))
         (SEQ
          (COND
...
(SDEFUN |VECTCAT-;outerProduct;2SM;10| ((|u| S) (|v| S) ($ |Matrix| R))
        (SPROG
         ((#1=#:G745 NIL) (|i| NIL) (#2=#:G744 NIL) (#3=#:G743 NIL) (|j| NIL)
          (#4=#:G742 NIL))
         (SEQ
          (SPADCALL
           (PROGN
                       ...
                       (CONS '#()
                             (|makeByteWordVec2| 48
                                                 '(1 6 8 0 9 2 11 10 0 0 12 2 7
                                                   ...
                                                   18 1 0 0 8 19 1 6 11 0 20 1
                                                   6 11 0 21 2 6 7 0 11 22 2 7
                                                   10 0 0 23 1 0 10 0 24 1 7 0
                                                   0 25 2 6 0 26 0 27 1 0 0 0
                                                   28 2 7 0 11 0 29 2 0 0 11 0
                                                   30 1 6 0 0 31 2 6 0 0 0 32 2
                                                   0 0 0 0 33 2 7 0 0 0 34 2 0
                                                   0 0 7 35 2 0 0 7 0 36 2 0 7
