        ...
        (SPROG ((|p'| (|Union| (|Complex| S) "failed")))
               (SEQ
                ...
                (EXIT
                 (COND ((QEQCAR |p'| 1) (CONS 1 "failed"))
                       ('T
                        (CONS 0 (SPADCALL (QCDR |p'|) |n| (QREFELT $ 16))))))))) 
        ...
        (SPROG ((|p'| (|Union| S "failed")))
               (SEQ
                ...
                (EXIT
                 (COND ((QEQCAR |p'| 1) (CONS 1 "failed"))
                       ('T
                        (CONS 0 (SPADCALL (QCDR |p'|) |n| (QREFELT $ 27))))))))) 
        ...
        (SPROG
         ...
         (SEQ
          (LETT |num| (SPADCALL (SPADCALL |f| (QREFELT $ 32)) (QREFELT $ 26))
                . #2=(|NUMERIC;complexNumericIfCan;FU;8|))
          (EXIT
           (COND ((QEQCAR |num| 1) (CONS 1 "failed"))
                 (#3='T
                  (SEQ
        ...
        (SPROG
         ...
         (SEQ
          (LETT |num|
                ...
                . #2=(|NUMERIC;complexNumericIfCan;FPiU;9|))
          (EXIT
           (COND ((QEQCAR |num| 1) (CONS 1 "failed"))
                 (#3='T
                  (SEQ
        ...
        (SPROG
         ...
         (SEQ
          (LETT |num| (SPADCALL (SPADCALL |f| (QREFELT $ 41)) (QREFELT $ 14))
                . #2=(|NUMERIC;complexNumericIfCan;FU;11|))
          (EXIT
           (COND ((QEQCAR |num| 1) (CONS 1 "failed"))
                 (#3='T
                  (SEQ
        ...
        (SPROG
         ...
         (SEQ
          (LETT |num|
                ...
                . #2=(|NUMERIC;complexNumericIfCan;FPiU;12|))
          (EXIT
           (COND ((QEQCAR |num| 1) (CONS 1 "failed"))
                 (#3='T
                  (SEQ
...
(SDEFUN |NUMERIC;numericIfCan;EPiU;15|
        ...
        (SPROG ((|old| (|PositiveInteger|)))
               (SEQ
                (LETT |old| (SPADCALL (QREFELT $ 60))
                      |NUMERIC;numericIfCan;EPiU;15|)
                (EXIT
                 (|finally|
...
(SDEFUN |NUMERIC;complexNumeric;PPiC;28|
        ...
        (SPROG ((|p'| (|Union| (|Complex| S) "failed")))
               (SEQ
                (LETT |p'| (SPADCALL |p| (QREFELT $ 9))
                      |NUMERIC;complexNumeric;PPiC;28|)
                (EXIT
                 (COND
                  ((QEQCAR |p'| 1)
                   (|error|
