           ...
           (#4='T
            (SEQ
             (LETT |r| (SPADCALL |x| (QREFELT $ 22))
                   . #5=(|PMPLCAT;patternMatch;PPPmrMPmr;2|))
             (EXIT
              (COND
               ((QEQCAR |r| 0) (SPADCALL (QCDR |r|) |p| |l| (QREFELT $ 24)))
               (#4#
                (SEQ (LETT |v| (SPADCALL |x| (QREFELT $ 26)) . #5#)
                     (EXIT
                      (COND
                       ((QEQCAR |v| 0) (SPADCALL (QCDR |v|) |p| |l| |vmatch|))
                       (#4#
                        (SEQ (LETT |u| (SPADCALL |p| (QREFELT $ 28)) . #5#)
                             (EXIT
                              (COND
                               ((QEQCAR |u| 0)
                                (SEQ
                                        ...
                                        (COND
                                         ...
                                         (#4#
                                          (SPADCALL |x|
                                                    ...
                                                    |l| |vmatch|
                                                    (QREFELT $ 16)))))
                                       (#4# (SPADCALL (QREFELT $ 41)))))))))))
                               (#4#
                                (SEQ
                                 (LETT |u| (SPADCALL |p| (QREFELT $ 43)) . #5#)
                                 (EXIT
                                  (COND
                                   ((QEQCAR |u| 0)
                                    (SEQ
...
(SDEFUN |PMPLCAT;patternMatch;PPPmrMPmr;2!2|
        ...
        (PROG (|vmatch| $)
          (LETT |vmatch| (QREFELT $$ 1)
                . #1=(|PMPLCAT;patternMatch;PPPmrMPmr;2|))
          (LETT $ (QREFELT $$ 0) . #1#)
...
(SDEFUN |PMPLCAT;patternMatch;PPPmrMPmr;2!0| ((|l1| NIL) ($ NIL))
        (SPROG
         ((#1=#:G720 NIL) (#2=#:G719 NIL) (#3=#:G721 NIL) (#4=#:G723 NIL)
          (#5=#:G690 NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL NIL)
...
(DEFUN |PatternMatchPolynomialCategory| (&REST #1=#:G786)
  (SPROG NIL
         (PROG (#2=#:G787)
           (RETURN
            (COND
