...
(DEFUN |DistributedMultivariatePolynomial;| (|#1| |#2|)
  (SPROG
   ((#1=#:G764 NIL) (|pv$| NIL) (#2=#:G754 NIL) (#3=#:G755 NIL) (#4=#:G756 NIL)
    ...
    (DV$2 NIL) (DV$1 NIL))
   (PROGN
    (LETT DV$1 (|devaluate| |#1|) . #12=(|DistributedMultivariatePolynomial|))
    (LETT DV$2 (|devaluate| |#2|) . #12#)
    (LETT |dv$| (LIST '|DistributedMultivariatePolynomial| DV$1 DV$2) . #12#)
    (LETT $ (GETREFV 57) . #12#)
    (QSETREFV $ 0 |dv$|)
    (QSETREFV $ 3
              (LETT |pv$|
...
(MAKEPROP '|DistributedMultivariatePolynomial| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL
              ...
              (|DirectProduct| (NRTEVAL (LENGTH (QREFELT $ 6))) 20)
           ...
           (CONS
            ...
            (CONS
             ...
             (CONS
              '#((|PolynomialCategory| 7 (|DirectProduct| (LENGTH 6) 20)
                                       (|OrderedVariableList| 6))
                 (|MaybeSkewPolynomialCategory| 7
                                                (|DirectProduct| (LENGTH 6) 20)
                                                (|OrderedVariableList| 6))
                 (|PolynomialFactorizationExplicit|)
                 (|FiniteAbelianMonoidRing| 7 (|DirectProduct| (LENGTH 6) 20))
                 (|UniqueFactorizationDomain|)
                 (|AbelianMonoidRing| 7 (|DirectProduct| (LENGTH 6) 20))
