...
(SDEFUN |JCT;transform;JB1Jbe;4| ((|jv| JB1) ($ |JetBundleExpression| JB2))
        (SPROG
         ((|res| (|JetBundleExpression| JB2)) (#1=#:G752 NIL) (#2=#:G758 NIL)
          (#3=#:G760 NIL) (|k| NIL) (#4=#:G759 NIL)
          (|qint| (|JetBundleExpression| JB2)) (|pint| (JB1)) (#5=#:G738 NIL)
