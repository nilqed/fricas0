                         ...
                         (SEQ
                          (LETT |num|
                                (SPADCALL
                                 (SPADCALL |num|
                                           (SPADCALL
                                            (SPADCALL 2 (QREFELT $ 29))
                                            (SPADCALL
                                             (SPADCALL 5 8 (QREFELT $ 37))
                           ...
                           (LETT |den|
                                 (SPADCALL
                                  (SPADCALL (SPADCALL (QREFELT $ 42)) |nf|
                                            (QREFELT $ 34))
                                  (SPADCALL 3 8 (QREFELT $ 37)) (QREFELT $ 39))
                                 . #1#)))))
                       (EXIT
                  ...
                  (SEQ
                   (LETT |lc|
                         (SPADCALL
                          ...
                          (QREFELT $ 20))
                         . #3#)
                   (LETT |b1| (|spadConstant| $ 16) . #3#)
                   (LETT |b2| (|spadConstant| $ 16) . #3#)
                   (LETT |b3| (|spadConstant| $ 16) . #3#)
                   (LETT |b4| (|spadConstant| $ 16) . #3#)
                   (LETT |c| (|spadConstant| $ 16) . #3#)
                   (LETT |cl| (|spadConstant| $ 16) . #3#)
                        ...
                        (SEQ
                         (LETT |c|
                               (SPADCALL
                                ...
                                (QREFELT $ 20))
                               . #3#)
                         (LETT |b1| (SPADCALL |b1| |c| (QREFELT $ 26)) . #3#)
                         (LETT |cl| (SPADCALL |c| |lc| (QREFELT $ 35)) . #3#)
                         (LETT |b2|
                               (SPADCALL |b2|
        ...
        (SPROG
         ...
         (SEQ
          (EXIT
           (SEQ
            (LETT |d| (SPADCALL |f| (QREFELT $ 28))
                  . #5=(|GALFACTU;bombieriNorm;UPPiF;10|))
            (LETT |b|
                  (SPADCALL
            ...
            (LETT |b|
                  (SPADCALL |b|
                            ...
                            (QREFELT $ 22))
                  . #5#)
            (LETT |dd| (QUOTIENT2 (- |d| 1) 2) . #5#)
            (SEQ (LETT |i| 1 . #5#) (LETT #3# |dd| . #5#) G190
  ...
  (SPROG ((|pv$| NIL) ($ NIL) (|dv$| NIL) (DV$3 NIL) (DV$2 NIL) (DV$1 NIL))
         (PROGN
          (LETT DV$1 (|devaluate| |#1|)
                . #1=(|GaloisGroupFactorizationUtilities|))
                       ...
                       (CONS '#()
                             (|makeByteWordVec2| 60
                                                 '(0 6 0 11 0 7 0 12 0 8 0 16 1
                                                   ...
                                                   35 2 36 0 23 23 37 2 36 0 0
                                                   0 38 2 8 0 0 36 39 2 8 0 13
                                                   0 40 1 8 0 0 41 0 8 0 42 1
                                                   43 23 8 44 1 7 6 0 47 2 7 6
                                                   0 27 48 2 43 8 27 23 49 2 8
                                                   0 27 0 50 1 43 23 8 51 2 8 0
                                                   0 0 52 1 8 0 0 54 0 6 0 56 0
                                                   7 0 57 1 23 58 0 59 2 0 23 7
                                                   27 45 1 0 23 7 46 1 0 23 7
                                                   53 1 0 8 7 25 2 0 8 7 13 14
                                                   1 0 8 7 15 1 0 8 7 9 1 0 8 7
                                                   10 1 0 8 7 30 2 0 8 7 13 60
                                                   1 0 23 7 55)))))
           '|lookupComplete|)) 
