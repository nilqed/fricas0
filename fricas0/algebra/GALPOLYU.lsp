...
(SDEFUN |GALPOLYU;factorsOfDegree;PiFL;1|
        ...
        (SPROG
         ((|lfact| (|List| UP)) (#1=#:G718 NIL) (|i| NIL) (#2=#:G717 NIL)
          (|fr| NIL))
...
(SDEFUN |GALPOLYU;factorOfDegree;PiFUP;2|
        ...
        (SPROG ((#1=#:G723 NIL) (|factor| (UP)) (#2=#:G724 NIL) (|i| NIL))
               (SEQ
                (EXIT
                 (SEQ
                        ...
                        (EXIT
                         (COND
                          ((EQL (SPADCALL |factor| (QREFELT $ 13)) |d|)
                           (PROGN (LETT #1# |factor| . #3#) (GO #4=#:G722))))))
                       (LETT |i| (|inc_SI| |i|) . #3#) (GO G190) G191
                       (EXIT NIL))
...
(SDEFUN |GALPOLYU;reverse;2UP;5| ((|p| UP) ($ UP))
        (SPROG
         ((|r| (UP)) (#1=#:G730 NIL) (#2=#:G734 NIL) (|i| NIL)
...
(DEFUN |GaloisGroupPolynomialUtilities| (&REST #1=#:G754)
  (SPROG NIL
         (PROG (#2=#:G755)
           (RETURN
            (COND
