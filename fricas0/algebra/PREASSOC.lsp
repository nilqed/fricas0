...
(SDEFUN |PREASSOC;makeMonic|
        ...
        (SPROG
         ((#1=#:G714 NIL) (|u| (|Union| R "failed")) (#2=#:G715 NIL)
          (#3=#:G706 NIL) (|i| NIL) (|a| (|PrimitiveArray| R))
            ...
            (SEQ (LETT |i| 0 . #4#)
                 ...
                 (SEQ
                  ...
                  (EXIT
                   (COND
                    ((QEQCAR |u| 1)
                     (PROGN (LETT #1# (CONS 1 "failed") . #4#) (GO #5=#:G713)))
                    ('T
                     (QSETAREF1 |a| |i|
...
(DEFUN |PrecomputedAssociatedEquations| (&REST #1=#:G742)
  (SPROG NIL
         (PROG (#2=#:G743)
           (RETURN
            (COND
