...
(SDEFUN |CFACET;cubicalFacet;IL$;1|
        ...
        (SPROG
         ((|mul2| (|Integer|)) (|fac2| (|List| (|Segment| (|Integer|))))
          ...
          (|hi| (|Integer|)) (|lo| (|Integer|)) (#1=#:G737 NIL) (|x| NIL))
...
(SDEFUN |CFACET;cubicalFacet;IL$;2|
        ...
        (SPROG
         ((|fac2| (|List| (|Segment| (|Integer|))))
          (|interv| (|Segment| (|Integer|))) (#1=#:G746 NIL) (|x| NIL))
...
(SDEFUN |CFACET;position;$LI;8| ((|e| $) (|lst| |List| $) ($ |Integer|))
        (SPROG ((#1=#:G767 NIL) (|res| (|Integer|)) (#2=#:G768 NIL) (|x| NIL))
               (SEQ
                (EXIT
...
(SDEFUN |CFACET;deltaOneDimension|
        ...
        (SPROG
         ((|res| (|List| $)) (|r2| ($)) (|r1| ($)) (|mult| (|Integer|))
          ...
          (|lo| (|Integer|)) (#1=#:G778 NIL) (|seg| NIL) (#2=#:G779 NIL)
...
(SDEFUN |CFACET;delta;$L;11| ((|orf| $) ($ |List| $))
        (SPROG
         ((|invert| (|Boolean|)) (|res| (|List| $)) (#1=#:G789 NIL) (|dim| NIL)
          (|dims| (|List| (|NonNegativeInteger|))) (|hi| (|Integer|))
          (|lo| (|Integer|)) (#2=#:G787 NIL) (|seg| NIL) (#3=#:G788 NIL)
...
(SDEFUN |CFACET;addIfNew2| ((|lst| |List| $) (|orfs| |List| $) ($ |List| $))
        (SPROG ((|res| (|List| $)) (#1=#:G802 NIL) (|orf| NIL) (#2=#:G801 NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (COND
...
(SDEFUN |CFACET;allSubsets;$NniL;14|
        ...
        (SPROG
         ((|res| (|List| $)) (|sub| (|List| $)) (|rHi1| ($))
          ...
          (|lo| (|Integer|)) (#3=#:G814 NIL) (|x| NIL) (#4=#:G815 NIL)
          (|xn| NIL) (#5=#:G813 NIL) (|mult| (|Integer|))
          (|facet| (|List| (|Segment| (|Integer|)))))
         (SEQ
          (EXIT
...
(SDEFUN |CFACET;allSubsets;$2NniL;15|
        ...
        (SPROG
         ((|res2| (|List| $)) (#1=#:G821 NIL) (|y| NIL) (|res| (|List| $)))
         (SEQ
...
(SDEFUN |CFACET;ltLocal|
        ...
        (SPROG
         ((#1=#:G831 NIL) (|hib| #2=(|Integer|)) (|lob| #3=(|Integer|))
          (|hia| #2#) (|loa| #3#) (#4=#:G832 NIL) (|a1| NIL) (#5=#:G833 NIL)
          (|b1| NIL))
         (SEQ
          (EXIT
           (SEQ
            (COND
             ((SPADCALL |a| |b| (QREFELT $ 30))
              (PROGN (LETT #1# NIL . #6=(|CFACET;ltLocal|)) (GO #7=#:G830))))
...
(SDEFUN |CFACET;<=;2$B;19| ((|ain| $) (|bin| $) ($ |Boolean|))
        (SPROG
         ((#1=#:G838 NIL) (|b| #2=(|List| (|Segment| (|Integer|)))) (|a| #2#))
         (SEQ
          (EXIT
                 ...
                 (SEQ
                  (COND
                   ((SPADCALL (QCAR |a|) (QCAR |b|) (QREFELT $ 17))
                    (PROGN (LETT #1# NIL |CFACET;=;2$B;20|) (GO #2=#:G842))))
...
(SDEFUN |CFACET;coerce;$Of;21| ((|s| $) ($ |OutputForm|))
        (SPROG
         ((|body| (|OutputForm|)) (|elements| (|List| (|OutputForm|)))
          (#1=#:G851 NIL) (|x| NIL) (#2=#:G850 NIL) (|prefix| (|OutputForm|))
          (|m| (|Integer|)))
