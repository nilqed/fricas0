...
(DEFUN BUMPCOMPERRORCOUNT #1=() (PROG #1# (RETURN NIL)))
...
(DEFUN TOP #1=() (PROG #1# (RETURN (|returnToTopLevel|))))
...
(DEFUN TOPLEVEL #1=() (PROG #1# (RETURN (THROW '|top_level| '|restart|))))
